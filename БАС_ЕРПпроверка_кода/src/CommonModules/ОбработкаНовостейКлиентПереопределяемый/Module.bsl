...
//				ОткрываемаяФорма = ОбработкаНовостейКлиентСервер.НайтиПоПредставлению(СписокПараметров, "ИмяФормы");
...
//				Текст = ОбработкаНовостейКлиентСервер.НайтиПоПредставлению(СписокПараметров, "Текст");
