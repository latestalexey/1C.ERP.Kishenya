...
Процедура ПриОпределенииКраткогоИмениКонфигурации(КраткоеИмя) Экспорт
	...
	КраткоеИмя = "BASTrade" + ?(СтандартныеПодсистемыСервер.ЭтоБазоваяВерсияКонфигурации(), "Base", ""); // в конфигурации УТ3
	//++ НЕ УТ
	КраткоеИмя = "ARAutomationUkr"; // в конфигурации КА2
	//-- НЕ УТ
	//++ НЕ УТКА
    КраткоеИмя = "BASERP"; // в конфигурации BAS ERP
	//-- НЕ УТКА
...
Процедура ПриОпределенииАдресаСервераДляПроверкиНаличияОбновления(АдресСервера) Экспорт
	...
	АдресСервера = "downloads.bas-soft.eu";
