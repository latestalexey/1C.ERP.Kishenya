...
Функция ФильтрДиалоговВыбораИСохранения() Экспорт
	...
	Фильтр = НСтр("ru='Внешние отчеты и обработки (*.%1, *.%2)|*.%1;*.%2|Внешние отчеты (*.%1)|*.%1|Внешние обработки (*.%2)|*.%2';uk='Зовнішні звіти й обробки (*.%1, *.%2)|*.%1;*.%2|Зовнішні звіти (*.%1)|*.%1|Зовнішні обробки (*.%2)|*.%2'");
...
Функция НаименованиеПодсистемы(ДляПользователя) Экспорт
	...
	Возврат НСтр("ru='Дополнительные отчеты и обработки';uk='Додаткові звіти й обробки'",КодЯзыка);
КонецФункции
