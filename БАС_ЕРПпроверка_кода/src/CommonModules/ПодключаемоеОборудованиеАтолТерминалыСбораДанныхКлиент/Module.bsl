			...
			Для Каждого СтрокаФормата Из Параметры.ФорматЗагрузки Цикл
				...
				ИначеЕсли СтрокаФормата.Наименование = "Количество" Тогда
					...
					Исключение 
						ВыходныеПараметры.Очистить();
						ВыходныеПараметры.Добавить(999);
						ВыходныеПараметры.Добавить(НСтр("ru='Ошибка при загрузке поля ""Количество"".';uk='Помилка при завантаженні поля ""Кількість"".'"));
						Результат = Ложь;
					КонецПопытки;
				КонецЕсли;
			КонецЦикла;
...
Функция ТестУстройства(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ВыходныеПараметры.Добавить(?(Результат, "", НСтр("ru='Ошибка при подключении устройства';uk='Помилка при підключенні обладнання'")));
