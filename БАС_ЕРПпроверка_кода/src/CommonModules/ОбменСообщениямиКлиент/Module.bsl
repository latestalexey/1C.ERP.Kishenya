...
Процедура ОтправитьИПолучитьСообщения() Экспорт
	...
	Иначе
		...
		Состояние(НСтр("ru='Отправка и получение сообщений успешно завершены.';uk='Відправлення і отримання повідомлень успішно завершені.'"),,, БиблиотекаКартинок.Информация32);
