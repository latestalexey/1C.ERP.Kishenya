	...
	Если Удержания <> Неопределено Тогда
		...
		Иначе
			...
			Если Истина Тогда
				...
				УдержанияПоРабочимМестам = УдержанияПоОсновнымРабочимМестам(Удержания, ПериодРегистрации, Организация, ТаблицаМестРаботы, Истина);
...
Процедура ЗарегистрироватьНДФЛ(Движения, Отказ, Организация, ПериодРегистрации, РезультатыРасчетаНДФЛ, МенеджерВременныхТаблиц, ХарактерВыплаты = Неопределено, ЗаписыватьДвижения = Ложь) Экспорт
	...
	Иначе
		...
		Если Истина Тогда
			...
			УдержанияПоРабочимМестам = УдержанияПоОсновнымРабочимМестам(ТаблицыНДФЛиВС.ТаблицаНДФЛ, ПериодРегистрации, Организация, ТаблицаМестРаботы, Истина, Перечисления.ВидыОсобыхНачисленийИУдержаний.НДФЛ);
			УдержанияПоРабочимМестамВС = УдержанияПоОсновнымРабочимМестам(ТаблицыНДФЛиВС.ТаблицаВС, ПериодРегистрации, Организация, ТаблицаМестРаботы, Истина, Перечисления.ВидыОсобыхНачисленийИУдержаний.ВоенныйСбор);
...
Функция УдержанияПоОсновнымРабочимМестам(Удержания, ПериодРегистрации, Организация, ТаблицаРабочихМест, УчитыватьПодразделение = Ложь, ВидУдержания = Неопределено) Экспорт
