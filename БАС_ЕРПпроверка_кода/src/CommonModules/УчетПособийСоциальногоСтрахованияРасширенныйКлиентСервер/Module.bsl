...
Функция ОписаниеСтрокиДанныхОНачисленияхСреднегоЗаработкаФСС() Экспорт
	...
	ПоляОписания.Вставить("Предел", Новый ОписаниеТипов("Число"));
	ПоляОписания.Вставить("УчтеннаяСумма", Новый ОписаниеТипов("Число"));
	ПоляОписания.Вставить("СуммаСУчетомОграничений", Новый ОписаниеТипов("Число"));
