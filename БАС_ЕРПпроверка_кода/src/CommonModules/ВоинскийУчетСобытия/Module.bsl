...
Процедура ЗарегистрироватьИзменениеОбразованияФизическогоЛицаПередЗаписью(Источник, Отказ, Замещение) Экспорт
	...
	Если НЕ Источник.ОсновноеОбразование Тогда
		Возврат;
	КонецЕсли; 
	...
	Запрос.Текст =
		...
		|	ОбразованиеФЛ.ОсновноеОбразование КАК ОсновноеОбразование,
		...
		|	И ОбразованиеФЛ.ОсновноеОбразование
	...
	Если СтрокаСсылки <> Неопределено Тогда
		ЗаполнитьЗначенияСвойств(СтрокаСсылки, Источник, "ОсновноеОбразование,УчебноеЗаведение,ВидОбразования,Специальность,Окончание,Квалификация");
	КонецЕсли; 
