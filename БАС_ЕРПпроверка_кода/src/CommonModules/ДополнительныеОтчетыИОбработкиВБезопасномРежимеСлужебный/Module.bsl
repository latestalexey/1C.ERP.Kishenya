...
Функция ВыполнитьСценарийБезопасногоРежима(Знач КлючСессии, Знач Сценарий, Знач ИсполняемыйОбъект, ПараметрыВыполнения, СохраняемыеПараметры = Неопределено, ОбъектыНазначения = Неопределено) Экспорт
	...
	Для Каждого ШагСценария Из Сценарий Цикл
		...
		Иначе
			...
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Неизвестный вид действия для этапа сценария: %1';uk='Невідомий вид дії для етапу сценарію: %1'"), ШагСценария.ВидДействия);
		...
		Для Каждого ПараметрМетода Из ПараметрыМетода Цикл
			...
			Иначе
				...
				ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Неизвестный параметр для этапа сценария: %1';uk='Невідомий параметр для етапу сценарію: %1'"), ПараметрМетода.Вид);
...
Функция ТекстИсключенияРазрешениеНеПредоставлено(Знач КлючСессии, Знач ТипТребуемогоРазрешения)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Дополнительному отчету или обработке %1 не предоставлено разрешение {%2}%3!';uk='Додатковому звіту або обробці %1 не наданий дозвіл {%2}%3!'"),
...
Функция ТекстИсключенияРазрешениеНеПредоставленоДляОграничителя(Знач КлючСессии, Знач ТипТребуемогоРазрешения, Знач ПроверяемоеОграничение, Знач Ограничитель)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Для дополнительного отчета или обработки %1
              ...
              |;uk='Для додаткового звіту або обробки %1
