...
Функция ТестУстройства(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Иначе                  
		СтрокаТекста = НСтр("ru='Тестовая строка 1';uk='Тестовий рядок 1'") + Символы.ПС + НСтр("ru='Тестовая строка 2';uk='Тестовий рядок 2'") + Символы.ПС + НСтр("ru='Тестовая строка 3';uk='Тестовий рядок 3'");
