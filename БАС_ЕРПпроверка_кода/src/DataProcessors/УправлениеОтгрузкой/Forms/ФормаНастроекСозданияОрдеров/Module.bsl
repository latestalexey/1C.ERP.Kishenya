...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МассивРаспоряжений.ЗагрузитьЗначения(Параметры.МассивРаспоряжений);
...
Процедура ОформитьРасходныеОрдераНаСервере(Отказ)
	...
	Если Не СоздатьОрдера Тогда
		...
		ТекстСообщения = НСтр("ru='По выбранным распоряжениям не требуется отгрузка товаров.';uk='За обраними розпорядженнями не потребується відвантаження товарів.'");
