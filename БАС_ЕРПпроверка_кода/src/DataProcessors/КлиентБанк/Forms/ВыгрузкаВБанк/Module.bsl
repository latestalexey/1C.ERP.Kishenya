...
Процедура ЗаполнитьСписокВыбораПериодов()
	...
	СписокВыбораПериода.Добавить("Все время",     НСтр("ru='Все время';uk=' Увесь час'"));
	СписокВыбораПериода.Добавить("Дату",          НСтр("ru='Дату...';uk='Дату...'"));
	СписокВыбораПериода.Добавить("Сегодня",       НСтр("ru='Сегодня';uk='Сьогодні'"));
	СписокВыбораПериода.Добавить("Три дня",       НСтр("ru='Три дня';uk='Три дні'"));
	СписокВыбораПериода.Добавить("Неделю",        НСтр("ru='Неделю';uk='Тиждень'"));
				...
				Иначе // Веб клиент без расширения для работы с файлами
					...
					Исключение
						ШаблонСообщения = НСтр("ru='При записи файла возникла ошибка
                            |%1'
                            |;uk='При записі файлу відбулася помилка
                            |%1'");
