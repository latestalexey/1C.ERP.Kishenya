...
Процедура ОткрытьНастройкиПередачиМатериаловВПроизводство(Команда)
	//++ НЕ УТКА
	ОткрытьФорму("РегистрСведений.НастройкаПередачиМатериаловВПроизводство.ФормаСписка", , ЭтаФорма);
	//-- НЕ УТКА
	Возврат // в УТ11 обработчик пустой
КонецПроцедуры
