...
Процедура Применить(Команда)
	...
	ИначеЕсли МассивОтмеченныхЭлементовСписка.Количество() > МаксимальноеКоличествоПользовательскихПолей() Тогда
		...
		СтрокаСообщения = НСтр("ru='Уменьшите количество полей (можно выбирать не более [КоличествоПолей] полей)';uk='Зменшіть кількість полів (можна вибирати не більш [КоличествоПолей] полів)'");
