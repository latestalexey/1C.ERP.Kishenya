...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЗаказДавальцуНаСырье") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru='Заказ давальцу на сырье и материалы';uk='Замовлення давальцю на сировину і матеріали'"),
			СформироватьПечатнуюФормуЗаказаДавальцуНаСырье(
				СтруктураТипов, 
				ОбъектыПечати, 
				ПараметрыПечати,
				ПараметрыВывода
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЗаказДавальцаНаУслуги") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru='Заказ давальца на услуги по выпуску продукции';uk='Замовлення давальця на послуги з випуску продукції'"),
			СформироватьПечатнуюФормуЗаказаДавальцаНаУслуги(
				СтруктураТипов, 
				ОбъектыПечати, 
				ПараметрыПечати,
				ПараметрыВывода
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЗаказПереработчикаНаСырье") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru='Заказ переработчика на сырье и материалы';uk='Замовлення переробника на сировину і матеріали'"),
			СформироватьПечатнуюФормуЗаказаПереработчикаНаСырье(
				СтруктураТипов, 
				ОбъектыПечати, 
				ПараметрыПечати,
				ПараметрыВывода
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЗаказПереработчикуНаУслуги") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru='Заказ переработчику на услуги по выпуску продукции';uk='Замовлення переробнику на послуги з випуску продукції'"),
			СформироватьПечатнуюФормуЗаказаПереработчикуНаУслуги(
				СтруктураТипов, 
				ОбъектыПечати, 
				ПараметрыПечати,
				ПараметрыВывода
...
Функция СформироватьПечатнуюФормуЗаказаДавальцуНаСырье(СтруктураТипов, ОбъектыПечати, ПараметрыПечати, ПараметрыВывода, КомплектыПечати = Неопределено) Экспорт	
...
Функция СформироватьПечатнуюФормуЗаказаДавальцаНаУслуги(СтруктураТипов, ОбъектыПечати, ПараметрыПечати, ПараметрыВывода, КомплектыПечати = Неопределено) Экспорт	
...
Функция СформироватьПечатнуюФормуЗаказаПереработчикаНаСырье(СтруктураТипов, ОбъектыПечати, ПараметрыПечати, ПараметрыВывода, КомплектыПечати = Неопределено) Экспорт	
...
Функция СформироватьПечатнуюФормуЗаказаПереработчикуНаУслуги(СтруктураТипов, ОбъектыПечати, ПараметрыПечати, ПараметрыВывода, КомплектыПечати = Неопределено) Экспорт	
...
#Область ВыводПодвала
		...
		Если ТипЗнч(ДанныеПечати.Ссылка) = Тип("ДокументСсылка.ЗаказПереработчику") Тогда
			ТекстИтоговойСтроки = НСтр("ru='Всего наименований %1';uk='Усього найменувань %1'", КодЯзыкаПечать);
		Иначе
		//-- НЕ УТ
