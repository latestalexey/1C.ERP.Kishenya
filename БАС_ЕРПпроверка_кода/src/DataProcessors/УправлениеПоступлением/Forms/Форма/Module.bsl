...
Функция ТекстЗапросаРаспоряженияНаПоступление()
	...
	//++ НЕ УТ
	|				КОГДА ТИП(Документ.ВозвратМатериаловИзПроизводства)
	|					ТОГДА ТоварыКПоступлению.ДокументПоступления.Подразделение
	|				КОГДА ТИП(Документ.ВыпускПродукции)
	|					ТОГДА ТоварыКПоступлению.ДокументПоступления.Подразделение
	//-- НЕ УТ
...
//++ НЕ УТ
	|				КОГДА ТоварыКПоступлению.ДокументПоступления ССЫЛКА Документ.ВозвратМатериаловИзПроизводства
	|				 	ТОГДА &ИмяВозвратМатериаловИзПроизводства
	|				КОГДА ТоварыКПоступлению.ДокументПоступления ССЫЛКА Документ.ВыпускПродукции
	|				 	ТОГДА &ИмяВыпускПродукции	
	|				КОГДА ТоварыКПоступлению.ДокументПоступления ССЫЛКА Документ.ЗаказПереработчику
	|				 	ТОГДА &ИмяЗаказПереработчику
	|				КОГДА ТоварыКПоступлению.ДокументПоступления ССЫЛКА Документ.ВозвратСырьяОтПереработчика
	|				 	ТОГДА &ИмяВозвратСырьяОтПереработчика
	|				КОГДА ТоварыКПоступлению.ДокументПоступления ССЫЛКА Документ.ПоступлениеОтПереработчика
	|				 	ТОГДА &ИмяПоступлениеОтПереработчика
//++ НЕ УТКА
	|				КОГДА ТоварыКПоступлению.ДокументПоступления ССЫЛКА Документ.ЗаказНаПроизводство
	|				 	ТОГДА &ИмяЗаказНаПроизводство
	|				КОГДА ТоварыКПоступлению.ДокументПоступления ССЫЛКА Документ.ПоступлениеСырьяОтДавальца
	|				 	ТОГДА &ИмяПоступлениеСырьяОтДавальца
	|				КОГДА ТоварыКПоступлению.ДокументПоступления ССЫЛКА Документ.ЗаказДавальца
	|				 	ТОГДА &ИмяЗаказДавальца
//-- НЕ УТКА
//-- НЕ УТ
	|			КОНЕЦ,
...
//++ НЕ УТ
	РаспоряженияНаПоступление.Параметры.УстановитьЗначениеПараметра("ИмяВозвратМатериаловИзПроизводства", 
		Метаданные.Документы.ВозвратМатериаловИзПроизводства.Синоним);
	РаспоряженияНаПоступление.Параметры.УстановитьЗначениеПараметра("ИмяВыпускПродукции", 
		Метаданные.Документы.ВыпускПродукции.Синоним);
	РаспоряженияНаПоступление.Параметры.УстановитьЗначениеПараметра("ИмяПоступлениеОтПереработчика", 
		Метаданные.Документы.ПоступлениеОтПереработчика.Синоним);
	РаспоряженияНаПоступление.Параметры.УстановитьЗначениеПараметра("ИмяВозвратСырьяОтПереработчика", 
		Метаданные.Документы.ВозвратСырьяОтПереработчика.Синоним);
	РаспоряженияНаПоступление.Параметры.УстановитьЗначениеПараметра("ИмяЗаказПереработчику", 
		Метаданные.Документы.ЗаказПереработчику.Синоним);
//++ НЕ УТКА
	РаспоряженияНаПоступление.Параметры.УстановитьЗначениеПараметра("ИмяЗаказНаПроизводство", 
		Метаданные.Документы.ЗаказНаПроизводство.Синоним);
	РаспоряженияНаПоступление.Параметры.УстановитьЗначениеПараметра("ИмяПоступлениеСырьяОтДавальца", 
		Метаданные.Документы.ПоступлениеСырьяОтДавальца.Синоним);
	РаспоряженияНаПоступление.Параметры.УстановитьЗначениеПараметра("ИмяЗаказДавальца", 
		Метаданные.Документы.ЗаказДавальца.Синоним);
//-- НЕ УТКА
//-- НЕ УТ
