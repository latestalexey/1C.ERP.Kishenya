...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если ОтветПередЗакрытием <> Истина Тогда
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("ru='Данные были изменены. Сохранить изменения?';uk='Дані були змінені. Зберегти зміни?'"), 
...
Процедура ПрименитьОграниченияНастроек()
	...
	ШаблонПодсказки = НСтр("ru='Максимум %1';uk='Максимум %1'");
...
Функция ПодписьКоличестваКопий(Знач Количество)
	...
	МассивПредставлений.Добавить(НСтр("ru='последнюю копию';uk='останню копію'"));
	МассивПредставлений.Добавить(НСтр("ru='последние копии';uk='останні копії'"));
	МассивПредставлений.Добавить(НСтр("ru='последних копий';uk='останніх копій'"));
