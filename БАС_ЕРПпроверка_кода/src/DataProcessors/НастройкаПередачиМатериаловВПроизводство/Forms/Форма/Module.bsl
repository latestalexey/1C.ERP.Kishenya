...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<как для подразделении в целом>';uk='<як для підрозділі в цілому>'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ТекстСправочнойНадписи);
	Элемент.Оформление.УстановитьЗначениеПараметра("ОтметкаНезаполненного", Ложь);
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<как для номенклатуры в целом>';uk='<як для номенклатури в цілому>'"));
...
Функция ПрочитатьНастройкиПоСпискуМатериаловНаСервере(СписокНоменклатуры)
	...
	Иначе
		НаименованиеЗадания = НСтр("ru='Заполнение настройки передачи материалов в производство';uk='Заповнення настройки передачі матеріалів у виробництво'");
...
Функция ЗаписатьНастройкуНаСервере()
	...
	Для каждого ДанныеСтроки Из Объект.Товары Цикл
		Попытка
			...
			Если ЗначениеЗаполнено(ДанныеСтроки.Склад) Тогда
...
Функция СкладПередачиМатериаловВПроизводство(Подразделение)
	...
	Возврат ?(ЗначениеЗаполнено(СкладПередачиМатериаловВПроизводство), 
				...
				НСтр("ru='<склад не указан>';uk='<склад не вказано>'"));
