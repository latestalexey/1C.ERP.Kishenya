...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	КоличествоСтрок = Форма.R.Количество();
	ЗаполнитьПоказательНаСервере("MXXXXG15_1", ФИОИсполнителя, Форма, "Уведомление");
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	Если     (Лев(ИмяЯчейки, 7) = "RXXXXG5") 
		 ИЛИ (Лев(ИмяЯчейки, 7) = "MXXXXG4") 
		 ИЛИ (Лев(ИмяЯчейки, 7) = "MXXXXG6") 
		 ИЛИ (Лев(ИмяЯчейки, 7) = "MXXXXG7") 
		 ИЛИ (Лев(ИмяЯчейки, 7) = "MXXXXG8") 
		 ИЛИ (Лев(ИмяЯчейки, 7) = "MXXXXG9") 
		 ИЛИ (Лев(ИмяЯчейки, 8) = "MXXXXG10") 
		 ИЛИ (Лев(ИмяЯчейки, 8) = "MXXXXG11") Тогда
		 
		Если Найти(ИмяЯчейки, "Описание") = 0 И НЕ Лев(ИмяЯчейки, 9) = "MXXXXG11_" Тогда
		
			ТабличныйДокумент.Области[ИмяЯчейки].Значение = НЕ ТабличныйДокумент.Области[ИмяЯчейки].Значение;
			
			Если (Лев(ИмяЯчейки, 7) = "RXXXXG5") Тогда
				СинхронизацияРазделов1и2(ЭтаФорма);
			КонецЕсли;
...
Процедура СинхронизацияРазделов1и2(Форма, ПересчитыватьКоличествоСтраниц = Истина)
	...
	Для НомерСтроки = 1 По КоличествоСтрок Цикл
		...
		Должность 		   = ТабличныйДокумент.Области["RXXXXG1_"+ Формат(НомерСтроки,"ЧГ=;")].Значение;
		КоличествоВакансий = ТабличныйДокумент.Области["RXXXXG2_"+ Формат(НомерСтроки,"ЧГ=;")].Значение;
		
		ВыводитьДопРаздел  = ТабличныйДокумент.Области["RXXXXG5_"+ Формат(НомерСтроки,"ЧГ=;")].Значение;
		
		ТабличныйДокумент.Области["MXXXXG1_"+ Формат(НомерСтроки,"ЧГ=;")].Значение = Должность;
		...
		Верх = ТабличныйДокумент.Области["MXXXXG1_"+ Формат(НомерСтроки,"ЧГ=;")].Верх-2;
