...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2016Кв3УФ";
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("НалогНаНедвижимость");
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	Если МесяцОтчета = 3 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("H1KV", "X", Форма);
	ИначеЕсли МесяцОтчета = 6 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("HHY",  "X", Форма);
	ИначеЕсли МесяцОтчета = 9 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("H3KV", "X", Форма);
	ИначеЕсли МесяцОтчета = 12 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("HY",   "X", Форма);
	КонецЕсли;
...
Процедура ВосстановитьСохраненныеДанные()
	...
	КонецЕсли;	
	СписокСохранения.Свойство("НалогНаНедвижимость", 		   СтруктураРеквизитовФормы.НалогНаНедвижимость);
...
Функция Сохранить(Автосохранение = Ложь, НаимТекРаздела) Экспорт	
	...
	СписокСохранения.Вставить("НалогНаНедвижимость", 		    СтруктураРеквизитовФормы.НалогНаНедвижимость);
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	ЗаполнитьПоказательНаСервере("R0212G3", R02G16, Форма, "ПриложениеЦП");
	...
	R0413G3 = ПолучитьПоказательНаСервере("R01G3", Форма, "ПриложениеЦП")
	...
	ЗаполнитьПоказательНаСервере("R0314G3", ПолучитьПоказательНаСервере("R01G16", Форма, "ПриложениеТЦ"), Форма, "ПриложениеРИ");
	
	ЗаполнитьПоказательНаСервере("R0413G3", ПолучитьПоказательНаСервере("R0413G3", Форма, "ПриложениеЦП"), Форма, "ПриложениеРИ");
	
	R04213G3 = ПолучитьПоказательНаСервере("R04213G3", Форма, "ПриложениеРИ");
	Если ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04117G3", Форма, "ПриложениеРИ")) > ОкруглитьЧислоПоФормату(Форма, R04213G3) Тогда
		ЗаполнитьПоказательНаСервере("R04117G3", R04213G3, Форма, "ПриложениеРИ");
	КонецЕсли;												
	...
	R029G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R027G3", Форма, "ПриложениеВП"))* 0.05;
	Если R029G3 < 0 Тогда
		R029G3 = 0;
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("R029G3", R029G3, Форма, "ПриложениеВП");
	
	R032G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R031G3", Форма, "ПриложениеВП"))* 0.05;
	Если R032G3 < 0 Тогда
		R032G3 = 0;
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("R032G3", R032G3, Форма, "ПриложениеВП");	
	
	R035G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R034G3", Форма, "ПриложениеВП"))* 0.05;
	Если R035G3 < 0 Тогда
		R035G3 = 0;
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("R035G3", R035G3, Форма, "ПриложениеВП");	
	...
	Если ИмяСтраницыПанели = "ПриложениеПН" Тогда
		...
		Для КодСтроки = 1 По 24 Цикл
			...
			Если КодСтроки < 22 Тогда	
				...
				R0125G3 = R0125G3 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01" +КодСтрокиСтр+"G3", Форма, "ПриложениеПН"));
				R0125G6 = R0125G6 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01" +КодСтрокиСтр+"G6", Форма, "ПриложениеПН"));
																	  
			Иначе										
				R0125G3 = R0125G3 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01" +КодСтрокиСтр+"G3", Форма, "ПриложениеПН"));
			КонецЕсли;	
		КонецЦикла;
		ЗаполнитьПоказательНаСервере("R0125G3", R0125G3, Форма, "ПриложениеПН");
		ЗаполнитьПоказательНаСервере("R0125G6", R0125G6, Форма, "ПриложениеПН");
	КонецЕсли;
	//////////////////////////////////////////////////////////////////////////////////////////
	// АВ
	...
	Если ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R005G3", Форма, "ПриложениеАВ")) > ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R004G3", Форма, "ПриложениеАВ")) Тогда
	...
	R016G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0161G3", Форма, "ПриложениеЗП"))
			  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01641G3", Форма, "ПриложениеЗП"))
			  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0165G3", Форма, "ПриложениеЗП"))
			  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0166G3", Форма, "ПриложениеЗП"));
	...
	R023G3 = 0;
	Если ИмяСтраницыПанели = "ПриложениеПН" Тогда
		R023G3 = R023G3 + ПолучитьПоказательНаСервере("R0125G6", Форма, "ПриложениеПН");
	КонецЕсли;
	Для каждого ДанныеПН Из Форма.ТаблицаСтраницыРаздела1 Цикл
		...
		Если ДанныеПН.АктивнаяСтраница = Ложь Тогда
			...
			R0125G6 = 0;
			Если ДанныеПН.Данные[0].Значение.Свойство("R0125G6", R0125G6) Тогда
	 			R023G3 = R023G3 + R0125G6;
			КонецЕсли;
		КонецЕсли; 
	КонецЦикла;
	...
	R026G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G3", Форма, "Декларация")) 
			 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R008G3", Форма, "Декларация")) 	
			 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R010G3", Форма, "Декларация")) 
			 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R012G3", Форма, "Декларация")) 
			 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R015G3", Форма, "Декларация"));
	...
	R026G3 = R026G3 * 2 / 9;										 
	// но только в декларации за 3 квартал 2016 года
	Если НЕ (Год(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2016 и Месяц(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 9) Тогда
		ЗаполнитьПоказательНаСервере("R026G3",0, Форма, "Декларация");
	Иначе	
		ЗаполнитьПоказательНаСервере("R026G3",R026G3, Форма, "Декларация");
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HZU", Форма, "Декларация"))Тогда
		// это уточняющая декларация
		
		R031G3  =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R027G3", Форма, "Декларация"))* 0.03;
		ЗаполнитьПоказательНаСервере("R031G3", R031G3, Форма, "Декларация");
		R035G3  =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R032G3", Форма, "Декларация"))* 0.03;
		ЗаполнитьПоказательНаСервере("R035G3", R035G3, Форма, "Декларация");
		R039G3  =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R036G3", Форма, "Декларация"))* 0.03;
		ЗаполнитьПоказательНаСервере("R039G3", R039G3, Форма, "Декларация");
	...
	Иначе
		...
		ЗаполнитьПоказательНаСервере("R030G3", ПолучитьПоказательНаСервере("R030G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R031G3", 0, Форма, "Декларация");
		...
		ЗаполнитьПоказательНаСервере("R034G3", ПолучитьПоказательНаСервере("R033G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R035G3", 0, Форма, "Декларация");
		
		ЗаполнитьПоказательНаСервере("R036G3", ПолучитьПоказательНаСервере("R034G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R037G3", ПолучитьПоказательНаСервере("R035G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R038G3", ПолучитьПоказательНаСервере("R036G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R039G3", 0, Форма, "Декларация");
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
   ...
   ИначеЕсли ИмяЯчейки = "H1KVP"
	...
	ИначеЕсли ИмяЯчейки >= "HD1" И ИмяЯчейки <= "HD9" И НЕ ИмяЯчейки = "HD3"
		  ИЛИ ИмяЯчейки >= "HF1" И ИмяЯчейки <= "HF7" Тогда
...
Процедура ЗаполнитьПриложениеРИ_АМ_ТЦ()
   ...
   // Списание    = Кт оборот 10,11,12,286 - не в корр с 10,11,12,13,286 при условии, что на конец приода нет остатка по этим счетам учета (по Дт)
	...
	R0113G3 = 0; СписокОСДляR0113G3 = Новый СписокЗначений;
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(Выборка.ОстаточнаяСтоимостьНУ) Тогда
			СписокОСДляR0123G3.Добавить(Выборка.НеоборотныйАктив);
			R0123G3 = R0123G3 + Выборка.ОстаточнаяСтоимостьНУ;
		КонецЕсли;
	...
	Если НЕ R0113G3 = 0 Тогда
		...
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R0113G3", 
																"Сума залишкової вартості ОЗ при списанні за даними БО",
																"+",
																"!АС", 
																R0113G3,
																,//Счет
    ...
    Если НЕ R0123G3 = 0 Тогда
		...
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R0123G3", 
																"Сума залишкової вартості ОЗ при списанні за даними ПО",
																"+",
																"!АС", 
																R0123G3,
																,//Счет
	...
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_АМ_Уценки	 								Тогда ЗаполнитьКорректировкуРИ("R0112G3", "+",  Выборка.Сумма, Выборка.Статья)  		
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_АМ_Дооценки									Тогда ЗаполнитьКорректировкуРИ("R0122G3", "-",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_АМ_ОстаточБУ								Тогда ЗаполнитьКорректировкуРИ("R0113G3", "+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_АМ_ОстаточНУ								Тогда ЗаполнитьКорректировкуРИ("R0123G3", "-",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Резерв_47_Корректировка						Тогда ЗаполнитьКорректировкуРИ("R0222G3", "-",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Резерв_38_Корректировка						Тогда ЗаполнитьКорректировкуРИ("R0223G3", "-",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Фин_ДоходКапитал							Тогда ЗаполнитьКорректировкуРИ("R0322G3", "-",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_ЦП_ФинрезПлюсБУ							Тогда ЗаполнитьКорректировкуРИ("R0423G3", "-",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_3_Страховик								Тогда ЗаполнитьКорректировкуРИ("R0424G3", "-",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_1_ОбрДоход								Тогда ЗаполнитьКорректировкуРИ("R0416G3", "+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_1_ПропорцДоход							Тогда ЗаполнитьКорректировкуРИ("R0425G3", "-",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_1_ПропорцЗатрат							Тогда ЗаполнитьКорректировкуРИ("R0426G3", "-",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_2_Страховка								Тогда ЗаполнитьКорректировкуРИ("R0418G3", "+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_НефтегазАморт					Тогда ЗаполнитьКорректировкуРИ("R0419G3", "+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_НефтегазУценка  				Тогда ЗаполнитьКорректировкуРИ("R04110G3","+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_НефтегазЗатраты 				Тогда ЗаполнитьКорректировкуРИ("R04111" , "+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ЗадолженностьДоход  			Тогда ЗаполнитьКорректировкуРИ("R04112G3","+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ЗадолженностьСебест 			Тогда ЗаполнитьКорректировкуРИ("R0427G3", "-",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_Задолженность		  			Тогда ЗаполнитьКорректировкуРИ("R04113G3","+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ЗадолженностьПогашПокупатель	Тогда ЗаполнитьКорректировкуРИ("R0428G3", "-",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ЗадолженностьПогашПродавец	Тогда ЗаполнитьКорректировкуРИ("R04114G3","+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ЗадолженностьПогашСебест		Тогда ЗаполнитьКорректировкуРИ("R0429G3", "-",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_КассовыйДоход					Тогда ЗаполнитьКорректировкуРИ("R04115G3","+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_КассовыйЗатраты				Тогда ЗаполнитьКорректировкуРИ("R04210G3","-",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_РезервБанкаПлюс				Тогда ЗаполнитьКорректировкуРИ("R04116G3","+",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_РезервБанкаМинус				Тогда ЗаполнитьКорректировкуРИ("R04211G3","-",  Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_РезервОтпусков				Тогда ЗаполнитьКорректировкуРИ("R04212G3","-",  Выборка.Сумма, Выборка.Статья)
		Иначе
			Попытка		
				Если Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ЗатратыВнешниеКредиты			Тогда ЗаполнитьКорректировкуРИ("R04117G3","+",  Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_УменьшениеРезерва 			Тогда ЗаполнитьКорректировкуРИ("R04118G3","+",  Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ДоходыВнешниеКредиты			Тогда ЗаполнитьКорректировкуРИ("R04213G3","-",  Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ДоходыУменьшениеРезерва		Тогда ЗаполнитьКорректировкуРИ("R04214G3","-",  Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_СписаниеНалоговогоДолга		Тогда ЗаполнитьКорректировкуРИ("R04215G3","-",  Выборка.Сумма, Выборка.Статья)
				КонецЕсли;
			Исключение	
			КонецПопытки;
		КонецЕсли;	
...
Процедура ЗаполнитьПриложениеЗП()
	...
	// заполним суммы по налогу на недвижимость из Дт6415 
	ЗапросНалогНедвиж = Новый Запрос();
	ЗапросНалогНедвиж.Текст = "ВЫБРАТЬ
	                    |	ХозрасчетныйОбороты.СуммаОборотДт КАК Выплачено
	                    |ИЗ
	                    |	РегистрБухгалтерии.Хозрасчетный.Обороты(
	                    |			&ДатаНач,
	                    |			&ДатаКон,
	                    |			,
	                    |			Счет В ИЕРАРХИИ (&Сч6415),
	                    |			&Налоги,
	                    |			Организация = &Организация
	                    |			И Субконто1 = &НалогНаНедвижимость) КАК ХозрасчетныйОбороты
						|";
	ЗапросНалогНедвиж.УстановитьПараметр("ДатаНач", СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);
	ЗапросНалогНедвиж.УстановитьПараметр("ДатаКон", СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
	ЗапросНалогНедвиж.УстановитьПараметр("Сч6415", ПланыСчетов.Хозрасчетный.РасчетыПоДругимНалогам);
	ЗапросНалогНедвиж.УстановитьПараметр("Налоги", ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Налоги);
	ЗапросНалогНедвиж.УстановитьПараметр("НалогНаНедвижимость", СтруктураРеквизитовФормы.НалогНаНедвижимость);
    ЗапросНалогНедвиж.УстановитьПараметр("Организация", СтруктураРеквизитовФормы.Организация);
	
	ТекущиеДанные = ЗапросНалогНедвиж.Выполнить().Выбрать();
	Если ТекущиеДанные.Следующий() Тогда
		
		СтруктураДанныхПриложениеЗП["R0165G3"] = ТекущиеДанные.Выплачено;
	
		_ДобавитьСтрокуРасшифровки(ЭтаФорма,"R0165G3", "16.5 Сума нарахованого та сплаченого податку на майно",
															"+", "!ДО", ТекущиеДанные.Выплачено, ПланыСчетов.Хозрасчетный.РасчетыПоДругимНалогам,,
															НачалоГода (СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета), СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета
															, "ПриложениеЗП",,,,
															СтруктураРеквизитовФормы.НалогНаНедвижимость);			
	КонецЕсли;	
...
Процедура ЗаполнитьУбытокПрошлогоГода(ПараметрыЗаполненияЗвит1С)
	...
	R0324G3 = 0;
	Если Год(ДатаПрошлогоГода) = 2014 Тогда
		ИмяСтрокиПрошлойДекларации = "07";
	Иначе	
	...
	Иначе
		...
		Если ГодПериода = 2014 Тогда
			ИмяСхемы1 = ИмяСхемы1 + "13";
			ИмяСхемы2 = ИмяСхемы2 + "01";
		ИначеЕсли ГодПериода = 2015 Тогда 
...
Процедура ЗаполнитьПоказателиПрошогоПериода(ПараметрыЗаполненияЗвит1С)
	...
	Если ПолучитьДанныеЗаПрошлыйКварталИз1С Тогда
		// обычное заполнение отчета из встроенной подсистемы
		ДанныеПрошлогоКвартала = ЗначениеПоПредыдущейДекларации(ДатаПрошлогоКвартала,"Декларация","ru = 'строк 18, 21, 24 Декларации, 16.3 Приложения ЗП';uk= 'рядків 18, 21, 24 Декларації, 16.3 Додатка ЗП'", ВыводитьПредупреждения);
		Если ДанныеПрошлогоКвартала <> Неопределено  Тогда
			...
			// для годовой за 2016
			Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2016 И Месяц(ДатаПрошлогоКвартала) = 9 Тогда
				R0166G3 = ДанныеПрошлогоКвартала.R026G3;
			КонецЕсли;
		КонецЕсли;
		...
		Если ПолучитьДанныеЗаПрошлыйГодИз1С Тогда
			...
			Если ДанныеПрошлогоГода <> Неопределено и Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) > 2016 Тогда
				R0163G3 = ДанныеПрошлогоКвартала.R01642G3;
			КонецЕсли;
		КонецЕсли;
		...
		СтруктураДанныхПриложениеЗП.R0166G3 = R0166G3;
	Иначе
		// Заполнение отчета из FREDO Звіт
		ИмяСхемы = "J01001";  // Декларация о прибыли 
		ГодПериода   = Год(ДатаПрошлогоКвартала);
		
		Если ГодПериода < 2016 или (ГодПериода = 2016 и Месяц(ДатаПрошлогоКвартала) <= 6) Тогда
			//старая схема
...
Функция ЗначениеПоПредыдущейДекларации(ДатаОкончанияПериода,ИмяПоля,ИмяПоказателяРасшНаРазныхЯзыках,ВыводитьПредупреждения )
	...
	Иначе	
		...
		Для каждого СтрокаТаблицыРезультатов Из ТаблицаРезультатов Цикл
			...
			ДанныеОтчета.Свойство("ПоказателиОтчета",ПоказателиОтчета);
			Если ПоказателиОтчета.ПолеТабличногоДокументаДекларация.Свойство("Н097") Тогда
				Если ЗначениеЗаполнено(СтруктураДанныхДекларация.H097) = ЗначениеЗаполнено(ПоказателиОтчета.ПолеТабличногоДокументаДекларация.Н097)  Тогда
					ПоказателиОтчета.Свойство("ПолеТабличногоДокумента" + ИмяПоля, ПоказателиПоля);	
					Возврат ПоказателиПоля;
				Иначе				
					Продолжить;	
				КонецЕсли;
			ИначеЕсли ЗначениеЗаполнено(СтруктураДанныхДекларация.H097) Тогда
				// заполняем декларацию по АйТи, но в прошлогодних декларациях такого поля не было
				Продолжить;
			Иначе
				// возвращаем декларацию общую, за прошлый год
				ПоказателиОтчета.Свойство("ПолеТабличногоДокумента" + ИмяПоля, ПоказателиПоля);	
				Возврат ПоказателиПоля;
			КонецЕсли;
		...
		Если ПараметрыЗаполненияЗвит1С.Свойство("ПараметрыЗаполненияПоказателиПрошогоПериода", ПараметрыЗаполненияПоказателиПрошогоПериода) Тогда
			...
			Попытка
				...
				Иначе
					...
					// для годовой за 2016
					Если ПараметрыЗаполненияПоказателиПрошогоПериода.ПараметрыЗапроса.ГодПериода = 2016 И 
						 ПараметрыЗаполненияПоказателиПрошогоПериода.ПараметрыЗапроса.НомерПериода = 25 Тогда
						 
						R0166G3 = ПолучитьЗначениеПоказателяЗвит1С(Данные, "A26");
					КонецЕсли;
				КонецЕсли;
			Исключение
				ТекстОшибки = "Помилка алгоритму заповнення звіту!
			...
			ЗаполнитьПоказательНаСервере("R0166G3", R0166G3, ЭтаФорма, "ПриложениеЗП");
...
Процедура  ОпределитьСписокВыгружаемыхСхем(тбСхемыXML);
	...
	Для Каждого стр Из  тбСхемыXML Цикл
		...
		Если Лев(Стр.Префикс,2) = "D9"  Тогда
			стр.фВыгрузка = 0;
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0100515", "J0108103"), "J0100115");  
	...
	НовСтрока = тбСхемыXML.Добавить();
	НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0151803", "J0181803"), "J0111803");  
	...
	НовСтрока = тбСхемыXML.Добавить();
	НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0150306", "J0180303"), "J0110307");  
	...
	НовСтрока = тбСхемыXML.Добавить();
	НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0152803", "J0182803"), "J0112803");  
	...
	НовСтрока = тбСхемыXML.Добавить();                    
	НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0150605", "J0180603"), "J0110605");  
	...
	НовСтрока = тбСхемыXML.Добавить();              
	НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0151305", "J0181303"), "J0111305");  
	...
	НовСтрока = тбСхемыXML.Добавить();              
	НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0151406", "J0181403"), "J0111406");  
	...
	Для  Инд = 1 ПО ТаблицаСтраницыРаздела1.Количество() Цикл
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0151505", "J0181503"), "J0111505");  
	...
	НовСтрока = тбСхемыXML.Добавить();              
	НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0151605", "J0181603"), "J0111605");  
	...
	Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HZU", ЭтаФорма, "Декларация")) Тогда
		НовСтрока = тбСхемыXML.Добавить();                     
		НовСтрока.ИмяСхемы = ?(ГодоваяДекларация, ?(ПроизводительСХ, "J0151706", "J0181703"), "J0111706");  
...
Процедура ОткрытьФормуПараметров(Команда)
	...
	мПараметрыФормы.Вставить("НалогНаНедвижимость", 			СтруктураРеквизитовФормы.НалогНаНедвижимость);
...
Процедура ЗаполнитьНастраиваемыеПараметрыЗаполнения()
	...
	Если Выборка.Следующий() Тогда
		...
		ДанныеОтчета.Свойство("НалогНаНедвижимость", СтруктураРеквизитовФормы.НалогНаНедвижимость);
