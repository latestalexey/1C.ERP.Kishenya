...
Процедура СформироватьОтчет(ТабличныйДокумент) Экспорт
	...
	Справочники.ОбъектыЭксплуатации.ПроверитьЗаполнение(ОбъектЭксплуатации, ПараметрыПроверки, ЕстьОшибки);
...
Процедура ВывестиЗаголовокОтчета(ТабличныйДокумент, Макет)
	...
	ШаблонЗаголовкаОтчета = НСтр("ru='Контроль корректности заполнения объекта эксплуатации ""%Наименование%""';uk='Контроль коректності заповнення об''єкта експлуатації ""%Наименование%""'");
...
Процедура ВывестиОшибки(ТабличныйДокумент, ОбъектОшибки, Уровень, ПотокОшибок, Макет)
	...
	Если ПотокОшибок.СчетчикОшибок.Получить(ОбъектОшибки) = Неопределено Тогда
		Возврат;
	КонецЕсли;
