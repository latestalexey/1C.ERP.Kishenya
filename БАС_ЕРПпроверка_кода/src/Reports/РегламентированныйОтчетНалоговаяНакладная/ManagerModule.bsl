...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утвеждена приказом Минфина Украины от 31.12.2015 г.  № 1307 (в редакции Приказа № 276 от 23.02.2017)';uk= 'Затверджена наказом Мінфіну України від 31.12.2015 р. № 1307 (в редакції Наказу № 276 від 23.02.2017)'");
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20140301 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "", '2014-01-14'		,"957"				,"ФормаОтчета2014Мес12УФ");
	Форма20150101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "", '2015-01-01'		,"957"				,"ФормаОтчета2015УФ");
