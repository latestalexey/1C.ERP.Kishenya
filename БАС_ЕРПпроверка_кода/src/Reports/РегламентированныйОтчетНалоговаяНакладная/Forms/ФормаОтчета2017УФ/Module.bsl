...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2017";
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С, ИспользоватьДанныеЗЦ = Ложь)
	...
	ДанныеШапки.Свойство("H03",     СтруктураДанныхНалоговыйДокумент.H03);
