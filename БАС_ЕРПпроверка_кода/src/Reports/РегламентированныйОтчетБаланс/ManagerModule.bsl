...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     =  НСтр("ru='Приложение к П(с)БУ №1 ""Общие требования к финансовой отчетности"" с изменениями внесенными Приказом Минфина Украины от 27.06.2013 №627';uk='Додаток до П(с)БО №1 ""Загальні вимоги до фінансової звітності"" зі змінами внесеними Наказом Мінфіну України від 27.06.2013 №627'");
