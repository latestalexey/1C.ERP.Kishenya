	...
	Если ТекущиеДанные.Пометка Тогда
		...
		Если НесовместимыеТипы.Количество() = 1 Тогда
			ТекстВопроса = НСтр("ru='Ранее были выбран тип несовместимый с текущим. 
                ...
                |;uk='Раніше був вибраний тип несумісний з поточними. 
                |Для використання вибраного типу необхідно відключити несумісний. Відключити?'");
		Иначе
			ТекстВопроса = НСтр("ru='Ранее были выбраны типы несовместимые с текущим. 
                ...
                |;uk='Раніше були обрані типи несумісні з поточним. 
                |Для використання вибраного типу необхідно відключити несумісні типи. Відключити?'");
		КонецЕсли;
...
Процедура ДобавитьПредопределенныеТипы()
	...
	СтрокаПредопределенныеТипы.ПредставлениеТипа = НСтр("ru='Предопределенные типы';uk='Напередвизначені типи'");
...
Процедура ДобавитьДополнительныеСвойства()
	...
	СтрокаДополнительныеРеквизиты.ПредставлениеТипа = НСтр("ru='Дополнительные реквизиты';uk='Додаткові реквізити'");
	
	СтрокаДополнительныеСведения = ДеревоТипов.ПолучитьЭлементы().Добавить();
	СтрокаДополнительныеСведения.ПредставлениеТипа = НСтр("ru='Дополнительные сведения';uk='Додаткові відомості'");
