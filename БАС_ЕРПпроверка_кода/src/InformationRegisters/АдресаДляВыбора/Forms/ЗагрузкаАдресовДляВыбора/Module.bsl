...
Процедура ЗагрузитьТабличныйДокумент()
	...
	Пока ЗаполненыКОАТУУНаименование Цикл
		...
		Иначе
			//Ошибка
			ТекстОшибки = НСтр("ru='Некорректный признак 2-го уровня в строке ';uk='Некоректний ознака 2-го рівня в рядку '") + СтроковыйНомер;
			ЕстьОшибкиРаспознавания = Истина;
			Прервать;
		...
		Иначе
			...
			Иначе
				//Ошибка
				ТекстОшибки = НСтр("ru='Некорректный признак 3-го уровня в строке ';uk='Некоректний ознака 3-го рівня в рядку '") + СтроковыйНомер;
				ЕстьОшибкиРаспознавания = Истина;
				Прервать;
