...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(Запись, РегистрыСведений.ДополнительныеНастройкиЗарплатаКадры.НастройкиПечатныхФорм());
...
Процедура УстановитьДерево()
	...
	ДобавитьСтрокиПорядка(Список, "Справочник.ПодразделенияОрганизаций", НСтр("ru='По подразделению';uk='По підрозділу'"));
	ДобавитьСтрокиПорядка(Список, "Справочник.Должности", НСтр("ru='По должности';uk='За посадою'"));
	ДобавитьСтрокиПорядка(Список, "Справочник.Сотрудники", НСтр("ru='По сотруднику';uk='По співробітникові'"));
...
Функция ДоступныеПоляПорядка()
	...
	ДоступныеПоляПодразделений.Вставить("Код", НСтр("ru='Номер';uk='Номер'"));
	ДоступныеПоляПодразделений.Вставить("Наименование", НСтр("ru='Наименование';uk='Найменування'"));
	ДоступныеПоляПодразделений.Вставить("РеквизитДопУпорядочиванияИерархического", НСтр("ru='Приоритет';uk='Пріоритет'"));
	...
	ДоступныеПоляДолжности.Вставить("Наименование", НСтр("ru='Наименование';uk='Найменування'"));
	ДоступныеПоляДолжности.Вставить("НаименованиеКраткое", НСтр("ru='Краткое наименование';uk='Коротке найменування'"));
	ДоступныеПоляДолжности.Вставить("РеквизитДопУпорядочивания", НСтр("ru='Приоритет';uk='Пріоритет'"));
	
	ДоступныеПоля.Вставить("Справочник.Должности", ДоступныеПоляДолжности);
	
	ДоступныеПоляСотрудника = Новый Структура;
	ДоступныеПоляСотрудника.Вставить("Код", НСтр("ru='Таб. номер';uk='Таб. номер'"));
	ДоступныеПоляСотрудника.Вставить("Наименование", НСтр("ru='Имя';uk='Ім''я'"));
...
Функция ОписаниеУпорядочивания(НастройкаПорядка, НастройкаУпорядочиванияСпискаСотрудников = Неопределено)
	...
	Если ПустаяСтрока(Описание) Тогда
		Описание = НСтр("ru='Упорядочивание не используется';uk='Упорядкування не використовується'")
	КонецЕсли;
