...
Процедура ОбновитьФлагиИспользованияСерийНаСкладахИВПроизводстве()
	...
	|	ЕСТЬNULL(ВидыНоменклатуры.ИспользоватьСерии, ЛОЖЬ) КАК ИспользоватьСерииНоменклатуры,
	|	ЕСТЬNULL(ВидыНоменклатуры.УчитыватьСебестоимостьПоСериям, ЛОЖЬ) КАК УчитыватьСебестоимостьПоСериям,
	|	ЛОЖЬ КАК УказыватьПриПланированииОтбора
	|ИЗ
	|	Справочник.СтруктураПредприятия КАК СтруктураПредприятия
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВидыНоменклатуры КАК ВидыНоменклатуры
	|		ПО СтруктураПредприятия.Ссылка = ВидыНоменклатуры.Склад
	|ГДЕ
	|	ЕСТЬNULL(ВидыНоменклатуры.ИспользоватьСерии, ЛОЖЬ) <> СтруктураПредприятия.ИспользоватьСерииНоменклатуры
	|		ИЛИ ЕСТЬNULL(ВидыНоменклатуры.УчитыватьСебестоимостьПоСериям, ЛОЖЬ) <> СтруктураПредприятия.УчитыватьСебестоимостьПоСериям";	
	//-- НЕ УТ
