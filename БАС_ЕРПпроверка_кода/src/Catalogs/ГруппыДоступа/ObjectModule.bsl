		   ...
		   И НЕ УправлениеДоступом.ЕстьРоль("ПолныеПрава") Тогда
			...
			ВызватьИсключение
				НСтр("ru='Предопределенную группу доступа Администраторы
                           ...
                           |;uk='Визначену групу доступу Адміністратори
                           |можна змінювати, або в привілейованому режимі,
                           |або при наявності ролі ""Повні права"".'");
		КонецЕсли;
			...
			Если ТипЗнч(ТекущаяСтрока.Пользователь) <> Тип("СправочникСсылка.Пользователи") Тогда
				ВызватьИсключение
					НСтр("ru='Предопределенная группа доступа Администраторы
                               ...
                               |;uk='Наперед визначена група доступу Адміністратори
                               |може містити тільки користувачів.
                               |
                               |Групи користувачів, зовнішні користувачі і 
                               |групи зовнішніх користувачів неприпустимі.'");
			КонецЕсли;
		КонецЦикла;
	...
	ИначеЕсли Профиль = Справочники.ПрофилиГруппДоступа.Администратор Тогда
		ВызватьИсключение
			НСтр("ru='Предопределенный профиль Администратор может быть только
                       ...
                       |;uk='Напередвизначений профіль Адміністратор може бути тільки
                       |у напередвизначеної групи доступу Адміністратори.'");
	КонецЕсли;
