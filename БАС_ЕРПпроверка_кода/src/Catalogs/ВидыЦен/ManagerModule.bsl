...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	//++ НЕ УТ 
	Результат.Добавить("ИспользоватьПриВыпускеПродукции");
	Результат.Добавить("ИспользоватьПриПередачеПродукцииДавальцу");
	//-- НЕ УТ 
...
//	СправочникСсылка.ВидыЦен - Найденный вид цен
//
Функция ВидЦеныВыпускаПродукцииПоУмолчанию() Экспорт
	...
	|ГДЕ
	|	НЕ ВидыЦен.ПометкаУдаления
	|	И ВидыЦен.ИспользоватьПриВыпускеПродукции";
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ВыводитьПроизвольныйВидЦен", ЗначениеПараметра) И ЗначениеПараметра = Истина Тогда
		...
		КонецЕсли;
		//++ НЕ УТ 
		// Если в параметрах передан отбор по реквизиту "ИспользоватьПриВыпускеПродукции"
		Если Параметры.Отбор.Свойство("ИспользоватьПриВыпускеПродукции") Тогда
			Запрос.Текст = Запрос.Текст + "
			|	И ВидыЦен.ИспользоватьПриВыпускеПродукции = &ИспользоватьПриВыпускеПродукции";
			Запрос.УстановитьПараметр("ИспользоватьПриВыпускеПродукции", Параметры.Отбор.ИспользоватьПриВыпускеПродукции);
		КонецЕсли;
		// Если в параметрах передан отбор по реквизиту "ИспользоватьПриПередачеПродукцииДавальцу"
		Если Параметры.Отбор.Свойство("ИспользоватьПриПередачеПродукцииДавальцу") Тогда
			Запрос.Текст = Запрос.Текст + "
			|	И ВидыЦен.ИспользоватьПриПередачеПродукцииДавальцу = &ИспользоватьПриПередачеПродукцииДавальцу";
			Запрос.УстановитьПараметр("ИспользоватьПриПередачеПродукцииДавальцу", Параметры.Отбор.ИспользоватьПриПередачеПродукцииДавальцу);
		КонецЕсли;
		//-- НЕ УТ 
