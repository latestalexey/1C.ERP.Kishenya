...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВариантОбластиДействия = НСтр("ru='конкретный товар';uk='конкретний товар'");
	...
	ИначеЕсли ЗначениеЗаполнено(ВидНоменклатуры) Тогда
		...
		НоменклатураПриИзмененииСервер();	
		ВариантОбластиДействия = НСтр("ru='вид номенклатуры';uk='Общепит вид номенклатури'");	
	Иначе
		НоменклатураПриИзмененииСервер();
	КонецЕсли;	
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ВариантОбластиДействия = НСтр("ru='конкретный товар';uk='конкретний товар'") 
	...
	ИначеЕсли ВариантОбластиДействия = НСтр("ru='вид номенклатуры';uk='Общепит вид номенклатури'") 
	...
	ИначеЕсли ВариантОбластиДействия = НСтр("ru='список товаров';uk='список товарів'") Тогда
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ВариантОбластиДействия = НСтр("ru='конкретный товар';uk='конкретний товар'") Тогда		
	...
	ИначеЕсли ВариантОбластиДействия = НСтр("ru='вид номенклатуры';uk='Общепит вид номенклатури'") Тогда
		НоваяСтрокаОбластиДействия 				   = ТаблицаОбластиДействия.Добавить();
		НоваяСтрокаОбластиДействия.ВидНоменклатуры = ВидНоменклатуры;
	Иначе
...
Процедура ВариантОбластиДействияПриИзменении(Элемент)
	...
	Если ТекущаяОбластьДействия.ВариантОбластиДействия = НСтр("ru='список товаров';uk='список товарів'") Тогда
...
Процедура ЗаполнитьОбластьДействия(СсылкаСертификатаНоменклатуры)
	...
	ИначеЕсли КоличествоЭлементовТаблицы > 0 Тогда
		ВариантОбластиДействия = НСтр("ru='список товаров';uk='список товарів'");
...
Процедура УстановитьТекущуюОбластьДействия()
	...
	Если ВариантОбластиДействия = НСтр("ru='конкретный товар';uk='конкретний товар'")
		Или ВариантОбластиДействия = НСтр("ru='вид номенклатуры';uk='Общепит вид номенклатури'") Тогда
