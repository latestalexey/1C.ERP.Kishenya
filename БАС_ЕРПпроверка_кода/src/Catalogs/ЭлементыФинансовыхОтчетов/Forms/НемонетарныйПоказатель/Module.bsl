...
Процедура ОбновитьЗаголовокФормы() Экспорт
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		ЭтаФорма.Заголовок = НСтр("ru='Немонетарный показатель';uk='Немонетарний показник'");
	Иначе
		ЭтаФорма.Заголовок = НСтр("ru='Немонетарный показатель (создание)';uk='Немонетарний показник (створення)'"); ;
	КонецЕсли;
