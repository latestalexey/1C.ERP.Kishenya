...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ЗначениеЗаполнено(ОбъектАвторизации) Тогда
		ВызватьИсключение НСтр("ru='У внешнего пользователя не задан объект авторизации.';uk='У зовнішнього користувача не заданий об''єкт авторизації.'");
	Иначе
		ТекстОшибки = "";
	...
	Иначе
		...
		Если ЗначениеЗаполнено(СтарыйОбъектАвторизации)
		   И СтарыйОбъектАвторизации <> ОбъектАвторизации Тогда
			...
			ВызватьИсключение НСтр("ru='Невозможно изменить ранее указанный объект авторизации.';uk='Неможливо змінити раніше вказаний об''єкт авторизації.'");
		КонецЕсли;
	КонецЕсли;
