...
Функция КешРеквизитовФормы()
	...
	Результат.Вставить("ИспользоватьМетодикуББВ", Константы.ИспользоватьМетодикуББВ.Получить());
	Результат.Вставить("ИспользоватьМетодикуПооперационноеПланирование", Константы.ИспользоватьМетодикуПооперационноеПланирование.Получить());
	Результат.Вставить("ИспользоватьМетодикуРегистрацияОпераций", Константы.ИспользоватьМетодикуРегистрацияОпераций.Получить());
