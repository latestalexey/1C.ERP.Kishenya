...
Процедура ОбновитьСоставСотрудниковГруппы(Команда)
	...
	Если НастройкиЗаполнения = Неопределено Тогда
		...
		ПоказатьПредупреждение(Оповещение, НСтр("ru='Перед тем как сформировать список сотрудников необходимо настроить критерии отбора';uk='Перед тим як сформувати список працівників необхідно налаштувати критерії відбору'"));
...
Процедура УстановитьОтображение()
	...
	Если ТолькоПросмотрФормироватьАвтоматически Тогда
		...
		ЗарплатаКадрыКлиентСервер.УстановитьРасширеннуюПодсказкуЭлементуФормы(
			ЭтаФорма, "ФормироватьАвтоматически", НСтр("ru='Для автоматического формирования состава сотрудников по параметрам, необходимо очистить состав подчиненных групп';uk='Для автоматичного формування складу співробітників за параметрами, необхідно очистити склад підлеглих груп'"));
...
Процедура ВыполнитьПодборСотрудников(МножественныйВыбор)
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		ТекстВопроса = НСтр("ru='Данные еще не записаны.
            ...
            |Підібрати співробітників можна буде тільки після запису даних.
