...
Процедура ЗаполнитьТаблицуДокументовОснований()
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Склады КАК СкладПоступления
	|		ПО (&СкладПолучатель = СкладПоступления.Ссылка)
	|ГДЕ
...
Процедура СформироватьИнформационнуюНадписьОтборы()
	...
	ИнформационнаяНадписьОтборы = НСтр("ru='Отбор по: %Организация%, %ОрганизацияПолучатель%, %СкладОтправитель%, %СкладПолучатель%, %ХозяйственнаяОперация%.';uk='Відбір за: %Организация%, %ОрганизацияПолучатель%, %СкладОтправитель%, %СкладПолучатель%, %ХозяйственнаяОперация%.'");
...
Процедура ВывестиИнформационнуюНадписьКоличествоДокументов(Форма)
	...
	Если Форма.КоличествоДокументов <> 0 Тогда
		ТекстНадписи = НСтр("ru='Подобрано документов - %КоличествоДокументов%.';uk='Підібрано документів - %КоличествоДокументов%.'");
