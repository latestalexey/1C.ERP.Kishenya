...
Процедура ДокументыОснованияИмеютВерныйСпособДоставки(Отказ)
	...
	|	ЛОЖЬ
	|ИЗ
	|	Документ.ВозвратСырьяДавальцу КАК Шапка
	|ГДЕ
	|	Шапка.Ссылка В(&МассивСсылок)
	|
	|СГРУППИРОВАТЬ ПО
	...
	|	СУММА(ВЫБОР
	|			КОГДА НЕ ДокументТовары.ЗаказДавальца.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|				ТОГДА 1
	|			ИНАЧЕ 0
	|		КОНЕЦ),
	|	СУММА(ВЫБОР
	|			КОГДА ДокументТовары.ЗаказДавальца.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|				ТОГДА 1
	|			ИНАЧЕ 0
	|		КОНЕЦ),
	|	ИСТИНА
	...
	|	ИСТИНА
	|ИЗ
	|	Документ.ПередачаСырьяПереработчику КАК Шапка
	|ГДЕ
	|	Шапка.Ссылка В(&МассивСсылок)
	...
	|	ДокументТовары.Ссылка,
	|	СУММА(ВЫБОР
	|			КОГДА НЕ ДокументТовары.ЗаказПереработчику.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|				ТОГДА 1
	|			ИНАЧЕ 0
	|		КОНЕЦ),
	|	СУММА(ВЫБОР
	|			КОГДА ДокументТовары.ЗаказПереработчику.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|				ТОГДА 1
	|			ИНАЧЕ 0
	|		КОНЕЦ),
	|	ИСТИНА
