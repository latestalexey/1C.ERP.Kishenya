...
// Функция возвращает текст запроса для отражения документа в украинском регламентированном учете.
Функция ТекстОтраженияВРеглУчетеУКР() Экспорт
		
#Область ТекстКорректировкиНДСПартий // Дт 23, 9X :: Кт 6435
	ТекстКорректировкиНДСПартий = "
	|ВЫБРАТЬ //// Условная продажа (Дт 23, 9X :: Кт 6435)
...
#КонецОбласти 
	...
	Возврат ТекстКорректировкиНДСПартий;
	
КонецФункции

// Функция возвращает текст запроса дополнительных временных таблиц, 
// необходимых для отражения в украинском регламетированном учете
...
Функция ТекстЗапросаТаблицаПрочиеРасходы(Запрос, ТекстыЗапроса, Регистры)
	...
	|	СУММА(ТаблицаТовары.СуммаНДСРегл) КАК СуммаРегл,
