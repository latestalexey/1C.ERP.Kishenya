...
Процедура СрокПриИзменении(Элемент)
	...
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьДатуОкончанияПоСроку(ЭтаФорма, "ДатаПредоставления", "Объект.ДатаОкончания", "МесяцОкончания", Срок);
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьРазмерПогашения(Объект.РазмерПогашения, Объект.Сумма, Срок, ВидПлатежей, Объект.ОграничениеПлатежа);
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьРазмерПлатежа(Объект.РазмерПлатежа, Срок, ВидПлатежей, ДанныеЗайма());
...
Процедура ПриИзмененииМесяцаИзменений()
	...
	// Дата изменений ограничена крайней операцией по займу.
...
Процедура ПриИзмененииМесяцаОкончания()
	...
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьСрокПоДатеОкончания(Срок, Объект.ДатаОкончания, ДатаПредоставления);
...
Процедура ПрочитатьДанныеФормы(ТекущийОбъект = Неопределено)
	...
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьСрокПоДатеОкончания(Срок, ТекущийОбъект.ДатаОкончания, ДатаПредоставления);
...
Функция ДанныеЗайма()
	...
	ДанныеЗайма.Вставить("МесяцПредоставления", ДатаПредоставления);
