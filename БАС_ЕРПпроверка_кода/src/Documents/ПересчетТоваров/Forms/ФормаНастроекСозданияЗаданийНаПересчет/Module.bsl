...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаПараметрыРегламнтногоЗадания.Видимость = РежимРедактированиеРегламентногоЗадания;
	Элементы.СоздатьЗадания.Заголовок = ?(РежимРедактированиеРегламентногоЗадания,
		НСтр("ru='Закрыть и сохранить регламентное задание';uk='Закрити і зберегти регламентне завдання'"),
		НСтр("ru='Создать задания';uk='Створити завдання'"));
...
Процедура СоздатьЗадания(Команда)
	...
	Иначе
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Задания на пересчет';uk='Завдання на перерахунок'"),, Результат.СтрокаСообщения);
...
Функция СоздатьЗаданияНаСервере(ПараметрыГенерации)
	...
	Результат.Вставить("СтрокаСообщения", НСтр("ru='Создано %СтрокаСкладовСКоличеством% на пересчет.';uk='Створено %СтрокаСкладовСКоличеством% на перерахунок.'"));
...
#Область НастройкиКомпановкиДанных
