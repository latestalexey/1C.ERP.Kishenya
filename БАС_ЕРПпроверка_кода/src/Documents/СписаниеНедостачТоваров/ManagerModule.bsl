...
#Область ТекстСписаниеКомиссионныхИДавальческихТоваров // (Дт :: Кт 0221, 0241)
	...
	|	0 КАК СуммаПРКт,
	|	0 КАК СуммаВРКт,
	|	""Списание комиссионного (давальческого) товара"" КАК Содержание
	|
	|ИЗ
...
#Область ТекстКорректировкиНДСПартийСобственныхТоваров // (Дт 23, 9X :: Кт 6435)
	ТекстКорректировкиНДСПартийСобственныхТоваров = "
	|ВЫБРАТЬ   ////  Условная продажа при использовании облагаемого товара в необлагаемых операциях  (Дт 23, 9X :: Кт 6435)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#КонецОбласти
	...
	Возврат ТекстСписаниеКомиссионныхИДавальческихТоваров
		...
		+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстКорректировкиНДСПартийСобственныхТоваров
		;
