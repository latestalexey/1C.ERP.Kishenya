	...
	Если ПроверятьЗаполнениеПрогнозныхКурсовВалют И ВалютыПроверкиКурсов.Количество() <> 0 Тогда
		...
		Если НеНайденныеКурсы.Количество() <> 0 Тогда
			...
			ТекстСообщения = 
                ...
                |Необходимо установить прогнозные курсы валют %1 в сценарии бюджетирования ""%2"" для каждого периода плана.'
                |;uk='План продажів відображається в бюджетуванні. 
                |Необхідно встановити прогнозні курси валют %1 в сценарії бюджетування ""%2"" для кожного періоду плану.'");
			ТекстСообщения = 
