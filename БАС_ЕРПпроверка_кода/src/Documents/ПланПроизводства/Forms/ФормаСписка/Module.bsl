...
Процедура ПересчитатьПотребностиПланаПроизводства(Команда)
	...
	ПересчитатьПотребностиПланаПроизводстваНаСервере(ВыделенныеСтроки);
...
&НаСервере
Процедура ПересчитатьПотребностиПланаПроизводстваНаСервере(МассивСсылок)
	
	Для каждого Элемент Из МассивСсылок Цикл
		Документы.ПланПроизводства.ПересчитатьПотребностиПланаПроизводства(Элемент);
	КонецЦикла; 
