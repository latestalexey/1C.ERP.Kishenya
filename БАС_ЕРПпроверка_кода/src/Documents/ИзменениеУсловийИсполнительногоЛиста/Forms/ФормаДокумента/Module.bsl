...
Процедура ПросчитатьДатуОкончания(ТекСтрока)
	...
	Если ТекСтрока.ДатаРождения <> Дата("00010101") Тогда
		ТекСтрока.ДатаОкончания = ДобавитьМесяц(ТекСтрока.ДатаРождения, 12 * 18); //18 лет в месяцах
	КонецЕсли;
...
Функция КлючевыеРеквизитыЗаполненияФормыОписаниеКлючевыхРеквизитов() Экспорт
	...
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("ЭлементФормы, Представление", "ИсполнительныйЛист", НСтр("ru='исполнительного листа';uk='виконавчого листа'")));
...
Процедура УстановитьВидимостьТЧДети(Форма)
	...
	Элементы = Форма.Элементы;
	Объект = Форма.Объект;
	Элементы.ДетиГруппа.Видимость = (ЗначениеЗаполнено(Объект.ИсполнительныйЛист) И (Объект.ИсполнительныйЛист.Дети.Количество() > 0));
