...
#Область ТекстРеализацияУслугНДС                 // (Дт 70 :: Кт 643)
	...
	|ВЫБРАТЬ //// Начисление НДС по работам, услугам (Дт 70 :: Кт 643)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ТекстПоступлениеТоваровУслугНДС         // (Дт 6442 :: Кт 63)
...
#Область ТекстКорректировкиНДСПартийРеализацияТоваров   // (Дт 90 :: Кт 6435)
	ТекстКорректировкиНДСПартийРеализацияТоваров = "
	|ВЫБРАТЬ // Условная продажа (Дт 90 :: Кт 6435)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ТекстКорректировкиНДСПартийРеализацияРабот    // (Дт 90 :: Кт 6435)
	ТекстКорректировкиНДСПартийРеализацияРабот = "
	|ВЫБРАТЬ // Условная продажа (Дт 90 :: Кт 6435)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
...
#Область ТекстКорректировкиНДСПартийПередачаНаКомиссию // (Дт 283 :: Кт 6435)
	ТекстКорректировкиНДСПартийПередачаНаКомиссию = "
...
#Область ТекстКорректировкиНДСПартийРеализацияИПередачаНаСубКомиссиюКомиссионногоТовара // (Дт 6441 :: Кт 6435)
	ТекстКорректировкиНДСПартийРеализацияИПередачаНаСубКомиссиюКомиссионногоТовара = "
	|ВЫБРАТЬ //// Условная продажа при передаче товаров на комиссию (Дт 6441 :: Кт 6435)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ТекстПередачаНаКомиссиюНДСУКР // (Дт 6431 :: Кт 6432)
	...
	|	0 КАК СуммаПРКт,
	|	0 КАК СуммаВРКт,
	|	""НДС: обязательства, товары"" КАК Содержание
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#КонецОбласти
	...
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстПередачаНаКомиссиюНДСУКР
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстКорректировкиНДСПартийРеализацияТоваров
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстКорректировкиНДСПартийРеализацияРабот
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстКорректировкиНДСПартийПередачаНаКомиссию
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстКорректировкиНДСПартийРеализацияИПередачаНаСубКомиссиюКомиссионногоТовара
	...
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстПриемНаКомиссиюНДСУКР
	;
...
Функция ТекстЗапросаТаблицаПрочиеРасходы(Запрос, ТекстыЗапроса, Регистры)
	...
	|		ТОГДА 
	|			0
	|		КОГДА ТаблицаТовары.НалоговоеНазначениеПолучателя.ВидДеятельностиНДС = ЗНАЧЕНИЕ(Перечисление.ВидыДеятельностиНДС.Облагаемая)
	|		ТОГДА
	|			ТаблицаТовары.СуммаБезНДСРегл
...
Функция ТекстЗапросаТаблицаПартииПрочихРасходов(Запрос, ТекстыЗапроса, Регистры)
    ...
    //++ НЕ УТ
	|		ИЛИ (
	|		ТаблицаТовары.ВариантРаспределенияРасходов = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаВнеоборотныеАктивы)
