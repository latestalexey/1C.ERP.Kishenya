...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСоздатьНаОсновании) Экспорт
	...
	//++ НЕ УТ
	Документы.ДепонированиеЗарплаты.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
	//-- НЕ УТ
...
Функция ТекстЗапросаВременнаяТаблицаВедомостиНаВыплатуЗарплаты(Запрос, ТекстыЗапроса)
	
	ИмяРегистра = "ТаблицаВедомостиНаВыплатуЗарплаты";
	...
	|ПОМЕСТИТЬ ТаблицаВедомостиНаВыплатуЗарплаты
	|
	|ИЗ
	...
	|	И &ХозяйственнаяОперацияПоЗарплате = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВыплатаЗарплатыЧерезКассу)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
...
Функция ТекстЗапросаТаблицаДенежныеСредстваКВыплате(Запрос, ТекстыЗапроса, Регистры)
	...
	//++ НЕ УТ
	Если НЕ ПроведениеСервер.ЕстьТаблицаЗапроса("ТаблицаВедомостиНаВыплатуЗарплаты", ТекстыЗапроса) Тогда
		ТекстЗапросаВременнаяТаблицаВедомостиНаВыплатуЗарплаты(Запрос, ТекстыЗапроса);
	КонецЕсли; 
	//-- НЕ УТ
	...
	|
	|ИЗ
	|	ТаблицаВедомостиНаВыплатуЗарплаты КАК ТаблицаВедомости
	|
	|ГДЕ
	|	&ИспользоватьЗаявкиНаРасходованиеДенежныхСредств
	|	И &Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыЗаявокНаРасходованиеДенежныхСредств.Отклонена)
	|	И &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВыплатаЗарплаты)
	|	И &ХозяйственнаяОперацияПоЗарплате <> ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВыплатаЗарплатыПоЗарплатномуПроекту)
