...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Если ДоступностьРаспоряженийТовары Тогда
		...
		//++ НЕ УТ
		|				ИЛИ ТИПЗНАЧЕНИЯ(ТаблицаРаспоряженийПоступление.ЗаказПоставщику) = ТИП(Документ.ЗаказПереработчику)
		//-- НЕ УТ
		//++ НЕ УТКА
		|				ИЛИ ТИПЗНАЧЕНИЯ(ТаблицаРаспоряженийПоступление.ЗаказПоставщику) = ТИП(Документ.ЗаказДавальца)
		//-- НЕ УТКА
		|)
		|	
		|	ОБЪЕДИНИТЬ ВСЕ
