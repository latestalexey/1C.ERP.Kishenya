...
Функция СформироватьПечатнуюАктаИнвентаризацииНаличныхДенежныхСредствУКР(МассивОбъектов, ОбъектыПечати)
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Если ВыборкаИтогов.НайтиСледующий(СтруктураПоиска) Тогда
			...
			ОбластьМакета.Параметры.СуммаПоФактуГрн = Формат(ВыборкаИтогов.СуммаПоФакту, "ЧЦ=15; ЧДЦ=0; ЧН='0'");
			...
			ОбластьМакета.Параметры.СуммаПоУчетуГрн = Формат(ВыборкаИтогов.СуммаПоУчету, "ЧЦ=15; ЧДЦ=0; ЧН='0'");
			...
			ОбластьМакета.Параметры.СуммаИзлишек = Формат(СуммаИзлишек, "ЧЦ=15; ЧДЦ=; ЧН=-");
			
			ОбластьМакета.Параметры.СуммаНедостача = Формат(СуммаНедостача, "ЧЦ=15; ЧДЦ=; ЧН=-");
