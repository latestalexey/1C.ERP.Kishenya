...
//
Функция ДанныеЗаполненияЗакрытияЛицевыхСчетов() Экспорт
...
//
Функция ДанныеЗаполненияСтрокиЗакрытияЛицевыхСчетов() Экспорт
...
Функция ДанныеЗакрытияЛицевыхСчетов(МассивДокументов, ДатаПолученияДанных) Экспорт
	...
	|		ПО ЗаявкиНаЗакрытиеЛицевыхСчетов.Банк = КлассификаторБанковРФ.Ссылка
	|
	|УПОРЯДОЧИТЬ ПО
...
Процедура ВыгрузитьФайлыДляОбменаСБанком(СтруктураПараметровДляФормированияФайла) Экспорт
	...
	СтруктураПараметровДляФормированияФайла.Вставить("ДанныеДокументов", ДанныеЗакрытияЛицевыхСчетов(
