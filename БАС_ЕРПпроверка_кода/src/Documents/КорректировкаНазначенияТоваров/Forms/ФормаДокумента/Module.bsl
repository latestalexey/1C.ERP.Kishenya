...
Процедура ПриЧтенииСозданииНаСервере()
	...
	//++ НЕ УТКА
	ЗапретСнятияРезерва = ТипЗнч(Объект.Заказ) = Тип("ДокументСсылка.ЗаказДавальца");
	//-- НЕ УТКА
...
//++ НЕ УТКА
	Если ТипЗнч(Объект.Заказ) = Тип("ДокументСсылка.ЗаказДавальца") Тогда
		ТекстПоступаетНаСклад = "";
	КонецЕсли;
//-- НЕ УТКА
