...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки = "") Экспорт
	...
	Настройки.ЗаголовокПомощникаСозданияОбмена = НСтр("ru='Настройка синхронизации с BAS Документооборот КОРП, ред 2.1';uk='Настройка синхронізації з BAS Документообіг КОРП, ред 2.1'");
	Настройки.ЗаголовокУзлаПланаОбмена = НСтр("ru='Синхронизация с BAS Документооборот КОРП, ред 2.1';uk='Синхронізація з BAS Документообіг КОРП, ред 2.1'");
...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ru='Настройки обмена ERP-ДО';uk='Настройка обміну ERP-ДО'");
...
Функция ОписаниеОграниченийПередачиДанных(НастройкаОтборовНаУзле, ВерсияКорреспондента, ИдентификаторНастройки = "") Экспорт
	...
	Возврат "Настройка ограничений передачи данных не предусмотрена.";
...
Функция ОписаниеЗначенийПоУмолчанию(ЗначенияПоУмолчаниюНаУзле, ВерсияКорреспондента, ИдентификаторНастройки = "") Экспорт
	...
	Возврат "Настройка значений по умолчанию не предусмотрена.";
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru='Создать обмен с конфигурацией ""BAS Документооборот КОРП, редакция 2.1""';uk='Створити обмін з конфігурацією ""BAS Документообіг КОРП, редакція 2.1""'");
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки = "") Экспорт
	...
	Возврат "ПланОбмена.ОбменУправлениеПредприятиемДокументооборот.Форма.ПодробнаяИнформация";
