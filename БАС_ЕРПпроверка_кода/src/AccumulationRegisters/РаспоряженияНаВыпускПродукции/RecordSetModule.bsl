...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|				ТОГДА ИСТИНА
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ                           КАК ВидДвиженияПриход,  // Обход ошибки платформы
	...
	СтруктураВременныеТаблицы.Вставить("ДвиженияРаспоряженияНаВыпускПродукцииИзменение", Выборка.Количество > 0);
