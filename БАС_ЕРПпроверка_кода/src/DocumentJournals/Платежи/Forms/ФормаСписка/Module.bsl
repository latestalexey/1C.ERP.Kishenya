...
Процедура ИнициализироватьРеквизиты()
	...
	//++ НЕ УТ
	ТекстЗапросаЗаказыКОплате = ТекстЗапросаЗаказыКОплате
		+ " ОБЪЕДИНИТЬ ВСЕ "
		+ ДенежныеСредстваСервер.ТекстЗапросаВедомостиКОплатеВБезналичнойФорме()
		+ " ОБЪЕДИНИТЬ ВСЕ "
		+ ДенежныеСредстваСервер.ТекстЗапросаВедомостиКОплатеНаличными();
	//-- НЕ УТ
	...
	//++ НЕ УТ
	КОплате.Параметры.УстановитьЗначениеПараметра("ВыводитьВедомостиНаВыплатуЗарплаты", Истина);
	//-- НЕ УТ
...
Процедура УстановитьКонстантыСписков()
	...
	//++ НЕ УТ
	КОплате.Параметры.УстановитьЗначениеПараметра("ВалютаРегламентированногоУчета",
...
Функция СписокОперацийОплаты(ИспользоватьНачислениеЗарплаты)
	...
	Если ИспользоватьНачислениеЗарплаты Тогда
		СписокОпераций.Добавить(Операции.ВыплатаЗарплатыПоЗарплатномуПроекту);
		СписокОпераций.Добавить(Операции.ВыплатаЗарплатыНаЛицевыеСчета);
		
		СписокОпераций.Добавить(Операции.ВыплатаЗарплатыЧерезКассу);
		СписокОпераций.Добавить(Операции.ВыплатаЗарплатыРаздатчиком);
	КонецЕсли;
	//-- НЕ УТ
