...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Если ПроведениеСервер.РассчитыватьИзменения(ДополнительныеСвойства) Тогда
		...
		// Новые изменения были помещены во временную таблицу "ДвиженияЭтапыПроизводстваИзменение".
		// Добавляется информация о ее существовании и наличии в ней записей об изменении.
		СтруктураВременныеТаблицы.Вставить("ДвиженияЭтапыПроизводстваИзменение", Выборка.Количество > 0);
