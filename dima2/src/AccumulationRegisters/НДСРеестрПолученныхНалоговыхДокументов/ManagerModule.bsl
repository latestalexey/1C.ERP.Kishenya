...
Функция ДокументыКОтражениюВМеждународномУчете() Экспорт
	...
	ДокументыКОтражению.Добавить("РегистрацияВходящегоНалоговогоДокумента");
...
Функция ПолноеИмяРегистра()
    Возврат "РегистрНакопления.НДСРеестрПолученныхНалоговыхДокументов";
КонецФункции 
...
#Область АналитикаУчетаПоПартнерам
	...
	|ИЗ
	|	РегистрНакопления.НДСРеестрПолученныхНалоговыхДокументов КАК Расчеты
	|
	...
	|			КОНЕЦ)
	|ГДЕ
	|	    Расчеты.Регистратор ССЫЛКА Документ.РегистрацияВходящегоНалоговогоДокумента
...
Процедура ЗаменитьАналитикуУчетаПоПартнерамПоРегистраторуРегистрацияВходящегоНалоговогоДокумента(Параметры) Экспорт
...
Процедура ЗаменитьАналитикуУчетаПоПартнерамПоРегистраторуРегистрацияВходящегоНалоговогоДокумента_ДанныеДляОбновления(Параметры) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	НДСРеестрОбороты.Регистратор
	|ИЗ
	|	РегистрНакопления.НДСРеестрПолученныхНалоговыхДокументов.Обороты(, , Регистратор, ) КАК НДСРеестрОбороты
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.НДССоставПоставкиДляРегистрацииВходящихНалоговыхДокументов.Обороты(, , Регистратор, ) КАК НДССоставПоставкиОбороты
	|		ПО НДСРеестрОбороты.Регистратор = НДССоставПоставкиОбороты.Регистратор
	|			И (НЕ НДСРеестрОбороты.АналитикаУчетаПоПартнерам = НДССоставПоставкиОбороты.АналитикаУчетаПоПартнерам)
	|			И НДСРеестрОбороты.ОбъектРасчетов = НДССоставПоставкиОбороты.ОбъектРасчетов
	|			И НДСРеестрОбороты.СтавкаНДС = НДССоставПоставкиОбороты.СтавкаНДС
	|			И НДСРеестрОбороты.ВидПоставки = НДССоставПоставкиОбороты.ВидПоставки
	|ГДЕ
	|	НДСРеестрОбороты.Регистратор ССЫЛКА Документ.РегистрацияВходящегоНалоговогоДокумента";
