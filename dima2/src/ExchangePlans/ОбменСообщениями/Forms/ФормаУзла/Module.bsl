...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЭтоЭтотУзел Тогда
		...
		ИначеЕсли Объект.Ведущая Тогда
			Элементы.ИнформационноеСообщение.Заголовок
				= НСтр("ru='Эта конечная точка является ведущей, т.е. инициирует отправку и получение сообщений обмена для текущей информационной системы.';uk='Ця кінцева точка є провідною, тобто ініціює відправлення та отримання повідомлень обміну для поточної інформаційної системи.'");
		Иначе
			Элементы.ИнформационноеСообщение.Заголовок
