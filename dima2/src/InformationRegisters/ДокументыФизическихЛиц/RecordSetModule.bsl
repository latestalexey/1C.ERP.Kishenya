...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ТекстСообщения = НСтр("ru='На %1 у физлица %2 уже введен документ, удостоверяющий личность.';uk='На %1 у фізособи %2 уже введений документ, що засвідчує особистість.'");
