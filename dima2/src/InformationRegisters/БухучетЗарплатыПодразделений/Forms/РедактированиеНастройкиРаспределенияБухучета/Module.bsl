...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтражениеЗарплатыВФинансовомУчетеУП.УстановитьЗаголовокСпособаОтражения(ЭтаФорма, "ТаблицаРаспределенияСпособОтраженияЗарплатыВБухучете");
	//ERP конец
...
Процедура ОповеститьОбИзменениях(Отказ)
	...
	Если Модифицированность Тогда
		...
		Если ПроверитьЗаполнение() Тогда
			...
			ИменаКолонок = "СпособОтраженияЗарплатыВБухучете,СтатьяФинансирования,ДоляРаспределения";
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ТаблицаРаспределения.Количество() = 0 Тогда
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не заполнено распределение';uk='Не заповнено розподіл'"));
