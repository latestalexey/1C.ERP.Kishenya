...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ТолькоОткрытие Тогда
		Заголовок = НСтр("ru='Открытие макета печатной формы';uk='Відкриття макету друкованої форми'");
	КонецЕсли;
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВебКлиент() И ТипМакета = "MXL" Тогда
		Элементы.НадписьЗавершениеИзмененияНеВебКлиент.Заголовок = НСтр("ru='После внесения необходимых изменений в макет нажмите на кнопку ""Завершить изменение""';uk='Після внесення необхідних змін у макет натисніть на кнопку ""Завершити зміну""'");
	КонецЕсли;
...
Процедура УстановитьНазваниеПрограммыДляОткрытияМакета()
	...
	Если ТипФайла = "mxl" Тогда
		НазваниеПрограммыДляОткрытияМакета = НСтр("ru='Работа с файлами';uk='Робота з файлами'");
		АдресПрограммыДляОткрытияМакета = "https://1c-dn.com/developer_tools/fileworkshop/";		
	ИначеЕсли ТипФайла = "doc" Тогда
		НазваниеПрограммыДляОткрытияМакета = НСтр("ru='Microsoft Word';uk='Microsoft Word'");
		АдресПрограммыДляОткрытияМакета = "http://office.microsoft.com/ru-ru/word";
	ИначеЕсли ТипФайла = "odt" Тогда
		НазваниеПрограммыДляОткрытияМакета = НСтр("ru='OpenOffice Writer';uk='Openoffice Writer'");
	...
	СведенияДляЗаполнения.Вставить("ОписаниеДействия", ?(Параметры.ТолькоОткрытие, НСтр("ru='открытия';uk='відкриття'"), НСтр("ru='внесения изменений';uk='внесення змін'")));
