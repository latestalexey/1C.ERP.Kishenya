...
Процедура ЗаполнитьСостоянияДокументовЗачисленияЗарплаты() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		НовоеСостояниеДокумента.Документ = Выборка.Ведомость;
...
Процедура ЗаполнитьОрганизациюВСостоянииДокументовЗачисленияЗарплаты() Экспорт
	...
	|		ПО СостоянияДокументовЗачисленияЗарплаты.Документ = ВедомостьНаВыплатуЗарплатыВБанк.Ссылка";
	...
	Если МетаданныеПлатежногоДокумента <> Неопределено Тогда
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ " + МетаданныеПлатежногоДокумента.ПолноеИмя() + " КАК ДокументЗачисленияЗарплаты
		|		ПО СостоянияДокументовЗачисленияЗарплаты.Документ = ДокументЗачисленияЗарплаты.Ссылка";
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "ВедомостьНаВыплатуЗарплатыВБанк.Организация", "ЕСТЬNULL(ВедомостьНаВыплатуЗарплатыВБанк.Организация, ДокументЗачисленияЗарплаты.Организация) КАК Организация");
	КонецЕсли;
