...
//
//	Параметры:
//		ВидРабочегоЦентра			- СправочникСсылка.ВидРабочегоЦентра - Вид рабочего центра, для которого устанавливается время переналадки
...
//
// Параметры:
//		ВидРабочегоЦентра	- СправочникСсылка.ВидРабочегоЦентра - Вид рабочего центра, для которого определяется время переналадки
//
// Возвращаемое значение:
//   ТаблицаЗначений   - длительность переналадки, содержит колонки:
//							- ТекущийВариантНаладки
//							- СледующийВариантНаладки
//							- ВремяПереналадки
//							- ЕдиницаВремениПереналадки
