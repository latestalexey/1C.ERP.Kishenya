...
Функция ОписаниеМетаданныхНакладных() Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеРемонтами") Тогда
		...
		Строка = ТаблицаЗначений.Добавить();
		Строка.ХозяйственнаяОперация 		= Перечисления.ХозяйственныеОперации.СписаниеТоваровПоТребованию;
		Строка.ТипДокумента 				= Тип("ДокументСсылка.ЗаказНаРемонт");
		Строка.ТипНакладной 				= Тип("ДокументСсылка.ВнутреннееПотреблениеТоваров");
		Строка.ОбъектМетаданныхДокумента	= Метаданные.Документы.ЗаказНаРемонт;
		Строка.ИспользуетсяРаспоряжение		= Истина;
		Строка.ПоНесколькимЗаказам			= ВнутреннееПотреблениеПоНесколькимЗаказам;
		Строка.ПриходныйОрдерНевозможен		= Истина;
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПроизводство") Тогда
		...
		Строка.ТипНакладной 				= Тип("ДокументСсылка.ПередачаМатериаловВПроизводство");
		Строка.ОбъектМетаданныхДокумента	= Метаданные.Документы.ПередачаМатериаловВПроизводство;
		Строка.Накладная					= Истина;
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПроизводство")
		Или ПолучитьФункциональнуюОпцию("ИспользоватьПроизводствоИзДавальческогоСырья") Тогда
		
		// Заказ на производство на передачу материалов в производство.
		Строка = ТаблицаЗначений.Добавить();
		Строка.ХозяйственнаяОперация 		= Перечисления.ХозяйственныеОперации.ПередачаВПроизводство;
		Строка.ТипДокумента 				= Тип("ДокументСсылка.ЗаказНаПроизводство");
		Строка.ТипНакладной 				= Тип("ДокументСсылка.ПередачаМатериаловВПроизводство");
		Строка.ОбъектМетаданныхДокумента	= Метаданные.Документы.ЗаказНаПроизводство;
		Строка.ИспользуетсяРаспоряжение		= Истина;
		Строка.РазделятьДокументыПоПодразделению = Истина;
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПроизводство") Тогда
		...
		Строка.ОбъектМетаданныхДокумента	= Метаданные.Документы.ВозвратМатериаловИзПроизводства;
		Строка.Накладная					= Истина;
		Строка.ИспользуютсяСтатусы			= Истина;
		Строка.КомандаСозданияФормы			= "СписокСоздатьВозвратМатериаловИзПроизводства";
		...
		Строка.ОбъектМетаданныхДокумента	= Метаданные.Документы.ВыпускПродукции;
		Строка.КомандаСозданияФормы			= "СписокСоздатьВыпускПродукции";
		Строка.Накладная					= Истина;
