...
Процедура ОбновитьИнформациюОСостоянииРегламентногоЗаданияНаСозданиеПересчетовТоваров(Знач ИдентификаторЗадания, ДатаОкончания, СостояниеВыполнения, Знач УстанавливатьПривилегированныйРежим = Истина)
	...
	СвойстваПоследнегоФоновогоЗадания 
		= ОбщегоНазначенияУТ.ПолучитьСвойстваПоследнегоФоновогоЗаданияВыполненияРегламентногоЗадания(ТекущееРегламентноеЗадание);
	...
	Иначе
		ДатаОкончания       = ?(ЗначениеЗаполнено(СвойстваПоследнегоФоновогоЗадания.Конец), СвойстваПоследнегоФоновогоЗадания.Конец, "<>");
