...
Процедура ИнициализацияФормы()
	...
	Если Объект.Завершен Тогда
		...
		ТекстСостояния = ?(Объект.Выполнено, 
			НСтр("ru='Задание выполнено %1.';uk='Завдання виконано %1.'"), 
			НСтр("ru='Задание отменено %1.';uk='Завдання скасовано %1.'"));
	...
	Иначе
		...
		ТекстСостояния = ?(ПолучитьФункциональнуюОпцию("ИзменятьЗаданияЗаднимЧислом"), 
			НСтр("ru='Изменения формулировки, важности, автора, а также перенос сроков исполнения и проверки задания 
                ...
                |;uk='Зміни формулювання, важливості, автора, а також перенесення  строків виконання і перевірки задачі 
                |набудуть чинності негайно для раніше виданої задачі.'"), 
			НСтр("ru='Изменения формулировки, важности, автора, а также перенос сроков исполнения и проверки задания 
                |не будут отражены в ранее выданной задаче.'
                |;uk='Зміни формулювання, важливості, автора, а також перенесення строків виконання і перевірки завдання 
                |не будуть відображені в раніше виданії задачі.'"));
