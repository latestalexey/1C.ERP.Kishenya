...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(Предмет) Тогда
		...
		Если Выборка.ЕстьОшибкиПроведен Тогда
			...
			ТекстОшибки = НСтр("ru='Согласование не может быть начато, т.к. документ %ДокументПредмет% не проведен';uk='Погодження не може бути розпочато, т. к. документ %ДокументПредмет% не проведено'");
...
Процедура ОбработкаРезультатовСогласованияОбработка(ТочкаМаршрутаБизнесПроцесса)
	...
	Если НеобходимоСогласовать Тогда
		...
		Если ПредметОбъект.Статус = Перечисления.СтатусыЗаказовПоставщикам.НеСогласован Тогда
			ПредметОбъект.Статус = Перечисления.СтатусыЗаказовПоставщикам.Согласован;
