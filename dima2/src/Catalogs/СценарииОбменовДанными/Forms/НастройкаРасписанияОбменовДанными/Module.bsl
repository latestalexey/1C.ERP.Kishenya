...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru='Сценарии синхронизации данных для: [УзелИнформационнойБазы]';uk='Сценарії синхронізації даних для: [УзелИнформационнойБазы]'");
...
Процедура ВыполнитьСценарий(Команда)
	...
	Сообщение = НСтр("ru='Синхронизируются данные по сценарию ""%1""...';uk='Синхронізуються дані по сценарії ""%1""...'");
	...
	Если Отказ Тогда
		Сообщение = НСтр("ru='Сценарий синхронизации выполнен с ошибками.';uk='Сценарій синхронізації виконаний з помилками.'");
		Картинка = БиблиотекаКартинок.Ошибка32;
	Иначе
		Сообщение = НСтр("ru='Сценарий синхронизации успешно выполнен.';uk='Сценарій синхронізації успішно виконаний.'");
