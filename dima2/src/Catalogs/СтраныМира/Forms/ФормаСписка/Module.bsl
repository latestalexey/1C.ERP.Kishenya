...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СписокКлассификатор.Видимость           = МожноДобавлятьВСправочник;
	Элементы.СписокВыбратьИзКлассификатора.Видимость = МожноДобавлятьВСправочник;
	Элементы.СписокОбновитьИзКлассификатора.Видимость = МожноДобавлятьВСправочник;
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	Если Не Копирование Тогда
		...
		ТекстВопроса = НСтр("ru='Есть возможность подобрать страну мира из классификатора.
                                |Подобрать?'
                                |;uk='Існує можливість підібрати країну світу із класифікатора.
                                |Підібрати?'");
...
Процедура ОбновитьИзКлассификатораНаСервере()
	...
	УправлениеКонтактнойИнформациейСлужебный.ОбновитьСуществующиеСтраныМира();
