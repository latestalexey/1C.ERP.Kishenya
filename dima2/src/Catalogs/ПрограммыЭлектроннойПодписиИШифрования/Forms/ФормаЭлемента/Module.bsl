...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЦикла;
	Элементы.Наименование.СписокВыбора.Добавить("", НСтр("ru='<Другая программа>';uk='<Інша програма>'"));
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не Запрос.Выполнить().Пустой() Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Программа с указанным именем и типом уже добавлена в список.';uk='Програма з іменем та типом вже додана в список.'"),
			,
			"Объект.ИмяПрограммы");
	КонецЕсли;
...
Процедура УстановитьПометкуУдаления(Команда)
	...
	ПоказатьВопрос(
		...
		НСтр("ru='Для установки отметки удаления необходимо записать внесенные Вами изменения.
                   |Записать данные?'
                   |;uk='Для встановлення позначки вилучення необхідно записати внесені Вами зміни.
                   |Записати дані?'"), РежимДиалогаВопрос.ДаНет);
