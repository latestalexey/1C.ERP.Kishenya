...
Функция ПоставляемыеНастройкиПрограмм() Экспорт
	...
	Настройка.Представление       = НСтр("ru='ViPNet CSP';uk='ViPNet CSP'");
	...
	// КриптоПро CSP
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru='КриптоПро CSP';uk='КриптоПро CSP'");
	...
	// ЛИССИ CSP
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru='ЛИССИ CSP';uk='ЛІССІ CSP'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru='Сигнал-КОМ CSP (RFC 4357)';uk='Сигнал-КОМ CSP (RFC 4357)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru='Сигнал-КОМ CSP (ITU-T X.509 v.3)';uk='Сигнал-КОМ CSP (ITU-T X. 509 v.3)'");
