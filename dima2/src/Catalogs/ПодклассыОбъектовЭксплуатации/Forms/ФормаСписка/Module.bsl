...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") И Параметры.Отбор.Свойство("Владелец") Тогда
		...
		Если Не ЗначениеЗаполнено(ИспользуютсяПодклассы) Или Не ИспользуютсяПодклассы Тогда
			...
			ТекстЗаголовка = НСтр("ru='Для элемента: ""%Владелец%"" использование подклассов не определено';uk='Для елемента: ""%Владелец%"" використання підкласів не визначено'");
		...
		Иначе
			...
			ТекстЗаголовка = НСтр("ru='Подклассы объектов ремонта (%Владелец%)';uk='Підкласи об''єктів ремонту (%Владелец%)'");
			ТекстЗаголовка = СтрЗаменить(ТекстЗаголовка, "%Владелец%", Строка(Владелец));
