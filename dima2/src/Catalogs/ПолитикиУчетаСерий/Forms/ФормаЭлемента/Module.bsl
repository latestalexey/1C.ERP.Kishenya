...
Процедура УстановитьДоступностьНаСервере()
	...
	Если Объект.ТипПолитики = Перечисления.ТипыПолитикУказанияСерий.СправочноеУказаниеСерий Тогда
		...
		Элементы.УказыватьДляМатериаловПриВыполненииМаршрутныхЛистов.Доступность = Объект.УказыватьПриДвиженииМатериалов;
		...
		Элементы.УказыватьДляИзделийПриВыполненииМаршрутныхЛистов.Доступность    = Объект.УказыватьПриДвиженииПродукции;
	...
	ИначеЕсли Объект.ТипПолитики = Перечисления.ТипыПолитикУказанияСерий.АвторасчетПоFEFOОстатковСерий Тогда
		...
		Элементы.УказыватьДляМатериаловПриВыполненииМаршрутныхЛистов.Доступность = Ложь;
		...
		Элементы.УказыватьДляИзделийПриВыполненииМаршрутныхЛистов.Доступность    = Истина;
...
Процедура ТипПолитикиПриИзмененииНаСервере()
	...
	ИначеЕсли Объект.ТипПолитики = Перечисления.ТипыПолитикУказанияСерий.УправлениеОстаткамиСерий Тогда
		...
		Объект.УказыватьДляМатериаловПриВыполненииМаршрутныхЛистов = Истина;
