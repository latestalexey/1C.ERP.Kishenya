...
Процедура ЗаполнитьПоКадровымДаннымФизическогоЛица()
	...
	ДанныеСотрудников = КадровыйУчет.ОсновныеСотрудникиФизическихЛиц(Объект.ФизическоеЛицо, Истина, Объект.Владелец, ПолучатьНаДату);
	
	КадровыеДанные = КадровыйУчет.КадровыеДанныеСотрудников(Истина, ДанныеСотрудников.ВыгрузитьКолонку("Сотрудник"), "Должность", ПолучатьНаДату);
