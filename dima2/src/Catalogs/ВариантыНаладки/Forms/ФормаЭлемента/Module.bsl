...
Процедура ПодобратьЦветОформления()
	...
	Пока Выборка.Следующий() Цикл
		ЦветВариантаНаладки = Выборка.ЦветОформления.Получить();
...
Процедура СохранитьЦветОформления(ТекущийОбъект)
	...
	Если ЦветОформления <> ПустойЦвет Тогда
		...
		ЦветОформленияОбъекта.Вставить("ЦветОформленияRGB", ОперативныйУчетПроизводства.ЦветВФорматеRGB(ЦветОформления));
	Иначе
