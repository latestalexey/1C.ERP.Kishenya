...
Процедура ЗаполнитьРасшифровкуСоотношенияКритериев(Форма)
	...
	Если ОценкаВремя = ОценкаСтоимость Тогда
		...
		Форма.Элементы.РасшифровкаСоотношениеКритериев.Заголовок = НСтр("ru='Текущая оценка: критерии оптимизации эквивалентны.';uk='Поточна оцінка: критерії оптимізації еквівалентні.'");
		
	ИначеЕсли ОценкаВремя = 100 Тогда
		
		Форма.Элементы.РасшифровкаСоотношениеКритериев.Заголовок = НСтр("ru='Текущая оценка: учитывается единственный критерий - сокращение срока выпуска.';uk='Поточна оцінка: враховується єдиний критерій - скорочення строку випуску.'");
		
	ИначеЕсли ОценкаСтоимость = 100 Тогда
		
		Форма.Элементы.РасшифровкаСоотношениеКритериев.Заголовок = НСтр("ru='Текущая оценка: учитывается единственный критерий - сокращение стоимости расписания.';uk='Поточна оцінка: враховується єдиний критерій - скорочення вартості розкладу.'");
		
	Иначе
		
		Форма.Элементы.РасшифровкаСоотношениеКритериев.Заголовок = 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Текущая оценка: значимость сокращения срока выпуска по отношению к сокращению стоимости расписания определяется соотношением %1% к %2%.';uk='Поточна оцінка: значимість скорочення терміну випуску по відношенню до скорочення вартості розкладу визначається співвідношенням %1% до %2%.'"),
