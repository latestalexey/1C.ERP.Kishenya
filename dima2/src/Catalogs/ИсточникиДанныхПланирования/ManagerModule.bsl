...
Функция ШаблоныСхемыКомпоновкиДанных() Экспорт
	...
	//++ НЕ УТ
	ШаблоныУП = Обработки.ИсточникиДанныхПланированияКА.ШаблоныСхемыКомпоновкиДанных();
	
	Для каждого ЭлементМассива Из ШаблоныУП Цикл
		Шаблоны.Добавить(ЭлементМассива);
	КонецЦикла;
	//-- НЕ УТ
	
	//++ НЕ УТКА
	ШаблоныУП = Обработки.ИсточникиДанныхПланированияУП.ШаблоныСхемыКомпоновкиДанных();
