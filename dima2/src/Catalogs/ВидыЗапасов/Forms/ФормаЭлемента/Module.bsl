...
Процедура УправлениеЭлементамиФормы()
	...
	//++ НЕ УТ
	ЭтоПродукцияДавальца = (Объект.ТипЗапасов = Перечисления.ТипыЗапасов.ПродукцияДавальца);
	ЭтоМатериалДавальца = (Объект.ТипЗапасов = Перечисления.ТипыЗапасов.МатериалДавальца);
	Если ЭтоПродукцияДавальца Тогда
		Элементы.Комитент.Видимость   = Истина;
		Элементы.Контрагент.Видимость = Истина;
		Элементы.Договор.Видимость    = Истина;
	КонецЕсли;
	Если ЭтоМатериалДавальца Тогда
		Элементы.Комитент.Видимость   = Истина;
		Элементы.Контрагент.Видимость = Истина;
	КонецЕсли;
	//-- НЕ УТ
