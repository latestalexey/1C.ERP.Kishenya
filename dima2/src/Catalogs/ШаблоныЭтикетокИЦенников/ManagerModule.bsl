...
Функция МаксимальноеКоличествоНаСтранице(ПолеТабличногоДокумента, Назначение) Экспорт
	...
	Описание = НСтр("ru='На странице %1 помещается по вертикали: %2, по горизонтали: %3';uk='На сторінці %1 вміщається по вертикалі: %2, по горизонталі: %3'");
...
Функция ПолучитьОбразцыШтрихкодов() Экспорт
	...
	ПримерКода.Пример       = "4820051000057";
