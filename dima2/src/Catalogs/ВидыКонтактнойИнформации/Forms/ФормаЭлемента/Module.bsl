...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ЗапретРедактированияРеквизитовОбъектов") Тогда
			...
			МодульЗапретРедактированияРеквизитовОбъектов.ЗаблокироватьРеквизиты(ЭтотОбъект,, НСтр("ru='Разрешить редактирование типа и группы';uk='Дозволити редагування типу й групи'"));
...
Процедура ПриОткрытии(Отказ)
	...
	СкрытьВидимостьНенужныхРеквизитовДляУкраины();
	ЗаполнитьКорректныеЗаголовкиДляУкраины();
...
&НаКлиенте
Процедура СкрытьВидимостьНенужныхРеквизитовДляУкраины()
	
	Элементы.ПроверятьПоКлассификатору.Видимость = Ложь;
	Элементы.СкрыватьНеактуальныеАдреса.Видимость = Ложь;
	Элементы.УказыватьОКТМОВручную.Видимость = Ложь;
	Элементы.ПроверятьКорректностьАдреса.Видимость = Ложь;
	
КонецПроцедуры

&НаКлиенте
Процедура ЗаполнитьКорректныеЗаголовкиДляУкраины()
	
	Элементы.АдресТолькоРоссийский.Заголовок = "Только украинский";
