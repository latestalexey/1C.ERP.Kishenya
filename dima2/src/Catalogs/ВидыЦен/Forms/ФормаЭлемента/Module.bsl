...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТ
		ВалютаПлановойЦены = Константы.ВалютаПлановойСебестоимостиПродукции.Получить();
	//-- НЕ УТ
...
//++ НЕ УТ
	Форма.Элементы.ИспользоватьПриВыпускеПродукции.Доступность = (Форма.ВалютаПлановойЦены = Форма.Объект.ВалютаЦены);
//-- НЕ УТ
...
Процедура НастроитьВидимостьЭлементовФормы(Форма)
	...
	//++ НЕ УТКА
	Форма.Элементы.ИспользоватьПриПередачеПродукцииДавальцу.Видимость = Форма.ИспользоватьПроизводство;
	//-- НЕ УТКА
