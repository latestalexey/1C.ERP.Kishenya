...
Процедура ОбработатьВыборКартыЛояльности(ТекущиеДанные)
	...
	Иначе // Карта не зарегистрирована.
		...
		Иначе
			...
			Если ТипКода = ПредопределенноеЗначение("Перечисление.ТипыКодовКарт.Штрихкод") Тогда
				ТекстСообщения = НСтр("ru='Карта ""%1"" со штрихкодом %2 не зарегистрирована. Карты вида ""%1"" регистрируются только с помощью помощника регистрации карт лояльности';uk='Карта ""%1"" зі штрихкодом %2 не зареєстрована. Карти виду ""%1"" реєструються тільки з допомогою помічника реєстрації карт лояльності'");
			Иначе
				ТекстСообщения = НСтр("ru='Карта ""%1"" с магнитным кодом %2 не зарегистрирована. Карты вида ""%1"" регистрируются только с помощью помощника регистрации карт лояльности';uk='Карта ""%1"" з магнітним кодом %2 не зареєстрована. Карти виду ""%1"" реєструються тільки з допомогою помічника реєстрації карт лояльності'");
			КонецЕсли;
