...
Процедура ИнициализироватьДополнительныеСвойстваДляЗаписи(ЗначенияДополнительныхСвойств = Неопределено) Экспорт
	...
	Если ЗначенияДополнительныхСвойств = Неопределено Тогда
		...
		ДополнительныеСвойства.ОбновитьНаименованиеПолное = (
			...
			Или (НаименованиеПолное = ДополнительныеСвойства.РеквизитыДоЗаписи.НаименованиеПолное
				И ДополнительныеСвойства.РеквизитыДоЗаписи.НаименованиеПолное = ДополнительныеСвойства.РеквизитыДоЗаписи.Наименование));
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	// Стандартный механизм проверки заполнения применяется только для проверки стандартных реквизитов: "Наименование", "Код" и "Владелец"
	// Проверка реквизитов, доп. реквизитов и табличных частей инициируется владельцем (объектом эксплуатации) или формой элемента узла.
