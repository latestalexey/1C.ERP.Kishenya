...
Процедура СоздатьВидыСтажаПоНастройкам() Экспорт
	...
	// Непрерывный стаж
	Описание = ОписаниеВидаСтажа();
	Описание.Наименование = НСтр("ru='Непрерывный стаж';uk='Безперервний стаж'");
	Описание.КатегорияСтажа = Перечисления.КатегорииСтажа.Непрерывный;
	ЗаписатьВидСтажа(Описание);
	
	// Общий научно-педагогический стаж работы.
	Описание = ОписаниеВидаСтажа();
	Описание.Наименование = НСтр("ru='Общий научно-педагогический стаж работы';uk='Загальний науково-педагогічний стаж роботи'");
	...
	// Педагогический стаж
	Описание = ОписаниеВидаСтажа();
	Описание.Наименование = НСтр("ru='Педагогический стаж';uk='Педагогічний стаж'");
	...
	Описание = ОписаниеВидаСтажа();
	Описание.Наименование = НСтр("ru='Стаж для оплаты больничных листов с учетом нестраховых периодов (с 2010 года)';uk='Стаж для оплати лікарняних листів з урахуванням нестрахових періодів (з 2010 року)'");
	...
	// Прочий стаж
	Описание = ОписаниеВидаСтажа();
	Описание.Наименование = НСтр("ru='Прочий стаж';uk='Інший стаж'");
