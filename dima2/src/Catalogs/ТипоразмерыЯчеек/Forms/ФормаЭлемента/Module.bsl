...
Процедура УправлениеФормой()
	...
	Элементы.ВысотаЕдиницаИзмерения.Доступность  = Не Объект.НеОграниченаПоРазмерам;
	Элементы.ГлубинаЕдиницаИзмерения.Доступность = Не Объект.НеОграниченаПоРазмерам;
	Элементы.ШиринаЕдиницаИзмерения.Доступность  = Не Объект.НеОграниченаПоРазмерам;
	Элементы.ОбъемЕдиницаИзмерения.Доступность  = Не Объект.НеОграниченаПоРазмерам;
	
	Элементы.ВесЕдиницаИзмерения.Доступность = Не Объект.НеОграниченаПоГрузоподъемности;
