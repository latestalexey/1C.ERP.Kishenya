...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если Не ПроверкаУникальностиПоИдентификаторуКлиента()Тогда
		...
		Текст = НСтр("ru='Ошибка сохранение рабочего места!
                    ...
                    |;uk='Помилка збереження робочого місця!
                    |Робоче місце з таким ідентифікатором клієнта вже існує.'");
	...
	Если Не ПроверкаУникальностиПоНаименованию()Тогда
		Если ОтветПередЗаписью <> Истина Тогда
			...
			Текст = НСтр("ru='Указано неуникальное наименование рабочего места!
                        ...
                        |;uk='Зазначено не унікальне найменування робочого місця!
                        |Можливо в подальшому це ускладнить ідентифікацію та вибір робочого місця.
                        |Рекомендується вибирати унікальне найменування робочих місць.
                        |Продовжити збереження з зазначеним найменуванням?'");
