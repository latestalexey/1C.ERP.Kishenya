...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		Список, "ПоказыватьДоговорниковГПХ", ПоказыватьДоговорниковГПХ, Истина);
	...
	// Отбор по оформленности трудовых отношений устанавливаем, только если не нужно показывать еще и отдельных договорников ГПХ
	// и нет отбора по роли сотрудника 
	ТрудовыеОтношенияОформлены = Неопределено;
	РежимОтображенияТрудовыеОтношенияОформлены = Неопределено;
	...
	Если ЗначениеЗаполнено(Подразделение)
		И ТрудовыеОтношенияОформлены <> Ложь Тогда
	...
	Если ТрудовыеОтношенияОформлены <> Неопределено Тогда
		
		Если ПараметрыОтбораПоПериоду.ОтборПоПериодуКадровыхДанныхИспользуется
			И (ЗначениеЗаполнено(Филиал) Или ЗначениеЗаполнено(Подразделение)) Тогда
			
			ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
				Список, "ТрудовыеОтношенияОформлены", ТрудовыеОтношенияОформлены,
				ВидСравненияКомпоновкиДанных.Равно, , Истина, РежимОтображенияТрудовыеОтношенияОформлены);
	...
	ОценкаПроизводительностиКлиентСервер.ЗакончитьЗамерВремени("ОткрытиеФормыВыбораСправочникаСотрудники",
		ВремяНачалаЗамера);
...
Процедура ПодразделенияПриАктивизацииСтроки(Элемент)
	...
	ОценкаПроизводительностиКлиентСервер.НачатьЗамерВремени("АктивацияПодразделенияВФормеВыбораСправочникаСотрудники");	
...
Процедура СписокВыборЗначения(Элемент, Значение, СтандартнаяОбработка)
	...
	ОценкаПроизводительностиКлиентСервер.НачатьЗамерВремени("ПодборСотрудникаВФормеВыбораСправочникаСотрудники");
...
Процедура СписокПриСохраненииПользовательскихНастроекНаСервере(Элемент, Настройки)
	...
	КоллекцияИсключаемыхПараметров.Вставить("ТрудовыеОтношенияОформлены");
...
Процедура УстановитьПараметрыОтбораПоПериоду()
	...
	ДатаОкончанияОтбора = КонецДня(?(ЗначениеЗаполнено(ПериодРаботы.ДатаОкончания), ПериодРаботы.ДатаОкончания, ТекущаяДатаСеанса()));
