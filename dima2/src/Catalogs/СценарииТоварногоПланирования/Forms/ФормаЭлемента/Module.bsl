...
//++ НЕ УТКА
	Объект.ИспользоватьДляЗаказовНаПроизводство = Объект.ИспользоватьВПланированииПроизводства;
//-- НЕ УТКА
...
//++ НЕ УТКА
	Форма.Элементы.ИспользоватьДляЗаказовНаПроизводство.Доступность = Форма.Объект.ИспользоватьВПланированииПроизводства;
//-- НЕ УТКА
	
//++ НЕ УТ
	Форма.Элементы.ИспользоватьДляПланированияМатериалов.Доступность = Форма.Объект.ИспользоватьВПланированииПроизводства;
	Форма.Элементы.ИспользоватьДляЗаказовНаВнутреннееПотребление.Доступность = Форма.Объект.ИспользоватьВПланированииПроизводства;
	
	Форма.Элементы.СценарийБюджетирования.Доступность = Форма.Объект.ОтражаетсяВБюджетировании;
	Форма.Элементы.СценарийБюджетирования.АвтоОтметкаНезаполненного = Форма.Объект.ОтражаетсяВБюджетировании;
//-- НЕ УТ
