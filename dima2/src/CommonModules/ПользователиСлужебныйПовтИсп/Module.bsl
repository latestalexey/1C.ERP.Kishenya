...
Функция НедоступныеРоли(Назначение = "ДляПользователей", Сервис = Неопределено) Экспорт
	...
	ПроверитьНазначение(Назначение,
		НСтр("ru='Ошибка в функции НедоступныеРоли общего модуля ПользователиСлужебныйПовтИсп.';uk='Помилка у функції НедоступныеРоли загального модуля ПользователиСлужебныйПовтИсп.'"));
...
Функция ДеревоРолей(ПоПодсистемам = Истина, Назначение = "ДляПользователей") Экспорт
	...
	ПроверитьНазначение(Назначение,
		НСтр("ru='Ошибка в функции ДеревоРолей общего модуля ПользователиСлужебныйПовтИсп.';uk='Помилка у функції ДеревоРолей загального модуля ПользователиСлужебныйПовтИсп.'"));
	   ...
	   И Назначение <> "СовместноДляПользователейИВнешнихПользователей" Тогда
		...
		ВызватьИсключение ЗаголовокОшибки + Символы.ПС + Символы.ПС + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Параметр Назначение ""%1"" указан некорректно.
                       ...
                       |- ""СовместноДляПользователейИВнешнихПользователей"".'
                       |;uk='Параметр Призначення ""%1"" вказано некоректно.
                       |
                       |Допустимі тільки такі значення:
                       |- ""ДляАдминистраторов"",
                       |- ""ДляПользователей"",
                       |- ""ДляВнешнихПользователей"",
                       |- ""СовместноДляПользователейИВнешнихпользователей"".'"),
