...
Процедура ИсключитьПовторениеЗаписейТекущихТарифныхСтавокСотрудников() Экспорт
	...
	ЗарплатаКадрыВызовСервера.ИсключитьПовторениеЗаписейТекущихДанныхСотрудников("ТекущаяТарифнаяСтавкаСотрудников");
	
КонецПроцедуры

Процедура ИсключитьПовторениеЗаписейТекущихКадровыхДанныхСотрудников() Экспорт
	
	ЗарплатаКадрыВызовСервера.ИсключитьПовторениеЗаписейТекущихДанныхСотрудников("ТекущиеКадровыеДанныеСотрудников");
