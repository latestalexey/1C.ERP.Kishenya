...
//  Передано - Число, объем данных, переданных меду сервером платформы и клиентским приложением
//    данного сеанса с момента начала сеанса (в байтах),
//  ПереданоЗа5Минут - Число, объем данных, переданных между сервером платформы и клиентским
//    приложением данного сеанса за последние 5 минут (в байтах),
//  СерверныхВызовов - Число, количество вызовов сервера платформы от имена данного сеанса с
//    момента начала сеанса,
//  СерверныхВызововЗа5Минут - Число, количество вызовов сервера платформы от имени данного сеанса
//    за последние 5 минут,
//  ДлительностьСерверныхВызовов - Число, время исполнения вызовов сервера платформы от имени
...
//    обращения, в случае, если сеанс выполняется вызов сервера платформы (иначе - значение равно 0),
//  ДлительностьСерверныхВызововЗа5Минут - Число, время исполнения вызовов сервера платформы от имени
...
//  ИмяПользователя - Строка, имя пользователя платформы, подсоединенного к информационной базе,
...
//  ПереданоСУБД - Число, объем данных, переданных между сервером платформы и сервером баз данных,
//    с момента установки данного соединения,
//  ПереданоСУБДЗа5Минут - Число, объем данных, переданных между сервером платформы и сервером баз
...
Процедура ДобавитьУсловиеФильтра(Фильтр, Знач Свойство, Знач ВидСравненияЗначений, Знач Значение) Экспорт
	...
	Иначе
		...
		ВызватьИсключение НСтр("ru='Некорректно задано описание фильтра!';uk='Некоректно задано опис фільтра!'");
...
Функция ПроверитьУсловияФильтра(Знач ПроверяемыйОбъект, Знач Фильтр = Неопределено) Экспорт
	...
	Для Каждого Условие Из Фильтр Цикл
		...
		Иначе
			...
			ВызватьИсключение НСтр("ru='Некорректно задан фильтр!';uk='Некоректно заданий фільтр!'");
...
Функция МенеджерАдминистрирования(Знач ПараметрыАдминистрирования)
	...
	Иначе
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Неизвестный тип подключения: %1!';uk='Невідомий тип підключення: %1!'"), ПараметрыАдминистрирования.ТипПодключения);
