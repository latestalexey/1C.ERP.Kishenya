...
Функция ПолучитьНаборыСвойствДляОбъектаЭксплуатации(Объект) Экспорт
...
Функция ПолучитьНаборыСвойствДляУзлаОбъектаЭксплуатации(Объект) Экспорт
	
	Наборы = Новый СписокЗначений;
	
	НаборСвойств = Справочники.НаборыДополнительныхРеквизитовИСведений.Справочник_УзлыОбъектовЭксплуатации_Общие;
	Наборы.Добавить(НаборСвойств, НСтр("ru='Общие свойства узлов';uk='Загальні властивості вузлів'"));
	//++ НЕ УТКА
	ПолучитьНаборыСвойствКлассаОбъектаЭксплуатации(Объект, Наборы);
	//-- НЕ УТКА
...
Процедура ПолучитьНаборыСвойствКлассаОбъектаЭксплуатации(Объект, Наборы)
	...
	Наборы.Добавить(НаборыСвойств.ПаспортныеХарактеристики, НСтр("ru='Свойства по классификации';uk='Властивості класифікації'"));
