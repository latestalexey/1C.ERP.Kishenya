	...
	Если НЕ ПолучитьФункциональнуюОпцию("БазоваяВерсия") Тогда
		...
		Иначе
			Разделы.Добавить(Метаданные.Подсистемы.БюджетированиеИПланирование,
				НСтр("ru='Отчеты по бюджетированию и планированию';uk='Звіти по бюджетуванню і плануванню'"));
		КонецЕсли;
		//-- НЕ УТ
		...
		Разделы.Добавить(Метаданные.Подсистемы.Производство,
			НСтр("ru='Отчеты по производству';uk='Звіти по виробництву'"));
		//-- НЕ УТ
		
		//++ НЕ УТКА
		Разделы.Добавить(Метаданные.Подсистемы.МеждународныйФинансовыйУчет,
			НСтр("ru='Отчеты по международному финансовому учету';uk='Звіти по міжнародному фінансовому обліку'"));
		//-- НЕ УТКА
	КонецЕсли;
КонецПроцедуры
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ОписаниеВарианта.Описание = НСтр("ru='По каким этапам прозводства можно уменьшить длительность выполнения?';uk='За якими етапами виробництва можна зменшити тривалість виконання?'");
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Анализ фактической себестоимости выпущенной продукции после закрытия месяца.';uk='Аналіз фактичної собівартості випущеної продукції після закриття місяця.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Какова себестоимость единицы произведенной продукции?
        ...
        |;uk='Яка собівартість одиниці виробленої продукції?
        |Яка сукупна собівартість всієї випущеної продукції за період?'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Позаказный анализ удельной себестоимости выпущенной продукции.';uk='Позамовний аналіз питомої собівартості випущеної продукції.'");
	//-- НЕ УТ
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Данные бухгалтерского и налогового учета об основных средствах.';uk='Дані бухгалтерського і податкового обліку про основні засоби.'");
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ВедомостьАмортизацииОСБухгалтерскийУчет");
	ОписаниеВарианта.Описание = НСтр("ru='Данные бухгалтерского и налогового учета об основных средствах.';uk='Дані бухгалтерського і податкового обліку про основні засоби.'");
	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ВедомостьАмортизацииНМАБухгалтерскийУчет);
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Данные бухгалтерского и налогового учета об нематериальных активах.';uk='Дані бухгалтерського і податкового обліку про нематеріальних активах.'");
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ВедомостьАмортизацииНМАБухгалтерскийУчет");
	ОписаниеВарианта.Описание = НСтр("ru='Данные бухгалтерского и налогового учета об нематериальных активах.';uk='Дані бухгалтерського і податкового обліку про нематеріальних активах.'");
	//-- НЕ УТ
	...
	ОписаниеВарианта.Описание = НСтр("ru='Контроль поступлений и списаний партий товаров.
        ...
        |Контроль розподілу витрат механізмом партионного учета.'");
	...
	ВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, ОписаниеОтчета, ВыводитьВариантыОтчетов);
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Анализ исполнительской дисциплины бюдженого процесса.';uk='Аналіз виконавської дисципліни бюдженого процесу.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Выполнены или нет задачи бюджетирования?
        ...
        |;uk='Виконані чи ні задачі бюджетування?
        |Які прострочені, ким і на скільки днів?'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Сколько бюджетных задач выполнено и не выполнено исполнителями?
        ...
        |;uk='Скільки бюджетних задач виконано і не виконано виконавцями?
        |В рамках яких бюджетних кроків?'");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Анализа изменения доли просроченной дебиторской задолженности с разбивкой по периодам.';uk='Аналізу зміни частки простроченої дебіторської заборгованості з розбивкою за періодами.'");
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Анализ загрузки видов рабочих центров по графику производства.';uk='Аналіз завантаження видів робочих центрів за графіком виробництва.'");
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ЗагрузкаВидовРабочихЦентровТаблица");
	ОписаниеВарианта.Описание = НСтр("ru='Показывает загрузку видов рабочих центров в каждом поздразделении.';uk='Показує завантаження видів робочих центрів у кожному підрозділі.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Занятость видов рабочих центров с детализацией до производственных процессов.';uk='Зайнятість видів робочих центрів з деталізацією до виробничих процесів.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Обзор значений нефинансовых показателей по периодам.';uk='Огляд значень нефінансових показників за періодами.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Выполнен ли план производства?
        ...
        |;uk='Чи виконаний план виробництва?
	...
	ОписаниеВарианта.Описание = НСтр("ru='Оценка фактического состояния производства продукции по плану.
        ...
        |;uk='Оцінка фактичного стану виробництва продукції за планом.
        |Які замовлення на виробництво ще не надійшли на склад?'");
	//-- НЕ УТ
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Сколько выпущено, передано продукции давальцам?';uk='Скільки випущено, передано продукції давальцям?'");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Сколько передано сырья и материалов переработчикам?';uk='Скільки передано сировини і матеріалів переробникам?'");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Сколько продукции поступило от переработчиков?';uk='Скільки продукції надійшло від переробників?'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Сколько материалов и сырья поступило от давальцев?
        ...
        |;uk='Скільки матеріалів і сировини надійшло від давальців?
        |Скільки повернуто або списано?'");
	...
	ВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, ОписаниеОтчета, ВыводитьВариантыОтчетов);
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Сравнение запланированных в рамках сценариев сумм с фактическим исполнением за период.';uk='Порівняння запланованих в рамках сценаріїв сум з фактичним виконанням за період.'");
	...
	ВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, ОписаниеОтчета, ВыводитьВариантыОтчетов);
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Сравнение плановых и фактических сальдо и оборотов по показателям за период.';uk='Порівняння планових і фактичних сальдо і оборотів за показниками за період.'");
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ОборотноСальдоваяВедомость");
	ОписаниеВарианта.Описание = НСтр("ru='Сравнение плановых и фактических сальдо и оборотов по показателям за период.';uk='Порівняння планових і фактичних сальдо і оборотів за показниками за період.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Контроль денежных средств в кассах ККМ.
        ...
        |У якій касі ККМ, коли і скільки грошових коштів приходило або йшло?'");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ПлановаяИФактическаяСебестоимостьВыпущеннойПродукции");
	ОписаниеВарианта.Описание = НСтр("ru='Каковы плановые и фактические затраты по выпущенной продукции?
        ...
        |;uk='Які планові і фактичні витрати по випущеній продукції?
        |За якими об''єктами і статтями калькуляції відбулися відхилення?'");
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ОтклоненияСебестоимостиПоСтатьямКалькуляции");
	...
	ОтключитьВариантОтчета(Настройки, ОписаниеОтчета, "ПлановаяИФактическаяСебестоимостьВыпущеннойПродукцииРасшифровка");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Проверка соответствия настройки связанных статей правилам получения фактических данных показателей бюджетов.';uk='Перевірка відповідності настройки пов''язаних статей правилами отримання фактичних даних показників бюджетів.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Анализ колебаний выручки в сравниваемых периодах
        ...
        |;uk='Аналіз коливань виторгу у порівнюваних періодах
        |з отриманого приросту/спаду.'");
	...
	ТекстОписания = НСтр("ru='Суммовые оценки отклонений от курса ЦБ при валютных взаиморасчетах с клиентами.';uk='Сумові оцінки відхилень від курсу ЦБ при валютних взаєморозрахунках з клієнтами.'");
	...
	ТекстОписания = НСтр("ru='Суммовые оценки отклонений от курса ЦБ при валютных взаиморасчетах с поставщиками.';uk='Сумові оцінки відхилень від курсу ЦБ при валютних взаєморозрахунках з постачальниками.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Выявление отклонений оборотов международного финансового учета
        ...
        |;uk='Виявлення відхилень оборотів міжнародного фінансового обліку
        |від оборотів регламентованого бухгалтерського обліку.'");
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Как обороты бюджетных статей влияют на показатели?';uk='Як обороти бюджетних статей впливають на показники?'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Когда были выполнены последние ремонты? 
        ...
        |;uk='Коли були виконані останні ремонти? 
        |Які поточні і планові показників напрацювань?
        |Який залишковий ресурс у величині показника і строку служби?'");
	...
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.СравнениеКалькуляцииИСпецификацииЗаказа);
	ОтключитьОтчет(ОписаниеОтчета);
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Последовательность выполнения операций маршрутной карты в виде схемы.';uk='Послідовність виконання операцій маршрутної карти у вигляді схеми.'");
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Какие заказы на ремонт оформлены, выполнены или просрочены?';uk='Які замовлення на ремонт оформлені, виконані чи прострочені?'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Какие заказы на ремонт оформлены?
        ...
        |;uk='Які замовлення на ремонт оформлені?
        |Скільки замовлень на ремонт виконано за планом?
        |Чи є прострочені ремонтні роботи?'");
	//-- НЕ УТКА
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Оценка выпуска по подразделениям.';uk='Оцінка випуску по підрозділах.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Какой объем выпуска в подразделениях?
                                            ...
                                            |;uk='Який обсяг випуску у підрозділах?
                                            |Немає помилок при оформленні документів випуску?
                                            |Чи немає помилок у відображенні витрат по роботах і напівфабрикатах?'");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Оценка потребности в трудовых ресурсах для исполнения планов производства.';uk='Оцінка потреби в трудових ресурсах для виконання планів виробництва.'");
	ВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, ОписаниеОтчета, ВыводитьВариантыОтчетов);
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Оценка потребности в видах РЦ для исполнения планов производства и сопоставление с доступностью для определения дефицита.';uk='Оцінка потреби у видах РЦ для виконання планів виробництва і зпівставлення з доступністю для визначення дефіциту.'");
	ВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, ОписаниеОтчета, ВыводитьВариантыОтчетов);
	ОтключитьВариантОтчета(Настройки, ОписаниеОтчета, "Расшифровка");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;  
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");  
	ОписаниеВарианта.Описание = НСтр("ru='Состояние расчетов по договорам лизинга.';uk='Стан розрахунків за договорами лізингу.'"); 
	...
	ОписаниеВарианта.Описание = НСтр("ru='Каков остаток сырья и материалов у переработчиков?';uk='Який залишок сировини і матеріалів у переробників?'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Выявление отклонений данных оперативного учета
        ...
        |;uk='Виявлення відхилень даних оперативного обліку
        |від даних регламентованого бухгалтерського обліку.'");
...
Функция ИмяОтчетаПоКлючуОбъекта(Форма) Экспорт
	...
	Иначе
		...
		Иначе
			ИмяОтчета = Форма.НастройкиОтчета.ОтчетСсылка.Имя;
		КонецЕсли;
	КонецЕсли;
...
Функция ДобавитьКомандуПоНефинансовомуПоказателю(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ЗначенияНефинансовыхПоказателей) 
		...
		КомандаОтчет.Представление = НСтр("ru='Значения показателя';uk='Значення показника'");
		КомандаОтчет.СписокФорм = "ФормаДокумента,ФормаЭлемента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыВажное";
...
Функция ДобавитьКомандуКонтрольПередачиПродукции(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.КонтрольПередачиПродукцииДавальцу) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Контроль передачи';uk='Контроль передачі'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуКонтрольПередачиСырьяИМатериалов(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.КонтрольПередачиСырьяИМатериаловПереработчику) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Контроль передачи сырья и материалов';uk='Контроль передачі сировини і матеріалів'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуКонтрольПоставкиПродукции(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.КонтрольПоставкиПродукцииПереработчиком) 
		...
		КомандаОтчет.Представление = НСтр("ru='Контроль поставки продукции';uk='Контроль постачання продукції'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуКонтрольПоставкиСырьяИМатериалов(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.КонтрольПоставкиСырьяИМатериаловДавальцем) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Контроль поставки';uk='Контроль постачання'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуЛимитыРасходаДенежныхСредств(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ЛимитыРасходаДенежныхСредствПоДаннымБюджетирования)
		...
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
		КомандаОтчет.ФункциональныеОпции = "";
		КомандаОтчет.ПараметрыФормы.Вставить("КлючВарианта", "ИспользованияЛимитовРасходаДенежныхСредств");
		КомандаОтчет.ПараметрыФормы.Вставить("СформироватьПриОткрытии", Истина);
		КомандаОтчет.ПараметрыФормы.Вставить("ВидимостьКомандВариантовОтчетов", Ложь);
...
Функция ДобавитьКомандуОборотнаяВедомостьБюджетированияПоСтатьеБюджетов(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ОборотнаяВедомостьБюджетирования) 
		...
		КомандаОтчет.Представление = НСтр("ru='Оборотная ведомость';uk='Оборотна відомість'");
		КомандаОтчет.СписокФорм = "ФормаДокумента,ФормаЭлемента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыВажное";
...
Функция ДобавитьКомандуОборотноСальдоваяВедомостьБюджетированияПоПоказателюБюджетов(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ОборотноСальдоваяВедомостьБюджетирования) 
		...
		КомандаОтчет.Представление = НСтр("ru='Оборотно-сальдовая ведомость';uk='Оборотно-сальдова відомість'");
		КомандаОтчет.СписокФорм = "ФормаДокумента,ФормаЭлемента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыВажное";
...
Функция ДобавитьКомандуОтклоненияРасходов(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ОтклонениеЗаказаФактаОтКалькуляции) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Отклонения расходов';uk='Відхилення витрат'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуОшибкиНастройкиШаблоновПроводок(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ОшибкиНастройкиШаблоновПроводок) 
		...
		КомандаОтчет.Представление = НСтр("ru='Ошибки настройки шаблонов проводок';uk='Помилки настройки шаблонів проводок'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуОшибкиУточненияСчетов(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ОшибкиУточненияСчетов) 
		...
		КомандаОтчет.Представление = НСтр("ru='Ошибки уточнения счетов';uk='Помилки уточнення рахунків'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуПотребностьВМатериалах(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ПлановаяПотребностьВМатериалах) 
		...
		КомандаОтчет.Представление = НСтр("ru='Потребность в материалах';uk='Потреба в матеріалах'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуПотребностьВПолуфабрикатах(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ПлановаяПотребностьВПолуфабрикатах) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Потребность в полуфабрикатах';uk='Потреба в напівфабрикатах'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуПроверкаСвязейПоказателейБюджетовПоПоказателюБюджетов(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ПроверкаСвязейПоказателейБюджетов) 
		...
		КомандаОтчет.Представление = НСтр("ru='Проверить настройку связей';uk='Перевірити настройку зв''язків'");
		КомандаОтчет.СписокФорм = "ФормаДокумента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуРасчетыПоДоговору(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.РеестрДоговоровЛизинга) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Расчеты по договору';uk='Розрахунки за договором'");
		КомандаОтчет.СписокФорм = "ФормаДокумента,ФормаЭлемента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Множественный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуРезультатРаботыПравилПолученияФактическихДанныхПоСтатьеБюджетов(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.РезультатРаботыПравилПолученияФактическихДанных) 
		...
		КомандаОтчет.Представление = НСтр("ru='Результат работы правил';uk='Результат роботи правил'");
...
Функция ДобавитьКомандуСравнениеСПлановойКалькуляцией(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.СравнениеКалькуляцииИРесурснойСпецификации) 
		...
		КомандаОтчет.Представление = НСтр("ru='Отклонения от плановой калькуляции';uk='Відхилення від планової калькуляції'");
		КомандаОтчет.СписокФорм = "ФормаДокумента,ФормаЭлемента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуСтоимостьМатериаловИРабот(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.СтоимостьМатериаловИРаботСпецификации) 
		...
		КомандаОтчет.Представление = НСтр("ru='Стоимость материалов и работ';uk='Вартість матеріалів та робіт'");
		КомандаОтчет.СписокФорм = "ФормаДокумента,ФормаЭлемента";
		КомандаОтчет.Порядок       = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Одиночный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуКарточкаНМАМеждународныйУчет(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.КарточкаНМАМеждународныйУчет) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Карточка НМА (международый учет)';uk='Картка НМА (міжнародний облік)'");
...
Функция ДобавитьКомандуКарточкаОСМеждународныйУчет(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.КарточкаОСМеждународныйУчет) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Карточка ОС (международый учет)';uk='Картка ОЗ (міжнародний облік)'");
		КомандаОтчет.СписокФорм = "ФормаЭлемента, ФормаСписка";
		КомандаОтчет.Порядок = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Множественный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуСравнениеНМА(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.СравнениеНМА) Тогда
		...
		КомандаОтчет.Представление = НСтр("ru='Сравнение НМА в бухгалтерском и международном учете';uk='Порівняння НМА у бухгалтерському та міжнародному обліку'");
		КомандаОтчет.СписокФорм = "ФормаЭлемента, ФормаСписка";
		КомандаОтчет.Порядок = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Множественный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
...
Функция ДобавитьКомандуСравнениеОС(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.СравнениеОС) Тогда
		
		КомандаОтчет = КомандыОтчетов.Добавить();
		
		КомандаОтчет.Идентификатор = Метаданные.Отчеты.СравнениеОС.ПолноеИмя();
		КомандаОтчет.Представление = НСтр("ru='Сравнение ОС в бухгалтерском и международном учете';uk='Порівняння ОЗ у бухгалтерському та міжнародному обліку'");
		КомандаОтчет.СписокФорм = "ФормаЭлемента, ФормаСписка";
		КомандаОтчет.Порядок = 50;
		КомандаОтчет.РежимИспользованияПараметра = РежимИспользованияПараметраКоманды.Множественный;
		КомандаОтчет.МестоРазмещенияКоманды = "ПодменюОтчетыПерейти";
