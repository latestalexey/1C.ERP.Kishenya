...
Процедура ЗаполнитьДанныеОПрофиляхНастроекЭДО() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		НастройкаЭДО.Комментарий = НСтр("ru='##Настройка ЭДО помечена на удаление автоматически при обновлении.';uk='##Налаштування ЕДО позначена на вилучення автоматично при оновленні.'");
