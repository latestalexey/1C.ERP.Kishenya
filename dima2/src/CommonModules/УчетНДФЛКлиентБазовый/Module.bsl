...
Процедура НДФЛПриАктивизацииСтроки(Форма) Экспорт
	...
	Если ГруппаФормыПанельВычеты <> Неопределено Тогда
		...
		Иначе
			...
			Форма[ГруппаФормыПанельВычеты.Имя + "Заголовок"] = НСтр("ru='Вычеты';uk='Відрахування'") + " " + Строка(НДФЛТекущиеДанные[ОписаниеПанелиВычеты.ТабличнаяЧастьНДФЛ.ИмяПоляФизическоеЛицо]);
