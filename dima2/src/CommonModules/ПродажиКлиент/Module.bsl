...
Процедура ОповеститьОПерезаполненииЖелаемойДатыОтгрузки() Экспорт
	...
	ПоказатьОповещениеПользователя(
		НСтр("ru='Желаемая дата отгрузки перезаполнена';uk='Бажана дата відвантаження перезаполнена'"),
		,
		НСтр("ru='Желаемая дата отгрузки перезаполнена с учетом максимальной даты аванса.';uk='Бажана дата відвантаження перезаполнена з урахуванням максимальної дати авансу.'"),
...
// Создает Реализацию услуг по переработке по одному или нескольким заказам клиентов
//
// Параметры:
//	Список - ТаблицаФормы - список заказов клиентов, по выделенным заказам которого будет создано Акт выполненных работ
//	ИспользоватьРеализациюПоНесколькимЗаказам - Булево - значение ф.о. ИспользоватьРеализациюПоНесколькимЗаказам
//
Процедура СоздатьОтчетДавальцуНаОснованииЗаказаКлиента(Список, ИспользоватьОтчетДавальцуПоНесколькимЗаказам, ДатаОтгрузки) Экспорт
	...
	Если Список.ВыделенныеСтроки.Количество() = 1 Или Не ИспользоватьОтчетДавальцуПоНесколькимЗаказам Тогда
		...
		ПараметрыОснования.Вставить("ДокументОснование", ТекущиеДанные.Ссылка);
		ПараметрыОснования.Вставить("ДатаОтгрузки",      ДатаОтгрузки);
		ОткрытьФорму("Документ.ОтчетДавальцу.Форма.ФормаДокумента",
			Новый Структура("Основание", ПараметрыОснования));
