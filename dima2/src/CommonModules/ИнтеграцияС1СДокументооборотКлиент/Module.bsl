...
Процедура ВыбратьЗначениеДополнительногоРеквизита(Форма, Элемент, СтандартнаяОбработка) Экспорт
	...
	Если СписокДоступныхТипов.Количество() > 1 Тогда
		ЗаголовокФормы = НСтр("ru='Тип реквизита ""%Свойство%""';uk='Тип реквізиту ""%Свойство%""'");
...
Процедура ВыбратьЗначениеРеквизитаСоставногоТипаВТаблице(Форма, ТекущиеДанные, Реквизит, СтандартнаяОбработка) Экспорт
	...
	Если СписокДоступныхТипов.Количество() > 1 Тогда
		ЗаголовокФормы = НСтр("ru='Выбор типа данных';uk='Вибір типу даних'");
		ПараметрыФормы = Новый Структура("СписокДоступныхТипов, ЗаголовокФормы", СписокДоступныхТипов, ЗаголовокФормы);
		ИмяФормы = "Обработка.ИнтеграцияС1СДокументооборот.Форма.ВыборОдногоТипаИзСоставногоТипа";
...
Процедура ОткрытьОбъект(ТипОбъекта, ID, ВладелецФормы = Неопределено, 
	...
	// ежедневные отчеты и работа с корреспондентами.
	Если ИнтеграцияС1СДокументооборотКлиентПовтИсп.ДоступенФункционалВерсииСервиса("1.3.2.3") Тогда
		...
		СоответствиеФорм.Вставить("DMCorrespondent", "Корреспондент");
	КонецЕсли;
	...
	Иначе
		Если ЗначениеЗаполнено(ТипОбъекта) Тогда
			ПоказатьПредупреждение(, НСтр("ru='Просмотр объектов такого типа не поддерживается в этой версии Документооборота.';uk='Перегляд об''єктів такого типу не підтримується цією версією Документообігу.'"));
		КонецЕсли;
	КонецЕсли;
...
//
Процедура Оповестить_ЗаписьОбъекта(Форма) Экспорт
...
Процедура ВыбратьЗначениеПоТипуОбъекта(ТипОбъектаВыбора, Отбор = Неопределено, ВыбранноеЗначение = "", 
	...
	Заголовок = НСтр("ru='Выбор значения';uk='Вибір значення'");
	
	СоответствиеЗаголовков = Новый Соответствие;
	СоответствиеЗаголовков.Вставить("DMFile", 			НСтр("ru='Выбор файла';uk='Вибір файлу'")); 
	СоответствиеЗаголовков.Вставить("DMProject", 		НСтр("ru='Выбор проекта';uk='Вибір проекту'"));
	СоответствиеЗаголовков.Вставить("DMWorkType", 		НСтр("ru='Выбор вида работ';uk='Вибір виду робіт'")); 
	СоответствиеЗаголовков.Вставить("DMProjectTask", 	НСтр("ru='Выбор проектной задачи';uk='Вибір проектної задачі'"));
	СоответствиеЗаголовков.Вставить("DMFileFolder", 	НСтр("ru='Выбор папки файлов';uk='Вибір папки файлів'"));
	СоответствиеЗаголовков.Вставить("DMOrganization", 	НСтр("ru='Выбор организации';uk='Вибір організації'"));
	СоответствиеЗаголовков.Вставить("DMUser", 			НСтр("ru='Выбор пользователя';uk='Вибір користувача'"));
	СоответствиеЗаголовков.Вставить("DMActivityMatter", НСтр("ru='Выбор вопроса деятельности';uk='Вибір питання діяльності'"));
	СоответствиеЗаголовков.Вставить("DMCurrency", 		НСтр("ru='Выбор валюты';uk='Вибір валюти'"));
	СоответствиеЗаголовков.Вставить("DMCorrespondent", 	НСтр("ru='Выбор корреспондента';uk='Вибір кореспондента'"));
	СоответствиеЗаголовков.Вставить("DMContactPerson", 	НСтр("ru='Выбор контактного лица';uk='Вибір контактної особи'"));
	СоответствиеЗаголовков.Вставить("DMSubdivision", 	НСтр("ru='Выбор подразделения';uk='Вибір підрозділу'"));
	СоответствиеЗаголовков.Вставить("DMAccessLevel", 	НСтр("ru='Выбор грифа доступа';uk='Вибір грифа доступу'"));
	СоответствиеЗаголовков.Вставить("DMRelationType", 	НСтр("ru='Выбор типа связи';uk='Вибір типу зв''язки'"));
	СоответствиеЗаголовков.Вставить("DMPrivatePerson", 	НСтр("ru='Выбор физического лица';uk='Вибір фізичної особи'"));
	СоответствиеЗаголовков.Вставить("DMDocumentStatus", НСтр("ru='Выбор состояния документа';uk='Вибір стану документа'"));
	СоответствиеЗаголовков.Вставить("DMDeliveryMethod", НСтр("ru='Выбор способа доставки';uk='Вибір способу доставки'"));
	СоответствиеЗаголовков.Вставить("DMInternalDocument", НСтр("ru='Выбор внутреннего документа';uk='Вибір внутрішнього документа'"));
	СоответствиеЗаголовков.Вставить("DMIncomingDocument", НСтр("ru='Выбор входящего документа';uk='Вибір вхідного документа'"));
	СоответствиеЗаголовков.Вставить("DMOutgoingDocument", НСтр("ru='Выбор исходящего документа';uk='Вибір вихідного документа'"));
	СоответствиеЗаголовков.Вставить("DMIncomingDocumentType", 	НСтр("ru='Выбор вида входящего документа';uk='Вибір виду вхідного документа'"));
	СоответствиеЗаголовков.Вставить("DMOutgoingDocumentType", 	НСтр("ru='Выбор вида исходящего документа';uk='Вибір виду вихідного документа'"));
	СоответствиеЗаголовков.Вставить("DMInternalDocumentType", 	НСтр("ru='Выбор вида внутреннего документа';uk='Вибір виду внутрішнього документа'"));
	СоответствиеЗаголовков.Вставить("DMInternalDocumentFolder", НСтр("ru='Выбор папки внутреннего документа';uk='Вибір папки внутрішнього документа'"));
	СоответствиеЗаголовков.Вставить("DMProlongationProcedure", 	НСтр("ru='Выбор способа продления';uk='Вибір способу продовження'"));
	СоответствиеЗаголовков.Вставить("DMBusinessProcessOrderTemplate", 		  НСтр("ru='Выбор шаблона поручения';uk='Вибір шаблону доручення'"));
	СоответствиеЗаголовков.Вставить("DMBusinessProcessConsiderationTemplate", НСтр("ru='Выбор шаблона рассмотрения';uk='Вибір шаблону розгляду'"));
	СоответствиеЗаголовков.Вставить("DMBusinessProcessRegistrationTemplate",  НСтр("ru='Выбор шаблона регистрации';uk='Вибір шаблону реєстрації'"));
	СоответствиеЗаголовков.Вставить("DMBusinessProcessApprovalTemplate", 	  НСтр("ru='Выбор шаблона согласования';uk='Вибір шаблону погодження'"));
	СоответствиеЗаголовков.Вставить("DMBusinessProcessConfirmationTemplate",  НСтр("ru='Выбор шаблона утверждения';uk='Вибір шаблону затвердження'"));
	СоответствиеЗаголовков.Вставить("DMBusinessProcessPerformanceTemplate",   НСтр("ru='Выбор шаблона исполнения';uk='Вибір шаблону виконання'"));
	СоответствиеЗаголовков.Вставить("DMBusinessProcessAcquaintanceTemplate",  НСтр("ru='Выбор шаблона ознакомления';uk='Вибір шаблону ознайомлення'"));
	СоответствиеЗаголовков.Вставить("DMCompoundBusinessProcessTemplate", 	  НСтр("ru='Выбор шаблона составного бизнес-процесса';uk='Вибір шаблону складеного бізнес-процесу'"));
	СоответствиеЗаголовков.Вставить("DMComplexBusinessProcessTemplate", 	  НСтр("ru='Выбор шаблона комплексного бизнес-процесса';uk='Вибір шаблону комплексного бізнес-процесу'"));
	СоответствиеЗаголовков.Вставить("DMBusinessProcessImportance", 			  НСтр("ru='Выбор варианта важности';uk='Вибір варіанту важливості'"));
	
	СоответствиеЗаголовков.Вставить("DMIncomingEMail", НСтр("ru='Выбор входящего письма';uk='Вибір вхідного листа'"));
	СоответствиеЗаголовков.Вставить("DMOutgoingEMail", НСтр("ru='Выбор исходящего письма';uk='Вибір вихідного листа'"));
	СоответствиеЗаголовков.Вставить("DMDailyReport", НСтр("ru='Выбор ежедневного отчета';uk='Вибір щоденного звіту'"));
	...
	Если ИнтеграцияС1СДокументооборотКлиентПовтИсп.ДоступенФункционалВерсииСервиса("1.4.6.1") и
		...
		ОткрытьФорму("Обработка.ИнтеграцияС1СДокументооборот.Форма.ВыборОбъектаПоиском", ПараметрыФормы, ФормаВладелец,,,,
	...
	Иначе // В старых версиях используем простые формы.
		...
		Если ТипОбъектаВыбора = "DMInternalDocument" И ИнтеграцияС1СДокументооборотКлиентПовтИсп.ДоступенФункционалВерсииСервиса("1.2.7.3") Тогда
			ОткрытьФорму("Обработка.ИнтеграцияС1СДокументооборот.Форма.ВыборВнутреннегоДокумента", ПараметрыФормы, 
				ФормаВладелец,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
		Иначе
...
// Выполняет подключаемую команду интеграции с Документообротом из формы объекта или списка.
//
// Параметры:
...
Процедура НачатьСозданиеСвязанногоОбъектаДО(ОбъектИС, ОписаниеОповещения, ОткрытьФорму = Ложь) Экспорт
	...
	ИначеЕсли Правила.Количество() = 0 Тогда
		...
		ПараметрыФормы = Новый Структура;
		ПараметрыФормы.Вставить("Заголовок", НСтр("ru='Создать в Документообороте';uk='Створити у Документообігу'"));
		ПараметрыФормы.Вставить("ЗаголовокКоманды", НСтр("ru='Создать';uk='Створити'"));
	...
	Иначе // без открытия формы
		...
		Если ТипЗнч(ОбъектДОИлиСообщение) = Тип("Строка") Тогда // сообщение об ошибке
			...
			ПоказатьПредупреждение(ОписаниеОповещения, ОбъектДОИлиСообщение,,
				НСтр("ru='Не удалось записать объект Документооборота';uk='Не вдалося записати об''єкт Документообігу'"));
...
Процедура СоздатьИнтегрированныйОбъектБезПравила(Форма, ТипОбъектаИС, ТипОбъектаДО, ИдентификаторОбъектаДО) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Подходящих правил не найдено.';uk='Відповідних правил не знайдено.'"));
	
КонецПроцедуры

// Сохраняет имя пользователя и пароль для доступа к Документообороту.
...
//
Процедура СохранитьНастройкиАвторизации(ИмяПользователя, Пароль = "") Экспорт
	
	#Если ВебКлиент Тогда
	ИнтеграцияС1СДокументооборотВызовСервера.СохранитьНастройкиАвторизации(ИмяПользователя, Пароль);
	#Иначе
	...
	ИнтеграцияС1СДокументооборотВызовСервера.СохранитьНастройкиАвторизации(ИмяПользователя, Пароль,
		ИмяКомпьютера(), РазделенныйПароль[0], ИмяВременногоФайла);
	#КонецЕсли
	
КонецПроцедуры

// Получает имя пользователя и пароль для доступа к Документообороту.
...
Процедура ПрочитатьНастройкиАвторизации(ИмяПользователя, ПарольСохранен, Пароль) Экспорт
	...
	ПарольСохранен = Ложь;
	#Иначе
	ИнтеграцияС1СДокументооборотВызовСервера.ПрочитатьНастройкиАвторизации(
		ИмяПользователя, ИмяКомпьютера(), ПарольСохранен, ЧастьПароляВИБ, ИмяВременногоФайла);
	#КонецЕсли
...
// Проверяет подключение к Документообороту, при необходимости запрашивая имя пользователя и пароль.
//
// Параметры:
//
...
Процедура ПроверитьПодключение(ОписаниеОповещения, ФормаВладелец = Неопределено,
	...
	Если ИнтеграцияС1СДокументооборотКлиентПовтИсп.ПарольИзвестен() Тогда
	...
	ПрочитатьНастройкиАвторизации(ИмяПользователя, ПарольСохранен, Пароль);
	...
	Если ПовторноПоказыватьОкноАвторизации
		...
		ОткрытьФорму("Обработка.ИнтеграцияС1СДокументооборот.Форма.АвторизацияВ1СДокументооборот", 
			ПараметрыФормыАвторизации,ФормаВладелец,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
		Возврат;
	...
	Если ВерсияСервиса = "" Тогда // в процессе получения версии
...
Процедура НачатьПодключение() Экспорт
	...
	ПараметрыПриЗапускеИЗавершенииПрограммы = ПараметрыПриложения[
		"СтандартныеПодсистемы.ПараметрыПриЗапускеИЗавершенииПрограммы"];
	...
	Иначе // пароль пока не известен, получим его
		...
		Если ИмяПользователя <> Неопределено И ПарольСохранен Тогда
...
Процедура ПоказатьВопросДаНет(ОписаниеОповещенияОЗавершении, ТекстВопроса,
	...
	Если ТекстКнопкиДа = Неопределено Тогда
		Кнопки.Добавить(КодВозвратаДиалога.ОК, НСтр("ru='Да';uk='Так'"));
	Иначе
		Кнопки.Добавить(КодВозвратаДиалога.ОК, ТекстКнопкиДа);
	КонецЕсли;
	Если ТекстКнопкиНет = Неопределено Тогда
		Кнопки.Добавить(КодВозвратаДиалога.Отмена, НСтр("ru='Нет';uk='Ні'"));
	Иначе
	...
	Иначе
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Недопустимое значение кнопки по умолчанию: %1';uk='Неприпустиме значення кнопки за замовчуванням: %1'"),
			КнопкаПоУмолчанию);
...
Процедура СоздатьБизнесПроцессПослеПоискаСвязанногоОбъектаДО(Результат, Параметры) Экспорт
	...
	Если ИнтеграцияС1СДокументооборотКлиентПовтИсп.ДоступенФункционалВерсииСервиса("1.2.6.2") Тогда
		...
		ОткрытьФорму("Обработка.ИнтеграцияС1СДокументооборот.Форма.СозданиеБизнесПроцесса",
			Параметры,,,,, Параметры.ОписаниеОповещения);
...
Процедура НачатьВыборТипаБизнесПроцесса(ОписаниеОповещенияОЗакрытии) Экспорт
	...
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessPerformance", 	НСтр("ru='Исполнение';uk='Виконання'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessAcquaintance", 	НСтр("ru='Ознакомление';uk='Ознайомлення'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessOrder", 			НСтр("ru='Поручение';uk='Доручення'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessConsideration", 	НСтр("ru='Рассмотрение';uk='Розгляд'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessRegistration", 	НСтр("ru='Регистрация';uk='Реєстрація'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessApproval", 		НСтр("ru='Согласование';uk='Погодження'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessConfirmation", 	НСтр("ru='Утверждение';uk='Затвердження'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessInternalDocumentProcessing", 	НСтр("ru='Обработка внутреннего документа';uk='Обробка внутрішнього документа'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessIncomingDocumentProcessing", 	НСтр("ru='Обработка входящего документа';uk='Обробка вхідного документа'")));
	СписокДоступныхТиповБизнесПроцессов.Добавить(Новый Структура("XDTOClassName, Presentation", "DMBusinessProcessOutgoingDocumentProcessing", 	НСтр("ru='Обработка исходящего документа';uk='Обробка вихідного документа'")));
	
	ЗаголовокФормы = НСтр("ru='Тип бизнес-процесса';uk='Тип бізнес-процесу'");
...
Процедура НачатьВыборШаблонаБизнесПроцесса(ОписаниеОповещенияОЗакрытии, Форма) Экспорт
	...
	Иначе
		ТекстПредупреждения = НСтр("ru='Не найдено ни одного подходящего шаблона бизнес-процесса.';uk='Не знайдено жодного відповідного шаблону бізнес-процесу.'");
...
Процедура НачатьСогласование(Параметры) Экспорт
	...
	Если Не ИнтеграцияС1СДокументооборотВызовСервера.ПользователюРазрешенЗапускСогласования(
		...
		Если ТекстПредупреждения = "" Тогда // текст по умолчанию
			ТекстПредупреждения = НСтр("ru='Недостаточно прав для запуска согласования в Документообороте.';uk='Недостатньо прав для запуску погодження у Документообігу.'");
		КонецЕсли;
...
Процедура НачатьСогласованиеПослеВопроса(Результат, Параметры) Экспорт
	...
	Если ПодходящиеШаблоны.Количество() = 0 Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Подходящих шаблонов не найдено.';uk='Відповідних шаблонів не знайдено.'"));
	...
	Иначе // есть шаблон(ы)
		...
		Иначе // предложим выбор
			ПараметрыФормы = Новый Структура;
			ПараметрыФормы.Вставить("Заголовок", НСтр("ru='Выбор шаблона согласования';uk='Вибір шаблону погодження'"));
...
Процедура НачатьСогласованиеПослеВыбораШаблона(Результат, Параметры) Экспорт
	...
	Если ИнтеграцияС1СДокументооборотВызовСервера.ЗапуститьСогласованиеПоШаблону(Шаблон, Параметры.Предмет) Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Согласование запущено.';uk='Погодження запущено.'"));
...
Процедура ПрерватьСогласование(Параметры) Экспорт
	...
	Если Результат = Неопределено Тогда
		ТекстПредупреждения = НСтр("ru='В Документообороте не запущено согласование.';uk='У Документообігу не запущено погодження.'");
		ПоказатьПредупреждение(ОписаниеОповещенияПослеПредупреждения, ТекстПредупреждения);
		Возврат;
	КонецЕсли;
	Параметры.Вставить("Предмет", Результат);
	...
	Если Не ИнтеграцияС1СДокументооборотВызовСервера.ПользователюРазрешеноПрерываниеСогласования(
		...
		Если ТекстПредупреждения = "" Тогда // предупреждение по умолчанию
			ТекстПредупреждения = НСтр("ru='Недостаточно прав для прерывания согласования в Документообороте.';uk='Недостатньо прав для переривання погодження у Документообігу.'");
		КонецЕсли;
		ПоказатьПредупреждение(ОписаниеОповещенияПослеПредупреждения, ТекстПредупреждения);
		Возврат;
	КонецЕсли;
...
Процедура ПрерватьСогласованиеПослеВопроса(Результат, Параметры) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Согласование прервано.';uk='Погодження перервано.'"));
...
Процедура ВыполнитьСогласование(Параметры) Экспорт
	...
	Если ЗадачиСогласования.Количество() = 0 Тогда
		ТекстВопроса = НСтр("ru='В Документообороте нет адресованных вам задач согласования.';uk='У Документообігу немає адресованих вам задач погодження.'");
		Кнопки = Новый СписокЗначений;
		Кнопки.Добавить("ОК", НСтр("ru='ОК';uk='ОК'"));
		Кнопки.Добавить("ЛистСогласования", НСтр("ru='Лист согласования';uk='Аркуш погодження'"));
		ОписаниеОповещенияПослеВопроса = Новый ОписаниеОповещения(
...
Процедура ВыполнитьСогласованиеПослеВводаКомментария(Результат, Параметры) Экспорт
	...
	Если Параметры.Результат = "Согласовано" Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Согласовано.';uk='Погоджено.'"));
	...
	ИначеЕсли Параметры.Результат = "СогласованоСЗамечаниями" Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Согласовано с замечаниями.';uk='Погоджено із зауваженнями.'"));
	...
	ИначеЕсли Параметры.Результат = "НеСогласовано" Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Не согласовано.';uk='Не погоджено.'"));
...
Процедура ДобавитьПредметПослеВыбораТипа(Результат, Параметры) Экспорт
	...
	Если Результат = "ФайлСДиска" Тогда
	...
	ИначеЕсли Лев(Результат, 2) = "DM" Тогда // выбор объекта в ДО
		ОписаниеОповещения = Новый ОписаниеОповещения(
			"ДобавитьПредметПослеВыбораОбъектаДО",
			ИнтеграцияС1СДокументооборотКлиент,
			Параметры);
		Отбор = Новый Структура; // без отбора
		ВыбратьЗначениеПоТипуОбъекта(Результат,,,, ОписаниеОповещения);
	...
	Иначе // выбор объекта ИС
		ОписаниеОповещения = Новый ОписаниеОповещения(
			...
			ИнтеграцияС1СДокументооборотКлиент,
			Параметры);
		ОткрытьФорму(Результат + ".ФормаВыбора",,,,,, ОписаниеОповещения);
		
	КонецЕсли;
	
КонецПроцедуры

// Продолжает процесс добавления предмета после выбора объекта Документооборота.
//
// Параметры:
...
Процедура ДобавитьПредметПослеДобавленияФайла(ОписаниеФайла, Параметры) Экспорт
	...
	ОписаниеПредмета = Новый Структура;
	ОписаниеПредмета.Вставить("Предмет", ОписаниеФайла.Имя);
	ОписаниеПредмета.Вставить("ПредметID", ОписаниеФайла.Идентификатор);
	ОписаниеПредмета.Вставить("ПредметТип", "DMFile");
	ОписаниеПредмета.Вставить("РольПредмета", Параметры.РольПредмета);
	ОписаниеПредмета.Вставить("Представление", ОписаниеФайла.Имя);
	ОписаниеПредмета.Вставить("Расширение", ОписаниеФайла.Расширение);
...
Процедура ОткрытьКаталогФайла(Идентификатор) Экспорт
	...
	Если Не РасширениеРаботыСФайламиПодключено() Тогда
		ПоказатьПредупреждение(, НСтр("ru='Открывать каталог файла можно только после подключения
            ...
            |;uk='Відкривати каталог файлу можна тільки після підключення
            |розширення для роботи з файлами.'"));
		Возврат;
	КонецЕсли;
	...
	Если СведенияОРедактировании.Сохранен Тогда
		...
		Если Файл.Существует() Тогда
			...
			КонецЕсли;
		Иначе
			ПоказатьПредупреждение(, НСтр("ru='Файл не найден в рабочем каталоге.';uk='Файл не знайдений в робочому каталозі.'"));
		КонецЕсли;
	Иначе
		ПоказатьПредупреждение(, НСтр("ru='Файл не найден в рабочем каталоге.';uk='Файл не знайдений в робочому каталозі.'"));
		Возврат;
...
Процедура ОткрытьВерсиюФайла(Идентификатор, Имя, Расширение, УникальныйИдентификаторФормы) Экспорт
	...
	Параметры.Вставить("Расширение", Расширение);
	Параметры.Вставить("УникальныйИдентификаторФормы", УникальныйИдентификаторФормы);
	// Захват конкретных версий на редактирование не поддерживается.
...
// Начало процесса открытия файла. Общий вход для файла и версии.
//
// Параметры:
//   Параметры - Структура:
//     Идентификатор - Строка - идентификатор файла в ДО.
...
//
Процедура ОткрытьФайлНачало(Параметры)
		...
		Если СведенияОРедактировании.Сохранен 
			...
			Если Файл.Существует() Тогда
				...
				Если (РазницаДат <= 1 И РазницаДат >= -1 И РазмерВДокументообороте = РазмерНаДиске)
					...
					ОписаниеОповещения = Новый ОписаниеОповещения("ОткрытьФайлПослеВыбораИсточника",
						ИнтеграцияС1СДокументооборотКлиент,
						Параметры);
				...
				Иначе // уверенности нет, требуется вмешательство пользователя
					...
					Если РазницаДат > 0 Тогда // файл на диске свежее
						ПараметрыФормы.Вставить("Заголовок", НСтр("ru='На диске новый файл';uk='На диску новий файл'"));
						ПараметрыФормы.Вставить("Сообщение",
							НСтр("ru='Файл на диске новее, чем файл в Документообороте.
                                |Возможно, он был изменен.
                                |
                                |Использовать существующий файл или заменить его на файл из Документооборота,
                                |возможно, с потерей изменений?'
                                |;uk='Файл на диску новіше, ніж файл у Документообігу.
                                |Можливо, він був змінений.
                                |
                                |Використовувати існуючий файл або замінити його на файл з Документообігу,
                                |можливо, з втратою змін?'"));
					
					Иначе // файл на диске старше
						ПараметрыФормы.Вставить("Заголовок", НСтр("ru='В Документообороте новый файл';uk='У Документообігу новий файл'"));
						ПараметрыФормы.Вставить("Сообщение",
							НСтр("ru='Файл в Документообороте новее, чем файл на диске.
                                |Возможно, он был изменен.
                                |
                                |Взять файл из Документооборота, заменив файл на диске с потерей
                                |изменений, или использовать существующий файл?'
                                |;uk='Файл у Документообігу новіше, ніж файл на диску.
                                |Можливо, він був змінений.
                                |
                                |Взяти файл з Документообігу, замінивши файл на диску з втратою
                                |змін, або використати існуючий файл?'"));
		...
		Если ЗначениеЗаполнено(СведенияОРедактировании.РекомендуемаяПапка) Тогда
			...
			Иначе // попытаемся создать эту папку
				Попытка
					...
					КаталогВременныхФайлов = СведенияОРедактировании.РекомендуемаяПапка;
				Исключение // нет доступа или иные проблемы, но внимания администратора они не требуют
					КаталогВременныхФайлов = РабочийКаталогДанныхПользователя();
				КонецПопытки;
			КонецЕсли;
	...
	Генератор = Новый ГенераторСлучайныхЧисел(Секунда(ТекущаяДата()));
	#КонецЕсли
	Пока СчетчикПопыток < 100 Цикл
		...
		Иначе
			...
			КонецЕсли;
			#Иначе
			Суффикс = Символ(КодСимвола("A") + (Секунда(ТекущаяДата()) + СчетчикПопыток)) % 26;
			Если СчетчикПопыток > 13 Тогда // пора усложнить суффикс
				Суффикс = Суффикс + Строка((Секунда(ТекущаяДата()) + СчетчикПопыток) % 10);
			КонецЕсли;
			#КонецЕсли
		КонецЕсли;
			...
			Исключение
				ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Ошибка при создании каталога ""%1"":
                        |""%2"".'
                        |;uk='Помилка при створенні каталогу ""%1"":
                        |""%2"".'"),
					КаталогССуффиксом,
	...
	Если Не Успех Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удается создать файл в каталоге временных файлов.';uk='Не вдається створити файл у каталозі тимчасових файлів.'"));
	КонецЕсли;
	...
	Если Параметры.Тип = "DMFile" Тогда
		Адрес = ИнтеграцияС1СДокументооборотВызовСервера.
			ПолучитьФайлИПоместитьВХранилище(
				Параметры.Идентификатор, Параметры.УникальныйИдентификаторФормы,
				?(Параметры.НаЧтение, Неопределено, ТекущаяДата()),
	...
	ОткрытьФайлИзПослеПолученияИзДокументооборота(Параметры);
	
КонецПроцедуры

// Вызывается в ходе открытия файла после выбора источника: взять из ДО или использовать существующий.
//
// Параметры:
...
//
Процедура ОткрытьФайлПослеВыбораИсточника(Результат, Параметры) Экспорт
	...
	Если Результат = "ВзятьИзДокументооборота" Тогда
		...
		Исключение
			ПоказатьПредупреждение(, 
				НСтр("ru='Не удалось заменить файл на диске файлом из Документооборота.
                |Возможно, он заблокирован другим приложением.'
                |;uk='Не вдалося замінити файл на диску файл з Документообігу.
                |Можливо, він заблокований іншою програмою.'"));
			Возврат;
		КонецПопытки;
	...
	ИначеЕсли Результат = "ИспользоватьСуществующий" Тогда
		...
		Если Параметры.СведенияОРедактировании.НаЧтение И Не Параметры.НаЧтение Тогда
			...
			Исключение
				ПоказатьПредупреждение(, 
                    ...
                    |;uk='Не вдалося відкрити файл для редагування. Можливо, 
                    |він заблокований іншою програмою.'"));
				Возврат;
			КонецПопытки;
			ИнтеграцияС1СДокументооборотВызовСервера.ЗахватитьФайл(
				Параметры.Идентификатор, ТекущаяДата());
		КонецЕсли;
		...
		КонецЕсли;
		Если ОткрытьФайлПриложением(Параметры.ИмяВременногоФайла) 
			и Параметры.ОписаниеОповещения <> Неопределено Тогда
...
// Вызывается в ходе открытия файла после получения файла из ДО.
//
// Параметры:
//   Параметры - Структура:
//     Идентификатор - Строка - идентификатор файла в ДО.
...
//
Процедура ОткрытьФайлИзПослеПолученияИзДокументооборота(Параметры) Экспорт
	...
	Если Параметры.Свойство("СведенияОРедактировании", СведенияОРедактировании) Тогда // обновим их
		...
		СведенияОРедактировании.Вставить("ДатаСохранения", ТекущаяДата()); // так
...
//
Функция ОткрытьФайлПриложением(ПолныйПуть) Экспорт
...
Процедура СделатьВерсиюАктивной(ИдентификаторФайла, ИдентификаторВерсии, 
	...
	Если ИнтеграцияС1СДокументооборотВызовСервера.СделатьВерсиюАктивной(ИдентификаторФайла,
		...
		Если ТекстСообщения = "" Тогда
			ТекстСообщения = НСтр("ru='Активная версия изменена.';uk='Активна версія змінена.'");
		КонецЕсли;
...
Процедура ЗакончитьРедактированиеФайла(Идентификатор, Имя, Расширение,
		...
		Исключение
			ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось сохранить изменения по причине:
                    |%1'
                    |;uk='Не вдалося зберегти зміни з причини:
	...
	Если Не СведенияОРедактировании.Сохранен 
		...
		ПоказатьВопросДаНет(ОписаниеОповещения, 
			НСтр("ru='Файл не найден в рабочем каталоге. Освободить его?';uk='Файл не знайдений в робочому каталозі. Звільнити його?'"));
		Возврат;
	...
	ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Идет сохранение файла ""%1"" (%2). Пожалуйста, подождите...';uk='Збереження файлу ""%1"" (%2). Будь ласка, зачекайте...'"),
...
Процедура ЗакончитьРедактированиеСРасширениемПослеПомещения(Результат, Адрес, ПолныйПуть, Параметры) Экспорт
	...
	Если НастройкиДокументооборот.НужноИзвлечьТекст Тогда
		Параметры.Вставить("Текст", ФайловыеФункцииСлужебныйКлиентСервер.ИзвлечьТекст(
	...
	Если ИнтеграцияС1СДокументооборотВызовСервера.
		...
		Если Не Файл.ПолучитьТолькоЧтение() Тогда
			Файл.УстановитьТолькоЧтение(Истина);
		КонецЕсли;
		Состояние(НСтр("ru='Файл обновлен и освобожден.';uk='Файл оновлений і звільнений.'"));
		Если ОписаниеОповещения <> Неопределено Тогда
			ВыполнитьОбработкуОповещения(ОписаниеОповещения, Истина);
		КонецЕсли;
	КонецЕсли;
...
Процедура СохранитьИзмененияРедактируемогоФайла(Идентификатор, Имя, Расширение,
	...
	Если Не СведенияОРедактировании.Сохранен Тогда
		ПоказатьПредупреждение(, НСтр("ru='Не удалось сохранить изменения файла,
            ...
            |;uk='Не вдалося зберегти зміни файлу,
            |так як він зараз не захоплений на редагування.'"));
		Возврат;
	КонецЕсли;
	Если СведенияОРедактировании.НаЧтение Тогда
		ПоказатьПредупреждение(, НСтр("ru='Не удалось сохранить изменения файла,
            ...
            |;uk='Не вдалося зберегти зміни файлу,
            |так як він зараз збережений тільки для перегляду.'"));
		Возврат;
	КонецЕсли;
	Параметры.Вставить("СведенияОРедактировании", СведенияОРедактировании);
...
Процедура СохранитьИзмененияСРасширениемПослеПомещения(Результат, Адрес, ПолныйПуть, Параметры) Экспорт
	...
	НастройкиДокументооборот = ИнтеграцияС1СДокументооборотКлиентПовтИсп.ПолучитьНастройки();
	Если НастройкиДокументооборот.НужноИзвлечьТекст Тогда
		ИзвлеченныйТекст = ФайловыеФункцииСлужебныйКлиентСервер.ИзвлечьТекст(
			Параметры.СведенияОРедактировании.ПолныйПуть);
	...
	Если ИнтеграцияС1СДокументооборотВызовСервера.
		ОбновитьФайлДвоичнымиДаннымиВременногоХранилища(Параметры) Тогда
		Состояние(НСтр("ru='Изменения сохранены.';uk='Зміни збережені.'"));
		Если ОписаниеОповещения <> Неопределено Тогда
			ВыполнитьОбработкуОповещения(ОписаниеОповещения, Истина);
		КонецЕсли;
	КонецЕсли;
...
Процедура ОтменитьРедактированиеФайла(Идентификатор, ОписаниеОповещенияОЗавершении = Неопределено) Экспорт
	...
	ПоказатьВопросДаНет(ОписаниеОповещения,
		НСтр("ru='Отмена редактирования файла может привести к потере изменений. Продолжить?';uk='Скасування редагування файлу може призвести до втрати змін. Продовжити?'"));
...
Процедура СохранитьКакНачало(Параметры)
	...
	Если Не РасширениеРаботыСФайламиПодключено() Тогда
		...
		ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Идет сохранение файла ""%1"". Пожалуйста, подождите...';uk='Збереження файлу ""%1"". Будь ласка, зачекайте...'"),
			Параметры.ИмяФайла);
		Состояние(ТекстПояснения);
	...
	Диалог.Фильтр = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Все файлы (*.%1)|*.%1';uk='Всі файли (*. %1)|*. %1'"), Параметры.Расширение, Параметры.Расширение);
				...
				Если РазницаДат > 0 Тогда // спросим пользователя
					...
					ПараметрыФормы.Вставить("Сообщение",
						НСтр("ru='Файл на диске новее, чем файл в Документообороте.
                            |Возможно, он был изменен.
                            |
                            |Использовать существующий файл или взять файл из Документооборота?'
                            |;uk='Файл на диску новіше, ніж файл у Документообігу.
                            |Можливо, він був змінений.
                            |
                            |Використовувати існуючий файл або взяти файл з Документообігу?'"));
					ПараметрыФормы.Вставить("ПолныйПуть", СведенияОРедактировании.ПолныйПуть);
					ПараметрыФормы.Вставить("ДатаВремяНаДиске", ДатаВремяНаДиске);
					ПараметрыФормы.Вставить("ДатаВремяВДокументообороте", ДатаВремяВДокументообороте);
					ПараметрыФормы.Вставить("РазмерНаДиске", РазмерНаДиске);
...
Процедура СохранитьКакПослеВыбораИсточника(Результат, Параметры) Экспорт
	...
	ИначеЕсли Результат = "ИспользоватьСуществующий" Тогда
		...
		Исключение
			Инфо = ИнформацияОбОшибке();
			ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось скопировать файл (""%1"").';uk='Не вдалося скопіювати файл (""%1"").'"),
				КраткоеПредставлениеОшибки(Инфо));
			ПоказатьПредупреждение(, ТекстПредупреждения); 
			Возврат;
		КонецПопытки;
	...
	Состояние(НСтр("ru='Файл сохранен.';uk='Файл збережений.'"), , Параметры.ПолныйПуть);
	Если Параметры.ОписаниеОповещения <> Неопределено Тогда
		ВыполнитьОбработкуОповещения(Параметры.ОписаниеОповещения, Параметры);
	КонецЕсли;
		...
		Исключение
			ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось обновить файл по причине:
                    |%1'
                    |;uk='Не вдалося оновити файл з причини:
                    |%1'"), КраткоеПредставлениеОшибки(ИнформацияОбОшибке()));
			ПоказатьПредупреждение(, ТекстПредупреждения);
		КонецПопытки;
		Возврат;
...
Процедура ОбновитьИзФайлаНаДискеПослеПомещенияФайлаСРасширением(Результат, Адрес, ПолныйПуть, Параметры) Экспорт
	...
	НастройкиДокументооборот = ИнтеграцияС1СДокументооборотКлиентПовтИсп.ПолучитьНастройки();
	Если НастройкиДокументооборот.НужноИзвлечьТекст Тогда
		Параметры.Вставить("Текст", ФайловыеФункцииСлужебныйКлиентСервер.ИзвлечьТекст(ПолныйПуть));
	Иначе
		Параметры.Вставить("Текст", "");
	КонецЕсли;
	...
	Если ИнтеграцияС1СДокументооборотВызовСервера.
		ОбновитьФайлДвоичнымиДаннымиВременногоХранилища(Параметры) Тогда
		Состояние(НСтр("ru='Файл обновлен.';uk='Файл оновлений.'"));
		Если ОписаниеОповещения <> Неопределено Тогда
			ВыполнитьОбработкуОповещения(ОписаниеОповещения, Параметры);
		КонецЕсли;
	КонецЕсли;
...
Процедура СоздатьФайлСДискаПослеПодключенияРасширения(Подключено, Параметры) Экспорт
	...
	Если Подключено Тогда
		...
		ВыборФайла.Фильтр = НСтр("ru='Все файлы (*.*)|*.*';uk='Всі файли (*.*)|*.*'");
		...
		Исключение
			ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось создать файл по причине:
                    |%1'
                    |;uk='Не вдалося створити файл з причини:
                    |%1'"), КраткоеПредставлениеОшибки(ИнформацияОбОшибке()));
			ПоказатьПредупреждение(, ТекстПредупреждения);
		КонецПопытки;
...
Процедура СоздатьФайлСДискаПослеДиалогаВыбораФайла(ВыбранныеФайлы, Параметры) Экспорт
	...
	Параметры.Вставить("ПолноеИмяФайла", ВыбранныеФайлы[0]);
	Файл = Новый Файл;
...
Процедура СоздатьФайлСДискаПослеПолученияРазмера(Размер, Параметры) Экспорт
	...
	Если Размер > МаксРазмерФайла Тогда
		ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				 НСтр("ru='Размер файла ""%1"" (%2) превышает максимально допустимый (%3).';uk='Розмір файлу ""%1"" (%2) перевищує максимально допустимий (%3).'"),
				 Параметры.ПолноеИмяФайла, 
...
Процедура СоздатьФайлСДискаПослеПомещенияФайла(ПомещенныеФайлы, Параметры) Экспорт
	...
	НастройкиДокументооборот = ИнтеграцияС1СДокументооборотКлиентПовтИсп.ПолучитьНастройки();
	Если НастройкиДокументооборот.НужноИзвлечьТекст Тогда
		Параметры.Вставить("Текст", ФайловыеФункцииСлужебныйКлиентСервер.
...
Процедура СоздатьФайлСДискаЗавершение(Параметры)
	...
	Если ОписаниеОповещения <> Неопределено Тогда
		...
		ОписаниеФайла.Вставить("Идентификатор", ИдентификаторСозданногоФайла);
		ОписаниеФайла.Вставить("Имя", Параметры.Имя);
		ОписаниеФайла.Вставить("Расширение", Параметры.Расширение);
		ВыполнитьОбработкуОповещения(ОписаниеОповещения, ОписаниеФайла);
	КонецЕсли;
...
//   ID - Строка - идентификатор документа Документооборота
//   Тип - Строка - тип документа Документооборота
//   Представление - Строка - представление документа Документооборота
...
Процедура ОткрытьПрисоединенныеФайлы(Источник, Владелец = Неопределено, Уникальность = Неопределено, Окно = Неопределено) Экспорт
	...
	Параметры = Новый Структура;
	Параметры.Вставить("Владелец", Источник);
...
//
Процедура НачатьДобавлениеСвязи(ID, Тип, Представление, ТипДобавляемогоДокумента,
...
Процедура НачатьУдалениеСвязи(ИсходныйДокумент, СвязанныйДокумент, ТипСвязи,
	...
	ПоказатьВопросДаНет(ОповещениеПродолжения,
		НСтр("ru='Удалить связь?';uk='Вилучити зв''язок?'"));
...
Процедура ПодписатьФайл(ИдентификаторФайла, ИмяФайла, Редактируется, Зашифрован, ОписаниеФайла, ДанныеПодписейФайла) Экспорт
	...
	Если Редактируется Тогда
		ПоказатьПредупреждение(, ФайловыеФункцииСлужебныйКлиентСервер.СтрокаСообщенияОНедопустимостиПодписанияЗанятогоФайла());
		Возврат;
	КонецЕсли;
	
	Если Зашифрован Тогда
		ПоказатьПредупреждение(, ФайловыеФункцииСлужебныйКлиентСервер.СтрокаСообщенияОНедопустимостиПодписанияЗашифрованногоФайла());
		Возврат;
	КонецЕсли;
	
	ОписаниеДанных = Новый Структура;
	ОписаниеДанных.Вставить("Операция", НСтр("ru='Подписание файла';uk='Підписання файлу'"));
...
Процедура ИнформироватьОПодписанииОбъекта(ИмяФайла, ИдентификаторФайла) Экспорт
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Установлена подпись для ""%1""';uk='Установлений підпис для ""%1""'"), ИмяФайла);
	Состояние(ТекстСообщения);
...
Процедура НачатьСохранениеВместеСЭППослеПодключенияРасширения(Подключено, Параметры) Экспорт	
	...
	Иначе
		ПоказатьПредупреждение(, НСтр("ru='Для выполнения операции нужно установить расширение работы с файлами.';uk='Для виконання операції потрібно встановити розширення роботи з файлами.'"));
	КонецЕсли;
...
Процедура ПроверитьОднуПодпись(ДанныеСтроки, МенеджерКриптографии, УникальныйИдентификатор, 
	...
	Исключение
		ДанныеСтроки.Статус = НСтр("ru='Не верна';uk='Не вірна'");
		Инфо = ИнформацияОбОшибке();
...
Процедура ИнформироватьОПодписании(Представление) Экспорт
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Установлена подпись для ""%1""';uk='Установлений підпис для ""%1""'"),
		Представление);
	Состояние(ТекстСообщения);
...
Процедура НачатьФормированиеПодписиОбъекта(Форма, ОписаниеОповещенияОЗакрытии) Экспорт
	...
	ОписаниеДанных = Новый Структура;
	ОписаниеДанных.Вставить("Операция", НСтр("ru='Подписание документа';uk='Підписання документа'"));
	ОписаниеДанных.Вставить("ЗаголовокДанных", НСтр("ru='Документ';uk='Документ'"));
...
Процедура СоздатьИнтегрированныйОбъектЗавершение(Результат, ПараметрыОповещения) Экспорт
	...
	ИнтеграцияС1СДокументооборотВызовСервера.ДобавитьСвязь(ID, Тип, СсылкаНаОбъект);
...
Процедура НачатьДобавлениеЭПИзФайлаЗавершение(ОписаниеДанных, ПараметрыОповещения) Экспорт
	...
	Если МассивДанныхДляЗанесенияВБазу.Количество() = 1 Тогда
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Добавлена подпись из файла для ""%1""';uk='Додано підпис із файлу для ""%1""'"), СвойстваФайла.ИмяФайла);
	Иначе
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Добавлены подписи из файлов для ""%1""';uk='Додано підписи з файлів для ""%1""'"), СвойстваФайла.ИмяФайла);
	КонецЕсли;
...
Процедура ВыбратьЗначениеРеквизитаСоставногоТипаВТаблицеОбработка(ИмяТипа, Форма, ТекущиеДанные, Реквизит)
	...
	Если ИмяТипа = "integer" 
		...
		ПоказатьВводЗначения(Оповещение, ТекущиеДанные[Реквизит], НСтр("ru='Введите значение';uk='Введіть значення'"), ТипЗначения);
...
Процедура ПереключитьХронометражЗавершение(Результат, ПараметрыОповещения) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда
		...
		Если ПараметрыХронометража.ВключенХронометраж Тогда
			...
			НСтр("ru='Включен хронометраж по ""%1""';uk='Включений хронометраж по ""%1""'"), Строка(ПараметрыОповещения.ОбъектИС));
			Состояние(Текст);
		КонецЕсли;
...
Процедура ПереключитьХронометражПослеПоискаСвязанногоОбъектаДО(Результат, Параметры) Экспорт
	...
	Иначе
		...
		Если ПараметрыХронометража.ВключенХронометраж Тогда
			...
			Если ПараметрыХронометража.ВключенХронометраж Тогда
				Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Включен хронометраж по ""%1""';uk='Включений хронометраж по ""%1""'"), Строка(Параметры.ОбъектИС));
				Состояние(Текст);
			КонецЕсли;
