...
Процедура ПодобратьМногооборотнуюТару(Знач Форма,
	...
	Для Каждого ТекСтрока Из Форма.Объект[ИмяТаблицы] Цикл
	...
	Если КоличествоТоваров = 0 Тогда
		...
		ПоказатьПредупреждение(, НСтр("ru='В списке отсутствуют строки. Дозаполнение многообротной тарой не требуется.';uk='У списку відсутні рядки. Дозаповнення многообротною тарою не потрібно.'"));
...
Процедура ОповеститьПользователяОЗаполненииМногооборотнойТарой() Экспорт
	...
	ПоказатьОповещениеПользователя(
		НСтр("ru='Подбор многооборотной тары';uk='Підбір багатооборотної тари'"),
		,
		НСтр("ru='Подбор многооборотной тары завершен.';uk='Підбір багатооборотної тари завершений.'"));
...
Процедура ПредложитьПодобратьМногооборотнуюТару(Знач Форма,
	...
	ВариантыОтвета.Добавить("Дополнить", НСтр("ru='Дополнить';uk='Доповнити'"));
	ВариантыОтвета.Добавить("НеДополнять", НСтр("ru='Не дополнять';uk='Не доповнювати'"));
	...
	ПоказатьВопрос(
		...
		НСтр("ru='Дополнить многооборотной тарой?';uk='Доповнити багатооборотною тарою?'"),
		ВариантыОтвета);
