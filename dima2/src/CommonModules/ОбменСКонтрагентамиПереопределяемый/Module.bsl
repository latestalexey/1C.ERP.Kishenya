	...
	Если ДопустимыеВидыДокументов.Найти(ВидДокумента) = Неопределено Тогда
		ВызватьИсключение 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='ЭД ""Счет на оплату"" не может быть сформирована, т.к. не определено получение данных для основания вида %1';uk='ЕД ""Рахунок на оплату"" не може бути сформована, т. к. не визначено отримання даних для заснування виду  %1'"),
				ВидДокумента);
	КонецЕсли;
