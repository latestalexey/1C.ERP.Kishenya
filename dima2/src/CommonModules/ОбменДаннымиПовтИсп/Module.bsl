...
Функция СообщенияОбОшибках() Экспорт
	...
	СообщенияОбОшибках.Вставить(8,  НСтр("ru='Не корректно указано имя файла для выгрузки данных';uk='Не коректно зазначене ім''я файлу для вивантаження даних'"));
	...
	СообщенияОбОшибках.Вставить(81, НСтр("ru='Возникла коллизия изменений объектов.
        ...
        |;uk='Виникла колізія змін об''єктів.
        |Об''єкт цієї інформаційної бази був замінений версією об''єкту із другої інформаційної бази.'"));
	//
	СообщенияОбОшибках.Вставить(82, НСтр("ru='Возникла коллизия изменений объектов.
        ...
        |;uk='Виникла колізія змін об''єктів.
        |Об''єкт із другої інформаційної бази не прийнято. Об''єкт цієї інформаційної бази не змінено.'"));
	//
	...
	СообщенияОбОшибках.Вставить(177, НСтр("ru='Имя плана обмена из сообщения обмена не соответствует ожидаемому.';uk='Ім''я плану обміну з повідомлення обміну не відповідає очікуваному.'"));
	СообщенияОбОшибках.Вставить(178, НСтр("ru='Получатель из сообщения обмена не соответствует ожидаемому.';uk='Одержувач повідомлення з обміну не відповідає очікуваному.'"));
...
Функция ПланОбменаАвтономнойРаботы() Экспорт
	...
	Если Результат.Количество() = 0 Тогда
		...
		ВызватьИсключение НСтр("ru='Автономная работа в системе не предусмотрена.';uk='Автономна робота в системі не передбачена.'");
		
	ИначеЕсли Результат.Количество() > 1 Тогда
		
		ВызватьИсключение НСтр("ru='Создано более одного плана обмена для автономной работы.';uk='Створено більше одного плану обміну для автономної роботи.'");
	...
	Иначе
		...
		Если Не Каталог.Существует() Тогда
			...
			ШаблонСообщения = НСтр("ru='Каталог временных файлов не существует.
                    ...
                    |""%1"".'
                    |;uk='Каталог тимчасових файлів не існує.
                    |Необхідно переконатися, що в настройках програми задане правильне значення параметра
                    |""%1"".'");
