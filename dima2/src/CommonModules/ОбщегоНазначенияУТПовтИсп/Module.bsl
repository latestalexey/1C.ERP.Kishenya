...
Функция ПолучитьЗначенияКонстантПоУмолчанию() Экспорт
	...
	//++ НЕ УТ
	Результат.Вставить("ИспользоватьПроизводство", 		 Истина); // в УП (ERP)
	Результат.Вставить("ИспользоватьНачислениеЗарплаты", Истина);
	Результат.Вставить("ИспользоватьЗарплатаКадрыКорпоративнаяПодсистемы", Истина);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	// Казначейство
	Результат.Вставить("МаксимальныйРазмерФайлаПодтверждающегоДокумента",			40);
	Результат.Вставить("МаксимальныйРазмерФайлаАрхиваПодтверждающихДокументов",		100);
	//-- НЕ УТ
	
	//++ НЕ УТ
	// Материалы
	Результат.Вставить("ИспользоватьВнутреннееПотребление", Истина);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Результат.Вставить("ИспользоватьРасширенноеОбеспечениеПотребностей", Истина);
	Результат.Вставить("НеИспользоватьРасширенноеОбеспечениеПотребностей", Ложь);
	//-- НЕ УТ
...
Функция ЗначенияКонстантКонтролируемыхВБазовойВерсии() Экспорт 
	...
	Результат.Вставить(Метаданные.Константы.ИспользоватьСерииНоменклатуры.Имя, Ложь);
	...
	Результат.Вставить(Метаданные.Константы.ИспользоватьШифрование.Имя, Ложь);
	Результат.Вставить(Метаданные.Константы.ИспользоватьЭлектроннуюПочту1СДокументооборота.Имя, Ложь);
	Результат.Вставить(Метаданные.Константы.ИспользоватьЭлектронныеПодписи.Имя, Ложь);
	...
	Результат.Вставить(Метаданные.Константы.КонтролироватьУникальностьНоменклатурыИХарактеристикПоСочетаниюЗначенийРеквизитов.Имя, Ложь);
	Результат.Вставить(Метаданные.Константы.ИспользоватьСинхронизациюДанных.Имя, Истина);
	Результат.Вставить(Метаданные.Константы.ИспользоватьУчетПрочихДоходовРасходов.Имя, Ложь);
	Результат.Вставить(Метаданные.Константы.ФормироватьУправленческийБаланс.Имя, Ложь);
...
Функция ПолучитьИменаОтключаемыхНЕУКРКонстант() Экспорт
	...
	Результат.Вставить("УплачиваетсяТорговыйСбор");
...
Функция ПолучитьТаблицуЗависимостиКонстант() Экспорт
	...
	//++ НЕ УТ	
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ОграничиватьДоступНаУровнеЗаписей", Ложь, "ОграничиватьДоступНаУровнеЗаписейФизическиеЛица", Ложь);
	//-- НЕ УТ	
	...
	//++ НЕ УТ
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ПоддержкаПлатежейВСоответствииС275ФЗ", Истина, "ИспользоватьДоговорыСКлиентами", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ПоддержкаПлатежейВСоответствииС275ФЗ", Истина, "ИспользоватьДоговорыСПоставщиками", Истина);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Истина, "ИспользоватьПодразделения", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Истина, "ИспользоватьНесколькоВидовНоменклатуры", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство",	 					Ложь, "ИспользоватьПроизводствоНаСтороне", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводствоНаСтороне", 			Ложь, "ИспользоватьСтатусыЗаказовПереработчикам", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводствоНаСтороне", 			Истина, "ИспользоватьНесколькоВидовНоменклатуры", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьСтатусыЗаказовПереработчикам", 	Ложь, "НеЗакрыватьЗаказыПереработчикамБезПолнойОплаты", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьСтатусыЗаказовПереработчикам",		Ложь, "НеЗакрыватьЗаказыПереработчикамБезПолнойОтработки", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство",						Ложь, "АналитическийУчетПоГруппамПродукции", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"УчитыватьСебестоимостьТоваровПоВидамЗапасов",	Ложь, "АналитическийУчетПоГруппамПродукции", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"АналитическийУчетПоГруппамПродукции",			Истина, "ИспользоватьГруппыАналитическогоУчетаНоменклатуры", Истина);
	//-- НЕ УТ
	//++ НЕ УТКА
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Ложь, "ИспользоватьПланированиеПроизводства", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Ложь, "ИспользоватьИнтервалПланированияЧас", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Ложь, "НеЗакрыватьЗаказыНаПроизводствоБезПолнойОтработки", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводствоИзДавальческогоСырья", Истина, "ИспользоватьОбособленноеОбеспечениеЗаказов", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводствоИзДавальческогоСырья", Ложь, "ИспользоватьОтчетДавальцуПоНесколькимЗаказам", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводствоИзДавальческогоСырья", Ложь, "ИспользоватьСтатусыЗаказовДавальцев", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Ложь, "ИспользоватьПроизводствоИзДавальческогоСырья", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Ложь, "ИспользоватьВыпускПоНесколькимРаспоряжениям", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Ложь, "ИспользоватьПлановыеКалькуляцииПриВыпускеПродукции", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Ложь, "ИспользоватьКорректировкиЗаказаМатериаловВПроизводство", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьСтатусыЗаказовДавальцев",			Ложь, "НеЗакрыватьЗаказыДавальцевБезПолнойОплаты", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьСтатусыЗаказовДавальцев",			Ложь, "НеЗакрыватьЗаказыДавальцевБезПолнойОтработки", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Ложь, "ИспользоватьМетодикуББВ", Ложь);
	//-- НЕ УТКА
	
	//++ НЕ УТ
	// Ремонты
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьУправлениеРемонтами", Ложь, "ИспользоватьУзлыОбъектовЭксплуатации", Ложь);
	//-- НЕ УТ
	
	//++ НЕ УТКА
	// Международный учет
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		"ИспользоватьМеждународныйФинансовыйУчет", Истина, "ФормироватьПроводкиМеждународногоУчетаПоДаннымОперативного", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		"ИспользоватьМеждународныйФинансовыйУчет", Истина, "ИспользоватьУчетПрочихДоходовРасходов", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		"ИспользоватьМеждународныйФинансовыйУчет", Истина, "ИспользоватьГруппыФинансовогоУчета", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		"ИспользоватьМеждународныйФинансовыйУчет", Истина, "ФормироватьУправленческийБаланс", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		"ИспользоватьМеждународныйФинансовыйУчет", Ложь, "ФормироватьПроводкиМеждународногоУчетаПоДаннымОперативного", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		"ИспользоватьМеждународныйФинансовыйУчет", Ложь, "ФормироватьПроводкиМеждународногоУчетаПоДаннымРегламентированного", Ложь);
	
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьМеждународныйФинансовыйУчет", Ложь,
		"ИспользоватьДокументыВнеоборотныхАктивовМеждународныйУчет", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьМеждународныйФинансовыйУчет", Истина,
		"ИспользоватьДокументыВнеоборотныхАктивовМеждународныйУчет", Истина);
	
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьМеждународныйФинансовыйУчет", Истина,
		"ИспользоватьАмортизациюБухгалтерскогоУчетаВУправленческомУчете", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьДокументыВнеоборотныхАктивовМеждународныйУчет", Истина,
		"ИспользоватьАмортизациюБухгалтерскогоУчетаВУправленческомУчете", Ложь);
	//-- НЕ УТКА
	...
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьБюджетирование", Истина, 	"ИспользоватьЛимитыРасходаДенежныхСредств", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьБюджетирование", Ложь, 	"КонтролироватьПревышениеЛимитовРасходаДенежныхСредств", Ложь);
	//-- НЕ УТ
...
Функция СоответствиеКодовОКВЭД() Экспорт
	...
	Возврат СоотвествиеИзМакета("Списки2016Кв1", "s_okved", "Справочник.КлассификаторВидовЭкономическойДеятельности"); 

КонецФункции

Функция СоотвествиеИзМакета(ИмяМакета, ИмяОбласти, ИмяИсточникаМакета = Неопределено) 
	
	СоотвествиеКодов = Новый Соответствие;
	
	Макет = МакетПоИмениИсточникаИОбласти(ИмяМакета, ИмяОбласти, ИмяИсточникаМакета);
	Если Макет = Неопределено Тогда
		Возврат СоотвествиеКодов;
	КонецЕсли;
