...
Функция ВидПриложения()
	...
	Возврат НСтр("ru='Толстый клиент, обычное приложение';uk='Товстий клієнт, звичайний додаток'");
	#ИначеЕсли ТолстыйКлиентУправляемоеПриложение Тогда
	Возврат НСтр("ru='Толстый клиент, управляемое приложение';uk='Товстий клієнт, кероване додаток'");
