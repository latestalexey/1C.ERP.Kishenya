...
Функция ТаблицаПодсистемИРолейДляПросмотра(ПроверятьРольТекущегоПользователя)
	...
	Иначе
		НоваяСтрока = ТаблицаПодсистем.Добавить();
		НоваяСтрока.Подсистема = Метаданные.Подсистемы.БюджетированиеИПланирование.Имя;
		НоваяСтрока.МетаданныеРоли = Метаданные.Роли.РазделБюджетированиеИПланирование;
	КонецЕсли;
	//-- НЕ УТ
	...
	//++ НЕ УТ
	НоваяСтрока = ТаблицаПодсистем.Добавить();
	НоваяСтрока.Подсистема = Метаданные.Подсистемы.Зарплата.Имя;
	НоваяСтрока.МетаданныеРоли = Метаданные.Роли.РазделЗарплата;

	НоваяСтрока = ТаблицаПодсистем.Добавить();
	НоваяСтрока.Подсистема = Метаданные.Подсистемы.Кадры.Имя;
	НоваяСтрока.МетаданныеРоли = Метаданные.Роли.РазделКадры;
	//-- НЕ УТ
	НоваяСтрока = ТаблицаПодсистем.Добавить();
	...
	//++ НЕ УТКА
	НоваяСтрока = ТаблицаПодсистем.Добавить();
	НоваяСтрока.Подсистема = Метаданные.Подсистемы.МеждународныйФинансовыйУчет.Имя;
	НоваяСтрока.МетаданныеРоли = Метаданные.Роли.РазделМеждународныйФинансовыйУчет;
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	НоваяСтрока = ТаблицаПодсистем.Добавить();
	НоваяСтрока.Подсистема = Метаданные.Подсистемы.Производство.Имя;
	НоваяСтрока.МетаданныеРоли = Метаданные.Роли.РазделПроизводство;
	
	НоваяСтрока = ТаблицаПодсистем.Добавить();
	НоваяСтрока.Подсистема = Метаданные.Подсистемы.РегламентированныйУчет.Имя;
	НоваяСтрока.МетаданныеРоли = Метаданные.Роли.РазделРегламентированныйУчет;
	//-- НЕ УТ
