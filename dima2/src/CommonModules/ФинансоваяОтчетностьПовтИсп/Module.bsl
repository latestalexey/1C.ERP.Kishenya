...
Функция ДопустимыеСочетанияЭлементовБюджетов() Экспорт
	...
	//Колонки
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, МассивСтрокиКолонки                 , ВидЭлемента("ВсеСтатьиБюджетов")    ,, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, МассивСтрокиКолонки                 , ВидЭлемента("ВсеПоказателиБюджетов"),, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("Группа")               , ВидЭлемента("ВсеСтатьиБюджетов")    , МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("Группа")               , ВидЭлемента("ВсеПоказателиБюджетов"), МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("Измерение")            , ВидЭлемента("ВсеСтатьиБюджетов")    , МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("Измерение")            , ВидЭлемента("ВсеПоказателиБюджетов"), МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеСтатьиБюджетов")    , ВидЭлемента("Измерение")            , МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеПоказателиБюджетов"), ВидЭлемента("Измерение")            , МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ЭлементТаблицы")       , ВидЭлемента("ВсеСтатьиБюджетов")    , МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ЭлементТаблицы")       , ВидЭлемента("ВсеПоказателиБюджетов"), МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеСтатьиБюджетов")    , ВидЭлемента("ЭлементТаблицы")       , МассивСтрокиКолонки, ВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеПоказателиБюджетов"), ВидЭлемента("ЭлементТаблицы")       , МассивСтрокиКолонки, ВидТаблицы);
	...
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ПоказательБюджетов")   ,  ВидЭлемента("СтатьяБюджетов"));
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ПоказательБюджетов")   ,  ВидЭлемента("ВсеСтатьиБюджетов"));
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеПоказателиБюджетов"),  ВидЭлемента("СтатьяБюджетов"));
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеПоказателиБюджетов"),  ВидЭлемента("ВсеСтатьиБюджетов"));
	...
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ПоказательБюджетов")     , ВидЭлемента("СтатьяБюджетов")   , МассивСтрокиКолонки, МассивВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ПоказательБюджетов")     , ВидЭлемента("ВсеСтатьиБюджетов"), МассивСтрокиКолонки, МассивВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеПоказателиБюджетов")  , ВидЭлемента("СтатьяБюджетов")   , МассивСтрокиКолонки, МассивВидТаблицы);
	...
	//элементы вида "все"
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеПоказателиБюджетов"), ВидЭлемента("ВсеСтатьиБюджетов"), МассивСтрокиКолонки, МассивВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеПоказателиБюджетов"), ВидЭлемента("Группа")           , МассивСтрокиКолонки, МассивВидТаблицы);
	ДобавитьСтрокуСочетаний(ТаблицаСочетаний, ВидЭлемента("ВсеСтатьиБюджетов")    , ВидЭлемента("Группа")           , МассивСтрокиКолонки, МассивВидТаблицы);
...
//
// Параметры:
// 	Счет - ПланСчетовСсылка.Хозрасчетный, ПланСчетовСсылка.Международный - Счет субконто которого необходимо вернуть
//
// Возвращаемое значение:
// 	ВидыСубконто - ТаблицаЗначений - Виды субконто счета
//
...
Функция ТипЗначенияВидаАналитики(ИмяИзмерения, ВидАналитики) Экспорт
	...
	ИначеЕсли ИмяИзмерения = "Аналитика1"
		ИЛИ ИмяИзмерения = "Аналитика2"
		ИЛИ ИмяИзмерения = "Аналитика3"
		ИЛИ ИмяИзмерения = "Аналитика4"
		ИЛИ ИмяИзмерения = "Аналитика5"
		ИЛИ ИмяИзмерения = "Аналитика6" Тогда
...
Процедура ДобавитьСтрокуСочетаний(ТаблицаДопустимыхСочетаний, Родитель, Элемент, 
	...
	Иначе
		...
		Структура = Новый Структура("Родитель, Элемент, 
									|СтрокиКолонки, ВидТаблицы", 
									Родитель, Элемент, 
									СтрокиКолонки, ВидТаблицы);
...
Функция СоответствиеОтборовПоВладельцу() Экспорт
	...
	ДобавитьОтборПоВладельцу(Результат, Тип("СправочникСсылка.ДоговорыКредитовИДепозитов"), "Контрагент", Тип("СправочникСсылка.Партнеры"));
