...
Функция ПолучитьФайлИзИнтернет(Знач URL, Знач НастройкаСохранения, Знач НастройкаСоединения = Неопределено,
	...
	Если ИспользуетсяFTPПротокол Тогда
		...
		Исключение
			...
			СообщениеОбОшибке = НСтр("ru='Не удалось установить FTP-соединение с сервером %1:';uk='Не вдалося встановити FTP-з''єднання з сервером %1:'") + Символы.ПС + "%2";
	...
	Иначе
		...
		Исключение
            ...
            |%2'
            |;uk='Не вдалося встановити HTTP-з''єднання з сервером %1:
            |%2'");
	...
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		СообщениеОбОшибке = НСтр("ru='Не удалось получить файл с сервера %1:';uk='Не вдалося отримати файл з сервера %1:'") + Символы.ПС + "%2";
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru='Получение файлов из Интернета';uk='Одержання файлів з Інтернету'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
