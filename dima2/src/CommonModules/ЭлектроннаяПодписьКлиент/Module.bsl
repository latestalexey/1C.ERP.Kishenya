...
Процедура Подписать(ОписаниеДанных, Форма = Неопределено, ОбработкаРезультата = Неопределено) Экспорт
	...
	СерверныеПараметры.Вставить("Операция",            НСтр("ru='Подписание данных';uk='Підписання даних'"));
...
Процедура Зашифровать(ОписаниеДанных, Форма = Неопределено, ОбработкаРезультата = Неопределено) Экспорт
	...
	СерверныеПараметры = Новый Структура;
	СерверныеПараметры.Вставить("Операция",            НСтр("ru='Шифрование данных';uk='Шифрування даних'"));
	СерверныеПараметры.Вставить("ЗаголовокДанных",     НСтр("ru='Данные';uk='Дані'"));
...
Процедура Расшифровать(ОписаниеДанных, Форма = Неопределено, ОбработкаРезультата = Неопределено) Экспорт
	...
	СерверныеПараметры = Новый Структура;
	СерверныеПараметры.Вставить("Операция",            НСтр("ru='Расшифровка данных';uk='Розшифровка даних'"));
	СерверныеПараметры.Вставить("ЗаголовокДанных",     НСтр("ru='Данные';uk='Дані'"));
	СерверныеПараметры.Вставить("ОтборСертификатов");
...
Процедура ИнформироватьОПодписанииОбъекта(ПредставлениеДанных, МножествоДанных = Ложь, ИзФайла = Ложь) Экспорт
	...
	Если ИзФайла Тогда
		Если МножествоДанных Тогда
			ТекстСообщения = НСтр("ru='Добавлены подписи из файлов:';uk='Додані підписи з файлів:'");
		Иначе
			ТекстСообщения = НСтр("ru='Добавлена подпись из файла:';uk='Додан підпис з файлу:'");
		КонецЕсли;
	Иначе
		Если МножествоДанных Тогда
			ТекстСообщения = НСтр("ru='Установлены подписи:';uk='Встановлені підписи:'");
		Иначе
			ТекстСообщения = НСтр("ru='Установлена подпись:';uk='Встановлена підпис:'");
		КонецЕсли;
	КонецЕсли;
...
Процедура ИнформироватьОШифрованииОбъекта(ПредставлениеДанных, МножествоДанных = Ложь) Экспорт
	...
	ТекстСообщения = НСтр("ru='Выполнено шифрование:';uk='Виконано шифрування:'");
...
Процедура ИнформироватьОРасшифровкеОбъекта(ПредставлениеДанных, МножествоДанных = Ложь) Экспорт
	...
	ТекстСообщения = НСтр("ru='Выполнена расшифровка:';uk='Виконана розшифровка:'");
