...
Функция ОбновитьВторичныеДанные(МенеджерВременныхТаблиц, Объект, ИмяТЧ = "", ИмяВТ = "ВТВторичныеДанные", ПараметрыФиксацииВторичныхДанных = Неопределено) Экспорт
	...
	Если ИмяТЧ  = "" Тогда
		...
		Для каждого ОписаниеФиксацииРеквизита Из ПараметрыФиксацииВторичныхДанных.ОписаниеФиксацииРеквизитов Цикл
			...
			Если (ЗначениеЗаполнено(ОбновленныеДанные[ИмяРеквизита]) Или ЗначениеЗаполнено(Объект[ИмяРеквизита])) 
				И ОбновленныеДанные[ИмяРеквизита] <> Объект[ИмяРеквизита] Тогда 
				Объект[ИмяРеквизита] = ОбновленныеДанные[ИмяРеквизита];
				ОбъектОбновлен = Истина;
			КонецЕсли;	
		КонецЦикла;
	Иначе		
		...
		Для каждого ОписаниеФиксацииРеквизита Из ПараметрыФиксацииВторичныхДанных.ОписаниеФиксацииРеквизитов Цикл
			...
			Для каждого ОбновленнаяСтрока Из ОбновленныеДанные Цикл
				Если (ЗначениеЗаполнено(ОбновленнаяСтрока[ИмяРеквизита]) Или ЗначениеЗаполнено(Объект[ИмяТЧ][ОбновленнаяСтрока["НомерСтроки"] - 1][ИмяРеквизита])) 
					И ОбновленнаяСтрока[ИмяРеквизита] <> Объект[ИмяТЧ][ОбновленнаяСтрока["НомерСтроки"] - 1][ИмяРеквизита] Тогда 
...
Функция СтруктураПараметровОписанияФиксацииРеквизитов() Экспорт
	...
	ФиксацияРеквизита.СтрокаПредупреждения 		= НСтр("ru='Эти данные заполнены автоматически';uk='Ці дані автоматично'");
