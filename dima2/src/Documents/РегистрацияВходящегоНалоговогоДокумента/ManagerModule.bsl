...
Функция ТекстОтраженияВРеглУчетеУКР() Экспорт
	...
	|   И Операция.ВидОперации <> ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРегистрацияВходящегоНалоговогоДокумента.РасчетКорректировкиВозврат)
	|
	|СГРУППИРОВАТЬ ПО
	|	Операция.Ссылка,
	|	Операция.Дата,
...
Функция ТекстЗапросаТаблицаНДСУсловныеПродажи(Запрос, ТекстыЗапроса, Регистры)
	...
	|   	ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРегистрацияВходящегоНалоговогоДокумента.ТоварныйЧек)
	|   )
	|	И ПоставкаДокумента.СтавкаНДС В (ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20), ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС7))	
	|СГРУППИРОВАТЬ ПО
...
Процедура ИнициализироватьСоответствиеОбъектовРасчетовКлючамАналитикиУчетаПоПартнерам(Запрос)
	...
	ТипыОбъектаРасчетов = Новый Массив;
	ТипыОбъектаРасчетов.Добавить(Тип("Неопределено"));
	ТипыОбъектаРасчетов.Добавить(Тип("ДокументСсылка.ПоступлениеТоваровУслуг"));
	ТипыОбъектаРасчетов.Добавить(Тип("ДокументСсылка.ОтчетКомиссионера"));
	ТипыОбъектаРасчетов.Добавить(Тип("ДокументСсылка.ЗаказПоставщику"));
	ТипыОбъектаРасчетов.Добавить(Тип("СправочникСсылка.ДоговорыКонтрагентов"));
	ТипыОбъектаРасчетов.Добавить(Тип("ДокументСсылка.ОтчетПоКомиссииМеждуОрганизациями"));
	ТипыОбъектаРасчетов.Добавить(Тип("ДокументСсылка.ОтчетКомитенту"));
	ТипыОбъектаРасчетов.Добавить(Тип("ДокументСсылка.ПоступлениеУслугПрочихАктивов"));
	ТипыОбъектаРасчетов.Добавить(Тип("ДокументСсылка.ПередачаТоваровМеждуОрганизациями"));
	
	СоответствиеОбъектовРасчетовКлючамАналитики.Колонки.Добавить("ОбъектРасчетов", Новый ОписаниеТипов(ТипыОбъектаРасчетов)); 
