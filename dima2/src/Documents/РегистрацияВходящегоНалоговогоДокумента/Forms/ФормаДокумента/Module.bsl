...
|;uk='Для завантаження XML-образу вхідного податкового документа з FREDO Звіт необхідно зазначити контрагента, дату, номер і вид операції (податкову накладну чи розрахунок коригування).""
|""
|""Для групової завантаження XML-образів вхідних документів з FREDO Звіт необхідно скористатися комадной ""Завантажити документи з FREDO Звіт"" у формі списку.'"));
	    Возврат;
...
|;uk='Даний файл містить інформацію в закодованому вигляді і не є стандартним текстовим XML-файлом.""
|""Необхідно скористатися спеціалізованим програмним забезпеченням для його розшифровки.'"));
...
|;uk='Звертаємо увагу, що друкована форма призначається виключно для ознайомлення. Її не можна використовувати в якості паперової податкової накладної! ""
|""Друкарська форма має відмінності від офіційно затвердженої: наприклад, відсутні квадратики в полях ІПН, формат представлення дат призначений для зручного перегляду, і т. д.'"), 20, НСтр("ru='Важно: о печатной форме';uk='Важливо: про друкованій формі'"));
