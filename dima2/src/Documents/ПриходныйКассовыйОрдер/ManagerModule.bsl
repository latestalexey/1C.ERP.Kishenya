...
#Область ПоступлениеИзБанка // (Дт 30 :: Кт 31, 333, 334)
	ТекстПоступлениеИзБанка = "
	|ВЫБРАТЬ // Поступление из банка (Дт 30 :: Кт 31, 333, 334)
	|
	...
	|
	|	Операция.Касса.СчетУчета СчетДт,
...
#Область ПоступлениеИзКассыККМ // (Дт 30 :: Кт 309)
	ТекстПоступлениеИзКассыККМ = "
	|ВЫБРАТЬ //// Поступление из кассы ККМ (Дт 30 :: Кт 309)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	...
	|	НЕОПРЕДЕЛЕНО КАК НалоговоеНазначениеДт,
	|
	|	Операция.Касса.СчетУчета КАК СчетДт,
...
#Область ВозвратОтПодотчетника // (Дт 30 :: Кт 372)
...
#Область ВозвратАвансаОтПоставщика // (Дт 30 :: Кт 371)
	ТекстВозвратАвансаОтПоставщика = "
	|ВЫБРАТЬ //// Возврат аванса от поставщика (Дт 30 :: Кт 371)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ВозвратОплатыОтПоставщика // (Дт 30 :: Кт 63)
	ТекстВозвратОплатыОтПоставщика = "
	|ВЫБРАТЬ //// Возврат оплаты от поставщика (Дт 30 :: Кт 63)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПоступлениеАвансаОтКлиента // (Дт 30 :: Кт 681)
	ТекстПоступлениеАвансаОтКлиента = "
	|ВЫБРАТЬ //// Поступление аванса от клиента (Дт 30 :: Кт 681)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПоступлениеОплатыОтКлиента //  (Дт 30 :: Кт 36)
	ТекстПоступлениеОплатыОтКлиента = "
	|ВЫБРАТЬ //// Поступление оплаты от клиента (Дт 30 :: Кт 36)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область КонвертацияВалюты // (Дт 30 :: Кт 3333, 3342)
	ТекстКонвертацияВалюты = "
	|ВЫБРАТЬ //// Конвертация валюты (Дт 30 :: Кт 3333, 3342)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПоступлениеДСИзДругойКассы // (Дт 30 :: Кт 333, 334)
	ТекстПоступлениеДСИзДругойКассы = "
	|ВЫБРАТЬ //// Поступление ДС из другой кассы (Дт 30 :: Кт 333, 334)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ВнутренняяПередачаДС // (Дт 30 :: Кт 683)
	ТекстВнутренняяПередачаДС = "
	|ВЫБРАТЬ //// Внутренняя передача ДС (Дт 30 :: Кт 683)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПоступлениеАвансаОтДрОрганизации // (Дт 30 :: Кт 681)
	ТекстПоступлениеАвансаОтДрОрганизации = " 
	|ВЫБРАТЬ //// Поступление аванса от другой организации (Дт 30 :: Кт 681)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПоступлениеОплатыОтДрОрганизации // (Дт 30 :: Кт 36)
	ТекстПоступлениеОплатыОтДрОрганизации = "
	|ВЫБРАТЬ //// Поступление оплаты от другой организации (Дт 30 :: Кт 36)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ВозвратАвансаОтДрОрганизации // (Дт 30 :: Кт 371)
	ТекстВозвратАвансаОтДрОрганизации = "
	|ВЫБРАТЬ //// Возврат аванса от другой организации (Дт 30 :: Кт 371)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	...
	|	0 КАК СуммаВРДт,
	|	
	|	ЗНАЧЕНИЕ(Перечисление.ВидыСчетовРеглУчета.АвансыВыданные) ВидСчетаКт,
	|	ЕСТЬNULL(Расчеты.ЗаказПоставщику.ГруппаФинансовогоУчета, 
	|		ЗНАЧЕНИЕ(Справочник.ГруппыФинансовогоУчетаРасчетов.ПустаяСсылка)) КАК АналитикаУчетаКт,
	|	НЕОПРЕДЕЛЕНО КАК МестоУчетаКт,
	|
...
#Область ВозвратОплатыОтДрОрганизации // (Дт 30 :: Кт 63)
	ТекстВозвратОплатыОтДрОрганизации = "
	|ВЫБРАТЬ //// Возврат оплаты от другой организации (Дт 30 :: Кт 63)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ВозвратПредоставленногоЗайма // (Дт 30 :: Кт 377)
	ТекстВозвратПредоставленногоЗайма = "
	|ВЫБРАТЬ //// Возврат предоставленного займа (Дт 30 :: Кт 377)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПроцентыКомиссияПоПредоставленномуЗайму // (Дт 30 :: Кт 63)
	ТекстПроцентыКомиссияПоПредоставленномуЗайму = "
	|ВЫБРАТЬ //// Поступление начисленных процентов и комиссии по предоставленному займу (Дт 30 :: Кт 63)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПоступлениеЗалогаЗаПереданнуюТару // (Дт 30 :: Кт 36)
	ТекстПоступлениеЗалогаЗаПереданнуюТару = "
	|ВЫБРАТЬ //// Поступление залога за переданную тару (Дт 30 :: Кт 36)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПрочиеДоходы // (Дт 30 :: Кт 7X)
	ТекстПрочиеДоходы = "
...
#Область СторноПрочихРасходов // (Дт 9X :: Кт 30)
	ТекстСторноПрочихРасходов = "
	|ВЫБРАТЬ //// Прочие расходы (сторно) (Дт 9X :: Кт 30)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ПрочиеПоступления // (Дт 30 :: Кт XX)
	ТекстПрочиеПоступления = "
	|ВЫБРАТЬ //// Прочее поступление (Дт 30 :: Кт XX)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
Функция ТекстЗапросаТаблицаДвиженияДенежныеСредстваДоходыРасходы(Запрос, ТекстыЗапроса, Регистры)
	...
	|ГДЕ
	|	ДанныеДокумента.Ссылка = &Ссылка
	|	И &ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПрочееПоступлениеДенежныхСредств),
	|								ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПогашениеЗаймаСотрудником))
	|	И ТаблицаРасшифровкаПлатежа.СтатьяДоходов ССЫЛКА ПланВидовХарактеристик.СтатьиАктивовПассивов
	|
	|ОБЪЕДИНИТЬ ВСЕ
...
Функция СформироватьПечатнуюФормуКО1УКР(МассивОбъектов, ОбъектыПечати, КомплектыПечати, ПараметрыПечати)
	...
	Иначе
		...
		|	Хозрасчетный.СчетКт.Код  КАК КорСчетКод
		|ИЗ
