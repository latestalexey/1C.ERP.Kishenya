...
Функция ЗаполнитьЦеныПоСебестоимостиСервер()
	...
	Пока ПредварительныеДанные.Следующий() Цикл
		Если ПредварительныеДанные.Количество = 0 Тогда
			ТекстСообщения = НСтр("ru='Не было произведено ни одного расчета себестоимости товаров по организации ""%Организация%"".';uk='Не було вироблено жодного розрахунку собівартості товарів по організації ""%Организация%"".'");
