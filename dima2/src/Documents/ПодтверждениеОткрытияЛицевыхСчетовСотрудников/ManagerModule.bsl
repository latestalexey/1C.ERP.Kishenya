...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Подтверждение списка на открытие лицевых счетов';uk='Підтвердження списку на відкриття особових рахунків'");
	
	// Подтверждение списка на открытие лицевых счетов в Microsoft Word.
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор = "ПодтверждениеСпискаНаОткрытиеЛицевыхСчетов";
	КомандаПечати.Представление = НСтр("ru='Подтверждение списка на открытие лицевых счетов в Microsoft Word';uk='Підтвердження списку на відкриття особових рахунків в Microsoft Word'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПодтверждениеСпискаНаОткрытиеЛицевыхСчетов") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ПодтверждениеСпискаНаОткрытиеЛицевыхСчетов"
			, НСтр("ru='Подтверждение списка на открытие лицевых счетов';uk='Підтвердження списку на відкриття особових рахунків'"), ТабличныйДокумент);
	КонецЕсли;
...
Функция ПечатьПодтвержденияСпискаНаОткрытиеЛицевыхСчетов(МассивОбъектов, ОбъектыПечати, ДанныеДляПечати)
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ПодтверждениеОткрытияЛицевыхСчетовСотрудников_ПодтверждениеСпискаНаОткрытиеЛицевыхСчетов";
