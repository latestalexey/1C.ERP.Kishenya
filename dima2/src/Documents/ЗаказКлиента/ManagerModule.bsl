...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСоздатьНаОсновании) Экспорт
	...
	//++ НЕ УТ
	Документы.ВыпускПродукции.ДобавитьКомандуСоздатьНаОснованииЗаказаКлиента(КомандыСоздатьНаОсновании);
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Документы.ЗаказПереработчику.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
	//-- НЕ УТ
...
Функция ТекстЗапросаДляРасчетаСостоянийЗаказов() Экспорт
	...
	ТекстЗапроса ="
		...
		|	Документ.ЗаказКлиента КАК ДокументЗаказКлиента
		|ЛЕВОЕ СОЕДИНЕНИЕ
		|	РегистрНакопления.РасчетыСКлиентами.ОстаткиИОбороты(,,,,ЗаказКлиента В (&МассивЗаказов) И АналитикаУчетаПоПартнерам.Организация = ЗаказКлиента.Организация) КАК РасчетыСКлиентамиОстатки
		|ПО
...
Функция ЗаполнитьСерииПоНакладнымПроверитьДанныеОбновлены(Данные, МетаданныеИОтбор) Экспорт
...
Функция ПечатьДокументаДляЭДО(ДокументСсылка) Экспорт
	...
	Банк		= Шапка.БанковскийСчет.Банк;
	МФО	 		= Шапка.БанковскийСчет.Банк.Код;
