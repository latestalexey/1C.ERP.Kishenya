		...
		Если Параметры.Свойство("ЗначенияЗаполнения") И Параметры.ЗначенияЗаполнения.Свойство("Сотрудники") Тогда
			...
			Если МассивФизическихЛицДляЗаполнения.Количество() > 0 Тогда
				...
				ОбменСБанкамиПоЗарплатнымПроектам.СоздатьВТСостоянияОткрытияЛицевыхСчетовФизическихЛиц(
					Запрос.МенеджерВременныхТаблиц, Объект.Организация, Объект.ЗарплатныйПроект,
					Параметры.ЗначенияЗаполнения.ДатаПолученияДанных, Объект.Подразделение,
					МассивФизическихЛицДляЗаполнения, , Объект.Ссылка);
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	Оповестить("Запись_ЗаявкаНаОткрытиеЛицевыхСчетовСотрудников", Новый Структура("Ссылка", Объект.Ссылка), ЭтаФорма.ВладелецФормы);
КонецПроцедуры
...
Процедура ДокументыФизическихЛицВидДокументаПриИзменении(Элемент)
	...
	СотрудникиКлиентСервер.ОбработатьОтображениеСерияДокументаФизическогоЛица(ТекущиеДанные.ДокументВид, ТекущиеДанные.ДокументСерия, Элементы.ДокументыФизическихЛицСерия, ЭтаФорма);
	СотрудникиКлиентСервер.ОбработатьОтображениеНомерДокументаФизическогоЛица(ТекущиеДанные.ДокументВид, ТекущиеДанные.ДокументНомер, Элементы.ДокументыФизическихЛицНомер, ЭтаФорма);
...
Процедура ДокументыФизическихЛицВидДокументаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(ТекущиеДанные.ДокументВид) Тогда
		ТекущиеДанные.ДокументВид = ПредопределенноеЗначение("Справочник.ВидыДокументовФизическихЛиц.Паспорт");
	КонецЕсли;
...
Процедура ДокументыФизическихЛицСерияПриИзменении(Элемент)
	...
	СотрудникиКлиентСервер.ОбработатьОтображениеСерияДокументаФизическогоЛица(ТекущиеДанные.ДокументВид, ТекущиеДанные.ДокументСерия, Элемент, ЭтаФорма);
...
Процедура ДокументыФизическихЛицНомерПриИзменении(Элемент)
	...
	СотрудникиКлиентСервер.ОбработатьОтображениеНомерДокументаФизическогоЛица(ТекущиеДанные.ДокументВид, ТекущиеДанные.ДокументНомер, Элемент, ЭтаФорма);
...
&НаСервере
Процедура УстановитьОтметкуНезаполненногоОбязательныхПолей(ТекущиеДанные)
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаСчетДебета", "ОтметкаНезаполненного", Ложь);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаСчетДебета", "АвтоОтметкаНезаполненного", Ложь);
	
	ОтметкаНезаполненногоМиграционнойКарты = Не ПустаяСтрока(ТекущиеДанные.НомерМиграционнойКарты)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаНомерМиграционнойКарты", "ОтметкаНезаполненного", ОтметкаНезаполненногоМиграционнойКарты И ПустаяСтрока(ТекущиеДанные.НомерМиграционнойКарты));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаДатаНачалаПребыванияМиграционнойКарты", "ОтметкаНезаполненного", ОтметкаНезаполненногоМиграционнойКарты И Не ЗначениеЗаполнено(ТекущиеДанные.ДатаНачалаПребыванияМиграционнойКарты));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаДатаОкончанияПребыванияМиграционнойКарты", "ОтметкаНезаполненного", ОтметкаНезаполненногоМиграционнойКарты И Не ЗначениеЗаполнено(ТекущиеДанные.ДатаОкончанияПребыванияМиграционнойКарты));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаНомерМиграционнойКарты", "АвтоОтметкаНезаполненного", ОтметкаНезаполненногоМиграционнойКарты И ПустаяСтрока(ТекущиеДанные.НомерМиграционнойКарты));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаДатаНачалаПребыванияМиграционнойКарты", "АвтоОтметкаНезаполненного", ОтметкаНезаполненногоМиграционнойКарты И Не ЗначениеЗаполнено(ТекущиеДанные.ДатаНачалаПребыванияМиграционнойКарты));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаДатаОкончанияПребыванияМиграционнойКарты", "АвтоОтметкаНезаполненного", ОтметкаНезаполненногоМиграционнойКарты И Не ЗначениеЗаполнено(ТекущиеДанные.ДатаОкончанияПребыванияМиграционнойКарты));
	
	ОтметкаНезаполненногоМиграционногоДокумента = ЗначениеЗаполнено(ТекущиеДанные.ВидМиграционногоДокумента)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаВидМиграционногоДокумента", "ОтметкаНезаполненного", ОтметкаНезаполненногоМиграционногоДокумента И Не ЗначениеЗаполнено(ТекущиеДанные.ВидМиграционногоДокумента));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаНомерМиграционногоДокумента", "ОтметкаНезаполненного", ОтметкаНезаполненногоМиграционногоДокумента И ПустаяСтрока(ТекущиеДанные.НомерМиграционногоДокумента));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаДатаНачалаПребыванияМиграционногоДокумента", "ОтметкаНезаполненного", ОтметкаНезаполненногоМиграционногоДокумента И Не ЗначениеЗаполнено(ТекущиеДанные.ДатаНачалаПребыванияМиграционногоДокумента));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаДатаОкончанияПребыванияМиграционногоДокумента", "ОтметкаНезаполненного", ОтметкаНезаполненногоМиграционногоДокумента И Не ЗначениеЗаполнено(ТекущиеДанные.ДатаОкончанияПребыванияМиграционногоДокумента));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаВидМиграционногоДокумента", "АвтоОтметкаНезаполненного", ОтметкаНезаполненногоМиграционногоДокумента И Не ЗначениеЗаполнено(ТекущиеДанные.ВидМиграционногоДокумента));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаНомерМиграционногоДокумента", "АвтоОтметкаНезаполненного", ОтметкаНезаполненногоМиграционногоДокумента И ПустаяСтрока(ТекущиеДанные.НомерМиграционногоДокумента));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаДатаНачалаПребыванияМиграционногоДокумента", "АвтоОтметкаНезаполненного", ОтметкаНезаполненногоМиграционногоДокумента И Не ЗначениеЗаполнено(ТекущиеДанные.ДатаНачалаПребыванияМиграционногоДокумента));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛицевыеСчетаДатаОкончанияПребыванияМиграционногоДокумента", "АвтоОтметкаНезаполненного", ОтметкаНезаполненногоМиграционногоДокумента И Не ЗначениеЗаполнено(ТекущиеДанные.ДатаОкончанияПребыванияМиграционногоДокумента));
...
Процедура ЛицевыеСчетаУстановитьДоступность(ТекущиеДанные)
	...
	УстановитьОтметкуНезаполненногоОбязательныхПолей(ТекущиеДанные);
