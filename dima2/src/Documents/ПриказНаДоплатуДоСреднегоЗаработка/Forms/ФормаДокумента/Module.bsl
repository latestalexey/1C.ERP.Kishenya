...
Процедура ДанныеВРеквизиты()
	...
	ЗарплатаКадрыРасширенный.МногофункциональныеДокументыДобавитьЭлементыФормы(ЭтаФорма, НСтр("ru='Доплата утверждена';uk='Доплата затверджена'"), , "РазмерДоплатыУтвержден");
