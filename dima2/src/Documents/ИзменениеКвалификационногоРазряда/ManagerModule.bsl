...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Приказ о присвоении разряда';uk='Наказ про присвоєння розряду'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ПриказОПрисвоенииРазряда") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
						...
						НСтр("ru='Приказ о присвоении разряда';uk='Наказ про присвоєння розряду'"), 
...
Функция ПечатнаяФормаПриказаОПрисвоенииРазряда(МассивОбъектов, ОбъектыПечати)
	...
	ТабДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ПриказОПрисвоенииРазряда";
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл  
		...
		Параметры.Должность = СклонениеПредставленийОбъектов.ПросклонятьПредставление(Строка(Параметры.Должность), 3);
		...
		ОбластьПодвал.Параметры.ФИО = ФизическиеЛицаКлиентСервер.ФамилияИнициалы(ВыборкаПоДокументам.ФИОПолные);
