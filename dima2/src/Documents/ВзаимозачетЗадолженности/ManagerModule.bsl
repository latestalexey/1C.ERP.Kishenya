...
#Область Взаимозачет   // (Дт 3X, 6X :: Кт 3X, 6X)
	...
	|	ДвиженияКК.КорОбъектРасчетов.Подразделение КАК ПодразделениеДт,
...
Процедура СформироватьКлючиАналитикиПоДокументу(Запрос)
	...
	|	ЕСТЬNULL(ТаблицаОбъектовРасчетовПоДокументам.Организация, &Организация) КАК Организация,
