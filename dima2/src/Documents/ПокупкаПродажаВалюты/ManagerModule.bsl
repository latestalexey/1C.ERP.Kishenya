...
Функция ТекстЗапросаТаблицаПрочиеРасходы(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ВЫРАЗИТЬ(ДанныеДокумента.СуммаКомиссионные * &КоэффициентПересчетаВВалютуУпр КАК ЧИСЛО(15,2)) КАК СуммаБезНДС,
	|	&НалоговоеНазначениеОрганизации КАК НалоговоеНазначение, 
	|	ДанныеДокумента.СуммаКомиссионные КАК СуммаРеглБезНДС,
	|	0 КАК НДСРегл,
	|	ДанныеДокумента.СуммаКомиссионные КАК СуммаРегл
	|ИЗ
	|	Документ.ПокупкаПродажаВалюты КАК ДанныеДокумента
	|ГДЕ
	|	ДанныеДокумента.Ссылка = &Ссылка
