...
Функция ПолучитьДанныеДляПроведения()
	...
	ДополненныеДанныеДокумента = Документы.ИндексацияШтатногоРасписания.ДополненныеДанныеДокумента(ЭтотОбъект);
	...
	ДанныеДляПроведения.Вставить("БазовыеПериодыИндексации", ДополненныеДанныеДокумента.БазовыеПериодыИндексации);
