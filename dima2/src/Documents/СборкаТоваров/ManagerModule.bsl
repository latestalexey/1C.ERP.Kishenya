...
#Область ТекстСписаниеКомплектующихНаСборку // (Дт 231 :: Кт 281)
	ТекстСписаниеКомплектующихНаСборку = "
	|ВЫБРАТЬ //// Списание собственных комплектующих на сборку (Дт 231 :: Кт 281)
	|
	...
	|	0 КАК СуммаПРКт,
	|	0 КАК СуммаВРКт,
	|	ВЫБОР КОГДА Операция.ТипОперации = ЗНАЧЕНИЕ(Перечисление.ТипыОперацийЗаказаНаСборку.СборкаИзКомплектующих) ТОГДА
	|		""Списание собственных комплектующих на сборку""
	|	ИНАЧЕ
	|       ""Списание комплекта для разборки""
...
#Область ТекстСписаниеНаРасходыПродукцииДавальца // (Дт  :: Кт 023)
...
#Область ТекстСписаниеНаРасходыКомиссионныхКомплектующих // (Дт  :: Кт Кт 0241, 0241)
	ТекстСписаниеНаРасходыКомиссионныхКомплектующих = "
	|ВЫБРАТЬ //// Списание комиссионных товаров (Дт  :: Кт Кт 0221, 0241)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	...
	|		ТОГДА ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.ТоварыПринятыеНаКомиссию)
...
#Область ТекстОприходованиеКомплекта // (Дт 281 :: Кт 231)
	ТекстОприходованиеКомплекта = "
	|ВЫБРАТЬ //// Оприходование собранного комплекта (Дт 281 :: Кт 231) 
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	...
	|	0 КАК СуммаВРКт,
	|	ВЫБОР КОГДА Операция.ТипОперации = ЗНАЧЕНИЕ(Перечисление.ТипыОперацийЗаказаНаСборку.СборкаИзКомплектующих) ТОГДА
	|		""Оприходование собранного комплекта""
	|	ИНАЧЕ
	|       ""Оприходование комплектующей""
	|	КОНЕЦ КАК Содержание
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
