...
Процедура ЗаполнитьДопКолонкиВидовЗапасов() Экспорт
	...
	Для Каждого СтрокаТоваров Из ТаблицаТовары Цикл
		...
		Для Каждого СтрокаЗапасов Из ВидыЗапасов.НайтиСтроки(СтруктураПоиска) Цикл
			...
			НоваяСтрока.СуммаВзаиморасчетов		= ?(СтрокаЗапасов.Количество <> 0, Количество * СуммаВзаиморасчетовВСтроке		/ СтрокаЗапасов.Количество, 0);
			НоваяСтрока.СуммаНДСВзаиморасчетов	= ?(СтрокаЗапасов.Количество <> 0, Количество * СуммаНДСВзаиморасчетовВСтроке	/ СтрокаЗапасов.Количество, 0);
