...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимВыбора Тогда
		...
		Заголовок = НСтр("ru='Позиции заказов на производство плановой калькуляции';uk='Позиції замовлень на виробництво планової калькуляції'");
	...
	Иначе
		Если ОбъектКалькуляции = Перечисления.ОбъектыКалькуляции.Изделие Тогда
			...
			Заголовок = НСтр("ru='Изделия';uk='Вироби'");
			Для Каждого Строка Из ТаблицаОбъектов Цикл
		...
		Если ОбъектКалькуляции = Перечисления.ОбъектыКалькуляции.ЗаказНаПроизводство Тогда
			...
			Заголовок = НСтр("ru='Позиции заказов на производство';uk='Позиції замовлень на виробництво'");
			Для Каждого Строка Из ТаблицаОбъектов Цикл
				ЗаполнитьЗначенияСвойств(СписокЗаказовНаПроизводство.Добавить(), Строка);
			КонецЦикла;
