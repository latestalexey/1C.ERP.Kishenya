...
Процедура РассмотреноПриИзменении(Элемент)
	...
	Если Рассмотрено И ТребуетсяЗапросУведомленияОПрочтении Тогда
		...
		ПоказатьВопрос(ОбработчикОповещенияОЗакрытии,
		       НСтр("ru='Отправитель запросил уведомление о прочтении. Отправить?';uk='Відправник запросив сповіщення про прочитання. Відправити?'"),
		       РежимДиалогаВопрос.ДаНет,
		       ,
		       КодВозвратаДиалога.Да,
		       НСтр("ru='Запрос уведомления';uk='Запит повідомлення'"));
...
Процедура ИзменитьКодировку(Команда)
	...
	СписокКодировок.ПоказатьВыборЭлемента(ОбработчикОповещенияОЗакрытии,
	                                      НСтр("ru='Выберите кодировку';uk='Виберіть кодування'"), 
...
Процедура ЗаполнитьДополнительнуюИнформацию()
	...
	ДополнительнаяИнформацияОПисьме = НСтр("ru='Создано:';uk='Створено:'") + "   " + Объект.Дата 
	+ Символы.ПС + НСтр("ru='Получено';uk='Отримане'") + ":  " + Объект.ДатаПолучения 
	+ Символы.ПС + НСтр("ru='Важность';uk='Важливість'") + ":  " + Объект.Важность
	+ Символы.ПС + НСтр("ru='Кодировка';uk='Кодування'") + ": " + Объект.Кодировка;
