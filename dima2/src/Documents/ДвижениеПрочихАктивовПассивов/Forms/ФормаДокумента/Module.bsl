...
Процедура УправлениеЭлементамиФормы()
	...
	Если Объект.Источник = Объект.Получатель Тогда
		ПостфиксИсточника  = " " + ?(Объект.Увеличение, НСтр("ru='(Расход)';uk='(Витрата)'"), НСтр("ru='(Приход)';uk='(Прихід)'"));
		ПостфиксПолучателя = " " + ?(Объект.Увеличение, НСтр("ru='(Приход)';uk='(Прихід)'"), НСтр("ru='(Расход)';uk='(Витрата)'"));
	КонецЕсли;
