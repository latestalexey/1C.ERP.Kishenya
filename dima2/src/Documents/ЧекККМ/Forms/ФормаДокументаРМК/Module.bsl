...
&НаСервере
Процедура АнализВозможностиОплатыБонуснымиБаллами()
...
Процедура ЗаполнитьСлужебныеРеквизитыПоНоменклатуре()
	...
	НоменклатураСервер.ЗаполнитьСлужебныеРеквизитыПоНоменклатуреВКоллекции(
		Объект.Товары,
 			Новый Структура("ЗаполнитьПризнакХарактеристикиИспользуются, ЗаполнитьПризнакТипНоменклатуры, СтатьяДекларацииПоАкцизномуНалогу",
...
Процедура ОбработкаВыбораПодборНаСервере(ВыбранноеЗначение)
	...
	Для каждого СтрокаТовара Из ТаблицаТоваров Цикл
		...
		ТекущаяСтрока = Объект.Товары.Добавить();
		СписокСвойств = "НоменклатураНабора, ХарактеристикаНабора, Номенклатура, Характеристика, Упаковка, Цена, КоличествоУпаковок, ПроцентРучнойСкидки";
...
Процедура ОбновитьЗаголовокФормы()
	...
	Заголовок = СтрЗаменить(Заголовок, "%Продавец%", ?(ЗначениеЗаполнено(ТекущийПродавец),ТекущийПродавец, НСтр("ru='<Не выбран>';uk='<Не вибраний>'")));
...
Процедура НастроитьПраваДляПользователя(Пользователь)
	...
	Если КассирМожетБытьПродавцом И Не МенеджерТорговогоЗалаМожетБытьПродавцом Тогда
		Если Не ЗначениеЗаполнено(ТекущийПродавец) Тогда
