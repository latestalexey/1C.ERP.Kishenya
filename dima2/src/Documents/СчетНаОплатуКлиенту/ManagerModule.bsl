...
Функция ДанныеДляПечатныхФормСчетаНаОплатуИзвещения(ПараметрыПечати, МассивОбъектов)
	...
	|ГДЕ
	|	ЗаказДавальца.Ссылка В(ВЫБРАТЬ ТаблицаДокументов.ДокументОснование ИЗ ТаблицаДокументов) И ЗаказДавальца.СтавкаНДС <> ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НеНДС)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ 
	...
	|ГДЕ
	|	ОтчетДавальцу.Ссылка В(ВЫБРАТЬ ТаблицаДокументов.ДокументОснование ИЗ ТаблицаДокументов) И ОтчетДавальцу.СтавкаНДС <> ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НеНДС)
	|
	//-- НЕ УТКА
	|;
	|////////////////////////////////////////////////////////////////////////////////
