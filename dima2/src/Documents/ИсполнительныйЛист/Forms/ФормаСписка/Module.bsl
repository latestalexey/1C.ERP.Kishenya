...
&НаКлиенте
Процедура ОткрытьЖурналУчетаИсполнительныхДокументов(Команда)
	
	Уникальность = "Отчет.ЖурналУчетаИсполнительныхДокументов/КлючВарианта.ЖурналУчетаИсполнительныхДокументов";
	
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("КлючВарианта", "ЖурналУчетаИсполнительныхДокументов");
	...
	ОткрытьФорму("Отчет.ЖурналУчетаИсполнительныхДокументов.Форма", ПараметрыОткрытия, ЭтаФорма, Уникальность);
