...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Выполнение смежных этапов маршрутного листа №%1 от %2';uk='Виконання суміжних етапів маршрутного листа №%1 від %2'"),
						ПрефиксацияОбъектовКлиентСервер.ПолучитьНомерНаПечать(РеквизитыДокумента.Номер, Ложь, Истина),
		...
		Если ДанныеЭтапа.ЭтоПредыдущийЭтап Тогда
			...
			Для каждого ДанныеМЛ Из СписокМЛЭтапа Цикл
				...
				СтрокМЛ.Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
													...
													ПрефиксацияОбъектовКлиентСервер.ПолучитьНомерНаПечать(ДанныеМЛ.Номер, Ложь, Истина),
