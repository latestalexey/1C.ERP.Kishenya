...
Функция ДоступныеТипыАналитикБюджетирования(ДокументСсылка, ИмяТаблицы = "") Экспорт
	...
	Если ДокументСсылка <> Неопределено Тогда
		...
		|ИЗ
		|	Документ.ПланСборкиРазборки.ДополнительныеРеквизиты КАК ДополнительныеРеквизиты
		|ГДЕ
...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	//++ НЕ УТ
	|	ДанныеДокумента.Склад.Подразделение КАК Подразделение,
...
Функция ТекстЗапросаТаблицаОборотыБюджетов(Запрос, ТекстыЗапроса, Регистры)
	...
	|	&Дата КАК Период,
	|	&Статус КАК Статус,
	|	Товары.ДатаСборкиРазборки КАК ПериодПланирования,
	...
	|ИЗ
	|	Документ.ПланСборкиРазборки.Товары КАК Товары
	|	
	|ГДЕ
	...
	БюджетированиеСервер.УстановитьВЗапросеВыраженияЗаполненияАналитики(
		Запрос.Параметры.Ссылка, ТекстЗапроса, Запрос.Параметры.СтатьяБюджетов, Документы.ПланСборкиРазборки);
