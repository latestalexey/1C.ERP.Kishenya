...
#Область ТекстКорректировкиНДСПартий

ТекстКорректировкиНДСПартий = "
	|ВЫБРАТЬ //// Условная продажа (Дт 281 :: Кт 6435)
	|
	...
	|	КорректировкиНДСПартий.КорГруппаФинансовогоУчета КАК АналитикаУчетаДт,
	|	Операция.Склад КАК МестоУчетаДт,
	|
	|	ЗНАЧЕНИЕ(Справочник.Валюты.ПустаяСсылка) КАК ВалютаДт,
	|	Операция.Склад.Подразделение КАК ПодразделениеДт,
	|	КорректировкиНДСПартий.КорНаправлениеДеятельности КАК НаправлениеДеятельностиДт,
	|
	...
	|		Документ.КорректировкаНалоговогоНазначенияЗапасов КАК Операция
	|	ПО
