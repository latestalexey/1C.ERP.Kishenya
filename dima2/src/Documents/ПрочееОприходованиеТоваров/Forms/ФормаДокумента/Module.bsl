...
Процедура ПриОткрытии(Отказ)
	...
	ЭтоВозврватИзЭксплуатации = Ложь;
	...
	//++ НЕ УТКА
	МассивЭлементов.Добавить("ФормаРегистрБухгалтерииМеждународныйПроводкиДокументаОперативногоУчета");
	//-- НЕ УТКА
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементовФормы(Элементы, МассивЭлементов, "Видимость", (Не ЭтоВозврватИзЭксплуатации));
	//-- НЕ УТ
...
Процедура УстановитьУсловноеОформление()
	...
	//++ НЕ УТ
	#Область УсловноеОформлениеОперацииВозвратаИзЭксплуатации
