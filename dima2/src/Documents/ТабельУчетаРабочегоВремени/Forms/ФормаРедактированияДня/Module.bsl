...
Процедура ДанныеОВремениПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	Если НоваяСтрока Тогда
		...
		УстановитьТерриториюДляСтрокиПодробныхДанных(ДанныеТекущейСтроки);
		УстановитьУсловияТрудаДляСтрокиПодробныхДанных(ДанныеТекущейСтроки);
	КонецЕсли;	
КонецПроцедуры
...
Процедура УстановитьТерриториюВТаблицеПодробныхДанных()
	Для Каждого СтрокаТаблицы Из ДанныеОВремени Цикл
		 УстановитьТерриториюДляСтрокиПодробныхДанных(СтрокаТаблицы);			
	КонецЦикла;	
КонецПроцедуры	
...
Процедура УстановитьУсловияТрудаВТаблицеПодробныхДанных()
	Для Каждого СтрокаТаблицы Из ДанныеОВремени Цикл
		 УстановитьУсловияТрудаДляСтрокиПодробныхДанных(СтрокаТаблицы);			
	КонецЦикла;	
КонецПроцедуры	

&НаКлиенте
Процедура УстановитьТерриториюДляСтрокиПодробныхДанных(СтрокаТаблицы)
	Если Не РаботаВРазныхТерриториях Тогда
		СтрокаТаблицы.Территория = Территория;		
	КонецЕсли;		
КонецПроцедуры	

&НаКлиенте
Процедура УстановитьУсловияТрудаДляСтрокиПодробныхДанных(СтрокаТаблицы)
	Если Не РаботаВРазныхУсловиях Тогда
		СтрокаТаблицы.УсловияТруда = УсловияТруда;				
	КонецЕсли;	
КонецПроцедуры	
