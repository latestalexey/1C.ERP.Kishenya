...
Функция ДоступныеТипыАналитикБюджетирования(ДокументСсылка, ИмяТаблицы = "") Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПланПродаж.ВидПлана.ЗаполнятьСоглашение КАК ЗаполнятьСоглашение,
	|	ПланПродаж.ВидПлана.ЗаполнятьСоглашениеВТЧ КАК ЗаполнятьСоглашениеВТЧ,
	|	ПланПродаж.Соглашение,
	|	ПланПродаж.ЗаполнятьПланОплат,
	|	ПланПродаж.ВидПлана.ЗаполнятьПартнера КАК ЗаполнятьПартнера,
	|	ПланПродаж.ВидПлана.ЗаполнятьПартнераВТЧ КАК ЗаполнятьПартнераВТЧ
	|ИЗ
	...
	ВыборкаПлан = Результат[1].Выбрать();
	ВыборкаПлан.Следующий();
		
	ИспользуютсяДоговорыКонтрагентов = ВыборкаПлан.ЗаполнятьСоглашение И ЗначениеЗаполнено(ВыборкаПлан.Соглашение) 
			И ОбщегоНазначенияУТ.ЗначениеРеквизитаОбъектаТипаБулево(ВыборкаПлан.Соглашение, "ИспользуютсяДоговорыКонтрагентов")
			И ВыборкаПлан.ЗаполнятьПланОплат;
			
	Если ИспользоватьПартнеровИКонтрагентов Тогда
		
		Если ИспользуютсяДоговорыКонтрагентов Тогда
			ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Контрагенты"), ИмяТаблицы + ".Ссылка.Договор.Контрагент");
		Иначе
			
			Если ИмяТаблицы = "Товары" И (ВыборкаПлан.ЗаполнятьСоглашение ИЛИ ВыборкаПлан.ЗаполнятьСоглашениеВТЧ) Тогда
				ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Контрагенты"), "Товары.Соглашение.Контрагент");
			ИначеЕсли ВыборкаПлан.ЗаполнятьСоглашение Тогда
				ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Контрагенты"), ИмяТаблицы + ".Ссылка.Соглашение.Контрагент");
			КонецЕсли;
	...
	Если ИспользуютсяДоговорыКонтрагентов Тогда
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.СтатьиДвиженияДенежныхСредств"), ИмяТаблицы + ".Ссылка.Договор.СтатьяДвиженияДенежныхСредств");
	Иначе
		
		Если ИмяТаблицы = "Товары" И (ВыборкаПлан.ЗаполнятьСоглашение ИЛИ ВыборкаПлан.ЗаполнятьСоглашениеВТЧ) Тогда
			ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.СтатьиДвиженияДенежныхСредств"), "Товары.Соглашение.СтатьяДвиженияДенежныхСредств");
		ИначеЕсли ВыборкаПлан.ЗаполнятьСоглашение Тогда
			ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.СтатьиДвиженияДенежныхСредств"), ИмяТаблицы + ".Ссылка.Соглашение.СтатьяДвиженияДенежныхСредств");
		КонецЕсли;

	КонецЕсли; 
		
	ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.СтруктураПредприятия"), ИмяТаблицы + ".Ссылка.Подразделение");
	ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.ДоговорыКонтрагентов"), ИмяТаблицы + ".Ссылка.Договор");
	ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.ФорматыМагазинов"), ИмяТаблицы + ".Ссылка.ФорматМагазина");
	
	Если ИмяТаблицы = "Товары" Тогда
	
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Организации"), "Товары.Соглашение.Организация");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Партнеры"), "Товары.Партнер");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Склады"), "Товары.Склад");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Номенклатура"), "Товары.Номенклатура");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.ВидыНоменклатуры"), "Товары.Номенклатура.ВидНоменклатуры");
		ДоступныеТипыАналитик.Вставить(Тип("ПеречислениеСсылка.ТипыНоменклатуры"), "Товары.Номенклатура.ТипНоменклатуры");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Марки"), "Товары.Номенклатура.Марка");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Производители"), "Товары.Номенклатура.Производитель");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.СезонныеГруппы"), "Товары.Номенклатура.СезоннаяГруппа");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.ЦеновыеГруппы"), "Товары.Номенклатура.ЦеноваяГруппа");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.ТоварныеКатегории"), "Товары.Номенклатура.ТоварнаяКатегория");
	...
	Иначе 
		...
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Организации"), ИмяТаблицы + ".Ссылка.Соглашение.Организация");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Партнеры"), ИмяТаблицы + ".Ссылка.Партнер");
		ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Склады"), ИмяТаблицы + ".Ссылка.Склад");
...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	|		ИНАЧЕ ДанныеДокумента.СценарийБюджетирования.Валюта
	|	КОНЕЦ КАК Валюта,
	...
	|	ДанныеДокумента.СтатьяБюджетовОплат,
	|	ДанныеДокумента.ОтражаетсяВБюджетированииОплаты,
	|	ДанныеДокумента.СтатьяБюджетовОплатКредит,
	|	ДанныеДокумента.ОтражаетсяВБюджетированииОплатыКредит,
	//-- НЕ УТ
...
Функция ТекстЗапросаТаблицаОборотыБюджетов(Запрос, ТекстыЗапроса, Регистры)
	...
	Если НЕ ПроведениеСервер.ЕстьТаблицаЗапроса("ВтКонтрагентыПартнеров", ТекстыЗапроса) Тогда
		ТекстЗапросаВтКонтрагентыПартнеров(Запрос, ТекстыЗапроса);
	КонецЕсли;
	
	Если НЕ ПроведениеСервер.ЕстьТаблицаЗапроса("ВтПериодыПланирования", ТекстыЗапроса) Тогда
	...
	Если НЕ ПроведениеСервер.ЕстьТаблицаЗапроса("ВтПериодыКурсовВалюты", ТекстыЗапроса) Тогда
		ТекстЗапросаВтПериодыКурсовВалюты(Запрос, ТекстыЗапроса);
	КонецЕсли;
	
	Если НЕ ПроведениеСервер.ЕстьТаблицаЗапроса("ВтПрогнозныеКурсыВалюты", ТекстыЗапроса) Тогда
	...
	|	Товары.Соглашение.Организация КАК Организация,
	|	&Подразделение КАК Подразделение,
	...
	|	СУММА(Товары.Сумма * ЕСТЬNULL(КурсыВалютыДокумента.Курс, 1) / ЕСТЬNULL(КурсыВалютыРегл.Курс, 1)) КАК СуммаРегл,
	|	СУММА(Товары.Сумма * ЕСТЬNULL(КурсыВалютыДокумента.Курс, 1) / ЕСТЬNULL(КурсыВалютыУпр.Курс, 1)) КАК СуммаУпр
	|ИЗ
	...
	|	&СценарийБюджетирования КАК Сценарий,
	|	ПланОплат.Ссылка.Соглашение.Организация КАК Организация,
	|	&Подразделение КАК Подразделение,
	|	&СтатьяБюджетовОплат КАК СтатьяБюджетовОплат,
	|	
	|	//%АналитикаПланОплат1 КАК Аналитика1,
	|	//%АналитикаПланОплат2 КАК Аналитика2,
	|	//%АналитикаПланОплат3 КАК Аналитика3,
	|	//%АналитикаПланОплат4 КАК Аналитика4,
	|	//%АналитикаПланОплат5 КАК Аналитика5,
	|	//%АналитикаПланОплат6 КАК Аналитика6,
	|	
	|	СУММА(0),
	...
	|	//%АналитикаПланОплат5,
	|	//%АналитикаПланОплат6,
	|	ПланОплат.Ссылка.Соглашение.Организация,
	|	ПланОплат.ДатаПлатежа
	|	
	|ИМЕЮЩИЕ
	...
	|	&СценарийБюджетирования КАК Сценарий,
	|	ПланОплатКредит.Ссылка.Соглашение.Организация КАК Организация,
	|	&Подразделение КАК Подразделение,
	|	&СтатьяБюджетовОплатКредит КАК СтатьяБюджетовОплатКредит,
	|	
	|	//%АналитикаПланОплатКредит1 КАК Аналитика1,
	|	//%АналитикаПланОплатКредит2 КАК Аналитика2,
	|	//%АналитикаПланОплатКредит3 КАК Аналитика3,
	|	//%АналитикаПланОплатКредит4 КАК Аналитика4,
	|	//%АналитикаПланОплатКредит5 КАК Аналитика5,
	|	//%АналитикаПланОплатКредит6 КАК Аналитика6,
	|	
	|	СУММА(0),
	...
	|
	|СГРУППИРОВАТЬ ПО
	|	//%АналитикаПланОплатКредит1,
	|	//%АналитикаПланОплатКредит2,
	|	//%АналитикаПланОплатКредит3,
	|	//%АналитикаПланОплатКредит4,
	|	//%АналитикаПланОплатКредит5,
	|	//%АналитикаПланОплатКредит6,
	|	ПланОплатКредит.Ссылка.Соглашение.Организация,
	|	ПланОплатКредит.ДатаПлатежа
	|	
	|ИМЕЮЩИЕ
	...
	БюджетированиеСервер.УстановитьВЗапросеВыраженияЗаполненияАналитики(
		Запрос.Параметры.Ссылка, ТекстЗапроса, Запрос.Параметры.СтатьяБюджетов, Документы.ПланПродаж, "Товары");
		
	БюджетированиеСервер.УстановитьВЗапросеВыраженияЗаполненияАналитики(
		Запрос.Параметры.Ссылка, ТекстЗапроса, Запрос.Параметры.СтатьяБюджетовОплат, Документы.ПланПродаж, "ПланОплат");
	
	БюджетированиеСервер.УстановитьВЗапросеВыраженияЗаполненияАналитики(
		Запрос.Параметры.Ссылка, ТекстЗапроса, Запрос.Параметры.СтатьяБюджетовОплатКредит, Документы.ПланПродаж, "ПланОплатКредит");
...
Функция ТекстЗапросаВтКонтрагентыПартнеров(Запрос, ТекстыЗапроса)
	...
	|ВЫБРАТЬ
	|	ПланПродаж.Партнер,
	|	МАКСИМУМ(Контрагенты.Ссылка)
	|ИЗ
	|	Документ.ПланПродаж КАК ПланПродаж,
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Контрагенты КАК Контрагенты
	|		ПО ПланПродаж.Партнер = Контрагенты.Партнер
	|ГДЕ
	|	ПланПродаж.Ссылка = &Ссылка
	|
	|СГРУППИРОВАТЬ ПО
...
Процедура УстановитьПараметрыЗапросаКурсыСценария(Запрос)
	...
	КурсыСценария = Справочники.Сценарии.ТаблицаКурсовСценария(
		Запрос.Параметры.Сценарий, , Запрос.Параметры.НачалоПериода, Запрос.Параметры.ОкончаниеПериода);
