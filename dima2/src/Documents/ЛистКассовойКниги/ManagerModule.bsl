...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Титульный лист журнала регистрации приходных и расходных ордеров (КО-3)';uk='Титульний аркуш журналу реєстрації прибуткових і видаткових ордерів (КО-3)'");
	КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
	...
	КомандаПечати.Представление = НСтр("ru='Титульный лист журнала регистрации приходных и расходных ордеров (КО-3а)';uk='Титульний аркуш журналу реєстрації прибуткових і видаткових ордерів (КО-3а)'");
	КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ТитулЖурналРегистрацииПриходныхИРасходныхОрдеров") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru='Титульный лист журнала регистрации приходных и расходных ордеров (КО-3)';uk='Титульний аркуш журналу реєстрації прибуткових і видаткових ордерів (КО-3)'"),
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ТитулЖурналРегистрацииПриходныхИРасходныхОрдеров3а") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru='Титульный лист журнала регистрации приходных и расходных ордеров (КО-3а)';uk='Титульний аркуш журналу реєстрації прибуткових і видаткових ордерів (КО-3а)'"),
