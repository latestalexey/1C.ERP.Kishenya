...
Функция ДоступныеТипыАналитикБюджетирования(ДокументСсылка, ИмяТаблицы = "") Экспорт
	...
	Если ДокументСсылка <> Неопределено Тогда
		...
		|ИЗ
		|	Документ.ПланПродажПоКатегориям.ДополнительныеРеквизиты КАК ДополнительныеРеквизиты
		|ГДЕ
	...
	ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.СтруктураПредприятия"), "ТоварныеКатегории.Ссылка.Подразделение");
	ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.Склады"), "ТоварныеКатегории.Склад");
	ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.ВидыНоменклатуры"), "ТоварныеКатегории.ТоварнаяКатегория.Владелец");
	ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.ФорматыМагазинов"), "ТоварныеКатегории.Ссылка.ФорматМагазина");
	ДоступныеТипыАналитик.Вставить(Тип("СправочникСсылка.РейтингиПродажНоменклатуры"), "ТоварныеКатегории.РейтингПродаж");
...
Функция ТекстЗапросаТаблицаОборотыБюджетов(Запрос, ТекстыЗапроса, Регистры)
	...
	|	&Дата КАК Период,
	|	&Статус КАК Статус,
	|	ТоварныеКатегории.ДатаОтгрузки КАК ПериодПланирования,
	...
	|ИЗ
	|	Документ.ПланПродажПоКатегориям.ТоварныеКатегории КАК ТоварныеКатегории
	|	
	|ГДЕ
	...
	БюджетированиеСервер.УстановитьВЗапросеВыраженияЗаполненияАналитики(
		...
		ТекстЗапроса,
		Запрос.Параметры.СтатьяБюджетов, Документы.ПланПродажПоКатегориям);
