...
Функция МоделиЗаполненыКорректно()
	...
	Для каждого Строка Из МоделиПланирования Цикл
		Если НЕ ЗначениеЗаполнено(Строка.МодельПланирования) Тогда
			...
			ИмяПоля = НСтр("ru='Модель планирования';uk='Модель планування'");
			...
			ОбщегоНазначенияКлиентСервер.ДобавитьОшибкуПользователю(Ошибки, Поле, ТекстОшибки,, НомерСтроки);
		...
		ИначеЕсли НЕ ВыбранныеМодели.Найти(Строка.МодельПланирования) = Неопределено Тогда
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Модель ""%1"" выбрана более одного раза.';uk='Модель ""%1"" вибрано більше одного разу.'"), Строка.МодельПланирования);
