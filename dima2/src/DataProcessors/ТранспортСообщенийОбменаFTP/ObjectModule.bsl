...
Процедура ИнициализацияСообщенийОшибок()
	...
	// Общие коды ошибок
	СообщенияОшибок.Вставить(001, НСтр("ru='В каталоге обмена информацией не был обнаружен файл сообщения с данными.';uk='У каталозі обміну інформацією не був виявлений файл повідомлення з даними.'"));
	...
	СообщенияОшибок.Вставить(101, НСтр("ru='Не задан путь на сервере.';uk='Не заданий шлях на сервері.'"));
	СообщенияОшибок.Вставить(102, НСтр("ru='Ошибка инициализации подключения к FTP-серверу.';uk='Помилка ініціалізації підключення до Ftp-серверу.'"));
	СообщенияОшибок.Вставить(103, НСтр("ru='Ошибка подключения к FTP-серверу, проверьте правильность задания пути и права доступа к ресурсу.';uk='Помилка підключення до Ftp-серверу, перевірте правильність завдання шляхи й права доступу до ресурсу.'"));
	СообщенияОшибок.Вставить(104, НСтр("ru='Ошибка при поиске файлов на FTP-сервере.';uk='Помилка при пошуку файлів на Ftp-сервері.'"));
	СообщенияОшибок.Вставить(105, НСтр("ru='Ошибка при получении файла с FTP-сервера.';uk='Помилка при одержанні файлу з Ftp-сервера.'"));
	СообщенияОшибок.Вставить(106, НСтр("ru='Ошибка удаления файла на FTP-сервере, проверьте права доступа к ресурсу.';uk='Помилка вилучення файлу на FTP-сервері, перевірте права доступу до ресурсу.'"));
...
Функция ВыполнитьУдалениеФайлаНаFTPСервере(Знач ИмяФайла, ПроверкаПодключения = Ложь)
	...
	Исключение
		...
		Если ПроверкаПодключения Тогда
            ...
            |;uk='Не вдалося перевірити підключення за допомогою тестового файлу ""%1"".
            |Можливо, заданий каталог не існує або не доступний.
            |Рекомендується також звернутися до документації по FTP-сервері для настройки підтримки імен файлів з кирилицею.'");
