...
Процедура КомандаПечать(Команда)
	...
	Иначе
		...
		Если НЕ ЗначениеЗаполнено(ВыбранныеДаты) Тогда
			ТекстСообщения = НСтр("ru='Для печати сменно-суточных заданий необходимо выбрать даты заданий.';uk='Для друку змінно-добових завдань необхідно вибрати дати завдань.'");
		...
		Если НЕ ЗначениеЗаполнено(ВыбранныеБригады) Тогда
			ТекстСообщения = НСтр("ru='Для печати сменно-суточных заданий необходимо выбрать бригады.';uk='Для друку змінно-добових завдань необхідно вибрати бригади.'");
