...
Процедура ПроверитьКратностьКоличестваВШтуках(Отказ)
	...
	ШаблонОшибкаПродукция = НСтр("ru='Количество продукции (%1 %2) в строке %3 должно быть кратно количеству этапов, т.к. учет ведется в штучной единице измерения.';uk='Кількість продукції (%1 %2) в рядку %3 має бути кратна кількості етапів, т. к. облік ведеться в штучній одиниці вимірювання.'");
	ШаблонОшибкаОтход = НСтр("ru='Количество побочного и промежуточного выпуска (%1 %2) в строке %3 должно быть кратно количеству этапов, т.к. учет ведется в штучной единице измерения.';uk='Кількість побічного та проміжного випуску (%1 %2) в рядку %3 має бути кратна кількості етапів, т. к. облік ведеться в штучній одиниці вимірювання.'");
