...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Состав среднего заработка (расчет пособий по правилам до 1 января 2011 года)';uk='Склад середнього заробітку (розрахунок допомог з правилами до 1 січня 2011 року)'");
	...
	КомандаПечати.Представление = НСтр("ru='Расчетная база ПФР, ФСС, ФОМС';uk='Розрахункова база ПФР, ФСС, ФОМС'");
	...
	КомандаПечати.Представление = НСтр("ru='Статистическая отчетность';uk='Статистична звітність'");
...
Функция ПечатнаяФормаБазаСреднегоЗаработкаФСС(Макет, ЗаголовокСписка, ОбъектыПечати)
	...
	ОбластьЗаголовок.Параметры.ЗаголовокСписка = НСтр("ru='Состав среднего заработка (расчет пособий по правилам до 1 января 2011 года)';uk='Склад середнього заробітку (розрахунок допомог з правилами до 1 січня 2011 року)'");
	ТабДокумент.Вывести(ОбластьЗаголовок);
...
Функция ПечатнаяФормаБазаСтраховыхВзносов(Макет,ЗаголовокСписка, ОбъектыПечати)
	...
	ОбластьЗаголовок.Параметры.ЗаголовокСписка = НСтр("ru='Расчетная база ПФР, ФСС, ФОМС';uk='Розрахункова база ПФР, ФСС, ФОМС'");
	ТабДокумент.Вывести(ОбластьЗаголовок);
...
Функция ПечатнаяФормаСтатистическаяОтчетность(Макет, ЗаголовокСписка, ОбъектыПечати)
	...
	ОбластьЗаголовок.Параметры.ЗаголовокСписка = НСтр("ru='Статистическая отчетность';uk='Статистична звітність'");
	ТабДокумент.Вывести(ОбластьЗаголовок);
