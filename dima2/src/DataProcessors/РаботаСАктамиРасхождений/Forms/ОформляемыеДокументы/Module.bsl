...
Функция ТекстШапки(ТипДокумента, Описание , ХозяйственнаяОперация = Неопределено)
	...
	ИначеЕсли ТипДокумента = "ЗаказКлиента" Тогда
		ТекстШапки = НСтр("ru='Отменить строки документов ""Заказ клиента"" по недопоставленным товарам';uk='Скасувати рядка документів ""Замовлення клієнта"" по недопоставлених товарів'");
