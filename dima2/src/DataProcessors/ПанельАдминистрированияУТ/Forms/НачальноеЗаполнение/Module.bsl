...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаОбработкаЗагрузкаДанныхИзУТ23Открыть.Видимость             = Истина;
//	Элементы.ГруппаОбработкаЗагрузкаДанныхИзУТ23Открыть.Видимость             = УправлениеТорговлей И ЛокальныйРежим;
	...
	Элементы.ГруппаОбработкаПомощникПереходаСУправлениеПроизводственнымПредприятиемОткрыть.Видимость = НЕ УправлениеТорговлей И ЛокальныйРежим;;
