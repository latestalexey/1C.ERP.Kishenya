...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "" Тогда
		...
		ЗапрещеноОтключатьОбособление = Константы.ИспользоватьОбособленноеОбеспечениеЗаказов.Получить()
									  И Константы.ИспользоватьПроизводствоИзДавальческогоСырья.Получить();
		//-- НЕ УТКА
...
//++ НЕ УТКА
	ПодстановкаСпособы = НСтр("ru='покупка, перемещение, сборка, производство';uk='купівля, переміщення, збирання, виробництво'");
//-- НЕ УТКА
