...
Процедура СоздатьЭлементСправочника(ТекущийРодитель, Адрес, Секция, Линия, Стеллаж, Ярус, Позиция)
	...
	ИначеЕсли Объект.ОбновлятьСуществующие Тогда
		...
		Если СправочникОбъект.ЭтоГруппа Тогда
			ТекстИнформацииОбОшибке = НСтр("ru='Не возможно создать ячейку с адресом %Ячейка%, т.к. уже существует группа ячеек с таким адресом.';uk='Не можливо створити комірку з адресою %Ячейка%, т. к. вже існує група комірок з такою адресою.'");
