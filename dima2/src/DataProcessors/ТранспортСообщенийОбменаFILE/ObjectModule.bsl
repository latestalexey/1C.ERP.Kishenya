...
Функция ПолучитьСообщениеОбмена()
	...
	Если ТаблицаФайловСообщенийОбмена.Количество() = 0 Тогда
		...
		СтрокаСообщения = НСтр("ru='Каталог обмена информацией: ""%1""';uk='Каталог обміну інформацією: ""%1""'");
...
Функция ВыполнитьКопированиеФайла(Знач ИмяФайлаИсточника, Знач ИмяФайлаПриемника)
	...
	Исключение
		...
		СтрокаСообщения = НСтр("ru='Ошибка при копировании файла из %1 в %2. Описание ошибки: %3';uk='Помилка при копіюванні файлу з %1 в %2. Опис помилки: %3'");
...
Процедура ИнициализацияСообщенийОшибок()
	...
	СообщенияОшибок.Вставить(1, НСтр("ru='Ошибка подключения: Не указан каталог обмена информацией.';uk='Помилка підключення: Не зазначений каталог обміну інформацією.'"));
	СообщенияОшибок.Вставить(2, НСтр("ru='Ошибка подключения: Каталог обмена информацией не существует.';uk='Помилка підключення: Каталог обміну інформацією не існує.'"));
	
	СообщенияОшибок.Вставить(3, НСтр("ru='В каталоге обмена информацией не был обнаружен файл сообщения с данными.';uk='У каталозі обміну інформацією не був виявлений файл повідомлення з даними.'"));
	СообщенияОшибок.Вставить(4, НСтр("ru='Ошибка при распаковке сжатого файла сообщения.';uk='Помилка при розпакуванні стислого файлу повідомлення.'"));
	СообщенияОшибок.Вставить(5, НСтр("ru='Ошибка при сжатии файла сообщения обмена.';uk='Помилка при стиску файлу повідомлення обміну.'"));
	СообщенияОшибок.Вставить(6, НСтр("ru='Ошибка при создании временного каталога';uk='Помилка при створенні тимчасового каталогу'"));
	СообщенияОшибок.Вставить(7, НСтр("ru='Архив не содержит файл сообщения обмена';uk='Архів не містить файл повідомлення обміну'"));
	
	СообщенияОшибок.Вставить(8, НСтр("ru='Ошибка записи файла в каталог обмена информацией. Проверьте права пользователя на доступ к каталогу.';uk='Помилка запису файлу в каталог обміну інформацією. Перевірте права користувача на доступ до каталогу.'"));
	СообщенияОшибок.Вставить(9, НСтр("ru='Ошибка удаления файла из каталога обмена информацией. Проверьте права пользователя на доступ к каталогу.';uk='Помилка вилучення файлу з каталогу обміну інформацією. Перевірте права користувача на доступ до каталогу.'"));
