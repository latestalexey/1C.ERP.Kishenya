...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТолькоОбновлениеПараметровРаботыПрограммы Тогда
		Заголовок = НСтр("ru='Обновление параметров работы программы';uk='Оновлення параметрів роботи програми'");
	...
	ИначеЕсли РежимОбновленияДанных = "НачальноеЗаполнение" Тогда
		Заголовок = НСтр("ru='Начальное заполнение данных';uk='Початкове заповнення даних'");
	...
	ИначеЕсли РежимОбновленияДанных = "ПереходСДругойПрограммы" Тогда
		Заголовок = НСтр("ru='Переход с другой программы';uk='Перехід з іншої програми'");
	...
	Иначе
		Заголовок = НСтр("ru='Обновление версии программы';uk='Оновлення версії програми'");
...
Функция ЗагрузитьОбновитьПараметрыРаботыПрограммыВФоне()
	...
	Попытка
		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыВыполнения,
			НСтр("ru='Фоновое обновление параметров работы программы';uk='Фонове оновлення параметрів роботи програми'"));
		...
		Иначе
			КраткоеСообщениеОбОшибке =
				НСтр("ru='Ошибка получения результата от фонового задания
                           ...
                           |;uk='Помилка одержання результату від фонового завдання
                           |при оновленні параметрів роботи програми.'");
