...
Функция РезультатСопоставленияОбъектов(Параметры)
	...
	Если Параметры.РеквизитыФормы.ТолькоПрименитьТаблицуНеутвержденныхЗаписей Тогда
		...
		Если Отказ Тогда
			ВызватьИсключение НСтр("ru='Возникли ошибки в процессе сопоставления объектов.';uk='Виникли помилки в процесі зіставлення об''єктів.'");
		КонецЕсли;
...
Функция РезультатАвтоматическогоСопоставленияОбъектов(Параметры)
	...
	Если Отказ Тогда
		ВызватьИсключение НСтр("ru='Возникли ошибки в процессе автоматического сопоставления объектов.';uk='Виникли помилки в процесі автоматичного зіставлення об''єктів.'");
	КонецЕсли;
