...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("ИмяФайлаСообщенияОбмена") Тогда
		...
		НСтрока = НСтр("ru='Форма не может быть открыта интерактивно.';uk='Форма не може бути відкрита інтерактивно.'");
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если  Объект.ТаблицаАвтоматическиСопоставленныхОбъектов.Количество() > 0
		...
		ПоказатьПредупреждение(, НСтр("ru='Форма содержит данные автоматического сопоставления. Действие отменено.';uk='Форма містить дані автоматичного зіставлення. Дія скасована.'"));
...
Процедура ВыполнитьСопоставлениеОбъектов(Отказ)
	...
	Попытка
		...
		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыМетода,
			НСтр("ru='Автоматическое сопоставление объектов';uk='Автоматичне зіставлення об''єктів'"));
	...
	Исключение
		Отказ = Истина;
		ЗаписьЖурналаРегистрации(НСтр("ru='Помощник сопоставления объектов.Автоматическое сопоставление';uk='Помічник зіставлення об''єктів.Автоматичне зіставлення'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
