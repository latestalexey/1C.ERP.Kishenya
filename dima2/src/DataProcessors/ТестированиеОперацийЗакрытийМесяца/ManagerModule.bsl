...
Функция КонтрольныеРегистры() Экспорт
	...
	//++ НЕ УТ
	РегистрыКонтроля.Добавить("РегистрНакопления.ПартииНезавершенногоПроизводства");
	РегистрыКонтроля.Добавить("РегистрНакопления.ТрудозатратыНезавершенногоПроизводства");
	РегистрыКонтроля.Добавить("РегистрНакопления.ПрочиеРасходыНезавершенногоПроизводства");
	РегистрыКонтроля.Добавить("РегистрНакопления.МатериалыИРаботыВПроизводстве");
	//-- НЕ УТ
