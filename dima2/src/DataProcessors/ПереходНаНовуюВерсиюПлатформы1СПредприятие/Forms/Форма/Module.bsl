	...
	Элементы.ДекорацияНаписатьВТехПоддержку.Заголовок =
		ИнтернетПоддержкаПользователейКлиентСервер.ФорматированныйЗаголовок(
			ИнтернетПоддержкаПользователейКлиентСервер.ПодставитьДомен(
				НСтр("ru='<body>При возникновении проблем напишите в <a href=""mailto:webits-info@1c.ua"">техподдержку</a>.</body>';uk='<body>При виникненні проблем напишіть у <a href=""mailto:webits-info@1c.ua"">техпідтримку</a>.</body>'")));
	...
	Если ВРег(Лев(Сообщение, 6)) <> "<BODY>" Тогда
		...
		ПредставлениеHTML =
			ИнтернетПоддержкаПользователейКлиентСервер.ПодставитьДомен(
				...
				+ "<br /><br />" + НСтр("ru='При возникновении проблем напишите в <a href=""mailto:webits-info@1c.ua"">техподдержку</a>.';uk='При виникненні проблем напишіть у <a href=""mailto:webits-info@1c.ua"">техпідтримку</a>.'")
				+ "</body>");
