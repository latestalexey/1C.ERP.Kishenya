...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		ПоказатьВопрос(
			...
			НСтр("ru='Данные были изменены. Продолжить?';uk='Дані були змінені. Продовжити?'"),
...
&НаКлиенте
Процедура ПолучитьСостояниеЗаказов() Экспорт
...
Процедура УстановитьЗаголовок(ОбновитьЗаголовок = Истина, Знач ДанныеСтрокиЗаказа = Неопределено)
	...
	ТекстЗаголовок = НСтр("ru='Сокращение производства по заказу %1';uk='Скорочення виробництва по замовленню %1'");
	...
	Если ОбновитьЗаголовок И ПолучитьДанныеПоПродукции().ГрафикРассчитан = Ложь Тогда 
		...
		ТекстДополнение = ТекстДополнение + " " + НСтр("ru='невозможно';uk='неможливо'");
...
Процедура СократитьПроизводство(ВыбраннаяСтрока)
	...
	ИначеЕсли ВыбраннаяСтрока.КоличествоПоЗаказу = 0
		...
		ПоказатьПредупреждение(, НСтр("ru='Сократить производство на данном этапе невозможно.';uk='Скоротити виробництво на даному етапі неможливо.'"));
		Возврат;
