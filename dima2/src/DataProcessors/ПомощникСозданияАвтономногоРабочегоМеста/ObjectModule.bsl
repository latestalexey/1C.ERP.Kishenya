...
Функция СформироватьНаименованиеПриложенияВСервисе()
	...
	Результат = СтрЗаменить(Результат, "[Пояснение]", НСтр("ru='приложение в Интернете';uk='додаток в Інтернеті'"));
...
Функция ЗаголовокСистемы()
	...
	Возврат ?(ПустаяСтрока(Результат), НСтр("ru='Автономное рабочее место';uk='Автономне робоче місце'"), Результат);
КонецФункции
