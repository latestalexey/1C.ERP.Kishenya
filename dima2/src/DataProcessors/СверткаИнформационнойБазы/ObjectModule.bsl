...
КурсыВалют = Новый Соответствие;
Комментарий_УдалитьПриСверткеБазы = НСтр("ru='[Удалить при свертке базы]';uk='[Видалити підчас згортки бази]'");
Комментарий_НеУдалятьПриСверткеБазы = НСтр("ru='[Не удалять при свертке базы]';uk='[Не видаляти підчас згортки бази]'");
