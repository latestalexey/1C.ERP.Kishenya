...
Процедура ВыполнитьABCXYZКлассификациюЧастоИспользуемыеВозможности(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполняется ABC/XYZ классификация...';uk='Виконується ABC/XYZ класифікація...'"), БиблиотекаКартинок.Информация32);
	
	ВыполнитьABCXYZКлассификациюНаСервере();
	
	ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполнена ABC/XYZ классификация!';uk='Виконана ABC/XYZ класифікація!'"), БиблиотекаКартинок.Информация32);
...
Процедура ВыполнитьABCКлассификациюПолныеВозможности(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполняется ABC классификация...';uk='Виконується ABC класифікація...'"), БиблиотекаКартинок.Информация32);
	
	ВыполнитьABCКлассификациюНаСервере();
	
	ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполнена ABC классификация!';uk='Виконана ABC класифікація!'"), БиблиотекаКартинок.Информация32);
...
Процедура ВыполнитьXYZКлассификациюПолныеВозможности(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполняется XYZ классификация...';uk='Виконується XYZ класифікація...'"), БиблиотекаКартинок.Информация32);
	
	ВыполнитьXYZКлассификациюНаСервере();
	
	ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиетнов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполнена XYZ классификация!';uk='Виконана XYZ класифікація!'"), БиблиотекаКартинок.Информация32);
...
Процедура ОчиститьABCКлассификациюПолныеВозможности(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("ОчиститьABCКлассификациюПолныеВозможностиЗавершение", ЭтотОбъект), НСтр("ru='Вся информация об ABC классификации клиентов будет очищена. Продолжить?';uk='Вся інформація про ABC класифікації клієнтів буде очищена. Продовжити?'"), РежимДиалогаВопрос.ОКОтмена);
...
Процедура ОчиститьABCКлассификациюПолныеВозможностиЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
    ...
    Если КодВозврата = КодВозвратаДиалога.ОК Тогда
        ...
        ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполняется очистка ABC классификации...';uk='Виконується очищення ABC класифікації...'"), БиблиотекаКартинок.Информация32);
        
        ОчиститьABCКлассификациюНаСервере();
        
        ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполнена очистка ABC классификации!';uk='Виконане очищення ABC класифікації!'"), БиблиотекаКартинок.Информация32);
...
Процедура ОчиститьXYZКлассификациюПолныеВозможности(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("ОчиститьXYZКлассификациюПолныеВозможностиЗавершение", ЭтотОбъект), НСтр("ru='Вся информация об XYZ классификации клиентов будет очищена. Продолжить?';uk='Вся інформація про XYZ класифікації клієнтів буде очищена. Продовжити?'"), РежимДиалогаВопрос.ОКОтмена);
...
Процедура ОчиститьXYZКлассификациюПолныеВозможностиЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
    ...
    Если КодВозврата = КодВозвратаДиалога.ОК Тогда
        ...
        ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполняется очистка XYZ классификации...';uk='Виконується очищення XYZ класифікації...'"), БиблиотекаКартинок.Информация32);
        
        ОчиститьXYZКлассификациюНаСервере();
        
        ПоказатьОповещениеПользователя(НСтр("ru='Классификация клиентов';uk='Класифікація клієнтів'"),, НСтр("ru='Выполнена очистка XYZ классификации!';uk='Виконане очищення XYZ класифікації!'"), БиблиотекаКартинок.Информация32);
...
Процедура ОбновитьОтображениеФормы()
	...
	Если ПолныеВозможности Тогда
		...
		Заголовок = НСтр("ru='Классификация клиентов - полные возможности';uk='Класифікація клієнтів - повні можливості'");
	...
	Иначе
		...
		// Изменение заголовка формы и заголовка декорации
		Заголовок = НСтр("ru='Классификация клиентов - часто используемые возможности';uk='Класифікація клієнтів - часто використовувані можливості'");
...
Процедура ВыполнитьABCКлассификациюНаСервере()
	...
	Пока ДатаКлассификации <= МаксимальнаяДатаКлассификации Цикл
		...
		Справочники.Партнеры.ВыполнитьABCКлассификацию(ДатаКлассификации);
...
Процедура ВыполнитьXYZКлассификациюНаСервере()
	...
	Пока ДатаКлассификации <= МаксимальнаяДатаКлассификации Цикл
		...
		Справочники.Партнеры.ВыполнитьXYZКлассификацию(ДатаКлассификации);
