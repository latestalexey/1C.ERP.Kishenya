...
Функция СформироватьСписокТекущихДелВФоне()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Обновление списка текущих дел';uk='Оновлення список поточних справ'");
...
Процедура СоздатьЗаголовок(Дело, Группа, РазделСвернут)
	...
	Элемент.Подсказка = НСтр("ru='Развернуть/свернуть раздел';uk='Розгорнути/згорнути розділ'");
