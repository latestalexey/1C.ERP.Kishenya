...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Пользователь <> Неопределено Тогда
		...
		Заголовок = НСтр("ru='Настройки пользователя';uk='Настройки користувача'");
...
Процедура ПользовательСсылкаПриИзменении(Элемент)
	...
	Если РезультатПолученияНастроек() = "НетПользователяИБ" Тогда
		ТекстСообщения = НСтр("ru='У выбранного пользователя ""%1"" не указан
            ...
            |;uk='У вибраного користувача ""%1"" не вказаний
            |користувач інформаційної бази, переглянути його настройки неможливо.
            |Вирішити проблему можна в картці даного користувача.'");
...
Процедура НастройкиПередУдалением(Элемент, Отказ)
	...
	Отказ = Истина;
	ТекстВопроса = НСтр("ru='Очистить выбранные настройки?';uk='Очистити вибрані настройки?'");
...
Процедура СкопироватьВсеНастройки(Команда)
	...
	КопируемыеНастройки.Добавить("НастройкиОтчетов", НСтр("ru='Настройки отчетов';uk='Настройки звітів'"));
	КопируемыеНастройки.Добавить("НастройкиВнешнегоВида", НСтр("ru='Настройки внешнего вида';uk='Настройки зовнішнього вигляду'"));
	КопируемыеНастройки.Добавить("ДанныеФорм", НСтр("ru='Данные форм';uk='Дані форм'"));
	КопируемыеНастройки.Добавить("ПерсональныеНастройки", НСтр("ru='Персональные настройки';uk='Персональні настройки'"));
	КопируемыеНастройки.Добавить("Избранное", НСтр("ru='Избранное';uk='Вибране'"));
	КопируемыеНастройки.Добавить("НастройкиПечати", НСтр("ru='Настройки печати';uk='Настройки друку'"));
	КопируемыеНастройки.Добавить(
		"ПрочиеПользовательскиеНастройки", НСтр("ru='Настройки дополнительных отчетов и обработок';uk='Настройки додаткових звітів й обробок'"));
...
Процедура Очистить(Команда)
	...
	Если ВыделенныеСтроки.Количество() = 0 Тогда
		...
		ПоказатьПредупреждение(,НСтр("ru='Необходимо выбрать настройки, которые требуется удалить.';uk='Необхідно вибрати настройки, які потрібно вилучити.'"));
		Возврат;
		
	КонецЕсли;
	
	Оповещение = Новый ОписаниеОповещения("ОчиститьЗавершение", ЭтотОбъект, ДеревоНастроек);
	ТекстВопроса = НСтр("ru='Очистить выделенные настройки?';uk='Очистити виділені настройки?'");
	ПоказатьВопрос(Оповещение, ТекстВопроса, РежимДиалогаВопрос.ДаНет,, КодВозвратаДиалога.Да);
...
Процедура ОчиститьНастройкиВыбраннымПользователям(Команда)
	...
	ТекстВопроса = НСтр("ru='Очистить выделенные настройки?
        ...
        |;uk='Очистити виділені настройки?
        |Відкриється вікно вибору користувачів, яким необхідно очистити настройки.'");
...
Процедура ОчиститьВсеНастройки(Команда)
	...
	ТекстВопроса = НСтр("ru='Очистить все настройки у пользователя ""%1""?';uk='Очистити всі настройки у користувача ""%1""?'");
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстВопроса, Строка(ПользовательСсылка));
	КнопкиВопроса = Новый СписокЗначений;
	КнопкиВопроса.Добавить("Очистить", НСтр("ru='Очистить';uk='Очистити'"));
...
Процедура ОчиститьНастройкиОтчетовИВнешнегоВида(Команда)
	...
	ТекстВопроса = НСтр("ru='Очистить все настройки отчетов и внешнего вида у пользователя ""%1""?';uk='Очистити всі настройки звітів і зовнішнього вигляду у користувача ""%1""?'");
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстВопроса, Строка(ПользовательСсылка));
	КнопкиВопроса = Новый СписокЗначений;
	КнопкиВопроса.Добавить("Очистить", НСтр("ru='Очистить';uk='Очистити'"));
	КнопкиВопроса.Добавить("Отмена", НСтр("ru='Отмена';uk='Відмінити'"));
...
Процедура ОчиститьНастройкиВсехПользователей(Команда)
	...
	ТекстВопроса = НСтр("ru='Сейчас будут очищены все настройки всех пользователей.
                              |Продолжить?'
                              |;uk='Зараз будуть очищені всі настройки всіх користувачів.
                              |Продовжити?'");
	КнопкиВопроса = Новый СписокЗначений;
	КнопкиВопроса.Добавить("ОчиститьВсе", НСтр("ru='Очистить все';uk='Очистити всі'"));
	КнопкиВопроса.Добавить("Отмена", НСтр("ru='Отмена';uk='Відмінити'"));
...
Процедура РассчитатьКоличествоНастроек()
	...
	Если КоличествоНастроек <> 0 Тогда
		Элементы.НастройкиОтчетовСтраница.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Настройки отчетов (%1)';uk='Настройки звітів (%1)'"), КоличествоНастроек);
	Иначе
		Элементы.НастройкиОтчетовСтраница.Заголовок = НСтр("ru='Настройки отчетов';uk='Настройки звітів'");
	КонецЕсли;
	...
	Если КоличествоНастроек <> 0 Тогда
		Элементы.ВнешнийВидСтраница.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Внешний вид (%1)';uk=' Зовнішній вигляд (%1)'"), КоличествоНастроек);
	Иначе
		Элементы.ВнешнийВидСтраница.Заголовок = НСтр("ru='Внешний вид';uk=' Зовнішній вигляд'");
	КонецЕсли;
	...
	Если КоличествоНастроек <> 0 Тогда
		Элементы.ПрочиеНастройкиСтраница.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Прочие настройки (%1)';uk='Інші настройки (%1)'"), КоличествоНастроек);
	Иначе
		Элементы.ПрочиеНастройкиСтраница.Заголовок = НСтр("ru='Прочие настройки';uk='Інші настройки'");
	КонецЕсли;
	...
	Если ВРег(ИмяСобытия) = ВРег("ВыборПользователя") Тогда
		...
		Если Параметр.КопироватьВсе Тогда
			...
			Если МассивНастроек.Количество() = 7 Тогда
				ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Скопированы все настройки %1';uk='Скопійовано всі настройки %1'"), ПояснениеКомуСкопированыНастройки);
			Иначе
				ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1 скопированы %2';uk='%1 скопійовані %2'"), ИменаНастроек, ПояснениеКомуСкопированыНастройки);
			КонецЕсли;
				
			Состояние(НСтр("ru='Выполняется копирование настроек';uk='Виконується копіювання настройок'"));
			
			Отчет = Неопределено;
			СкопироватьВсеНастройкиНаСервере(ПользовательИнформационнойБазы, ПользователиПриемник, МассивНастроек, Отчет);
			
			Если Отчет <> Неопределено Тогда
				ТекстВопроса = НСтр("ru='Не все варианты отчетов и настройки были скопированы.';uk='Не всі варіанти звітів і настройки були скопійовані.'");
				КнопкиВопроса = Новый СписокЗначений;
				КнопкиВопроса.Добавить("Ок", НСтр("ru='ОК';uk='ОК'"));
				КнопкиВопроса.Добавить("ПоказатьОтчет", НСтр("ru='Показать отчет';uk='Показати звіт'"));
			...
			ПоказатьОповещениеПользователя(
				НСтр("ru='Копирование настроек';uk='Копіювання настройок'"), , ТекстПояснения, БиблиотекаКартинок.Информация32);
...
Процедура ОчиститьНастройкиВсехПользователейЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Очистка настроек';uk='Очищення настройок'"), ,
		НСтр("ru='Очищены все настройки всех пользователя';uk='Очищено всі настройки всіх користувачів'"), БиблиотекаКартинок.Информация32);
...
Процедура ОчиститьВсеНастройкиЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	ТекстПояснения = НСтр("ru='Очищены все настройки пользователя ""%1""';uk='Очищено всі настройки користувача ""%1""'");
...
Процедура ОчиститьНастройкиОтчетовИВнешнегоВидаЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	ТекстПояснения = НСтр("ru='Очищены все настройки отчетов и внешнего вида у пользователя ""%1""';uk='Очищено всі настройки звітів і зовнішнього вигляду у користувача ""%1""'");
...
Процедура ОповеститьОбУдалении(КоличествоНастроек, НазваниеНастройки = Неопределено, КоличествоПользователей = Неопределено)
	...
	Если КоличествоНастроек = 1
		...
		ТекстПояснения = НСтр("ru='""%1"" очищена пользователю ""%2""';uk='""%1"" очищена користувачеві ""%2""'");
	...
	ИначеЕсли КоличествоПользователей = Неопределено Тогда
		ТекстПояснения = НСтр("ru='Очищено %1 пользователю ""%2""';uk='Очищено %1 користувачеві ""%2""'");
	...
	Если КоличествоПользователей <> Неопределено Тогда
		...
		Если КоличествоНастроек = 1 Тогда
			ТекстПояснения = НСтр("ru='""%1"" очищена %2';uk='""%1"" очищена %2'");
		...
		Иначе
			ТекстПояснения = НСтр("ru='Очищено %1 %2';uk='Очищено %1 %2'");
	...
	ПоказатьОповещениеПользователя(
		НСтр("ru='Очистка настроек';uk='Очищення настройок'"), , ТекстПояснения, БиблиотекаКартинок.Информация32);
...
Процедура СкопироватьНастройки()
	...
	Если ДеревоНастроек.ВыделенныеСтроки.Количество() = 0 Тогда
		ПоказатьПредупреждение(,НСтр("ru='Необходимо выбрать настройки, которые требуется скопировать.';uk='Необхідно вибрати настройки, які потрібно скопіювати.'"));
		Возврат;
	ИначеЕсли ДеревоНастроек.ВыделенныеСтроки.Количество() = 1 Тогда
		...
		Если ДеревоНастроек.ТекущиеДанные.Тип = "ВариантЛичный" Тогда
            ...
            |;uk='Неможливо скопіювати особистий варіант звіту.
            |Для того щоб особистий варіант звіту став доступний іншим користувачам, необхідно
            |його перезберегти зі знятою позначкою ""Тільки для автора"".'"));
			Возврат;
		ИначеЕсли ДеревоНастроек.ТекущиеДанные.Тип = "НастройкаЛичная" Тогда
            ...
            |;uk='Неможливо скопіювати настройок особистого варіанта звіту.
            |Копіювання настройок особистих варіантів звітів не передбачено.'"));
			Возврат;
		КонецЕсли;
