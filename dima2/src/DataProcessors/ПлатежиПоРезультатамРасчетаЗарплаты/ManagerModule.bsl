...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если НужноПечататьМакет Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм,	"ПФ_MXL_СписокПлатежей",
			НСтр("ru='Печать';uk='Друк'"), ПечатьПлатежей(МассивОбъектов, ОбъектыПечати), ,
...
Функция ПечатьПлатежей(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ПлатежиПоРезультатамРасчетаЗарплаты_СписокПлатежей";
