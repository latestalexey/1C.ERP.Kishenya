...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеПечатью.ПриСозданииНаСервере(ЭтаФорма, Элементы.ЗачислениеЗарплаты.КоманднаяПанель);
...
Процедура Подключаемый_ВыполнитьКомандуПечати(Команда)
	...
	УправлениеПечатьюКлиент.ВыполнитьПодключаемуюКомандуПечати(Команда, ЭтаФорма, Элементы.ЗачислениеЗарплаты);
...
#КонецЕсли
	...
	ТекстСообщения = НСтр("ru='Для обмена с банками файлами рекомендуется установить расширение для веб-клиента 1С:Предприятие.';uk='Для обміну з банками файлами рекомендується встановити розширення для веб-клієнта 1С:Підприємство.'");
