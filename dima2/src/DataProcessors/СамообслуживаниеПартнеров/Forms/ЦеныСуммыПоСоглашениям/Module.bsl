...
Процедура СформироватьНаСервере()
	...
	|	ДокументСоглашениеСКлиентом.НалогообложениеНДС,
	...
	|	ВЫБОР
	|		КОГДА ДоступныеСоглашенияПартнера.НалогообложениеНДС = ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПродажаОблагаетсяНДС)
	...
	|	ДоступныеСоглашенияПартнера.НалогообложениеНДС,
...
Функция ИмяУсловия(Имя)
	...
	Если Имя = "ГрафикОплаты" Тогда
		Возврат НСтр("ru='График оплаты';uk='Графік оплати'");
	ИначеЕсли Имя = "НалогообложениеНДС" Тогда
		Возврат НСтр("ru='Налогообложение';uk='Оподаткування'");
	ИначеЕсли Имя = "ВидСоглашения" Тогда
		Возврат НСтр("ru='Вид соглашения';uk='Вид оферти'");
...
Процедура ВывестиВТабличныйДокумент(РезультатЗапроса,РезультатЗапросаСоглашения)
	...
	ОбластьПодзаголовок.Параметры.Текст = НСтр("ru='Условия, зависящие от соглашения';uk='Умови, які залежать від оферти'");
	...
	ТабличныйДокумент.Вывести(ОбластьПустаяСтрока); 
	ОбластьПодзаголовок.Параметры.Текст = НСтр("ru='Цены и суммы в зависимости от соглашения';uk='Ціни та суми в залежності від оферти'");
	ТабличныйДокумент.Вывести(ОбластьПодзаголовок);
	ТабличныйДокумент.Вывести(ОбластьПустаяСтрока);
