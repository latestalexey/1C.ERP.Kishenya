...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПравоДоступа("СохранениеДанныхПользователя", Метаданные) Тогда
		ТекстОшибки = НСтр("ru='Отсутствует право сохранения данных. Обратитесь к администратору.';uk='Відсутнє право збереження даних. Зверніться до адміністратора.'");
		// Отказ устанавливается в ПриОткрытии.
		Возврат;
	КонецЕсли;
	...
	Иначе
		...
		Элементы.ПрограммыДобавить.Видимость = Ложь;
		Элементы.ПрограммыИзменить.Видимость = Ложь;
		Элементы.ПрограммыУстановитьПометкуУдаления.Видимость = Ложь;
		Элементы.ПрограммыКонтекстноеМенюДобавить.Видимость = Ложь;
		Элементы.ПрограммыКонтекстноеМенюИзменить.Видимость = Ложь;
		Элементы.ПрограммыКонтекстноеМенюПрограммыУстановитьПометкуУдаления.Видимость = Ложь;
		Элементы.ПроверятьПодписиНаСервере.Видимость = Ложь;
		Элементы.ПодписыватьНаСервере.Видимость = Ложь;
		Элементы.ПрограммыПояснение.Заголовок =
			НСтр("ru='Список программ, предусмотренных администратором, которые можно использовать на компьютере.';uk='Список програм, передбачених адміністратором, які можна використовувати на комп''ютері.'");
	КонецЕсли;
	
	Если Не ЭлектроннаяПодпись.ОбщиеНастройки().ЗаявлениеНаВыпускСертификатаДоступно Тогда
		Элементы.СертификатыСоздать.Видимость = Истина;
	...
	Если ОбщегоНазначения.ЭтоПодчиненныйУзелРИБ() Тогда
		...
		Элементы.ПрограммыИзменить.ТолькоВоВсехДействиях = Ложь;
	КонецЕсли;
	...
	Элементы.ГруппаВебКлиентРасширениеНеУстановлено.Видимость =
		РежимРаботы.ЭтоВебКлиент И Параметры.Свойство("РасширениеНеПодключено");
...
Процедура ПрограммыПередНачаломИзменения(Элемент, Отказ)
	...
	Если Элементы.ПрограммыИзменить.Видимость Тогда
...
Процедура ОбновитьТекущуюВидимостьЭлементов()
	...
	Если Константы.ИспользоватьШифрование.Получить()
	 Или ЭлектроннаяПодпись.ОбщиеНастройки().ЗаявлениеНаВыпускСертификатаДоступно Тогда
		...
		Элементы.СертификатыСоздать.Заголовок = НСтр("ru='Добавить...';uk='Додати...'");
		Элементы.СертификатыКонтекстноеМенюСоздать.Заголовок = НСтр("ru='Добавить...';uk='Додати...'");
	...
	Если Константы.ИспользоватьШифрование.Получить() Тогда
		Элементы.ДобавитьИзУстановленныхНаКомпьютере.Заголовок =
			НСтр("ru='Из установленных на компьютере...';uk='Зі встановлених на комп''ютері...'");
	Иначе
		Элементы.ДобавитьИзУстановленныхНаКомпьютере.Заголовок =
			НСтр("ru='Из установленных на компьютере';uk='Зі встановлених на комп''ютері'");
	КонецЕсли;
	...
	Если Константы.ИспользоватьЭлектронныеПодписи.Получить() Тогда
		ЗаголовокФлажка = НСтр("ru='Проверять подписи и сертификаты на сервере';uk='Перевіряти підписи й сертифікати на сервері'");
		ПодсказкаФлажка =
			НСтр("ru='Позволяет не устанавливать программу на компьютер пользователя
                       |для проверки электронных подписей и сертификатов.
                       |
                       |Важно: на каждый компьютер, где работает сервер платформы
                       |или веб-сервер, использующий файловую информационную базу,
                       |должна быть установлена хотя бы одна из программ в списке.'
                       |;uk='Дозволяє не встановлювати програму на комп''ютер користувача
                       |для перевірки електронних підписів та сертифікатів.
                       |
                       |Важливо: на кожен комп''ютер, де працює сервер платформи
                       |або веб-сервер, який використовує файлову інформаційну базу,
                       |повинна бути встановлена хоча б одна з програм в списку.'");
	...
	Иначе
		ЗаголовокФлажка = НСтр("ru='Проверять сертификаты на сервере';uk='Перевіряти сертифікати на сервері'");
		ПодсказкаФлажка =
			НСтр("ru='Позволяет не устанавливать программу на компьютер пользователя
	...
	Если Не Константы.ИспользоватьЭлектронныеПодписи.Получить() Тогда
		ЗаголовокФлажка = НСтр("ru='Шифровать и расшифровывать на сервере';uk='Шифрувати і розшифровувати на сервері'");
		ПодсказкаФлажка =
			НСтр("ru='Позволяет не устанавливать программу и сертификат
                       ...
                       |;uk='Дозволяє не встановлювати програму і сертифікат
                       |на комп''ютер користувача для шифрування і розшифровки.
                       |
                       |Важливо: на кожен комп''ютер, де працює сервер платформи
                       |або веб-сервер, який використовує файлову інформаційну базу,
                       |повинна бути встановлена програма та сертифікат з закритим ключем.'");
	ИначеЕсли Не Константы.ИспользоватьШифрование.Получить() Тогда
		ЗаголовокФлажка = НСтр("ru='Подписывать на сервере';uk='Підписувати на сервері'");
		ПодсказкаФлажка =
			НСтр("ru='Позволяет не устанавливать программу и сертификат
                       ...
                       |должна быть установлена программа и сертификат с закрытым ключом.'
                       |;uk='Дозволяє не встановлювати програму і сертифікат
                       |на комп''ютер користувача для підписання.
                       |
                       |Важливо: на кожен комп''ютер, де працює сервер платформи
                       |або веб-сервер, який використовує файлову інформаційну базу,
                       |повинна бути встановлена програма та сертифікат з закритим ключем.'");
	Иначе
		ЗаголовокФлажка = НСтр("ru='Подписывать и шифровать на сервере';uk='Підписувати і шифрувати на сервері'");
		ПодсказкаФлажка =
			НСтр("ru='Позволяет не устанавливать программу и сертификат
                       ...
                       |должна быть установлена программа и сертификат с закрытым ключом.'
                       |;uk='Дозволяє не встановлювати програму і сертифікат
                       |на комп''ютер користувача для підписання, шифрування і розшифровки.
                       |
                       |Важливо: на кожен комп''ютер, де працює сервер платформи
                       |або веб-сервер, який використовує файлову інформаційну базу,
                       |повинна бути встановлена програма та сертифікат з закритим ключем.'");
...
&НаКлиенте
Процедура ОпределитьУстановленныеПрограммыПослеПодключенияРасширения(Подключено, Неопределен) Экспорт
...
&НаКлиенте
Процедура ОбработчикОжиданияОпределитьУстановленныеПрограммыПослеПодключенияРасширения(Подключено, Неопределен) Экспорт
...
Процедура ОбработчикОжиданияОпределитьУстановленныеПрограммыЦиклНачало(Контекст)
	...
	ПараметрыВыполнения.Вставить("ЭтоLinux",   ОбщегоНазначенияКлиентСервер.ЭтоLinuxКлиент());
...
Процедура ОбработчикОжиданияОпределитьУстановленныеПрограммыЦиклПродолжение(Менеджер, Контекст) Экспорт
	...
	Если Менеджер <> Неопределено Тогда
		ОбновитьЗначение(ОписаниеПрограммы.РезультатПроверки, НСтр("ru='Установлена на компьютере.';uk='Встановлена на комп''ютері.'"));
	...
	Если Ошибка.НеУказанПуть Тогда
		ОбновитьЗначение(ОписаниеПрограммы.РезультатПроверки, НСтр("ru='Не указан путь к программе.';uk='Не вказаний шлях до програми.'"));
		ОбновитьЗначение(ОписаниеПрограммы.Установлена, "");
	Иначе
		ТекстОшибки = НСтр("ru='Не установлена на компьютере.';uk='Не встановлена на комп''ютері.'") + " " + Ошибка.Описание;
		Если Ошибка.КАдминистратору И Не ЭтоПолноправныйПользователь Тогда
			ТекстОшибки = ТекстОшибки + " " + НСтр("ru='Обратитесь к администратору.';uk='Зверніться до адміністратора.'");
		КонецЕсли;
...
Процедура УстановитьПроверкуПодписейНаСервере(ПроверятьПодписиНаСервере)
	...
	Если Не ПравоДоступа("Установка", Метаданные.Константы.ПроверятьЭлектронныеПодписиНаСервере)
...
Процедура УстановитьПодписаниеНаСервере(ПодписыватьНаСервере)
	...
	Если Не ПравоДоступа("Установка", Метаданные.Константы.СоздаватьЭлектронныеПодписиНаСервере)
