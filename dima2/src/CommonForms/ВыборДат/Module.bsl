...
Функция ЕстьОшибки()
	...
	Для Каждого Элемент Из Список Цикл
		...
		Иначе
			ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Дата %1 уже была введена ранее.';uk='Дата %1 вже була введена раніше.'"), Формат(Элемент.Значение, "ДЛФ=Д"));
