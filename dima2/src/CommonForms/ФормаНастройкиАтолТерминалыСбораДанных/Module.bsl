...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокМодель.Добавить("0"     , НСтр("ru='Zebex PDL-20';uk='Zebex PDL-20'"));
	СписокМодель.Добавить("00"    , НСтр("ru='Zebex PDC-10';uk='Zebex PDC-10'"));
	СписокМодель.Добавить("000"   , НСтр("ru='Zebex PDL-10';uk='Zebex PDL-10'"));
	СписокМодель.Добавить("0000"  , НСтр("ru='Zebex PDW-10';uk='Zebex PDW-10'"));
	СписокМодель.Добавить("00000" , НСтр("ru='Zebex PDM-10';uk='Zebex PDM-10'"));
	СписокМодель.Добавить("000000", НСтр("ru='Zebex PDT-10';uk='Zebex PDT-10'"));
	СписокМодель.Добавить("1"  , НСтр("ru='Zebex Z-1050 (АТОЛ технологии)';uk='Zebex Z-1050 (АТОЛ технології)'"));
	СписокМодель.Добавить("3"  , НСтр("ru='Cipher CPT-711 (соединение с ПК через кабель)';uk='Cipher CPT-711 (з''єднання з ПК через кабель)'"));
	СписокМодель.Добавить("03" , НСтр("ru='Cipher CPT-720 (соединение с ПК через кабель)';uk='Cipher CPT-720 (з''єднання з ПК через кабель)'"));
	СписокМодель.Добавить("003", НСтр("ru='Cipher CPT-8300 (соединение с ПК через кабель)';uk='Cipher CPT-8300 (з''єднання з ПК через кабель)'"));
	СписокМодель.Добавить("4"  , НСтр("ru='Cipher CPT-800х (соединение с ПК через IR подставку)';uk='Cipher CPT-800х (з''єднання з ПК через IR підставку)'"));
	СписокМодель.Добавить("04" , НСтр("ru='Cipher CPT-8300 (соединение с ПК через IR подставку)';uk='Cipher CPT-8300 (з''єднання з ПК через IR підставку)'"));
	СписокМодель.Добавить("5"  , НСтр("ru='Cipher CPT-3510 для серии CPT-8x1x';uk='Cipher CPT-3510 для серії CPT-8x1x'"));
	СписокМодель.Добавить("6"  , НСтр("ru='Zebex Z-2030';uk='Zebex Z-2030'"));
	СписокМодель.Добавить("7"  , НСтр("ru='Терминалы с ОС WinCE/PocketPC/Windows Mobile и установленным ПО АТОЛ: Mobile Logistics';uk='Термінали з ОС WinCE/PocketPC/Windows Mobile і встановленим ПЗ АТОЛ: Mobile Logistics'"));
	СписокМодель.Добавить("07" , НСтр("ru='Терминалы Symbol SPT-1800 с установленным ПО АТОЛ:Mobile Logistics';uk='Термінали Symbol SPT-1800 з встановленим ПЗ АТОЛ:Mobile Logistics'"));
	СписокМодель.Добавить("007", НСтр("ru='Терминалы Symbol SPT-1550 с установленным ПО АТОЛ:Mobile Logistics';uk='Термінали Symbol SPT-1550 з встановленим ПЗ АТОЛ:Mobile Logistics'"));
	СписокМодель.Добавить("8"  , НСтр("ru='Cipher CPT-8x00 (соединение с ПК через подставку)';uk='Cipher CPT-8x00 (з''єднання з ПК через підставку)'"));
	СписокМодель.Добавить("9"  , НСтр("ru='Casio DT-900/DT-930';uk='Casio DT-900/DT-930'"));
	СписокМодель.Добавить("09" , НСтр("ru='Cipher CPT-800x/8300 (соединение с ПК через провод)';uk='Cipher CPT-800x/8300 (з''єднання з ПК через кабель)'"));
	СписокМодель.Добавить("10" , НСтр("ru='MobileLogistics 4.x';uk='MobileLogistics 4.x'"));
