...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокТипВесов.Добавить("3",  НСтр("ru='Штрих АС';uk='Штрих АС'"));
	СписокТипВесов.Добавить("5",  НСтр("ru='Штрих АС POS';uk='Штрих АС POS'"));
	СписокТипВесов.Добавить("11", НСтр("ru='Штрих POS2';uk='Штрих POS2'"));
