...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ВладелецФайла = Неопределено Тогда
		ВызватьИсключение НСтр("ru='Список присоединенных файлов можно посмотреть
                                     ...
                                     |;uk='Список приєднаних файлів можна подивитися
                                     |тільки у формі об''єкта-власника.'");
	КонецЕсли;
	...
	Если Параметры.РежимВыбора Тогда
		...
		Заголовок = НСтр("ru='Выбор присоединенного файла';uk='Вибір приєднаного файлу'");
...
Процедура НастроитьДинамическийСписок(ИмяСправочникаХранилищаФайлов)
	...
	ЗаголовокОшибки = НСтр("ru='Ошибка при настройке динамического списка присоединенных файлов.';uk='Помилка при настройці динамічного списку приєднаних файлів.'");
	ОкончаниеОшибки = НСтр("ru='В этом случае настройка динамического списка невозможна.';uk='У цьому випадку настройка динамічного списку неможлива.'");
