...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокИсточникЗагрузки.Добавить("Документ", НСтр("ru='Документ терминала сбора данных';uk='Документ терміналу збору даних'"));
	СписокИсточникЗагрузки.Добавить("База",     НСтр("ru='База терминала сбора данных';uk='База терміналу збору даних'"));
