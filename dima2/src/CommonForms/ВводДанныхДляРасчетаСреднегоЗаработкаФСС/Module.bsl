...
Процедура ПеречитатьДанныеУчета(Команда)
	...
	ОценкаПроизводительностиКлиентСервер.НачатьЗамерВремени("ПересчетДанныхВФормеВводДанныхДляРасчетаСреднегоЗаработкаФСС");
...
Процедура ОбновитьПредельныеВеличиныБазыСреднегоЗаработка()
	...
	ПредельнаяВеличина = УчетПособийСоциальногоСтрахования.ПредельнаяВеличинаБазыСтраховыхВзносов(МесяцыПредельныхВеличин);
