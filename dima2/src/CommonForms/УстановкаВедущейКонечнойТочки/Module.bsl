...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Установка ведущей конечной точки для ""%1""';uk='Установка провідною кінцевої точки для ""%1""'"),
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	ТекстПредупреждения = НСтр("ru='Отменить выполнение операции?';uk='Скасувати виконання операції?'");
...
Процедура Установить(Команда)
	...
	Состояние(НСтр("ru='Выполняется установка ведущей конечной точки. Пожалуйста, подождите...';uk='Виконується установка провідною кінцевої точки. Будь ласка, зачекайте...'"));
	...
	Если Отказ Тогда
        ...
        |;uk='При установці провідною кінцевої точки виникли помилки.
	...
	ПоказатьОповещениеПользователя(,, НСтр("ru='Установка ведущей конечной точки успешно завершена.';uk='Установка провідною кінцевої точки успішно завершена.'"));
