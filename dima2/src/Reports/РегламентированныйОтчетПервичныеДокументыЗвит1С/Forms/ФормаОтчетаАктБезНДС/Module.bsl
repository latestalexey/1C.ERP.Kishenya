...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	СодержаниеДокумента = "    Ми, що нижче підписалися, представники Замовника [ПредставлениеПокупателя] [ПредставительПокупателя], з одного боку, і представник Виконавця [ПредставлениеПоставщика] [ПредставительПоставщика], з іншого боку, склали цей акт про те, що на підставі наведених документів:";	
	СодержаниеДокумента = СтрЗаменить(СодержаниеДокумента, "[ПредставлениеПокупателя]", СокрЛП(СтруктураДанныхПервичныйДокумент.ПредставлениеПокупателя));
	СодержаниеДокумента = СтрЗаменить(СодержаниеДокумента, "[ПредставительПокупателя]", СокрЛП(СтруктураДанныхПервичныйДокумент.ПредставительПокупателя));
	СодержаниеДокумента = СтрЗаменить(СодержаниеДокумента, "[ПредставлениеПоставщика]", СокрЛП(СтруктураДанныхПервичныйДокумент.ПредставлениеПоставщика));
	СодержаниеДокумента = СтрЗаменить(СодержаниеДокумента, "[ПредставительПоставщика]", СокрЛП(СтруктураДанныхПервичныйДокумент.ПредставительПоставщика));
	СтруктураДанныхПервичныйДокумент.СодержаниеДокументаШаблон = СодержаниеДокумента;
