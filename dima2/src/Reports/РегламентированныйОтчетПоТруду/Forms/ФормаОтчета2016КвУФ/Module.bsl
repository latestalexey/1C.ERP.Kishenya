...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2016Кв";
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	П9010   = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("П9020", Форма, "ОтчетПоТруду"))
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("П9030", Форма, "ОтчетПоТруду"))
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("П9040", Форма, "ОтчетПоТруду"))
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("П9050", Форма, "ОтчетПоТруду"))
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("П9060", Форма, "ОтчетПоТруду"));
	ЗаполнитьПоказательНаСервере("П9010", П9010, Форма, "ОтчетПоТруду");
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	СтруктураДанныхОтчетПоТруду["П9070"] =  ТаблСреднеспЧисленности[0].Средняя;
...
Процедура ВосстановитьГраницыРаспределенияРаздел3()
	...
	ЗаполнитьПоказательНаСервере("Пр3", 1500.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр4", 2000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр5", 2500.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр6", 3000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр7", 3500.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр8", 4000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр9", 5000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр10",10000, ЭтаФорма, "ОтчетПоТруду");
	
	ЗаполнитьПоказательНаСервере("Пр200", 1500.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр300", 2000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр400", 2500.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр500", 3000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр600", 3500.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр700", 4000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр800", 5000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр900", 10000.0, ЭтаФорма, "ОтчетПоТруду");
...
Процедура РасчетПоказателейКоличестваРаботников()
	...
	ЗапросПриемУвольнение.УстановитьПараметр("ДатаНач", НачалоГода(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета));
	...
	//ЗапросПриемУвольнение.УстановитьПараметр("ВнутреннееСовместительство", Перечисления.ВидыЗанятости.ВнутреннееСовместительство);
	ЗапросПриемУвольнение.УстановитьПараметр("ОсновноеМестоРаботы", Перечисления.ВидыЗанятости.ОсновноеМестоРаботы);
	ЗапросПриемУвольнение.УстановитьПараметр("ПриемНаРаботу", Перечисления.ВидыКадровыхСобытий.Прием);
	ЗапросПриемУвольнение.УстановитьПараметр("Увольнение",Перечисления.ВидыКадровыхСобытий.Увольнение);
	...
	|РаботникиОрганизаций.ВидСобытия КАК ПричинаИзмененияСостояния
	|
	|ИЗ РегистрСведений.КадроваяИсторияСотрудников КАК РаботникиОрганизаций
	...
	|И (РаботникиОрганизаций.ВидЗанятости = &ОсновноеМестоРаботы)
	|И (РаботникиОрганизаций.ВидСобытия = &ПриемНаРаботу    ИЛИ РаботникиОрганизаций.ВидСобытия = &Увольнение)
	|И НЕ (РаботникиОрганизаций.ВидСобытия = &ПриемНаРаботу И   РаботникиОрганизаций.Период = &ДатаКон)
	|И НЕ (РаботникиОрганизаций.ВидСобытия = &Увольнение    И   РаботникиОрганизаций.Период = &ДатаНач)";
	
	ТаблицаПриемУвольнение = ЗапросПриемУвольнение.Выполнить().Выгрузить();
	
	ПараметрыОтбора = Новый Структура();
	// принятые все
	ПараметрыОтбора.Вставить("ПричинаИзмененияСостояния",Перечисления.ВидыКадровыхСобытий.Прием);
	СтруктураДанныхОтчетПоТруду["П3020_1"] = ТаблицаПриемУвольнение.НайтиСтроки(ПараметрыОтбора).Количество();
	
	ПараметрыОтбора.Вставить("ПринятНаНовоеРабочееМесто", Истина);
	СтруктураДанныхОтчетПоТруду["П3030_1"] = ТаблицаПриемУвольнение.НайтиСтроки(ПараметрыОтбора).Количество();
	
	ПараметрыОтбора.Удалить("ПринятНаНовоеРабочееМесто");
	...
	// уволенные женщины
	ПараметрыОтбора.Вставить("ПричинаИзмененияСостояния",Перечисления.ВидыКадровыхСобытий.Увольнение);
	...
	ЗапросПоШтатным.УстановитьПараметр("Увольнение",		  Перечисления.ВидыКадровыхСобытий.Увольнение);
	
	ЗапросПоШтатным.Текст = "
	|ВЫБРАТЬ 
	|	КОЛИЧЕСТВО(Сотрудник) КАК КоличествоВсего,
	|	СУММА(ВЫБОР КОГДА ФизическоеЛицо.Пол = ЗНАЧЕНИЕ(Перечисление.ПолФизическогоЛица.Женский) ТОГДА 1 ИНАЧЕ 0 КОНЕЦ) КАК КоличествоЖенщин
	|
	|ИЗ
	|	РегистрСведений.КадроваяИсторияСотрудников.СрезПоследних(&ДатаКон, Организация = &Организация 
	|																  И ВидЗанятости = &ОсновноеМестоРаботы)	КАК РаботникиОрганизаций
	|
	|ГДЕ 	
...
Процедура РазбитьНачисленияПоШкале(ТаблицаНачислений)
	...
	Для каждого стр Из ТаблицаНачислений Цикл
		...
		ИначеЕсли (стр.Результат >= ПолучитьПоказательНаСервере("Пр3",ЭтаФорма, "ОтчетПоТруду")) и (стр.Результат <= СтруктураДанныхОтчетПоТруду["Пр300"]) Тогда 
			СтруктураДанныхОтчетПоТруду["П6040_1"] = СтруктураДанныхОтчетПоТруду["П6030_1"] + 1;
...
Функция ПроверитьГраницыРаспределенияРаздел4()
	...
	Если ПолучитьПоказательНаСервере("Пр10",ЭтаФорма, "ОтчетПоТруду") <> ПолучитьПоказательНаСервере("Пр900",ЭтаФорма, "ОтчетПоТруду") Тогда
	    Результат = Ложь;
	КонецЕсли;
	...
	Если Результат = Ложь И (НЕ СтруктураРеквизитовФормы.ПолучениеДанныхДляЗвит1С = Истина) Тогда
		Сообщить(НСтр("ru='Не заполнены (или не правильно заполнены) параметры распределения размера заработной платы в разделе IV.
	                   |Строки 6030...6110 заполнены не будут!';uk= 'Не заповнені (або заповнені некоректно) параметри розподілу розміру зарабітної плати в разділі IV.
	                   |Рядки 6030...6110 заповнені не будуть!'"));	
	КонецЕсли;
