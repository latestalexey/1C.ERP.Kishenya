...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2017Кв";
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "ЕРП" Тогда
		...
		СтруктураДанныхОтчетПоТруду["П9070"] =  ТаблСреднеспЧисленности.ЧисленностьРаботников;
	Иначе
...
Процедура ВосстановитьГраницыРаспределенияРаздел3()
	...
	ЗаполнитьПоказательНаСервере("Пр3", 4000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр4", 5000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр5", 5500.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр6", 6000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр7", 7000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр8", 8000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр9", 10000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр91",15000.01, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр10",20000, ЭтаФорма, "ОтчетПоТруду");
	
	ЗаполнитьПоказательНаСервере("Пр200", 4000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр300", 5000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр400", 5500.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр500", 6000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр600", 7000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр700", 8000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр800", 10000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр900", 15000.0, ЭтаФорма, "ОтчетПоТруду");
	ЗаполнитьПоказательНаСервере("Пр910", 20000.0, ЭтаФорма, "ОтчетПоТруду");
...
Процедура РасчетНачисленийШтатныхРаботников(МенеджерВременныхТаблиц)
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "ЕРП" Тогда
		...
		|				И НачислениеУдержание.ВключатьВФОТ = ИСТИНА) КАК Начисления
		|
		|СГРУППИРОВАТЬ ПО
...
Процедура РасчетНачисленийПоКатегориямРаботников(МенеджерВременныхТаблиц)
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "ЕРП" Тогда
		...
		|			Организация = &Организация
		|				И НачислениеУдержание ССЫЛКА ПланВидовРасчета.Начисления
		|				И НачислениеУдержание.ВключатьВФОТ = ИСТИНА
