...
Функция ТекстЗапросаЗакупкиОбороты()
	...
	|	ВЫБОР 
	|		КОГДА НастройкиХозопераций.Приход = ЗНАЧЕНИЕ(Перечисление.ТипыДанныхУчета.Номенклатура)
	|			ТОГДА ЗакупкиОбороты.КоличествоОборот * &ТекстЗапросаВесУпаковки
	|			ИНАЧЕ 0
	|	КОНЕЦ КАК Об_ВесПриход,
	|	ВЫБОР 
	|		КОГДА НастройкиХозопераций.Расход = ЗНАЧЕНИЕ(Перечисление.ТипыДанныхУчета.Номенклатура)
	|			ТОГДА ЗакупкиОбороты.КоличествоОборот * &ТекстЗапросаВесУпаковки
	|			ИНАЧЕ 0
	|	КОНЕЦ КАК Об_ВесРасход,
	...
	|	ВЫБОР 
	|		КОГДА НастройкиХозопераций.Приход = ЗНАЧЕНИЕ(Перечисление.ТипыДанныхУчета.Номенклатура)
	|			ТОГДА ЗакупкиОбороты.КоличествоОборот * &ТекстЗапросаОбъемУпаковки
	|			ИНАЧЕ 0
	|	КОНЕЦ КАК Об_ОбъемПриход,
	|	ВЫБОР 
	|		КОГДА НастройкиХозопераций.Расход = ЗНАЧЕНИЕ(Перечисление.ТипыДанныхУчета.Номенклатура)
	|			ТОГДА ЗакупкиОбороты.КоличествоОборот * &ТекстЗапросаОбъемУпаковки
	|			ИНАЧЕ 0
	|	КОНЕЦ КАК Об_ОбъемРасход,
...
Функция ТекстЗапросаСебестоимостьТоваровОборотыПоЗаписям()
	...
	//++ НЕ УТКА
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ВозвратСырьяДавальцу
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ВозвратСырьяДавальцу).Договор
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ОтчетДавальцу
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ОтчетДавальцу).Договор
	//-- НЕ УТКА
	//++ НЕ УТ
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ВозвратСырьяОтПереработчика
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ВозвратСырьяОтПереработчика).Договор
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ОтчетПереработчика
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ОтчетПереработчика).Договор
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ПередачаСырьяПереработчику
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ПередачаСырьяПереработчику).Договор
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ПоступлениеОтПереработчика
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ПоступлениеОтПереработчика).Договор
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ВозвратСырьяДавальцу
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ВозвратСырьяДавальцу).Договор
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ОтчетДавальцу
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ОтчетДавальцу).Договор
	//-- НЕ УТКА
	//++ НЕ УТ
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ВозвратСырьяОтПереработчика
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ВозвратСырьяОтПереработчика).Договор
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ОтчетПереработчика
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ОтчетПереработчика).Договор
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ПередачаСырьяПереработчику
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ПередачаСырьяПереработчику).Договор
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ПоступлениеОтПереработчика
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ПоступлениеОтПереработчика).Договор
	//-- НЕ УТ
	...
	//++ НЕ УТКА
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ВозвратСырьяДавальцу
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ВозвратСырьяДавальцу).Контрагент
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ОтчетДавальцу
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ОтчетДавальцу).Контрагент
	//-- НЕ УТКА
	//++ НЕ УТ
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ВозвратСырьяОтПереработчика
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ВозвратСырьяОтПереработчика).Контрагент
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ОтчетПереработчика
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ОтчетПереработчика).Контрагент
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ПередачаСырьяПереработчику
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ПередачаСырьяПереработчику).Контрагент
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ПередачаТоваровМеждуОрганизациями
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ПередачаТоваровМеждуОрганизациями).Контрагент
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ПоступлениеОтПереработчика
	|					ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.ДокументДвижения КАК Документ.ПоступлениеОтПереработчика).Контрагент
	//-- НЕ УТ
	|				КОГДА СебестоимостьТоваровЗаписи.ДокументДвижения ССЫЛКА Документ.ВозвратТоваровМеждуОрганизациями
	...
	//++ НЕ УТКА
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ВозвратСырьяДавальцу
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ВозвратСырьяДавальцу).Контрагент
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ОтчетДавальцу
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ОтчетДавальцу).Контрагент
	//-- НЕ УТКА
	//++ НЕ УТ
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ВозвратСырьяОтПереработчика
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ВозвратСырьяОтПереработчика).Контрагент
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ОтчетПереработчика
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ОтчетПереработчика).Контрагент
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ПередачаСырьяПереработчику
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ПередачаСырьяПереработчику).Контрагент
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ПередачаТоваровМеждуОрганизациями
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ПередачаТоваровМеждуОрганизациями).Контрагент
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ПоступлениеОтПереработчика
	|				ТОГДА ВЫРАЗИТЬ(СебестоимостьТоваровЗаписи.Регистратор КАК Документ.ПоступлениеОтПереработчика).Контрагент
	//-- НЕ УТ
	|			КОГДА СебестоимостьТоваровЗаписи.Регистратор ССЫЛКА Документ.ВозвратТоваровМеждуОрганизациями
