...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена Приказом Минфина Украины от 28.01.2016 № 21 (с изменениями внесенными Приказом Миинфина от 25.05.2016 № 503)';uk= 'Затверджено Наказом Міністерства фінінсів від 28.01.2016 № 21 (зі змінами,  що внесені Наказом Мінфіна від 25.05.2016 № 503)'");
	НоваяФорма.ДатаНачалоДействия = '2016-08-01';
	НоваяФорма.ДатаКонецДействия  = '2017-02-28';
		
	НоваяФорма = ТаблицаФормОтчета.Добавить();
	НоваяФорма.ФормаОтчета        = "ФормаОтчета2017УФ";
	НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена Приказом Минфина Украины от 28.01.2016 № 21 (в редакции Приказа Миинфина от 23.02.2017 № 276)';uk= 'Затверджено Наказом Міністерства фінінсів від 28.01.2016 № 21 (в редакції Наказу Мінфіна від 23.02.2017 № 276)'");
