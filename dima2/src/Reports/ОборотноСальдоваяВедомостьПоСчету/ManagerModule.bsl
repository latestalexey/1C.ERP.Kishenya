...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Оборотно-сальдовая ведомость по счету %1 %2';uk='Оборотно-сальдова відомість по рахунку %1 %2'"),
...
// Получает список субсчетов выбранного счета, состав субконто которых не полностью соответствует
// составу субконто счета
...
// совершенно отчичается от состава субконто счета
...
// Получает таблицу состава субконто счетов в которой счета с одинаковым составом субконто объеденены в одну строку
// Параметры:
...
// * ВидыСубконто - Массиы - Виды субконто счетов
	...
	Иначе
		...
		Для Каждого СчетаИСубконто Из СоставСубконтоСчетов(ОсобенныеСчета, ВидыСубконтоЭталон(Счет)) Цикл
			...
			Для ИндексВидаСубконто = 0 По СчетаИСубконто.ВидыСубконто.ВГраница() Цикл
				...
				ПараметрыЗапроса.Вставить("Субконто"+ (ИндексВидаСубконто + 1), "(Субконто" + (ИндексВидаСубконто + 1) + ").*");
