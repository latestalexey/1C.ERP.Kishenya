...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	СтруктураЗамены = Новый Соответствие();
 	СтруктураЗамены.Вставить(" грн.",НСтр("ru=' грн.';uk=' грн.'"));
 	СтруктураЗамены.Вставить(" прож.миним.",НСтр("ru=' прож.миним.';uk=' прож.мінім.'"));
 	СтруктураЗамены.Вставить(" доли",НСтр("ru=' доли';uk=' частки'"));
	...
	Попытка
		...
		Если КлючВарианта = "ЖурналУчетаИсполнительныхДокументов" Тогда
			...
			ДокументРезультат.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ЖурналУчетаИсполнительныхДокументов";
	...
	Исключение
		...
		ВызватьИсключение НСтр("ru='В настройку отчета внесены критичные изменения. Журнал учета исполнительных документов не будет сформирован.';uk='У настройку звіту внесені критичні зміни. Журнал обліку виконавчих документів не буде сформований.'") + " " + Инфо.Описание;
...
Процедура ВывестиСтрокуПоСотруднику(ДокументРезультат, СтрокаСотрудника, ОбластьСтрока)
	...
	ОбластьСтрока.Параметры.Дата = Формат(СтрокаСотрудника.Дата, "ДФ=""ММММ гггг""") + " " + НСтр("ru='г.';uk='р.'");
