...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2013Кв3";
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	НовСтрока.ИмяСхемы = "S0100113"; 
	НовСтрока.ПредставлениеСхемы =НСтр("ru='Баланс (Единое окно, S0100113)';uk= 'Баланс (Єдино вікно, S0100113)'");
