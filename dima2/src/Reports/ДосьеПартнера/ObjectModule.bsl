...
Функция ВыполнитьПакетЗапросовПоПартнеру(Партнер,СоответствиеЗапросыДанные)
	...
	Запрос.УстановитьПараметр("СтрокаТиповое",НСтр("ru='Типовое';uk='Типове'"));
	Запрос.УстановитьПараметр("СтрокаИндивидуальное",НСтр("ru='Индивидуальное';uk='Індивідуальне'"));
