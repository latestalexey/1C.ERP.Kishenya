...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ТекстЗапроса = СтрЗаменить(
		...
		Справочники.УпаковкиЕдиницыИзмерения.ТекстЗапросаВесУпаковки("МатериалыИРаботыВПроизводствеОстатки.Номенклатура.ЕдиницаИзмерения", "МатериалыИРаботыВПроизводствеОстатки.Номенклатура"));
		
	ТекстЗапроса = СтрЗаменить(
		ТекстЗапроса, 
		"&ТекстЗапросаОбъемНоменклатуры", 
		Справочники.УпаковкиЕдиницыИзмерения.ТекстЗапросаОбъемУпаковки("МатериалыИРаботыВПроизводствеОстатки.Номенклатура.ЕдиницаИзмерения", "МатериалыИРаботыВПроизводствеОстатки.Номенклатура"));
	...
	СкладскиеОперацииПриемки.Добавить(Перечисления.СкладскиеОперации.ПередачаВПроизводствоОтгрузка);
	СкладскиеОперацииПриемки.Добавить(Перечисления.СкладскиеОперации.ОтгрузкаПоПеремещениюВПроизводстве);
	...
	ОстаткиСерийСправочно.Колонки.Добавить("Подразделение", Новый ОписаниеТипов("СправочникСсылка.СтруктураПредприятия"));
	...
	ТекстЗапроса = СхемаКомпоновкиДанных.НаборыДанных.СерииОстаткиИСерииСправочно.Элементы.ЗапросПоОстаткам.Запрос;
	...
	СхемаКомпоновкиДанных.НаборыДанных.СерииОстаткиИСерииСправочно.Элементы.ЗапросПоОстаткам.Запрос = ТекстЗапроса;
