...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	//Основные средства: остаочная стоимость
	...
	//
	//Всего по разделуI
	Форма.ТабличныйДокумент.Области.П10953.Значение = Форма.ТабличныйДокумент.Области.П10053.Значение
	...
	Форма.ТабличныйДокумент.Области.П10954.Значение = Форма.ТабличныйДокумент.Области.П10054.Значение
	...
	//Вместе чистые доходы(030 + 040 + 050) 
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
   ...
   КонецПопытки;	
	...
	П10113_12 = СНД(Счет12);
	
	П10113 = П10113_10 + П10113_11 + П10113_12;
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П10113", "",	"+", "!СНД",П10113_12,Счет12,,НачалоГода(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета), СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
	
	П10114_10 = СКД(Счет10);
	П10114_11 = СКД(Счет11);
	П10114_12 = СКД(Счет12) ;
	
	П10114 = П10114_10 + П10114_11 + П10114_12;
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П10114", "",	"+", "!СКД",П10114_12,Счет12);
	
	//строка 032 основные средства: износ
	П10123_  = СНК(Счет13);
	П10123_4 = СНК(Счет13_4);
	
	П10123 = П10123_ - П10123_4;
	...
	// также в этой строке указываются и товары.2.6 П(С)БУ 25: "Окремо відображається готова продукція ..., а також наводиться покупна вартість товарів, придбаних підприємствами для подальшого продажу"
	...
	//_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П16253", "Показник ""Поточні зобов'язання за розрахунками: зі страхування"", графа ""На початок звітного періоду""",	"+", "!СНКР",П16253, Счет65,,НачалоГода(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета), СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
	//
	//УстановитьЗначениеПоказателя("П16254", П16254);
	//_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П16254", "Показник ""Поточні зобов'язання за розрахунками: зі страхування"", графа ""На початок звітного періоду""",	"+", "!СККР",П16254, Счет65);
	//развернутое сальдо по счету 65
