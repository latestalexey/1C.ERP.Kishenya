...
Функция ПараметрыДоступностиОтборов(ВидБюджета) Экспорт
	...
	СтруктураОписанияВидаБюджета = БюджетнаяОтчетностьРасчетКэшаСервер.ПолучитьСтруктуруОписанияВидаБюджета(ВидБюджета, 
	...
	Результат = Новый Структура("ДоступенВыборСценария, 
								|ДоступенВыборОрганизация, 
								|ДоступенВыборПодразделение", 
								Ложь, Ложь, Ложь);
