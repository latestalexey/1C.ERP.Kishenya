...
Перем R011G7;
&НаСервере
Перем R012G4_20, R0121G4, R012G6, R0121G6, R012G7;
&НаСервере
Перем R60GA, R60GB;
&НаСервере
Перем R130GA, R130GB;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2018УФ";
	...
	СтруктураРеквизитовФормы.мИдГруппы1_11  = "T11R";
	СтруктураРеквизитовФормы.мИдГруппы1_12  = "T12R";
	...
	СтруктураРеквизитовФормы.мИдГруппы51_11	= "П5T11R";
	СтруктураРеквизитовФормы.мИдГруппы51_12	= "П5T12R";
	...
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы51_11,СтруктураРеквизитовФормы.мИдГруппы51_11);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы51_12,СтруктураРеквизитовФормы.мИдГруппы51_12);
	...
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы51_11,1);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы51_12,1);
	...
	// Версия формы
	//	СтруктураРеквизитовФормы.мВерсияФормы = "01/06/2018";
	СтруктураРеквизитовФормы.мВерсияФормы = "11/07/2018";
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("мИдГруппы51_11");
	СтруктураРеквизитовФормы.Вставить("мИдГруппы51_12");
...
Процедура ФормироватьСтруктуруСвойствСтраниц() Экспорт
	...
	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппы51_11;
	НовСтр.Область = "МногострочнаяЧасть_11";
	НовСтр.ВысотаСтроки = 1;
	
	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппы51_12;
	НовСтр.Область = "МногострочнаяЧасть_12";
	НовСтр.ВысотаСтроки = 1;
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРазделаНаКлиенте(ИдГруппы) Экспорт
	...
	ИдГрупп.Вставить("мИдГруппы51_11", СтруктураРеквизитовФормы.мИдГруппы51_11);
	ИдГрупп.Вставить("мИдГруппы51_12", СтруктураРеквизитовФормы.мИдГруппы51_12);
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРаздела(ИдГруппы, ИдГрупп) Экспорт
	...
	ИначеЕсли  ИдГруппы = ИдГрупп.мИдГруппы1
	       ИЛИ ИдГруппы = ИдГрупп.мИдГруппы1_11
	...
	ИначеЕсли   ИдГруппы = ИдГрупп.мИдГруппы51 
			ИЛИ ИдГруппы = ИдГрупп.мИдГруппы51_11
			ИЛИ ИдГруппы = ИдГрупп.мИдГруппы51_12
...
Функция ОпределитьИдМногострочногоРазделаПоАктивнойСтранице(ИмяЛиста = Неопределено, ТекущаяСтраница, ИдГрупп)
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Приложение5" Тогда
		...
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппы51_11);
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппы51_12);
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	Если ЗначениеЗаполнено(НалоговаяИнспекция) Тогда 
		...
		ЗаполнитьПоказательНаСервере("HSTI", НалоговаяИнспекция_Наименование, 	Форма, "Заявление");
...
Процедура ОбновитьПользовательскиеНастройки(СписокСохранения, ВыполнялосьОбновлениеДанных)
	...
	Если ВерсияФормы = "01/06/2018" Тогда
		
		ДанныеМногострочныхРазделов = Неопределено;
		Если СписокСохранения.Свойство( "ДанныеМногострочныхРазделов", ДанныеМногострочныхРазделов) Тогда
			
			ДанныеТаблицы11 = Неопределено;
			Если ДанныеМногострочныхРазделов.Свойство(СтруктураРеквизитовФормы.мИдГруппы1_11, ДанныеТаблицы11) Тогда
				ДанныеТаблицы11.Колонки.Добавить("T11RXXXXG43",Новый ОписаниеТипов("Строка"));
				ДанныеМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы1_11, ДанныеТаблицы11);	
			КонецЕсли;
			
			ДанныеТаблицы11 = Неопределено;
			Если ДанныеМногострочныхРазделов.Свойство(СтруктураРеквизитовФормы.мИдГруппы51_11, ДанныеТаблицы11) Тогда
				ДанныеТаблицы11.Колонки.Добавить("П5T11RXXXXG43",Новый ОписаниеТипов("Строка"));
				ДанныеМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы51_11, ДанныеТаблицы11);	
			КонецЕсли;
		...
		КонецЕсли;
   	  ...
   	  СписокСохранения.ВерсияФормы = "11/07/2018";
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяСтраницыПанели Тогда
		...
		ИдГрупп.Вставить("мИдГруппы51_11", Форма.СтруктураРеквизитовФормы.мИдГруппы51_11);
		ИдГрупп.Вставить("мИдГруппы51_12", Форма.СтруктураРеквизитовФормы.мИдГруппы51_12);
	...
	ТаблицаБлока = Форма[ТаблицаБлока];
	R0110G6 = ТаблицаБлока.Итог("T11RXXXXG6");
	R0110G7 = ТаблицаБлока.Итог("T11RXXXXG7");
	R0110G8 = ТаблицаБлока.Итог("T11RXXXXG8");
	ЗаполнитьПоказательНаСервере("R0110G6", R0110G6, Форма, "Приложение1");
	ЗаполнитьПоказательНаСервере("R0110G7", R0110G7, Форма, "Приложение1");
	ЗаполнитьПоказательНаСервере("R0110G8", R0110G8, Форма, "Приложение1");	
	
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппы1_12, ТаблицаБлока);
	ТаблицаБлока = Форма[ТаблицаБлока];
	R0120G6 = ТаблицаБлока.Итог("T12RXXXXG6");
	R0120G7 = ТаблицаБлока.Итог("T12RXXXXG7");
	R0120G8 = ТаблицаБлока.Итог("T12RXXXXG8");
	ЗаполнитьПоказательНаСервере("R0120G6", R0120G6, Форма, "Приложение1");
	ЗаполнитьПоказательНаСервере("R0120G7", R0120G7, Форма, "Приложение1");
	ЗаполнитьПоказательНаСервере("R0120G8", R0120G8, Форма, "Приложение1");	
	...
	R60GB = ПолучитьПоказательНаСервере("R013G5", Форма, "Приложение1");
	...
	R130GB = ПолучитьПоказательНаСервере("R023G5", Форма, "Приложение1");
	...
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппы51_11, ТаблицаБлока);
	ТаблицаБлока = Форма[ТаблицаБлока];
	R0110G6 = ТаблицаБлока.Итог("П5T11RXXXXG6");
	R0110G7 = ТаблицаБлока.Итог("П5T11RXXXXG7");
	R0110G8 = ТаблицаБлока.Итог("П5T11RXXXXG8");
	ЗаполнитьПоказательНаСервере("R0110G6", R0110G6, Форма, "Приложение5");
	ЗаполнитьПоказательНаСервере("R0110G7", R0110G7, Форма, "Приложение5");
	ЗаполнитьПоказательНаСервере("R0110G8", R0110G8, Форма, "Приложение5");	
	
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппы51_12, ТаблицаБлока);
	ТаблицаБлока = Форма[ТаблицаБлока];
	R0120G6 = ТаблицаБлока.Итог("П5T12RXXXXG6");
	R0120G7 = ТаблицаБлока.Итог("П5T12RXXXXG7");
	R0120G8 = ТаблицаБлока.Итог("П5T12RXXXXG8");
	ЗаполнитьПоказательНаСервере("R0120G6", R0120G6, Форма, "Приложение5");
	ЗаполнитьПоказательНаСервере("R0120G7", R0120G7, Форма, "Приложение5");
	ЗаполнитьПоказательНаСервере("R0120G8", R0120G8, Форма, "Приложение5");	
	...
	НовосозданноеПредприятие = ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HPVN", Форма, "Приложение9"));
	...
	Для СтрНомер = 1 По 12 Цикл
		...
		// учтем что отчетныйы период может быть и месячным и квартальным
		Если  НовосозданноеПредприятие
			И ПолучитьПоказательНаСервере(ИмяТекущейЯчейкиМес, Форма, "Приложение9") >= Месяц(Форма.СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета)
			И ПолучитьПоказательНаСервере(ИмяТекущейЯчейкиМес, Форма, "Приложение9") <= Месяц(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета)
			И ПолучитьПоказательНаСервере(ИмяТекущейЯчейкиГод, Форма, "Приложение9") = Год(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда
		
			СуммаПоСтолбцу3НП = СуммаПоСтолбцу3НП + ПолучитьПоказательНаСервере(ИмяТекущейЯчейкиСтолбца3, Форма, "Приложение9");	
			СуммаПоСтолбцу4НП = СуммаПоСтолбцу4НП + ПолучитьПоказательНаСервере(ИмяТекущейЯчейкиСтолбца4, Форма, "Приложение9");	
			СуммаПоСтолбцу5НП = СуммаПоСтолбцу5НП + ПолучитьПоказательНаСервере(ИмяТекущейЯчейкиСтолбца5, Форма, "Приложение9");
			СуммаПоСтолбцу6НП = СуммаПоСтолбцу6НП + ПолучитьПоказательНаСервере(ИмяТекущейЯчейкиСтолбца6, Форма, "Приложение9");
	...
	Если Не СуммаПоСтолбцу6 = 0 И НЕ НовосозданноеПредприятие Тогда
	    ЗаполнитьПоказательНаСервере("R03G3", 100 * СуммаПоСтолбцу3 / СуммаПоСтолбцу6, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R03G4", 100 * СуммаПоСтолбцу4 / СуммаПоСтолбцу6, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R03G5", 100 * СуммаПоСтолбцу5 / СуммаПоСтолбцу6, Форма, "Приложение9");
	Иначе
	    ЗаполнитьПоказательНаСервере("R03G3", 0, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R03G4", 0, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R03G5", 0, Форма, "Приложение9");
	КонецЕсли;
	
	
	Если Не СуммаПоСтолбцу6НП = 0 И НовосозданноеПредприятие Тогда
	    ЗаполнитьПоказательНаСервере("R04G3", 100 * СуммаПоСтолбцу3НП / СуммаПоСтолбцу6НП, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R04G4", 100 * СуммаПоСтолбцу4НП / СуммаПоСтолбцу6НП, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R04G5", 100 * СуммаПоСтолбцу5НП / СуммаПоСтолбцу6НП, Форма, "Приложение9");
	Иначе
	    ЗаполнитьПоказательНаСервере("R04G3", 0, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R04G4", 0, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R04G5", 0, Форма, "Приложение9");
	КонецЕсли;
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли НаименованиеТекЛиста = "Приложение1"
		   И (ЛЕВ(ИмяЯчейки, 3) = "T11" ИЛИ ЛЕВ(ИмяЯчейки, 3) = "T12")
	...
	ИначеЕсли НаименованиеТекЛиста = "Приложение5"
		   И (Найти(ИмяЯчейки, "G42") > 0) 
		   И (Найти(ИмяЯчейки, "П5T1R") > 0 ИЛИ Найти(ИмяЯчейки, "П5T2R") > 0) 
		   Тогда 	
	...
	ИначеЕсли НаименованиеТекЛиста = "Приложение5"
		   И (Найти(ИмяЯчейки, "G5") > 0) 
		   И (Найти(ИмяЯчейки, "П5T11R") > 0 ИЛИ Найти(ИмяЯчейки, "П5T12R") > 0) 
		   Тогда 	
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	Если ИмяРаздела = "Приложение9" Тогда
...
Процедура ПодготовитьДанныеДляПриложения5ВРазрезеКонтрагентов(Таблица,МассивСтатей,ИмяКолонки,ИмяГруппы)
	...
	ТаблицаКонтрагентов.Колонки.Добавить("БазаНДС7",		ОписаниеТиповЧисло);
		...
		Для каждого строка Из НужныеСтроки Цикл
			...
			ИначеЕсли ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппы52 Тогда	
				...
				Если  НЕ Строка.СтавкаНДС = Перечисления.СтавкиНДС.НДС7
					И НЕ Строка.СтавкаНДС = Перечисления.СтавкиНДС.НДС20 Тогда
				...
				Если    СтатьяДекларации = СтрокиДекларацииНДС.НДС_НКПокупкаСНДСвВРОблагПриобрОФ 
					...
					Если Строка.СтавкаНДС = Перечисления.СтавкиНДС.НДС7 Тогда
						R021G6 = R021G6 +  строка.НДСОборот;	
					Иначе	
			...
			НоваяСтрока.Контрагент = ?(РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "ЕРП",СокрЛП(Строка.Контрагент),СокрЛП(Строка.Контрагент));
			...
			Если  Строка.СтавкаНДС = Перечисления.СтавкиНДС.НДС7 Тогда
				НоваяСтрока.БазаНДС7 = строка.БазаНДСОборот;  
	...
	ТаблицаКонтрагентов.Свернуть("ИННКонтрагента,Дата,КассовыйМетод,КонтрагентСпецКода,СХПоставка", "БазаНДС,БазаНДС7, НДС,НДС7");
	...
	Для каждого строка Из Таблица Цикл
		...
		Если ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппы51 Тогда
			...
			Если    Строка.ИННКонтрагента = "100000000000"
				...
				//ИЛИ Строка.ИННКонтрагента = "600000000000" 
				Тогда
				...
				ИначеЕсли Строка.ИННКонтрагента = "600000000000" Тогда
					...
					СтруктураДанныхПриложение5["R0016G4"]  = СтруктураДанныхПриложение5["R0016G4"] + Строка.БазаНДС - Строка.БазаНДС7;
					СтруктураДанныхПриложение5["R00161G4"] = СтруктураДанныхПриложение5["R00161G4"]+ Строка.БазаНДС7;
					СтруктураДанныхПриложение5["R0016G5"]  = СтруктураДанныхПриложение5["R0016G5"] + Строка.НДС;
					СтруктураДанныхПриложение5["R00161G6"] = СтруктураДанныхПриложение5["R00161G6"]+ Строка.НДС7;
					
					
					Если НЕ Строка.БазаНДС = 0 Тогда
						_ДобавитьСтрокуРасшифровки(ЭтаФорма,"R0016G4", "Показник ""Обсяг поставки (без ПДВ)"" графи ""Інші"" ("+Строка.ИННКонтрагента+"), рядок 4.1 Додатку 5, Таблиці 1","+","" 					+ Строка.Контрагент, строка.БазаНДС - Строка.БазаНДС7,,,,,"Приложение5");
					КонецЕсли;
					Если НЕ Строка.БазаНДС = 0 Тогда
						_ДобавитьСтрокуРасшифровки(ЭтаФорма,"R00161G4", "Показник ""Обсяг поставки (без ПДВ)"" графи ""Інші"" ("+Строка.ИННКонтрагента+"), рядок 4.2 Додатку 5, Таблиці 1","+","" 					+ Строка.Контрагент, строка.БазаНДС7,,,,,"Приложение5");
					КонецЕсли;
					Если НЕ Строка.НДС = 0 Тогда
						_ДобавитьСтрокуРасшифровки(ЭтаФорма,"R0016G5", "Показник ""Сумма ПДВ, основна ставка"" графи ""Інші"" ("+Строка.ИННКонтрагента+"), рядок 4.1 Додатку 5, ""Податкові зобов'язання""","+",""		+ Строка.Контрагент, строка.НДС,,,,,"Приложение5");
					КонецЕсли;
					Если НЕ Строка.НДС7 = 0 Тогда
						_ДобавитьСтрокуРасшифровки(ЭтаФорма,"R00161G6", "Показник ""Сумма ПДВ, ставка 7%"" графи ""Інші"" ("+Строка.ИННКонтрагента+"), рядок 4.2 Додатку 5, Таблиці 1 ""Податкові зобов'язання""","+",""	+ Строка.Контрагент, строка.НДС7,,,,,"Приложение5");
					КонецЕсли;
		...
		Для каждого строка Из НайденныеСтроки Цикл
			...
			Иначе
				...
				Если Строка.ИННКонтрагента = "600000000000" Тогда
					Если Строка.СтавкаНДС = Перечисления.СтавкиНДС.НДС7 Тогда
						R0121G4 = R0121G4 + Строка.БазаНДСОборот;	
						R0121G6 = R0121G6 + Строка.НДСОборот;		
					ИначеЕсли Строка.СтавкаНДС = Перечисления.СтавкиНДС.НДС20 Тогда		
...
&НаСервере
Процедура ЗаполнитьИнформациюОНезарегистрированныхДокументах()

	Запрос = Новый Запрос();
	Если КонецМесяца(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = КонецМесяца('2018-06-01') Тогда
	    Запрос.УстановитьПараметр("ДатаНачала", '2015-07-01');
	Иначе	
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "ЕРП" Тогда
		Запрос.Текст = "ВЫБРАТЬ
		               |	МАКСИМУМ(ВЫБОР
		               |			КОГДА НО.Регистратор ССЫЛКА Документ.НалоговаяНакладная
		               |					ИЛИ НО.Регистратор ССЫЛКА Документ.Приложение2КНалоговойНакладной
		               |				ТОГДА ВЫБОР
		               |						КОГДА НО.Регистратор.ВидОперации В (&УслугиОтНерезидента)
		               |							ТОГДА ""500000000000""
		               |						КОГДА ЕСТЬNULL(НО.ПродажаНижеОбычнойЦены, ЛОЖЬ) = ИСТИНА
		               |							ТОГДА &ИННОрганизации
		               |						КОГДА НО.Регистратор.ВидОперации = &СводнаяУсловнаяПродажа
		               |							ТОГДА ""600000000000""
		               |						КОГДА НО.Регистратор.ВидОперации В (&ОсобыеВидыОпераций)
		               |							ТОГДА ВЫБОР
		               |									КОГДА ЕСТЬNULL(НО.Регистратор.НалоговаяНакладная.Сводная, НО.Регистратор.Сводная)
		               |										ТОГДА ""600000000000""
		               |									ИНАЧЕ ""400000000000""
		               |								КОНЕЦ
		               |						КОГДА НО.Регистратор.ТипПричиныНевыдачиПокупателю = 1
		               |							ТОГДА ""100000000000""
		               |						КОГДА НО.Регистратор.ТипПричиныНевыдачиПокупателю = 12
		               |							ТОГДА ""200000000000""
		               |						КОГДА НО.Регистратор.ТипПричиныНевыдачиПокупателю = 7
		               |							ТОГДА ""300000000000""
		               |						КОГДА ЕСТЬNULL(ПОДСТРОКА(НО.Регистратор.Контрагент.ИННПлательщикаНДС, 1, 1), """") = """"
		               |							ТОГДА ""100000000000""
		               |						ИНАЧЕ НО.Регистратор.Контрагент.ИННПлательщикаНДС
		               |					КОНЕЦ
		               |			ИНАЧЕ НО.АналитикаУчетаПоПартнерам.Контрагент.ИННПлательщикаНДС
		               |		КОНЕЦ) КАК ИННКонтрагента,
		               |	НО.Регистратор.Дата КАК Дата,
		               |	НО.Регистратор.Номер КАК Номер,
		               |	НО.Регистратор КАК Регистратор,
		               |	ЕСТЬNULL(НО.Регистратор.СпецРежимНалогообложения, 0) КАК СпецРежимНалогообложения,
		               |	ВЫБОР
		               |		КОГДА НО.Регистратор ССЫЛКА Документ.Приложение2КНалоговойНакладной
		               |			ТОГДА ИСТИНА
		               |		ИНАЧЕ ЛОЖЬ
		               |	КОНЕЦ КАК ЭтоКорректировка,
		               |	СУММА(НО.СуммаБезНДС) КАК База,
		               |	СУММА(ВЫБОР
		               |			КОГДА НО.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20)
		               |				ТОГДА НО.СуммаНДС
		               |			ИНАЧЕ 0
		               |		КОНЕЦ) КАК НДС20,
		               |	СУММА(ВЫБОР
		               |			КОГДА НО.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС7)
		               |				ТОГДА НО.СуммаНДС
		               |			ИНАЧЕ 0
		               |		КОНЕЦ) КАК НДС7,
		               |	МАКСИМУМ(ВЫБОР
		               ...
		               |						КОГДА НО.Регистратор.ВидОперации В (&ОсобыеВидыОпераций)
		               |							ТОГДА """"
		               |						ИНАЧЕ НО.Регистратор.Контрагент
		               |					КОНЕЦ
		               |			ИНАЧЕ НО.АналитикаУчетаПоПартнерам.Договор.Контрагент
		               |		КОНЕЦ) КАК Контрагент
		               |ИЗ
		               |	РегистрНакопления.НДСРеестрВыданныхНалоговыхДокументов КАК НО
		               |ГДЕ
		               |	НО.Период МЕЖДУ &ДатаНачала И &ДатаОкончания
		               |	И ЕСТЬNULL(НО.Регистратор.ВключаетсяВУточняющийРасчет, ИСТИНА) = ЛОЖЬ
		               |	И НО.АналитикаУчетаПоПартнерам.Организация = &Организация
		               |	И НЕ ЕСТЬNULL(НО.Регистратор.СтатусРегистрацииВЕРНН, ЗНАЧЕНИЕ(Перечисление.СтатусыРегистрацииВЕРНННалоговыхДокументов.ЗарегистрированВЕРНН)) = ЗНАЧЕНИЕ(Перечисление.СтатусыРегистрацииВЕРНННалоговыхДокументов.ЗарегистрированВЕРНН)
		               |
		               |СГРУППИРОВАТЬ ПО
		               |	ЕСТЬNULL(НО.Регистратор.СпецРежимНалогообложения, 0),
		               |	НО.Регистратор,
		               |	НО.Регистратор.Дата,
		               |	НО.Регистратор.Номер
		               |
		               |ИМЕЮЩИЕ
		               |	СУММА(НО.СуммаНДС) > 0
		               |
	...
	Иначе
		...
		Запрос.Текст = "ВЫБРАТЬ
					|	МАКСИМУМ(ВЫБОР КОГДА  НО.Регистратор ССЫЛКА Документ.НалоговаяНакладная ИЛИ НО.Регистратор ССЫЛКА Документ.Приложение2КНалоговойНакладной
					|					    ТОГДА 
					|							ВЫБОР КОГДА НО.Регистратор.ВидОперации В (&УслугиОтНерезидента) 
					|                             	   		ТОГДА ""500000000000""
					|								  КОГДА ЕстьNULL(НО.ПродажаНижеОбычнойЦены, Ложь) = Истина
					|									ТОГДА &ИННОрганизации						
					|								  КОГДА НО.Регистратор.ВидОперации В (&ОсобыеВидыОпераций)
					|                             	     	ТОГДА ВЫБОР КОГДА ЕстьNULL(НО.Регистратор.НалоговаяНакладная.Сводная, НО.Регистратор.Сводная) Тогда ""600000000000"" ИНАЧЕ ""400000000000"" КОНЕЦ
					...
					|                             	     	ТОГДА ""300000000000""
					|								  КОГДА ЕстьNULL(ПОДСТРОКА(НО.Регистратор.Контрагент.ИНН,1,1), """") = """" 
					|                             	     	ТОГДА ""100000000000""
					|                             	   ИНАЧЕ НО.Регистратор.Контрагент.ИНН
					|                          	КОНЕЦ
					|					ИНАЧЕ НО.ДоговорКонтрагента.Владелец.ИНН 
					|			 КОНЕЦ) КАК	ИННКонтрагента,
								
				   |	НО.Регистратор.Дата  КАК Дата,
				   
				   |	ВЫБОР
				   |		КОГДА НО.ПродажаНижеОбычнойЦены
	               |				И НЕ ЕСТЬNULL(НО.Регистратор.НалоговаяДляРезерваНомераПриПродажаНижеОбычнойЦены, ЗНАЧЕНИЕ(Документ.НалоговаяНакладная.ПустаяСсылка)) = ЗНАЧЕНИЕ(Документ.НалоговаяНакладная.ПустаяСсылка)
	               |			ТОГДА НО.Регистратор.НалоговаяДляРезерваНомераПриПродажаНижеОбычнойЦены.Номер
	               |		ИНАЧЕ НО.Регистратор.Номер
	               |	КОНЕЦ КАК Номер,
	               |	ВЫБОР
				   |		КОГДА НО.ПродажаНижеОбычнойЦены
	               |				И НЕ ЕСТЬNULL(НО.Регистратор.НалоговаяДляРезерваНомераПриПродажаНижеОбычнойЦены, ЗНАЧЕНИЕ(Документ.НалоговаяНакладная.ПустаяСсылка)) = ЗНАЧЕНИЕ(Документ.НалоговаяНакладная.ПустаяСсылка)
	               |			ТОГДА НО.Регистратор.НалоговаяДляРезерваНомераПриПродажаНижеОбычнойЦены
	               |		ИНАЧЕ НО.Регистратор
	               |	КОНЕЦ КАК Регистратор,
				   
				   |	ВЫБОР
	               |		КОГДА НО.Регистратор ССЫЛКА Документ.НалоговаяНакладная
	               |			ТОГДА ВЫРАЗИТЬ(НО.Регистратор КАК Документ.НалоговаяНакладная).СпецРежимНалогообложения
	               |		КОГДА НО.Регистратор ССЫЛКА Документ.Приложение2КНалоговойНакладной
	               |			ТОГДА ВЫРАЗИТЬ(НО.Регистратор КАК Документ.Приложение2КНалоговойНакладной).НалоговаяНакладная.СпецРежимНалогообложения
	               ...
	               |			ИНАЧЕ 0
	               |		КОНЕЦ) КАК НДС7,
	               |	НО.ДоговорКонтрагента.Владелец.Наименование КАК Контрагент
	               |ИЗ
	               |	РегистрНакопления.НДСНалоговыеОбязательства КАК НО
	               |ГДЕ
	               |	НО.Период МЕЖДУ &ДатаНачала И &ДатаОкончания
				   |    И ЕСТЬNULL(НО.Регистратор.ВключаетсяВУточняющийРасчет, ИСТИНА) = ЛОЖЬ
				   |	И НО.Организация = &Организация
	               |	И ЕСТЬNULL(НО.Регистратор.ВключенаВЕдиныйРеестрНалоговыхНакладных, ИСТИНА) = ЛОЖЬ
	               |СГРУППИРОВАТЬ ПО
	               |	НО.ДоговорКонтрагента,
	               |	НО.Регистратор,
	               |	ВЫБОР
	               |		КОГДА НО.Регистратор ССЫЛКА Документ.НалоговаяНакладная
	               |			ТОГДА ВЫРАЗИТЬ(НО.Регистратор КАК Документ.НалоговаяНакладная).СпецРежимНалогообложения
	               ...
	               |	ВЫБОР
	               |		КОГДА НО.Регистратор ССЫЛКА Документ.НалоговаяНакладная
	               |			ТОГДА ВЫРАЗИТЬ(НО.Регистратор КАК Документ.НалоговаяНакладная).ОбособленноеПодразделение.Префикс
	               |		КОГДА НО.Регистратор ССЫЛКА Документ.Приложение2КНалоговойНакладной
	               |			ТОГДА ВЫРАЗИТЬ(НО.Регистратор КАК Документ.Приложение2КНалоговойНакладной).НалоговаяНакладная.ОбособленноеПодразделение.Префикс
	               |	КОНЕЦ,
	               |	ВЫБОР
				   |		КОГДА НО.ПродажаНижеОбычнойЦены
	               |				И НЕ ЕСТЬNULL(НО.Регистратор.НалоговаяДляРезерваНомераПриПродажаНижеОбычнойЦены, ЗНАЧЕНИЕ(Документ.НалоговаяНакладная.ПустаяСсылка)) = ЗНАЧЕНИЕ(Документ.НалоговаяНакладная.ПустаяСсылка)
	               ...
	               |		ИНАЧЕ НО.Регистратор
	               |	КОНЕЦ,
	               |	НО.ПродажаНижеОбычнойЦены,
	               |	НО.ДоговорКонтрагента.Владелец.ИНН,
	               |	НО.Регистратор.Дата,
				   |	ВЫБОР КОГДА ЕстьNULL(ПродажаНижеОбычнойЦены, ЛОЖЬ) И НЕ ЕстьNULL(Регистратор.НалоговаяДляРезерваНомераПриПродажаНижеОбычнойЦены, ЗНАЧЕНИЕ(Документ.НалоговаяНакладная.ПустаяСсылка)) = ЗНАЧЕНИЕ(Документ.НалоговаяНакладная.ПустаяСсылка)
			   	   |		ТОГДА Регистратор.НалоговаяДляРезерваНомераПриПродажаНижеОбычнойЦены.Номер 
			   	   |		ИНАЧЕ Регистратор.Номер 
				   |	КОНЕЦ,
	               |	НО.ДоговорКонтрагента.Владелец
				   |ИМЕЮЩИЕ СУММА(НДС) > 0
				   |УПОРЯДОЧИТЬ ПО Дата, Номер";
	КонецЕсли;
				   
	ДанныеФормы 	= ЭтаФорма[СтруктураРеквизитовФормы.мИдГруппы1_11];
	Таблица1_11 = ДанныеФормыВЗначение(ДанныеФормы, Тип("ТаблицаЗначений"));
	Таблица1_11.Очистить();
	
	ДанныеФормы 	= ЭтаФорма[СтруктураРеквизитовФормы.мИдГруппы1_12];
	Таблица1_12 = ДанныеФормыВЗначение(ДанныеФормы, Тип("ТаблицаЗначений"));
	Таблица1_12.Очистить();
	
	ДанныеФормы 	= ЭтаФорма[СтруктураРеквизитовФормы.мИдГруппы51_11];
	Таблица51_11 = ДанныеФормыВЗначение(ДанныеФормы, Тип("ТаблицаЗначений"));
	Таблица51_11.Очистить();
	
	ДанныеФормы 	= ЭтаФорма[СтруктураРеквизитовФормы.мИдГруппы51_12];
	Таблица51_12 = ДанныеФормыВЗначение(ДанныеФормы, Тип("ТаблицаЗначений"));
	Таблица51_12.Очистить();
	
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		
		Если  Выборка.Дата < СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета Тогда
			Если Выборка.ЭтоКорректировка Тогда
				СтрокаТаблицы = Таблица1_12.Добавить();
				Префикс = "T12";
			Иначе	
				СтрокаТаблицы = Таблица51_12.Добавить();
				Префикс = "П5T12";
			КонецЕсли;
		Иначе	
			Если Выборка.ЭтоКорректировка Тогда
				СтрокаТаблицы = Таблица1_11.Добавить();
				Префикс = "T11";
			Иначе	
				СтрокаТаблицы = Таблица51_11.Добавить();
				Префикс = "П5T11";
			КонецЕсли;
		КонецЕсли;
		
		// Так как старые незарегистрированные налоговые накладные могут быть зарегистрированы только по текущей форме
		// не имеет смысла номер и правила определения ИНН формировать на дату выписки таких налоговых.
		// И номер и дату будем формировать по текущим правилам
		 СтрокаТаблицы[Префикс + "RXXXXG2"]  = Выборка.ИННКонтрагента;
		 СтрокаТаблицы[Префикс + "RXXXXG3D"] = Выборка.Дата;
		 СтрокаТаблицы[Префикс + "RXXXXG41"] = ПрефиксацияОбъектовКлиентСервер.ПолучитьНомерНаПечать(Выборка.Номер,Истина,Истина);
		 СтрокаТаблицы[Префикс + "RXXXXG42"] = ?(ЗначениеЗаполнено(Выборка.СпецРежимНалогообложения), Выборка.СпецРежимНалогообложения, "");
		 СтрокаТаблицы[Префикс + "RXXXXG5"]  = (Строка(Выборка.СпецРежимНалогообложения) = "2");
		 СтрокаТаблицы[Префикс + "RXXXXG6"]  = Выборка.База;
		 СтрокаТаблицы[Префикс + "RXXXXG7"]  = Выборка.НДС20;
		 СтрокаТаблицы[Префикс + "RXXXXG8"]  = Выборка.НДС7;
		 
		 СтрокаТаблицы[Префикс + "RXXXXKontragent"]  = Выборка.Контрагент;
		
	КонецЦикла;
	
	// выводим таблицы в декларацию
	Пока Таблица1_11.Количество() < мСтруктураИсхКолвоСтрокРазделов[СтруктураРеквизитовФормы.мИдГруппы1_11] Цикл
		Таблица1_11.Добавить();
	КонецЦикла;
	ЗначениеВРеквизитФормы(Таблица1_11, СтруктураРеквизитовФормы.мИдГруппы1_11);
	
	Пока Таблица1_12.Количество() < мСтруктураИсхКолвоСтрокРазделов[СтруктураРеквизитовФормы.мИдГруппы1_12] Цикл
		Таблица1_12.Добавить();
	КонецЦикла;
	ЗначениеВРеквизитФормы(Таблица1_12, СтруктураРеквизитовФормы.мИдГруппы1_12);
	
	Пока Таблица51_11.Количество() < мСтруктураИсхКолвоСтрокРазделов[СтруктураРеквизитовФормы.мИдГруппы51_11] Цикл
		Таблица51_11.Добавить();
	КонецЦикла;
	ЗначениеВРеквизитФормы(Таблица51_11, СтруктураРеквизитовФормы.мИдГруппы51_11);
	
	Пока Таблица51_12.Количество() < мСтруктураИсхКолвоСтрокРазделов[СтруктураРеквизитовФормы.мИдГруппы51_12] Цикл
		Таблица51_12.Добавить();
	КонецЦикла;
	ЗначениеВРеквизитФормы(Таблица51_12, СтруктураРеквизитовФормы.мИдГруппы51_12);
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	ЗаполнитьИнформациюОНезарегистрированныхДокументах();
	...
	СтруктураДанныхПриложение5.R011G6 = R011G6;
	...
	СтруктураДанныхПриложение1.R012G4 = R012G4_20 + R012G7; 
	СтруктураДанныхПриложение1.R012G5 = R012G5; 
	//СтруктураДанныхПриложение1.R012G6 = R012G6; 
	СтруктураДанныхПриложение1.R012G7 = R012G7; 
	СтруктураДанныхПриложение1.R0121G4 = R0121G4; 
	СтруктураДанныхПриложение1.R0121G6 = R0121G6; 
	
	СтруктураДанныхДекларация.R41GA =  R41GA + R012G4_20;
	СтруктураДанныхДекларация.R41GB =  R41GB + R012G5;
	СтруктураДанныхДекларация.R42GA =  R42GA + R0121G4;
	СтруктураДанныхДекларация.R42GB =  R42GB + R0121G6;
	...
	СтруктураДанныхПриложение5.R021G6 = R021G6; 
	...
	СтруктураДанныхПриложение1.R021G6 = R021G6; 
	...
	Иначе
		...
		Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 6 И Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2018 Тогда		
			ИмяСхемы = ПрефиксСхемы+"19";
		Иначе
			ИмяСхемы = ПрефиксСхемы+"20"
		КонецЕсли;
	...
	Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 12 Тогда
		...
		Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "ЕРП" Тогда
				ЗапросП7.Текст = "ВЫБРАТЬ
				                 ...
				                 |	СУММА(Приложение2КНалоговойНакладнойТовары.СуммаНДС) КАК КорректировкаНДС,
				                 |	СУММА(Приложение2КНалоговойНакладнойТовары.СуммаСНДС) КАК База
				                 |ИЗ
				                 |	Документ.Приложение2КНалоговойНакладной.ТоварыПоДаннымПользователя КАК Приложение2КНалоговойНакладнойТовары
				                 |		ЛЕВОЕ СОЕДИНЕНИЕ Документ.Приложение2КНалоговойНакладной КАК Приложение2КНалоговойНакладной
				                 |		ПО Приложение2КНалоговойНакладнойТовары.Ссылка = Приложение2КНалоговойНакладной.Ссылка
				                 |ГДЕ
		...
		Пока ВыборкаП7НН.Следующий() Цикл
			...
			Пока ВыборкаП7П2.Следующий() Цикл
				...
				ВыборкаП7Детали = ВыборкаП7П2.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
				...
				Пока ВыборкаП7Детали.Следующий() Цикл
					...
					Если ВыборкаП7Детали.СтавкаНДС = Перечисления.СтавкиНДС.НДС20 Тогда
						...
						// покажем данные по этим корректировкам также в приложении 1 (перенесем данные суммы из строки R012 в строку R014
						СтруктураДанныхПриложение1.R012G4 = СтруктураДанныхПриложение1.R012G4 - ВыборкаП7Детали.База;
						СтруктураДанныхПриложение1.R012G5 = СтруктураДанныхПриложение1.R012G5 - ВыборкаП7Детали.КорректировкаНДС;
						СтруктураДанныхПриложение1.R014G4 = СтруктураДанныхПриложение1.R014G4 + ВыборкаП7Детали.База;
						СтруктураДанныхПриложение1.R014G5 = СтруктураДанныхПриложение1.R014G5 + ВыборкаП7Детали.КорректировкаНДС;
					...
					Иначе
						...
						// покажем данные по этим корректировкам также в приложении 1 (перенесем данные суммы из строки R012 в строку R014
						СтруктураДанныхПриложение1.R012G4  = СтруктураДанныхПриложение1.R012G4 - ВыборкаП7Детали.База;
						СтруктураДанныхПриложение1.R0121G6 = СтруктураДанныхПриложение1.R0121G6 - ВыборкаП7Детали.КорректировкаНДС;
						СтруктураДанныхПриложение1.R0141G4 = СтруктураДанныхПриложение1.R0141G4 + ВыборкаП7Детали.База;
						СтруктураДанныхПриложение1.R0141G6 = СтруктураДанныхПриложение1.R0141G6 + ВыборкаП7Детали.КорректировкаНДС;
		...
		Пока Таблица.Количество() < мСтруктураИсхКолвоСтрокРазделов[СтруктураРеквизитовФормы.мИдГруппы7] Цикл
			Таблица.Добавить();
		КонецЦикла;
		Таблица.Сортировать("П7T2RXXXXG2D,П7T2RXXXXG3S,П7T2RXXXXG4D,П7T2RXXXXG5S");
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	Иначе // физ. лицо	
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0200120"; 
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Декларация о НДС';uk='Декларація про ПДВ'");
		НовСтрока.НазваниеСтраницыПанели ="Декларация";
		НовСтрока.Префикс = "Д";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0200420"; 
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Приложение 1 (Расчет корректировки сумм НДС)';uk='Додаток 1 (Розрахунок коригування сум ПДВ)'");
		НовСтрока.НазваниеСтраницыПанели ="Приложение1";
		
		НовСтрока= тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0215220"; 
		...
		НовСтрока= тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0200520"; 
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Приложение 3 (Расчет суммы бюджетного возмещения)';uk='Додаток 3 (Розрахунок суми бюджетного відшкодування)'");
		НовСтрока.НазваниеСтраницыПанели ="Приложение3";
		НовСтрока.Префикс = "П3";

		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0299820";
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Приложение 4 (Заявление про возврат суммы бюджетного возмещения)';uk='Додаток 4(Заява про повернення сумми бюджетного відшкодування)'");
		НовСтрока.НазваниеСтраницыПанели ="Приложение4";
		НовСтрока.Префикс ="П4";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0215120";
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 5 (Расшифровка налоговых обязательств)';uk='Додаток 5(Розшифровка податкових забов''язань)'");
		НовСтрока.НазваниеСтраницыПанели ="Приложение5";
		НовСтрока.Префикс ="П5";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0299320";
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0215720"; 
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 7 ';uk='Додаток 7 '");
		НовСтрока.НазваниеСтраницыПанели ="Приложение7";
		НовСтрока.Префикс ="П7";
		                                    
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0215820";
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 8 ';uk='Додаток 8 '");
		НовСтрока.НазваниеСтраницыПанели ="Приложение8";
		НовСтрока.Префикс ="П8";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0215320";
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 9 ';uk='Додаток 9 '");
		НовСтрока.НазваниеСтраницыПанели ="Приложение9";
		НовСтрока.Префикс ="П9";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0299720";
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Заявление о выборе квартального отчетного (налогового) периода';uk='Заява про вибір квартального звітного (податкового) періоду'");
		НовСтрока.НазваниеСтраницыПанели ="Заявление";
