...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено Тогда
		...
		Иначе // новый документ
			...
			ЗаполнитьПоказательНаВсехЗакладках("HZG", "X", ЭтаФорма, "|Приложение2|Приложение3|Приложение4|Приложение9|Приложение10|");
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент) Экспорт
	...
	Если    Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Декларация"
		...
		ИЛИ Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Приложение7"  Тогда
...
&НаСервереБезКонтекста
Процедура ОставитьТолькоЦифры(Текст);
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если Форма.СтруктураРеквизитовФормы.мНеВыдаватьСообщенияОбОшибкахВРасчете = Истина ИЛИ Форма.СтруктураРеквизитовФормы.НеВыдаватьСообщенияОбОшибкахВРасчете ИЛИ НЕ ЭтоОбычнаяДекларация Тогда
	Иначе
	...
	Иначе
		...
		R120GA6 = ПолучитьПоказательНаСервере("R120GA", Форма, "Декларация") - ПолучитьПоказательНаСервере("R120GA4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R120GA6", R120GA6, Форма, "Декларация");
		
		R120GB6 = ПолучитьПоказательНаСервере("R120GB", Форма, "Декларация") - ПолучитьПоказательНаСервере("R120GB4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R120GB6", R70GB6, Форма, "Декларация");
		
		Если    ОкруглитьЧислоПоФормату(Форма, R120GA6) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R022G4", Форма, "Приложение1")) 
			ИЛИ ОкруглитьЧислоПоФормату(Форма, R120GB6) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R022G5", Форма, "Приложение1") + ПолучитьПоказательНаСервере("R022G6", Форма, "Приложение1")) Тогда	
			ТекстСообщенияОбОшибкахРасчета = ТекстСообщенияОбОшибкахРасчета + Символы.ПС + Символы.Таб 
			+ НСтр("ru='значения строки 12 не совпадает с итогом по Таблцие 2 Приложения Д1 к декларации';uk='значення рядка 12 декларації не співпадає з підсумком по Таблиці 2 Додатку Д1 до декларації'");
		КонецЕсли;		
	...
	// значение в строке с кодом 400000000 первой таблицы Прил 5 покажем с точностью до гривни - ибо это значение совпадает со строкой 4, а остальные суммы это расшифровка строки 1.
	R0014G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0014G4", Форма, "Приложение5"));
	R0014G5 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0014G5", Форма, "Приложение5"));
	R0014G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0014G6", Форма, "Приложение5"));
	ЗаполнитьПоказательНаСервере("R0014G4", R0014G4, Форма, "Приложение5");
	ЗаполнитьПоказательНаСервере("R0014G5", R0014G5, Форма, "Приложение5");
	ЗаполнитьПоказательНаСервере("R0014G6", R0014G6, Форма, "Приложение5");
	...
	Иначе
		...
		R11GA6 = ПолучитьПоказательНаСервере("R11GA", Форма, "Декларация") - ПолучитьПоказательНаСервере("R11GA4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R11GA6", R11GA6, Форма, "Декларация");
		
		R12GA6 = ПолучитьПоказательНаСервере("R12GA", Форма, "Декларация") - ПолучитьПоказательНаСервере("R12GA4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R12GA6", R12GA6, Форма, "Декларация");
		
		R41GA6 = ПолучитьПоказательНаСервере("R41GA", Форма, "Декларация") - ПолучитьПоказательНаСервере("R41GA4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R41GA6", R41GA6, Форма, "Декларация");
		
		R42GA6 = ПолучитьПоказательНаСервере("R42GA", Форма, "Декларация") - ПолучитьПоказательНаСервере("R42GA4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R42GA6", R42GA6, Форма, "Декларация");
		
		R11GB6 = ПолучитьПоказательНаСервере("R11GB", Форма, "Декларация") - ПолучитьПоказательНаСервере("R11GB4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R11GB6", R11GB6, Форма, "Декларация");
		
		R41GB6 = ПолучитьПоказательНаСервере("R41GB", Форма, "Декларация") - ПолучитьПоказательНаСервере("R41GB4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R41GB6", R41GB6, Форма, "Декларация");
		
		R12GB6 = ПолучитьПоказательНаСервере("R12GB", Форма, "Декларация") - ПолучитьПоказательНаСервере("R12GB4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R12GB6", R12GB6, Форма, "Декларация");
		
		R42GB6 = ПолучитьПоказательНаСервере("R42GB", Форма, "Декларация") - ПолучитьПоказательНаСервере("R42GB4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R42GB6", R42GB6, Форма, "Декларация");
		
		Если (ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R11GA6", Форма, "Декларация") + ПолучитьПоказательНаСервере("R12GA6", Форма, "Декларация") + ПолучитьПоказательНаСервере("R41GA6", Форма, "Декларация") + ПолучитьПоказательНаСервере("R42GA6", Форма, "Декларация")) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R010G4", Форма, "Приложение5")))
				  или
			 (ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R11GB6", Форма, "Декларация") + ПолучитьПоказательНаСервере("R41GB6", Форма, "Декларация")) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R010G5", Форма, "Приложение5")))
			      ИЛИ
			 (ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R12GB6", Форма, "Декларация") + ПолучитьПоказательНаСервере("R42GB6", Форма, "Декларация")) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R010G6", Форма, "Приложение5"))) 	  Тогда
		...
		R101GA6 = ПолучитьПоказательНаСервере("R101GA",  Форма, "Декларация") - ПолучитьПоказательНаСервере("R101GA4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R101GA6", R101GA6, Форма, "Декларация");
		
		R102GA6 = ПолучитьПоказательНаСервере("R102GA",  Форма, "Декларация") - ПолучитьПоказательНаСервере("R102GA4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R102GA6", R102GA6, Форма, "Декларация");
		
		R101GB6 = ПолучитьПоказательНаСервере("R101GB",  Форма, "Декларация") - ПолучитьПоказательНаСервере("R101GB4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R101GB6", R101GB6, Форма, "Декларация");
		
		R102GB6 = ПолучитьПоказательНаСервере("R102GB",  Форма, "Декларация") - ПолучитьПоказательНаСервере("R102GB4", Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R102GB6", R102GB6, Форма, "Декларация");
		
		Если (ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R101GA6", Форма, "Декларация") + ПолучитьПоказательНаСервере("R102GA6", Форма, "Декларация")) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R020G4", Форма, "Приложение5")))
				или
			 (ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R101GB6", Форма, "Декларация")) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R020G5", Форма, "Приложение5")))
				или
			 (ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R102GB6", Форма, "Декларация")) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R020G6", Форма, "Приложение5")))	Тогда
	...
	Иначе
		...
		Если ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R50GA6", Форма, "Декларация")) <> ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01G4", Форма, "Справка")) Тогда
			
			ТекстСообщенияОбОшибкахРасчета = ТекстСообщенияОбОшибкахРасчета + Символы.ПС + Символы.Таб 
			+ НСтр("ru='значения строки 5 не совпадает с итогом по Приложению №6 к декларации';uk='значення рядка 5 декларації не співпадає з підсумком Додатку 6 до декларації'");
	...
	Иначе
		...
		Если ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R150GB6", Форма, "Декларация")) <> R150GB Тогда
	...
	Если Не СуммаПоСтолбцу6 = 0 Тогда
	    ЗаполнитьПоказательНаСервере("R02G3", ОкруглитьЧислоПоФормату(Форма, 100 * СуммаПоСтолбцу3 / СуммаПоСтолбцу6), Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R02G4", ОкруглитьЧислоПоФормату(Форма, 100 * СуммаПоСтолбцу4 / СуммаПоСтолбцу6), Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R02G5", ОкруглитьЧислоПоФормату(Форма, 100 * СуммаПоСтолбцу5 / СуммаПоСтолбцу6), Форма, "Приложение9");
	Иначе
	    ЗаполнитьПоказательНаСервере("R02G3", 0, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R02G4", 0, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R02G5", 0, Форма, "Приложение9");
	...
	Если Не СуммаПоСтолбцу8 = 0 Тогда
	    ЗаполнитьПоказательНаСервере("R03G6", ОкруглитьЧислоПоФормату(Форма, 100 * СуммаПоСтолбцу6 / СуммаПоСтолбцу8), Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R03G7", ОкруглитьЧислоПоФормату(Форма, 100 * СуммаПоСтолбцу7 / СуммаПоСтолбцу8), Форма, "Приложение9");
	Иначе
	    ЗаполнитьПоказательНаСервере("R03G6", 0, Форма, "Приложение9");
	    ЗаполнитьПоказательНаСервере("R03G7", 0, Форма, "Приложение9");
	КонецЕсли;		
	...
	R170GB4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R101GB4", Форма, "Декларация"))
											...
											+ ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R114GB4", Форма, "Декларация"))
	...
	Иначе	
		...
		ЗаполнитьПоказательНаСервере("R181GB4", R181GB4, Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R190GB4", R190GB4, Форма, "Декларация");
		
		ЗаполнитьПоказательНаСервере("R182GB4", 0, Форма, "Декларация");
	...
	Если ЭтоОбычнаяДекларация Тогда
		...
		R2021GB6 = R2021GB - R2021GB4;
		ЗаполнитьПоказательНаСервере("R2021GB6", R2021GB6, Форма, "Декларация");
		
		Если Окр(R2021GB6, 0) > 0 Тогда
			СуммаСловами = Окр(R2021GB6, 0);
			R0304G1S = ЧислоПрописью(СуммаСловами, "Л=uk_UA; ДП=Ложь","гривня,гривні,гривень,ж,,,,,0");
			R0304G2  = Окр(R2021GB6, 0);
		Иначе
			R0304G1S = "";
			R0304G2  = 0;
		КонецЕсли;
	...
	Иначе
		...
		ЗаполнитьПоказательНаСервере("R200GB4", 0, Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R201GB4", 0, Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R202GB4", 0, Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R2021GB4", 0, Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R2022GB4", 0, Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R203GB4", 0, Форма, "Декларация");
		
		ЗаполнитьПоказательНаСервере("R210GB4", ПолучитьПоказательНаСервере("R190GB4", Форма, "Декларация"), Форма, "Декларация");
	...
	R183GB6 = ПолучитьПоказательНаСервере("R181GB6", Форма, "Декларация");
	R183GB6 = ?(R183GB6 <= 0, 0, ОкруглитьЧислоПоФормату(форма, R183GB6 * Форма.СтруктураРеквизитовФормы.ПроцентШтрафа / 100));
	ЗаполнитьПоказательНаСервере("R183GB6", R183GB6, Форма, "Декларация");
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	НаименованиеТекЛиста = Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим;
	 ...
	 //   
	 //   Значение = СтруктураДанныхСлужебныеДанные.HZKVP;
	 //   ОписаниеОповещения = Новый ОписаниеОповещения("ВводПоказателяВПолеТабличногоДокументЗавершение",
	 //   											   ЭтаФорма, Новый Структура("ИмяЯчейки, ИмяСтраницы,
	 //   																		 |ИмяЯчейкиКвадратов, ИмяСтраницыКвадратов, 
	 //   																		 |Размерность, ДополнитьЗначение, НольКакНоль", 
	 //   																		 "HZKVP",  "СлужебныеДанные",
	 //   																		 , ,
	 //   																		 1, Ложь, Неопределено));
	 //   
...
Процедура ВводПоказателяВПолеТабличногоДокументЗавершение(Значение, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли    Найти(ДополнительныеПараметры.ИмяЯчейкиКвадратов, "МесОш") > 0 Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(ЭтаФорма, "Приложение10",ДополнительныеПараметры.ИмяЯчейкиКвадратов, 2, Значение, ДополнительныеПараметры.ДополнитьЗначение, ДополнительныеПараметры.НольКакНоль);
	...
	ИначеЕсли    Найти(ДополнительныеПараметры.ИмяЯчейкиКвадратов, "ГодОш") > 0 Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(ЭтаФорма, "Приложение10",ДополнительныеПараметры.ИмяЯчейкиКвадратов, 4, Значение, ДополнительныеПараметры.ДополнитьЗначение, ДополнительныеПараметры.НольКакНоль);
...
Процедура ЗаполнитьАвто(Команда)
	...
	ИначеЕсли НЕ ЗначениеЗаполнено(СтруктураРеквизитовФормы.УточняемыйОтчет) Тогда
		...
		ПоказатьПредупреждение(Новый ОписаниеОповещения("ЗаполнитьАвтоЗавершение", ЭтаФорма) ,НСтр("ru='Не указана Декларация или последний уточняющий расчет к декларации, в коротой исправляются ошибки.
	...
	Иначе
		...
		Иначе
			...
			ПоказатьПредупреждение(Новый ОписаниеОповещения("ЗаполнитьАвтоЗавершение", ЭтаФорма), НСтр("ru='Указан некорректный отчет в качестве Декларации или последнего уточняющего расчета к декларации, в коротой исправляются ошибки.
...
Функция ПроверитьУточняемыйОтчет(Организация, УточняемыйОтчет, УточняемыйГод, УточняемыйКв, УточняемыйМес)
	...
	Если  УточняемыйОтчет.Организация  = Организация
		...
		И HZYP  = УточняемыйГод 
		И HZKVP = УточняемыйКв 
		И HZMP  = УточняемыйМес
		Тогда
	...
	Для i = 0 по МассивСтатей.Количество()- 1 Цикл
		...
		Для каждого строка Из НужныеСтроки Цикл
			...
			ИначеЕсли ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппы52 Тогда	
				...
				Если ТипЗнч(Строка.Регистратор) = Тип("ДокументСсылка.ГТДИмпорт") Тогда
					Если Строка.СтавкаНДС = Перечисления.СтавкиНДС.НДС7 Тогда
			...
			ИначеЕсли НЕ ЗначениеЗаполнено(Строка.ИННКонтрагента) Тогда	
				Сообщить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Имеются входящие налоговые накладные от контрагента  %1 с незаполненным ИНН!';uk= 'Є вхідні податкові налогові від контрагента  %1  з незаповненим ІПН!'"), Строка.ДоговорКонтрагента.Владелец));
			КонецЕсли;	
...
Процедура ЗаполнитьКолонку4ДаннымиИзОтчета()
	...
	Если Показатели.Свойство("R240GB") Тогда
		СтруктураДанныхДекларация["R202GB4"] = СтруктураДанныхДекларация["R202GB4"]    
												 + СтруктураДанныхДекларация["R2021GB4"];
														   
		СтруктураДанныхДекларация["R120GA4"] = СтруктураДанныхДекларация["R120GA4"]    
												 - СтруктураДанныхДекларация["R130GA4"];
														   
		СтруктураДанныхДекларация["R120GB4"] = СтруктураДанныхДекларация["R120GB4"]    
												 - СтруктураДанныхДекларация["R130GB4"];
														   
		СтруктураДанныхДекларация["R120GB4"] = СтруктураДанныхДекларация["R120GB4"]    
												 - СтруктураДанныхДекларация["R140GB4"];
														   
		СтруктураДанныхДекларация["R120GA4"] = СтруктураДанныхДекларация["R120GA4"]    
												 - СтруктураДанныхДекларация["R150GA4"];
		СтруктураДанныхДекларация["R120GB4"] = СтруктураДанныхДекларация["R120GB4"]    
												 - СтруктураДанныхДекларация["R150GB4"];
														   
	Иначе
		
		Если  Показатели.Свойство("R191G3")  Тогда
			 СтруктураДанныхДекларация["R191G3"] = Показатели.R191G3; 
		КонецЕсли;											 
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	Запрос.УстановитьПараметр ("НачДата",НачалоДня(СтруктураРеквизитовФормы.ДатаНач));
	...
	//16.2
	// корректировка кредита по результатам поданных уточненяющих расчетов
	R162GB = 0;
	...
	//////////////////////////////////
	// заполнение таблицы 2 и таблицы 3 Приложения 7 будет реализиовано ближе к декабрю 2016 года
	//////////////////////////////////
		...
		СтруктураДанныхДекларация.R120GA = СтруктураДанныхПриложение1.R022G4;
		СтруктураДанныхДекларация.R120GB = СтруктураДанныхПриложение1.R022G5 + СтруктураДанныхПриложение1.R022G6;

		СтруктураДанныхДекларация.R150GB = СтруктураДанныхПриложение7.R031G7
		 						             + СтруктураДанныхПриложение7.R032G7
											 + СтруктураДанныхПриложение7.R033G7;	 
		ВывестиМакетВТаблДокНаСервере(СтруктураРеквизитовФормы.НаимТекущегоРаздела, 1);
		Расчет(ЭтаФорма);
		СохранитьДанныеРаздела(СтруктураРеквизитовФормы.НаимТекущегоРаздела, Ложь);
...
//&НаСервере
//Функция ПоказателиПредыдущейДекларации(ДатаНачалаПериода,ДатаОкончанияПериода,ИсточникОтчета,ИсточникУточненки,ПредставлениеОтчета,ИмяПоля,ПредставлениеПоказателя)
//    перем ПоказателиОтчета;
		...
		Попытка
			...
			Если Данные = Неопределено Тогда
				...
				Если глМенеджерЗвит1С.ИмяСхемыЗвит1С = ПараметрыЗаполненияЗвит1С.ИмяСхемы Тогда
					ТекстСообщения = "Збереженого звіту ""Декларація по ПДВ"" ("+ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.ИмяСхемы+") за "+ПредставлениеПериода(ПараметрыЗаполненияЗвит1С.ДатПрошлогоПериода1, ПараметрыЗаполненияЗвит1С.ДатПрошлогоПериода2, "Л=uk_UA")+" не виявлено!
			...
			Иначе
				...
				R161GB = Данные.GetValue("MAIN", ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.ИмяПоказателяПредыдущейДекларации);
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	Если ЮрЛицо Тогда
		...
		// 0110 - общая
		    ...
		    НовСтрока.ИмяСхемы = "J0217009"; 
			НовСтрока.ПредставлениеСхемы =НСтр("ru='Уточняющий расчет к Декларации по НДС';uk='Уточнюючий розрахунок до Декларації з ПДВ'");
			НовСтрока.НазваниеСтраницыПанели ="Декларация";
	        НовСтрока.Префикс = "Д";

			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0200515"; 
		...
		// 012* - бывшая сокращенная
			НовСтрока = тбСхемыXML.Добавить();
		    НовСтрока.ИмяСхемы = "J0297009"; 
			НовСтрока.ПредставлениеСхемы =НСтр("ru='Уточняющий расчет к Декларации по НДС';uk='Уточнюючий розрахунок до Декларації з ПДВ'");
			НовСтрока.НазваниеСтраницыПанели ="Декларация";
	        НовСтрока.Префикс = "Д";

			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0209109"; 
			НовСтрока.ПредставлениеСхемы =НСтр("ru='Приложение 1 (Расчет корректировки сумм НДС)';uk='Додаток 1 (Розрахунок коригування сум ПДВ)'");
			НовСтрока.НазваниеСтраницыПанели ="Приложение1";
				
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0209208";
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 5 (Расшифровка налоговых обязательств)';uk='Додаток 5(Розшифровка податкових забов''язань)'");
			НовСтрока.НазваниеСтраницыПанели ="Приложение5";
			НовСтрока.Префикс ="П5";
			
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0299008";
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 6 (Справка)';uk='Додаток 6 (Довідка)'");
			НовСтрока.НазваниеСтраницыПанели ="Справка";
			НовСтрока.Префикс ="С1";
			
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0290705"; 
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 7 ';uk='Додаток 7 '");
			НовСтрока.НазваниеСтраницыПанели ="Приложение7";
			НовСтрока.Префикс ="П7";
			                                    
			//НовСтрока = тбСхемыXML.Добавить();
			//НовСтрока.ИмяСхемы = "J0290503";
		...
		ИначеЕсли (ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HNS",ЭтаФорма,"Декларация"))) Тогда
			...
			НовСтрока = тбСхемыXML.Добавить();
		    НовСтрока.ИмяСхемы = "J0294708"; 
			НовСтрока.ПредставлениеСхемы =НСтр("ru='Уточняющий расчет к Декларации по НДС';uk='Уточнюючий розрахунок до Декларації з ПДВ'");
			НовСтрока.НазваниеСтраницыПанели ="Декларация";
	        НовСтрока.Префикс = "Д";

			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0294108"; 
			НовСтрока.ПредставлениеСхемы =НСтр("ru='Приложение 1 (Расчет корректировки сумм НДС)';uk='Додаток 1 (Розрахунок коригування сум ПДВ)'");
			НовСтрока.НазваниеСтраницыПанели ="Приложение1";
				
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0294208";
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 5 (Расшифровка налоговых обязательств)';uk='Додаток 5(Розшифровка податкових забов''язань)'");
			НовСтрока.НазваниеСтраницыПанели ="Приложение5";
			НовСтрока.Префикс ="П5";
			
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0294008";
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 6 (Справка)';uk='Додаток 6 (Довідка)'");
			НовСтрока.НазваниеСтраницыПанели ="Справка";
			НовСтрока.Префикс ="С1";
			
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0294605"; 
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 7 ';uk='Додаток 7 '");
			НовСтрока.НазваниеСтраницыПанели ="Приложение7";
			НовСтрока.Префикс ="П7";
			                                    
			//НовСтрока = тбСхемыXML.Добавить();
			//НовСтрока.ИмяСхемы = "J0294503";
			//НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 8 ';uk='Додаток 8 '");
			//НовСтрока.НазваниеСтраницыПанели ="Приложение8";
			//НовСтрока.Префикс ="П8";

			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0294308";
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 9 ';uk='Додаток 9 '");
			НовСтрока.НазваниеСтраницыПанели ="Приложение9";
			НовСтрока.Префикс ="П9";
			
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0294401";
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение ДС10 ';uk='Додаток ДС10 '");
			НовСтрока.НазваниеСтраницыПанели ="Приложение10";
			НовСтрока.Префикс ="П10";
	...
	Иначе // физ. лицо	
		...
		НовСтрока = тбСхемыXML.Добавить();
	    НовСтрока.ИмяСхемы = "F0217009"; 
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Уточняющий расчет к Декларации по НДС';uk='Уточнюючий розрахунок до Декларації з ПДВ'");
		НовСтрока.НазваниеСтраницыПанели ="Декларация";
        НовСтрока.Префикс = "Д";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0200415"; 
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Приложение 1 (Расчет корректировки сумм НДС)';uk='Додаток 1 (Розрахунок коригування сум ПДВ)'");
		НовСтрока.НазваниеСтраницыПанели ="Приложение1";
		
		НовСтрока= тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0215208"; 
		...
		НовСтрока= тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0200513"; 
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Приложение 3 (Расчет суммы бюджетного возмещения)';uk='Додаток 3 (Розрахунок суми бюджетного відшкодування)'");
		НовСтрока.НазваниеСтраницыПанели ="Приложение3";

		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0299809";
		НовСтрока.ПредставлениеСхемы =НСтр("ru='Приложение 4 (Заявление про возврат суммы бюджетного возмещения)';uk='Додаток 4(Заява про повернення сумми бюджетного відшкодування)'");
		НовСтрока.НазваниеСтраницыПанели ="Приложение4";
		НовСтрока.Префикс ="П4";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0215108";
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 5 (Расшифровка налоговых обязательств)';uk='Додаток 5(Розшифровка податкових забов''язань)'");
		НовСтрока.НазваниеСтраницыПанели ="Приложение5";
		НовСтрока.Префикс ="П5";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0299308";
...
Процедура ОткрытьФормуПараметров(Команда)
	...
	Если ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HZG",  ЭтаФорма, "Декларация")) Тогда
		ИмяПоляТипа = "HZG";
	ИначеЕсли ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HSG",  ЭтаФорма, "Декларация")) Тогда
		ИмяПоляТипа = "HSG";
	ИначеЕсли ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HLG",  ЭтаФорма, "Декларация")) ТОгда
		ИмяПоляТипа = "HLG";
	ИначеЕсли ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HRB",  ЭтаФорма, "Декларация")) Тогда
		ИмяПоляТипа = "HRB";
	ИначеЕсли ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HNS",  ЭтаФорма, "Декларация")) Тогда	
		ИмяПоляТипа = "HNS";
	КонецЕсли;
	...
	мПараметрыФормы.Вставить("ИмяПоляТипа", ИмяПоляТипа);
