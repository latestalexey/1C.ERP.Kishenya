...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если НЕ ЭтоОбычнаяДекларация И ЛОЖЬ Тогда
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	КонецЕсли;
		...
		//////////////////////////////////
		// заполнение таблицы 2 и таблицы 3 Приложения 7 будет реализовано ближе к декабрю 2016 года
		//////////////////////////////////
