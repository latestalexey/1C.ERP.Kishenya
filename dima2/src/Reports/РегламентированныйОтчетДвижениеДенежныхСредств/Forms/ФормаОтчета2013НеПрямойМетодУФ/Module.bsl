...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	П35703 = ПолучитьПоказательНаСервере("П35003", Форма, "ДДС") 
								 ...
								 - ПолучитьПоказательНаСервере("П35004", Форма, "ДДС")
	...
	П35705 = ПолучитьПоказательНаСервере("П35005", Форма, "ДДС") 
								 ...
								 - ПолучитьПоказательНаСервере("П35006", Форма, "ДДС")
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации()  =  "БП" Тогда
		...
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "Рядок 3515, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,СчетДоходовОпер), Счет30,СчетДоходовОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "",	"+", "!ОБ",ОБ2(Счет31,СчетДоходовОпер),Счет31,СчетДоходовОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "",	"+", "!ОБ",ОБ2(Счет33,СчетДоходовОпер),Счет33,СчетДоходовОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "",	"+", "!ОБ",ОБ2(Счет30,СчетДоходовНеОпер),Счет30,СчетДоходовНеОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "",	"+", "!ОБ",ОБ2(Счет31,СчетДоходовНеОпер),Счет31,СчетДоходовНеОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "",	"+", "!ОБ",ОБ2(Счет33,СчетДоходовНеОпер),Счет33,СчетДоходовНеОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "",	"-", "!ОБ",ОБ2(СчетЗатратНеОпер,Счет30),СчетЗатратНеОпер,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "",	"-", "!ОБ",ОБ2(СчетЗатратНеОпер,Счет31),СчетЗатратНеОпер,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,П3515кол, "",	"-", "!ОБ",ОБ2(СчетЗатратНеОпер,Счет33),СчетЗатратНеОпер,Счет33,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	Иначе	
		...
		НомерКолонкиДДС = 6;
	КонецЕсли;
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П3524" + НомерКолонкиДДС, "Рядок 3524, графа " + НомерКолонкиДДС,	"+", "!ДО", ДО2(Счет97_1), Счет97_1,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П3524" + НомерКолонкиДДС, , "-", "!КО",КО2(Счет74_1), Счет74_1,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)),  КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	Иначе	
		...
		НомерКолонкиДДС = 6;
	КонецЕсли;
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П" + "3526" + НомерКолонкиДДС, "Рядок 3526, графа " + НомерКолонкиДДС,	"+", "!ДО", ДО2(Счет97_2), Счет97_2,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П" + "3526" + НомерКолонкиДДС, , "-", "!КО",КО2(Счет74_2), Счет74_2,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)),  КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	Если Истина Тогда //группировка
		...
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!ОБ",ОБ2(Счет15,Счет20),Счет15,Счет20, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!ОБ",ОБ2(Счет15,Счет21),Счет15,Счет21, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!ОБ",ОБ2(Счет15,Счет22),Счет15,Счет22, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!ОБ",ОБ2(Счет15,Счет23),Счет15,Счет23, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!ОБ",ОБ2(Счет15,Счет25),Счет15,Счет25, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!ОБ",ОБ2(Счет15,Счет26),Счет15,Счет26, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!ОБ",ОБ2(Счет15,Счет27),Счет15,Счет27, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!ОБ",ОБ2(Счет15,Счет28),Счет15,Счет28, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		...
		Иначе		
			_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!СКДР",СКДР2(Счет64_1_3),Счет64_1_3,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
			_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"+", "!СНДР",СНДР2(Счет64_1_3),Счет64_1_3,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		КонецЕсли;

		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"-", "!СКДР",СКДР2(Счет68_4),Счет68_4,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3550" + НомерКолонкиДДС, "0",	"+", "!СНДР",СНДР2(Счет68_4),Счет68_4,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3551" + НомерКолонкиДДС, "",	"-", "!ОБ",ОБ2(Счет15,Счет20),Счет15,Счет20, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3551" + НомерКолонкиДДС, "",	"-", "!ОБ",ОБ2(Счет15,Счет21),Счет15,Счет21, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3551" + НомерКолонкиДДС, "",	"-", "!ОБ",ОБ2(Счет15,Счет22),Счет15,Счет22, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3551" + НомерКолонкиДДС, "",	"-", "!ОБ",ОБ2(Счет15,Счет23),Счет15,Счет23, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3551" + НомерКолонкиДДС, "",	"-", "!ОБ",ОБ2(Счет15,Счет25),Счет15,Счет25, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3551" + НомерКолонкиДДС, "",	"-", "!ОБ",ОБ2(Счет15,Счет26),Счет15,Счет26, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3551" + НомерКолонкиДДС, "",	"-", "!ОБ",ОБ2(Счет15,Счет27),Счет15,Счет27, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3551" + НомерКолонкиДДС, "",	"-", "!ОБ",ОБ2(Счет15,Счет28),Счет15,Счет28, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	Если Истина Тогда //группировка
		...
		Иначе	
			_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3560" + НомерКолонкиДДС, "0",	"-", "!СККР",СККР2(Счет64_1_3),Счет64_1_3,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
			_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3560" + НомерКолонкиДДС, "0",	"+", "!СНКР",СНКР2(Счет64_1_3),Счет64_1_3,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		КонецЕсли;
	...
	Иначе	
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3562" + НомерКолонкиДДС, "",	"-", "!СККР",СККР2(Счет64_1_3),Счет64_1_3,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П" + "3562" + НомерКолонкиДДС, "",	"+", "!СНКР",СНКР2(Счет64_1_3),Счет64_1_3,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	КонецЕсли;
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П35806", "Рядок 3580, Графа 6",	"+", "!ОБ",ОБ2(Счет64_1_3,Счет31), Счет64_1_3,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П35806", "",	"+", "!ОБ",ОБ2(Счет64_1_3,Счет30), Счет64_1_3,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П35856", "Рядок 3585, Графа 6",	"+", "!ОБ",ОБ2(Счет68_4,Счет31), Счет68_4,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П35856", "",	"+", "!ОБ",ОБ2(Счет68_4,Счет30), Счет68_4,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П32554", "Рядок 3255, графа ""За попередній період""",	"+", "!ДО",ДО2(Счет14), Счет14,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П32554", "",	"+", "!ДО",ДО2(Счет35_2), Счет35_2,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33454", "Рядок 3345, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет45,Счет30), Счет45,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33454", "",	"+", "!ОБ",ОБ2(Счет45,Счет31),Счет45,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33504", "Рядок 3350, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет50,Счет30), Счет50,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33504", "",	"+", "!ОБ",ОБ2(Счет52,Счет30),Счет52,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33504", "",	"+", "!ОБ",ОБ2(Счет55,Счет30),Счет55,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33504", "",	"+", "!ОБ",ОБ2(Счет60,Счет30),Счет60,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33504", "",	"+", "!ОБ",ОБ2(Счет50,Счет31),Счет50,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33504", "",	"+", "!ОБ",ОБ2(Счет52,Счет31),Счет52,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33504", "",	"+", "!ОБ",ОБ2(Счет55,Счет31),Счет55,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33504", "",	"+", "!ОБ",ОБ2(Счет60,Счет31),Счет60,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33554", "Рядок 3355, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет67_1,Счет30), Счет67_1,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33554", "",	"+", "!ОБ",ОБ2(Счет67_1,Счет31),Счет67_1,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33604", "Рядок 3360, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет95_1,Счет30), Счет95_1,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33604", "",	"+", "!ОБ",ОБ2(Счет95_1,Счет31),Счет95_1,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33654", "Рядок 3365, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет95_2,Счет30), Счет95_2,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33654", "",	"+", "!ОБ",ОБ2(Счет95_2,Счет31),Счет95_2,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33904", "Рядок 3390, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет53,Счет30), Счет53,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33904", "0",	"+", "!ОБ",ОБ2(Счет53,Счет31),Счет53,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34054", "Рядок 3405, графа 5",	"+", "!СНД",СНД2(Счет30), Счет30,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34054", "",	"+", "!СНД",СНД2(Счет31),Счет31,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34054", "",	"+", "!СНД",СНД2(Счет33),Счет33,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	Если СтруктураРеквизитовФормы.ПолучениеДанныхДляЗвит1С = Истина Тогда
		...
		Иначе
			...
			Попытка
				...
				РезБалансПрошлыйПериод = глКомпонентаЗвит1С.GetReport(ИмяСхемы, 30, 1, Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета)-1);
				Если РезБалансПрошлыйПериод = Неопределено Тогда
					ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='За %1 не обнаружено ни одного сохраненного отчета %2!';uk='За %1 не виявлено жодного збереженого звіту %2!'"), ПредставлениеПериода( НачалоКвартала(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, -12)), "Л = ""uk_UA""; ФП = Истина" ), "Баланс");
					глМенеджерЗвит1С.ПредупреждениеЗвит1С(ТекстСообщения, "Завантаження даних з ""FREDO Звіт""");
				КонецЕсли;
			Исключение
				Если глМенеджерЗвит1С.ФлагОтладки Тогда
