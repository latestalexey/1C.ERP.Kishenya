...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	мБухИтогиПрошлыйГод.РассчитатьИтоги("Хозрасчетный", Итоги, "Сумма", "Счет,КорСчет", НачалоГода (ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета,-12)), КонецГода (ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета,-12)), , , , , , "Организация", СтруктураРеквизитовФормы.Организация);
	...
	П30004 = ОБ2(Счет30,Счет36)     + ОБ2(Счет31,Счет36)     + 
			 ...
			 ОБ2(Счет30,Счет70);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "Рядок 3000, графа ""За попередній період.""",	"+", "!ОБ",ОБ2(Счет30,Счет36),Счет30,Счет36, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "0",	"+","!ОБ", ОБ2(Счет31,Счет36),Счет31,Счет36, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "0",	"+", "!ОБ",ОБ2(Счет30,Счет68_5),Счет30,Счет68_5, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "0",	"+", "!ОБ",ОБ2(Счет31,Счет68_5),Счет31,Счет68_5, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "0",	"+", "!ОБ",ОБ2(Счет30,Счет37_7_1),Счет30,Счет37_7_1, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "0",	"+", "!ОБ",ОБ2(Счет31,Счет37_7_1),Счет31,Счет37_7_1, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "0",	"+", "!ОБ",ОБ2(Счет30,Счет37_7_2),Счет30,Счет37_7_2, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "0",	"+", "!ОБ",ОБ2(Счет31,Счет37_7_2),Счет31,Счет37_7_2, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30004", "0",	"+", "!ОБ",ОБ2(Счет30,Счет70),Счет30,Счет70, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30054", "Рядок 3005, графа ""За попередній період.""",	"+", "!ОБ",ОБ2(Счет30,Счет64),Счет30,Счет64, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30054", "",	"+","!ОБ",ОБ2(Счет31,Счет64),Счет31,Счет64, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30064", "Рядок 3006, графа ""За попередній період.""",	"+", "!ОБ",ОБ2(Счет31,Счет64_1_2),Счет31,Счет64_1_2, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30104", "Рядок 3010, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет48),Счет30,Счет48,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30104", "",	"+", "!ОБ",ОБ2(Счет31,Счет48),Счет31,Счет48, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30154", "Рядок 3015, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет68_1),Счет30,Счет68_1, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30154", "0",	"+","!ОБ",ОБ2(Счет31,Счет68_1),Счет31,Счет68_1, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30204", "Рядок 3020, графа ""За попередній період.""",	"+", "!ОБ",ОБ2(Счет30,Счет37_1),Счет30,Счет37_1, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30204", "0",	"+", "!ОБ",ОБ2(Счет31,Счет37_1),Счет31,Счет37_1, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30204", "0",	"+", "!ОБ",ОБ2(Счет30,Счет63),Счет30,Счет63, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30204", "0",	"+", "!ОБ",ОБ2(Счет31,Счет63),Счет31,Счет63, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30354", "Рядок 3035, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет37_4),Счет30,Счет37_4,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30354", "","+", "!ОБ",ОБ2(Счет31,Счет37_4),Счет31,Счет37_4,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30354", "","+", "!ОБ",ОБ2(Счет30,Счет37_5),Счет30,Счет37_5,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30354", "","+", "!ОБ",ОБ2(Счет31,Счет37_5),Счет31,Счет37_5,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30354", "","+", "!ОБ",ОБ2(Счет30,Счет71_5),Счет30,Счет71_5,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30354", "","+", "!ОБ",ОБ2(Счет31,Счет71_5),Счет31,Счет71_5,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30404", "Рядок 3040, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет71_3),Счет30,Счет71_3,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30404", "","+", "!ОБ",ОБ2(Счет31,Счет71_3),Счет31,Счет71_3,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30454", "Рядок 3045, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет37_3),Счет30,Счет37_3,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30454", "","+", "!ОБ",ОБ2(Счет31,Счет37_3),Счет31,Счет37_3,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	П30953 = ОБ(Счет30,Счет74_6) + ОБ(Счет31,Счет74_6) + 
			...
			ДО(Счет33) - ОБ(Счет33,Счет33)  - ОБ(Счет33,Счет30) - ОБ(Счет33,Счет31) + 
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "17",	"+", "!ДО",ДО(Счет33), Счет33);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "16",	"-", "!ОБ",ОБ(Счет33,Счет33), Счет33,Счет33);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "15",	"-", "!ОБ",ОБ(Счет33,Счет30), Счет33,Счет30);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "14",	"-", "!ОБ",ОБ(Счет33,Счет31), Счет33,Счет31);
	...
	П30954 = ОБ2(Счет30,Счет74_6) + ОБ2(Счет31,Счет74_6) + 
			ОБ2(Счет30,Счет71_9) + ОБ2(Счет31,Счет71_9) +
  			ДО2(Счет33) - ОБ2(Счет33,Счет33)  - ОБ2(Счет33,Счет30) - ОБ2(Счет33,Счет31) + 
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "Рядок 3095, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет74_6), Счет30,Счет74_6,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "20",	"+", "!ОБ",ОБ2(Счет31,Счет74_6),Счет31,Счет74_6,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "19",	"+", "!ОБ",ОБ2(Счет30,Счет71_9),Счет30,Счет71_9,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "18",	"+", "!ОБ",ОБ2(Счет31,Счет71_9),Счет31,Счет71_9,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "17",	"+", "!ДО",ДО2(Счет33), Счет33,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "16",	"-", "!ОБ",ОБ2(Счет33,Счет33), Счет33,Счет33,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "15",	"-", "!ОБ",ОБ2(Счет33,Счет30), Счет33,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "14",	"-", "!ОБ",ОБ2(Счет33,Счет31), Счет33,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "13",	"+", "!ОБ",ОБ2(Счет30,Счет37_7_3),Счет30,Счет37_7_3,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "12",	"+", "!ОБ",ОБ2(Счет31,Счет37_7_3),Счет31,Счет37_7_3,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "11",	"+", "# оборот по счету 75 актуален в отчетах 2013 года",0);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "10",	"+", "!ОБ",ОБ2(Счет30,Счет75), Счет30,Счет75,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "09",	"+", "!ОБ",ОБ2(Счет31,Счет75),Счет31,Счет75,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "08",	"+", "!ОБ",ОБ2(Счет30,Счет37_8), Счет30,Счет37_8,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "07",	"+", "!ОБ",ОБ2(Счет31,Счет37_8),Счет31,Счет37_8,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "06",	"+", "!ОБ",ОБ2(Счет30,Счет37_2), Счет30,Счет37_2, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "05",	"+", "!ОБ",ОБ2(Счет31,Счет37_2), Счет31,Счет37_2, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31004", "Рядок 3100, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет63,Счет30),Счет63,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31004", "0", "+", "!ОБ",ОБ2(Счет63,Счет31),Счет63,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31054", "Рядок 3105, графа ""За попередній період.""",	"+","!ОБ",ОБ2(Счет66,Счет30),Счет66,Счет30, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31054", "", "+","!ОБ",ОБ2(Счет66,Счет31),Счет66,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31104", "Рядок 3110, графа ""За попередній період.""",	"+", "!ОБ",ОБ2(Счет65_1,Счет31), Счет65_1,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31104", "", "+", "!ОБ",ОБ2(Счет65_2,Счет31),Счет65_2,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31104", "", "+", "!ОБ",ОБ2(Счет65_3,Счет31),Счет65_3,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31104", "", "+", "!ОБ",ОБ2(Счет65_6,Счет31),Счет65_6,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П31154", "Рядок 3115, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет64,Счет31), Счет64,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П31164", "Рядок 3116, графа ""За попередній період""",	"+", "!ОБ",П31164, Счет64_1_3,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П31174", "Рядок 3117, графа ""За попередній період""",	"+", "!ОБ",П31174, Счет64_1_2,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П31184", "Рядок 3118, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет64,Счет31), Счет64,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П31184", "",	"-", "!ОБ",ОБ2(Счет64_1_2,Счет31), Счет64_1_2,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П31184", "",	"-", "!ОБ",ОБ2(Счет64_1_3,Счет31), Счет64_1_3,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31354", "Рядок 3135, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет37_1,Счет30),Счет37_1,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31354", "0", "+", "!ОБ",ОБ2(Счет37_1,Счет31),Счет37_1,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "Рядок 3140, графа ""За попередній період.""",	"+", "!ОБ",ОБ2(Счет68_1,Счет30),Счет68_1,Счет30, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет68_1,Счет31),Счет68_1,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет36,Счет30),Счет36,Счет30, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет36,Счет31),Счет36,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет68_5,Счет30),Счет68_5,Счет30, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет68_5,Счет31),Счет68_5,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет37_7_1,Счет30),Счет37_7_1,Счет30, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет37_7_1,Счет31),Счет37_7_1,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет37_7_2,Счет30),Счет37_7_2,Счет30, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31404", "0", "+", "!ОБ",ОБ2(Счет37_7_2,Счет31),Счет37_7_2,Счет31, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "Рядок 3190, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет68_4,Счет30), Счет68_4,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "20", "+", "!ОБ",ОБ2(Счет68_4,Счет31), Счет68_4,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "19", "+", "!КО",КО2(Счет33), Счет33, ,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "18", "-", "!ОБ",ОБ2(Счет33,  Счет33), Счет33,Счет33,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "17", "-", "!ОБ",ОБ2(Счет30,  Счет33), Счет30,Счет33,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "16", "-", "!ОБ",ОБ2(Счет31,  Счет33), Счет31,Счет33,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "15", "+", "!ОБ",ОБ2(Счет37_2,Счет30), Счет37_2,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "14", "+", "!ОБ",ОБ2(Счет37_2,Счет31), Счет37_2,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "13", "+", "!ОБ",ОБ2(Счет37_7_3,Счет30), Счет37_7_3,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "12", "+", "!ОБ",ОБ2(Счет37_7_3,Счет31), Счет37_7_3,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "11",	"+", "# оборот по счету 99 актуален в отчетах 2013 и 2014 годов",0);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "10", "+", "!ОБ",ОБ2(Счет99,Счет30), Счет99,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "09", "+", "!ОБ",ОБ2(Счет99,Счет31), Счет99,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	Если ИспКлассыСчетов = Перечисления.КлассыСчетовРасходов.Класс9 Тогда
		...
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "08", "+", "!ОБ",ОБ2(Счет91,Счет30), Счет91,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "07", "+", "!ОБ",ОБ2(Счет91,Счет31), Счет91,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "06", "+", "!ОБ",ОБ2(Счет92,Счет30), Счет92,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "05", "+", "!ОБ",ОБ2(Счет92,Счет31), Счет92,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "04", "+", "!ОБ",ОБ2(Счет93,Счет30), Счет93,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "03", "+", "!ОБ",ОБ2(Счет93,Счет31), Счет93,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "02", "+", "!ОБ",ОБ2(Счет94,Счет30), Счет94,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "01", "+", "!ОБ",ОБ2(Счет94,Счет31), Счет94,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		
	ИначеЕсли ИспКлассыСчетов = Перечисления.КлассыСчетовРасходов.Класс8и9 Тогда	
		
		П31904 = П31904 + ОБ2(Счет84,Счет30) + ОБ2(Счет84,Счет31);
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "08", "+", "!ОБ",ОБ2(Счет84,Счет30), Счет84,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "07", "+", "!ОБ",ОБ2(Счет84,Счет31), Счет84,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П32004", "Рядок 3200, графа ""За попередній період""", "+", "!КО",П32004, Счет74_1,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П32154", "Рядок 3215, графа ""За попередній період""",	"+", "!КО",П32154, Счет73_2,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П32204", "Рядок 3220, графа ""За попередній період""",	"+", "!КО",П32204, Счет73_1,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П32254", "Рядок 3225, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет37_9),Счет30,Счет37_9,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П32254", "","+", "!ОБ",ОБ2(Счет31,Счет37_9),Счет31,Счет37_9,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П32504", "Рядок 3250, графа ""За попередній період""",	"+", "!КО",КО2(Счет73), Счет73,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П32504", "0",	"-", "!КО",П32204, Счет73_1,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П32504", "0",	"-", "!КО",П32154, Счет73_2,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П32554", "Рядок 3255, графа ""За попередній період""",	"+", "!ДО",ДО2(Счет14), Счет14,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П32554", "",	"+", "!ДО",ДО2(Счет35_2), Счет35_2,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П32704", "Рядок 3270, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет37_9,Счет30),Счет37_9,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П32704", "","+", "!ОБ",ОБ2(Счет37_9,Счет31),Счет37_9,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33004", "Рядок 3300, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет41), Счет30,Счет41,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33004", "",	"+", "!ОБ",ОБ2(Счет30,Счет42),Счет30,Счет42,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33004", "",	"+", "!ОБ",ОБ2(Счет30,Счет45),Счет30,Счет45,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33004", "",	"+", "!ОБ",ОБ2(Счет30,Счет46),Счет30,Счет46,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33004", "",	"+", "!ОБ",ОБ2(Счет31,Счет41),Счет31,Счет41,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33004", "",	"+", "!ОБ",ОБ2(Счет31,Счет42),Счет31,Счет42,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33004", "",	"+", "!ОБ",ОБ2(Счет31,Счет45),Счет31,Счет45,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33004", "",	"+", "!ОБ",ОБ2(Счет31,Счет46),Счет31,Счет46,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33054", "Рядок 3305, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет50), Счет30,Счет50,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33054", "",	"+", "!ОБ",ОБ2(Счет30,Счет60),Счет30,Счет60,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33054", "",	"+", "!ОБ",ОБ2(Счет30,Счет52),Счет30,Счет52,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33054", "",	"+", "!ОБ",ОБ2(Счет31,Счет50),Счет31,Счет50,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33054", "",	"+", "!ОБ",ОБ2(Счет31,Счет60),Счет31,Счет60,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33054", "",	"+", "!ОБ",ОБ2(Счет31,Счет52),Счет31,Счет52,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33404", "Рядок 3340, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,Счет55), Счет30,Счет55,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П33404", "0",	"+", "!ОБ",ОБ2(Счет31,Счет55),Счет31,Счет55,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33454", "Рядок 3345, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет45,Счет30), Счет45,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33454", "",	"+", "!ОБ",ОБ2(Счет45,Счет31),Счет45,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33504", "Рядок 3350, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет50,Счет30), Счет50,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33504", "",	"+", "!ОБ",ОБ2(Счет52,Счет30),Счет52,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33504", "",	"+", "!ОБ",ОБ2(Счет55,Счет30),Счет55,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33504", "",	"+", "!ОБ",ОБ2(Счет60,Счет30),Счет60,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33504", "",	"+", "!ОБ",ОБ2(Счет50,Счет31),Счет50,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33504", "",	"+", "!ОБ",ОБ2(Счет52,Счет31),Счет52,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33504", "",	"+", "!ОБ",ОБ2(Счет55,Счет31),Счет55,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33504", "",	"+", "!ОБ",ОБ2(Счет60,Счет31),Счет60,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33554", "Рядок 3355, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет67_1,Счет30), Счет67_1,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33554", "",	"+", "!ОБ",ОБ2(Счет67_1,Счет31),Счет67_1,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33604", "Рядок 3360, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет95_1,Счет30), Счет95_1,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33604", "",	"+", "!ОБ",ОБ2(Счет95_1,Счет31),Счет95_1,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33654", "Рядок 3365, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет95_2,Счет30), Счет95_2,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33654", "",	"+", "!ОБ",ОБ2(Счет95_2,Счет31),Счет95_2,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33904", "Рядок 3390, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет53,Счет30), Счет53,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П33904", "0",	"+", "!ОБ",ОБ2(Счет53,Счет31),Счет53,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П34054", "Рядок 3405, графа ""За попередній період""",	"+", "!CНД2",СНД2(Счет30), Счет30,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П34054", "",	"+", "!CНД2",СНД2(Счет31),Счет31,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	_ДобавитьСтрокуРасшифровки( ЭтаФорма,"_П34054", "",	"+", "!CНД2",СНД2(Счет33),Счет33,,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации()  =  "БП" Тогда
		...
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "Рядок 3410, графа ""За попередній період""",	"+", "!ОБ",ОБ2(Счет30,СчетДоходовОпер), Счет30,СчетДоходовОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "",	"+", "!ОБ",ОБ2(Счет31,СчетДоходовОпер),Счет31,СчетДоходовОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "",	"+", "!ОБ",ОБ2(Счет33,СчетДоходовОпер),Счет33,СчетДоходовОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "",	"+", "!ОБ",ОБ2(Счет30,СчетДоходовНеОпер),Счет30,СчетДоходовНеОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "",	"+", "!ОБ",ОБ2(Счет31,СчетДоходовНеОпер),Счет31,СчетДоходовНеОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "",	"+", "!ОБ",ОБ2(Счет33,СчетДоходовНеОпер),Счет33,СчетДоходовНеОпер,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "",	"-", "!ОБ",ОБ2(СчетЗатратНеОпер,Счет30),СчетЗатратНеОпер,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "",	"-", "!ОБ",ОБ2(СчетЗатратНеОпер,Счет31),СчетЗатратНеОпер,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"П34104", "",	"-", "!ОБ",ОБ2(СчетЗатратНеОпер,Счет33),СчетЗатратНеОпер,Счет33,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		...
		ЗапросКурсоваяРазницаЗатратОпер.УстановитьПараметр("ДатаКон", КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		ВыборкаКурсоваяРазницаЗатратОпер = ЗапросКурсоваяРазницаЗатратОпер.Выполнить().Выбрать();
		Если ВыборкаКурсоваяРазницаЗатратОпер.Следующий() Тогда
	...
	Для Каждого КорСчет Из СчетаДС Цикл
		...
		Для Каждого Счет Из Счета Цикл
			...
			_ДобавитьСтрокуРасшифровки( ЭтаФорма, ИмяЯчейки, 
																	...
																	?(ДанныеПрошлогоГода, КонецГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета,-12)), Неопределено),
																	,,,,
																	,СписокДоговоров);
