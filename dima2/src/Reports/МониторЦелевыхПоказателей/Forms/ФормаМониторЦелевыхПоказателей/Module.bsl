...
Процедура НарисоватьДиаграмму(ВариантАнализа, ИсточникДанных, ГруппаЭлементов, ИдентификаторЭлементаФормы)
	...
	Если ВыводитьКартинкиСостоянияИТренда Тогда
		...
		МассивРеквизитов.Добавить(Новый РеквизитФормы("КартинкаТренда__" + ИдентификаторЭлементаФормы, ОписаниеТипов, "", НСтр("ru='Картинка тренда';uk='Картинка тренда'")));
	КонецЕсли;
...
Процедура НарисоватьКратко(ВариантАнализа, ИсточникДанных, ГруппаЭлементов, ИдентификаторЭлементаФормы)
	...
	Если ВыводитьКартинкиСостоянияИТренда Тогда
		...
		МассивРеквизитов.Добавить(Новый РеквизитФормы("КартинкаТренда__" + ИдентификаторЭлементаФормы, ОписаниеТиповКартинок, "", НСтр("ru='Картинка тренда';uk='Картинка тренда'")));
	КонецЕсли;
...
Процедура НарисоватьПоляСправкиОПоказателе(ВариантАнализа, ИсточникДанных, ГруппаЭлементов, ИдентификаторЭлементаФормы)
	...
	МассивРеквизитов.Добавить(Новый РеквизитФормы("ЦельЗначение__" + ИдентификаторЭлементаФормы, ОписаниеТиповСтрок, "", НСтр("ru='Значение цели';uk='Значення мети'")));
	...
	// Заполним значения созданных полей
	ЭтаФорма["ЦельЗаголовок__" + ИдентификаторЭлементаФормы]	= НСтр("ru='Цель:';uk='Мета:'");
