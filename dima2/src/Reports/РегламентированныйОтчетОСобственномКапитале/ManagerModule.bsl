...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     =  НСтр("ru='Приложение к П(с)БУ №1 ""Общие требования к финансовой отчетности"" с изменениями внесенными Приказом Минфина Украины от 07.02.2013 №73';uk='Додаток до П(с)БО №1 ""Загальні вимоги до фінансової звітності"" зі змінами внесеними Наказом Мінфіну України від 07.02.2013 №73'");
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20130101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "", '2013-02-07'		,"73"				,"ФормаОтчета2014Кв1УФ");
