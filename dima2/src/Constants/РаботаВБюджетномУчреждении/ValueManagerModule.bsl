...
Процедура ПередЗаписью(Отказ)
	...
	Если Не УчетБюджетныхУчрежденийСуществует Тогда
		Если Значение Тогда
			ВызватьИсключение НСтр("ru='Нельзя установить значение РаботаВБюджетномУчреждении';uk='Не можна встановити значення РаботаВБюджетномУчреждении'");
		КонецЕсли;
	КонецЕсли;
	...
	Если УчетБюджетныхУчрежденийСуществует И Не УчетХозрасчетныхОрганизацийСуществует И Не Значение Тогда 
		ВызватьИсключение НСтр("ru='Нельзя сбросить значение РаботаВБюджетномУчреждении';uk='Не можна скинути значення РаботаВБюджетномУчреждении'");
	КонецЕсли;
