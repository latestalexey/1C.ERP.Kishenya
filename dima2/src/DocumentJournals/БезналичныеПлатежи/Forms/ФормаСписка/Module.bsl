...
Процедура ЗаполнитьКомандыСозданияДокументов()
	...
	//++ НЕ УТ
	ИспользоватьЗаймыСотрудникам                        = ПолучитьФункциональнуюОпцию("ИспользоватьЗаймыСотрудникам") И ПолучитьФункциональнуюОпцию("ИспользоватьНачислениеЗарплаты")
...
Процедура УстановитьКонстантыСписков()
	...
	//++ НЕ УТ
	Если Не ИспользоватьЗаявкиНаРасходованиеДенежныхСредств Тогда
		ЗаказыКОплате.Параметры.УстановитьЗначениеПараметра("ВалютаРегламентированногоУчета",
...
Процедура ИнициализироватьСписокОперацийОплаты()
	...
	Если ИспользоватьЗаявкиНаРасходованиеДенежныхСредств Тогда
		...
		СписокОпераций.Добавить(Операции.ОплатаЛизингодателю);
	Иначе
		...
		//++ НЕ УТ
		СписокОпераций.Добавить("ВыводитьВедомостиНаВыплатуЗарплаты", НСтр("ru='Ведомости на выплату зарплаты';uk='Відомості на виплату зарплати'"));
		//-- НЕ УТ
