...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТ
	Элементы.СписокСоздатьПоступлениеДенежныхДокументов.Видимость  = ПравоДоступа("Добавление", Метаданные.Документы.ПоступлениеДенежныхДокументов);
	//-- НЕ УТ
...
Процедура СоздатьПоступлениеДенежныхДокументов(Команда)
	...
	ОткрытьФорму("Документ.ПоступлениеДенежныхДокументов.ФормаОбъекта", СтруктураПараметры, ЭтаФорма);
	//-- НЕ УТ
	Возврат;
...
Функция ТекстЗапросаСписка()
	...
	|	,
	|	ВЫБОР
	|		КОГДА ДанныеДокумента.Тип = ТИП(Документ.ПоступлениеДенежныхДокументов)
	|			ТОГДА ВЫРАЗИТЬ(ДанныеДокумента.Ссылка КАК Документ.ПоступлениеДенежныхДокументов)
	|	КОНЕЦ КАК СсылкаПоступлениеДенежныхДокументов
	//-- НЕ УТ
	|ИЗ
